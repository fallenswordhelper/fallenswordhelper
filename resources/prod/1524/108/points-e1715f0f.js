import{j as n,a5 as t,g as e,s as a,al as s,am as i,r as l,ab as r,c as o,b as c,i as m,a6 as u,a7 as f}from"./calfSystem-34913441.js"
import{c as p}from"./createSpan-d7c936c3.js"
import{i as d}from"./insertTextBeforeEnd-90772609.js"
import{n as b}from"./numberIsNaN-a40c3bbb.js"
import{i as x}from"./intValue-e1798d0a.js"
import{p as g}from"./parseGoldUpgrades-53f708da.js"
let S=0,E=0
const h={}
...
e*i<=E?(l=e*s,a.className="fshBlue"):a.className="fshRed",u(`(+${l} stamina)`,a)}function $(n,t,e){const{target:a}=e,s=Number(a.value),i=function(n,t){if(h[n]||(h[n]={}),!h[n].span){const e=p()
d(t," "),m(t,e),h[n].span=e}return h[n].span}(n,t)
b(s)||0===s?i.className="fshHide":y(n,t,s,i)}function k(n){const t=N(n)
c(t.nextElementSibling.nextElementSibling.nextElementSibling.children[0].rows[0].cells[0].children[0],"keyup",o($,n,t))}function v(){E=x(t(e("statbar-fsp"))),k("Current"),k("Maximum"),a(`<a href="${s}${i}marketplace">Sell at Marketplace</a>`,N("Gold").nextElementSibling.nextElementSibling.nextElementSibling)}function C(n,t){const e=N(n).nextElementSibling.nextElementSibling
...
//# sourceMappingURL=points-e1715f0f.js.map
