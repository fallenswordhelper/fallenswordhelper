import{g as t}from"./getProfile-c2682b09.js"
import{e as n}from"./executeAll-ef9da8be.js"
import{q as s,s as e,aw as a,a5 as i,j as f,c,ad as o,v as r,g as u,ax as l,a7 as d,n as b,af as p,b as h,ab as m,K as k,w as q,o as g}from"./calfSystem-34913441.js"
import{i as y}from"./insertHtmlAfterEnd-feafb00f.js"
import{c as S}from"./createSpan-d7c936c3.js"
import{c as $}from"./csvSplit-21d1e5f2.js"
import{i as j}from"./insertElementAfter-639f3edf.js"
import{f as v}from"./formatLastActivity-8adc5cb7.js"
import{s as x}from"./setTipped-cc91a1bc.js"
import{o as T}from"./outputFormat-b1a8825f.js"
import{d as B,q as E}from"./quickbuffSuccess-68b38bf5.js"
...
const a=C(t.nextElementSibling.children[0].children[0]),i=function(t,n){if(!n){const n=S({className:"fshPlayer"})
...
x(s.replace("</center>",`<br>Stamina Cost: ${e}$&`),n),o.userIsDev&&r(t.parentNode,`<span></span> <span class="fshDodgerBlue tooltip-bottom-right" data-tooltip="Stamina Cost">${e}</span>`)}(t,n),M(t,n)}function O(){f('#buff-outer label[for^="skill-"]').forEach(G)}function P(t){const n=a("h1",u("players"))[0]
...
!function(t,n){E(n)&&(t.className="fshLime",e("On",t))}(n,await B([window.self],[n.dataset.buffid]))}const et=[]
...
for(const s of et[t])n.appendChild(s)}function ft(t){for(let n=1;n<=3;n++)t?at(`block${n}`):it(n)}function ct(t){m(F,t.target.checked),ft(t.target.checked)}function ot(){!function(){for(let t=1;t<=3;t++){const n=`block${t}`
et[t]=k(`#${n} > p`)}}()
const t=u("check-all")
y(t,_)
const n=s(".quickbuffSortCheckbox"),e=p(F)
n.checked=e,e&&ft(e),h(n,"change",ct)}function rt(){g(u("helperQBheader"),st),g(u("players"),L)}async function ut(){if(q())return
const s=u("quickbuff")
if(!s)return
const e=t(window.self)
y(s.children[0],'<div id="helperQBheader"><table class="quickbuffTable"><thead><tr><th class="quickbuffTableHeader">Sustain</th><th class="quickbuffTableHeader">Fury Caster</th><th class="quickbuffTableHeader">Guild Buffer</th><th class="quickbuffTableHeader">Buff Master</th><th class="quickbuffTableHeader">Extend</th><th class="quickbuffTableHeader">Reinforce</th></tr></thead><tbody><tr><td id="fshSus" class="quickbuffTableDetail">&nbsp;</td><td id="fshFur" class="quickbuffTableDetail">&nbsp;</td><td id="fshGB"  class="quickbuffTableDetail">&nbsp;</td><td id="fshBM"  class="quickbuffTableDetail">&nbsp;</td><td id="fshExt" class="quickbuffTableDetail">&nbsp;</td><td id="fshRI"  class="quickbuffTableDetail">&nbsp;</td></tr></tbody></table></div>'),n([O,Y,nt,rt,I,ot]),W(await e)}export{ut as default}
//# sourceMappingURL=quickBuff-380ce388.js.map
