import{b_ as t,ct as e,l as s,o as a,i as r,s as n,b as o,c,ao as i,aX as l,p as u,cs as g}from"./calfSystem-34913441.js"
import{l as d,r as p}from"./lastActivityToDays-2d0afe9f.js"
import{a as f}from"./all-414e0607.js"
import{c as E}from"./createTable-407ce13c.js"
import{c as h}from"./createButton-ae13c659.js"
import{c as m}from"./createInput-4ae8777b.js"
...
const _=(t,...e)=>(...s)=>e.reduce(((t,e)=>e(t)),t(...s)),y=(t,e)=>{const s=e||t.length
return(...e)=>{const a=e.length||1
if(s===a)return t(...e)
return y(((...s)=>t(...e,...s)),s-e.length)}},v=t=>e=>(t(e),e),C=t=>{const e=t.split("."),s=(t={},e=[])=>{const a=t[e.shift()]
...
const R=t=>e=>!t(e),L=t=>e=>Object.is(t,e),D=t=>e=>e<t,P=t=>e=>e>t,j=t=>e=>t===e,x={includes:t=>e=>e.includes(t),is:L,isNot:_(L,R),lt:D,gte:_(D,R),gt:P,lte:_(P,R),equals:j,notEquals:_(j,R),anyOf:t=>e=>t.includes(e)},M=t=>(...e)=>t.every((t=>t(...e))),w=({value:t="",operator:e="includes",type:s})=>{const a=(t=>{switch(t){case G.BOOLEAN:return Boolean
case G.NUMBER:return Number
case G.DATE:return t=>new Date(t)
case G.STRING:return _(String,(t=>t.toLowerCase()))
default:return t=>t}})(s),r=_(a,x[e])(t)
return _(a,r)},k=t=>{const e=(t=>{const e={}
...
var X
!function(t){t.TOGGLE_SORT="TOGGLE_SORT",t.DISPLAY_CHANGED="DISPLAY_CHANGED",t.PAGE_CHANGED="CHANGE_PAGE",t.EXEC_CHANGED="EXEC_CHANGED",t.FILTER_CHANGED="FILTER_CHANGED",t.SUMMARY_CHANGED="SUMMARY_CHANGED",t.SEARCH_CHANGED="SEARCH_CHANGED",t.EXEC_ERROR="EXEC_ERROR"}(X||(X={}))
const Y=t=>{const{get:e,set:s}=C(t)
return{get:e,set:y(s)}},B=({sortFactory:t,tableState:e,data:s,filterFactory:a,searchFactory:r})=>{let n=s.length,o=s
...
return e})(),i=Y("sort"),l=Y("slice"),u=Y("filter"),g=Y("search")
c.on("SUMMARY_CHANGED",(({filteredCount:t})=>{n=t}))
const d=t=>Object.assign({},t),p=y(c.dispatch,2),f=t=>(o=t,p("SUMMARY_CHANGED",{page:e.slice.page,size:e.slice.size,filteredCount:t.length})),E=y(((t,s,a)=>_(d,v(p(s)),t.set(e))(a))),h=()=>E(l,"CHANGE_PAGE",Object.assign({},l.get(e),{page:1})),m=(t,e)=>{const s=_(E(t,e),h,(()=>c.exec()))
return(t={})=>s(t)},b={sort:m(i,"TOGGLE_SORT"),filter:m(u,"FILTER_CHANGED"),search:m(g,"SEARCH_CHANGED"),slice:_(E(l,"CHANGE_PAGE"),(()=>c.exec())),exec:({processingDelay:n=20}={processingDelay:20})=>{c.dispatch("EXEC_CHANGED",{working:!0}),setTimeout((()=>{try{const n=a(u.get(e)),o=r(g.get(e)),d=t(i.get(e)),p=z(l.get(e)),E=_(n,o,v(f),d,p)(s)
...
return _(d,c,o,p)(s).map((t=>({index:s.indexOf(t),value:t})))},onDisplayChange(t){c.on("DISPLAY_CHANGED",t)},getTableState:()=>JSON.parse(JSON.stringify(e)),getMatchingItems:()=>[...o]},A=Object.assign(c,b)
...
return void 0===r?delete n[e]:Object.assign(n,{[e]:[{value:r,operator:s,type:a}]}),t.filter(n)},state:()=>t.getTableState().filter||{}},r)},J=U({SEARCH_CHANGED:"onSearchChange"}),Z=({table:t,scope:e=[]})=>{const s=J({emitter:t})
return Object.assign(s,{search:(s,a={})=>t.search(Object.assign({},{value:s,scope:e},a)),state:()=>t.getTableState().search},s)},K=U({CHANGE_PAGE:"onPageChange",SUMMARY_CHANGED:"onSummaryChange"}),V=({table:t})=>{let{slice:{page:e,size:s}}=t.getTableState(),a=t.filteredCount,r=s?Math.ceil(a/s):1
const n=K({emitter:t}),o={selectPage:e=>t.slice({page:e,size:s}),selectNextPage:()=>o.selectPage(e+1),selectPreviousPage:()=>o.selectPage(e-1),changePageSize:e=>t.slice({page:1,size:e}),isPreviousPageEnabled:()=>e>1,isNextPageEnabled:()=>r>e,state:()=>Object.assign(t.getTableState().slice,{filteredCount:a,pageCount:r})},c=Object.assign(o,n)
...
return e.addEventListener("input",l),"SELECT"===e.tagName&&e.addEventListener("change",l),i},lt=({el:t,table:e,delay:s=400,conf:a={}})=>{const r=a.scope||(t.getAttribute("data-st-search")||"").split(",").map((t=>t.trim())),n=a.flags||t.getAttribute("data-st-search-flags")||"",o=Z({table:e,scope:r}),c=ct((()=>{o.search(t.value,{flags:n})}),s)
...
a(ft,(()=>s.selectPage(1))),a(Et,(()=>s.selectPreviousPage())),a(mt,(()=>s.selectNextPage())),r(pt,ft),r(pt,Et),r(pt,ht),r(pt,mt),r(pt,bt),r(t,pt)}const _t=()=>m({dataset:{stSearch:"name, rank_name",stSearchFlags:"i"},placeholder:"Enter search term",required:!0,type:"text"})
function yt(e,a){const n=t("select",{innerHTML:'<option value="25">25</option><option value="50">50</option><option value="0" selected>All</option>'})
const c=s()
r(c,n),r(e,c)
const i=V({table:a})
...
return{top:e,domTable:a,bottom:r(t,s({className:"st-bottom-container"}))}}function Ht(t,e,o,c){yt(e,c),function(t,e){const n=s({className:"fsh-search-wrapper"}),o=_t(),c=h({innerHTML:"&times;"}),i=Z({table:e})
a(c,(()=>{o.value="",o.focus(),i.search("")})),r(n,o),r(n,c),r(t,n)}(e,c),function(t,e,a){const o=s()
r(t,o),V({table:e}).onSummaryChange((({page:t,size:e,filteredCount:s})=>{let r=0
...
n("Loading...",t)
const e=await f([g(),p()]);(([t,e])=>t?.guild_id&&e?.s)(e)&&Lt(t,e)}export{Dt as default}
//# sourceMappingURL=whosGotWhat-95679263.js.map
