...
import{S as s,L as n,M as e,bj as a,bk as o,be as l,bh as r,bl as c,O as i,P as u,Q as f,T as m,U as p,X as b,a0 as h,a3 as d,s as $,aQ as g,aS as v,m as x,q as k,ax as j,a8 as y,as as S,di as L,_ as M,N as _,am as C,b6 as q,bt as w,a4 as z}from"./calfSystem-Dr91xfiU.js"
import{h as B,u as F}from"./await_block-BURScWZB.js"
import{M as N}from"./ModalTitled-D7-oeBYs.js"
...
e.length=n.length}},d(t){t&&h(s),q(e,t)}}}function O(t){let s,n,e,a,o,l,r,c,b,$,g,v=t[8]+"",x=t[9]+""
return{c(){s=i("br"),n=u(),e=i("span"),a=i("a"),o=d(v),r=d("\n          says:"),c=u(),b=i("q"),$=d(x),g=u(),f(a,"href",l=""+(w+t[7])),f(a,"class","svelte-14ozmrh")},m(t,l){m(t,s,l),m(t,n,l),m(t,e,l),p(e,a),p(a,o),p(e,r),m(t,c,l),m(t,b,l),p(b,$),p(b,g)},p(t,s){2&s&&v!==(v=t[8]+"")&&z(o,v),2&s&&l!==(l=""+(w+t[7]))&&f(a,"href",l),2&s&&x!==(x=t[9]+"")&&z($,x)},d(t){t&&(h(s),h(n),h(e),h(c),h(b))}}}function P(t){return{c:M,m:M,p:M,d:M}}function U(t){let s,n,e,a,o,l,r={ctx:t,current:null,token:null,hasCatch:!1,pending:P,then:H,catch:Q}
...
n(1,a=t.split("<br>").map(o).filter(l))},function(){v("fsh_fsboxcontent",""),$("FS Box Log","clear storage"),n(1,a=[])}]}var E=class extends s{constructor(t){super(),n(this,t,D,A,e,{visible:0})}}
const G={visible:!0}
let I=0
function J(){I=t(G,I,E)}export{J as default}
//# sourceMappingURL=fsboxlog-CuTINQff.js.map
