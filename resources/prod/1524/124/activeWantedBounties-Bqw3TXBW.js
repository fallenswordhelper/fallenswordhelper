import{G as e,ag as n,i as t,dw as s,m as r,a7 as i,d as a,dx as o,v as c,a8 as u,q as l,a2 as f,ai as d,ae as p,g as b,aq as h,H as m,r as L,w as g,o as w,s as y}from"./calfSystem-0LeC9ahe.js"
import{f as v}from"./functionPasses-BXOT6NCP.js"
import{c as $}from"./createSpan-D5kgkTbn.js"
import{b as N}from"./now-Cx4PsKjI.js"
import{s as R}from"./shouldBeArray-BQeS0A9Y.js"
...
de(await x(1))}else!function(e,n){n&&(O().isRefreshed=!1,re()),e&&(E().isRefreshed=!1,Z())}(n.enableActiveBountyList,n.enableWantedList)}function he(e,n){y("activeWantedBounties",e),i(n,null),be()}function me(e){e.target===Q()&&he("getBountyListReset","bountyList"),e.target===ee()&&he("getWantedListReset","wantedList")}function Le(){g()||(n.enableActiveBountyList&&(k=A(),t(s(),k)),n.enableWantedList&&(T=A(),t(s(),T)),B()&&w(B(),me),j()&&w(j(),me),be())}export{Le as default}
//# sourceMappingURL=activeWantedBounties-Bqw3TXBW.js.map
