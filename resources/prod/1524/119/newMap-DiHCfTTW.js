...
import{ag as t,m as a,g as n,a9 as r,i as o,c as s,v as l,o as i,s as c,aC as u,aD as f,aE as d,aF as m,aG as p,aH as h,y as g,b as v,ai as b,aI as w,aJ as k,aK as y,aL as C,aM as L,ae as V,k as D,aA as M,q as x,aN as A,aO as S,aP as N,aQ as H,D as B,aR as T,aS as q,aT as E,aU as G,aV as P,aW as j,aX as F,aY as R,aZ as _,a_ as O,a$ as I,aj as W,a8 as K,b0 as Y,b1 as U,b2 as z,a as Q,$ as X,S as J,L as Z,M as ee,am as te,T as ae,_ as ne,a0 as re,O as oe,a3 as se,b3 as le,U as ie,a4 as ce,N as ue,P as fe,Q as de,b4 as me,b5 as pe,b6 as he,b7 as ge,Z as ve,X as be,a5 as we,b8 as ke,d as ye,b9 as Ce,ba as $e,bb as Le,E as Ve,bc as De,bd as Me,be as xe,bf as Ae,bg as Se,bh as Ne,bi as He,bj as Be,bk as Te,bl as qe,bm as Ee,bn as Ge,bo as Pe,bp as je,bq as Fe,br as Re,bs as _e,bt as Oe,bu as Ie,bv as We,bw as Ke,bx as Ye,by as Ue,bz as ze,bA as Qe,bB as Xe,bC as Je,bD as Ze,bE as et,bF as tt,bG as at,ah as nt}from"./calfSystem-Bit7wh4p.js"
import{i as rt}from"./insertElementAfter-ClbOKY3i.js"
import{t as ot}from"./toggleForce-br4z9gGd.js"
import{c as st}from"./createSpan-Ctesn2Q0.js"
import{i as lt}from"./insertTextBeforeEnd-Emnx41uB.js"
import{r as it,a as ct}from"./roundToString-Hif1MLyB.js"
import{a as ut}from"./addCommas-C_h2HN8s.js"
import{d as ft,q as dt}from"./quickbuffSuccess-CPtOyYNo.js"
import{c as mt}from"./createButton-G25vRD8t.js"
import{i as pt}from"./isArray-eVldfhw1.js"
import{o as ht}from"./openQuickBuffById-CejqyxyX.js"
import{c as gt}from"./createInput-Bw3IEiqp.js"
import{c as vt}from"./createLabel-CcGPYvi1.js"
import{r as bt}from"./rnd-D_QmA-Fa.js"
import{v as wt}from"./valueText-BctNKhqv.js"
import{c as kt}from"./createStyle-DpQOQW1V.js"
import{h as yt,u as Ct}from"./await_block-DiXVycKW.js"
import{u as $t}from"./uniq-CyVUXBym.js"
import{g as Lt}from"./guild-C79yJSIH.js"
import{c as Vt}from"./createTable-BIZt1kav.js"
import{g as Dt,t as Mt,a as xt}from"./getTitanString-DvEb_zLX.js"
import{n as At,a as St,s as Nt,r as Ht}from"./now-Cx4PsKjI.js"
import{p as Bt}from"./padZ-DFV6JBPu.js"
import{f as Tt}from"./fshOpen-AuKioUPF.js"
import{L as qt}from"./LinkButton-DERL_IYP.js"
import{r as Et}from"./reduceBuffArray-Diy1E3zc.js"
import{p as Gt}from"./profile-DqDi87Jh.js"
import{a as Pt}from"./all-YfMtr2SN.js"
import{n as jt}from"./numberIsNaN-CGkd1jiA.js"
import{r as Ft}from"./reliclist-0HdhXtED.js"
import{d as Rt}from"./daGroupStats-BnVv7ik7.js"
import{d as _t,m as Ot}from"./mercEffect-DtkWoVvA.js"
import{d as It}from"./daViewGroups-CSOAoOtl.js"
import{a as Wt}from"./attribsToArray-ok6eqWre.js"
import{g as Kt}from"./guildMembers-DVol-0Bs.js"
import{r as Yt}from"./remainingPages-BzskAxSU.js"
import{t as Ut}from"./testQuant-CUL735o8.js"
import{m as zt}from"./myStats-BF2M0N-_.js"
import{s as Qt}from"./shouldBeArray-CVwykJMd.js"
import{h as Xt}from"./hideElement--vKgDzDU.js"
import{s as Jt,j as Zt}from"./simpleCheckbox-B_EbohVT.js"
import{i as ea}from"./isSelected-BWnMzKlW.js"
import{b as ta}from"./bitwiseAnd-C5gmj-aX.js"
import"./buffReportParser-Bxs1JyzN.js"
import"./buffObj-BIwiFUIW.js"
import"./guildGroups-CAHGjeii.js"
import"./view-BefHcwCp.js"
...
Va.className=function(e){return xa[e]??"fshGreen"}(a),r(a,Da)}function Sa(e,t,a){t||a?Aa(e,t):Va&&ot(Va,!0)}function Na(e){return 0===e.type}let Ha=0,Ba=0,Ta=0,qa=0,Ea=0,Ga=0
...
return pt(e)&&e.some(Na)}(),Ga=GameData.player().killStreak}function ja(){!function(){const e=$("#actionlist-shield-imp")
...
return o(t,s),o(e.worldName,t),n}let Ia=0,Wa=0,Ka=0,Ya=0,Ua=0,za=0,Qa=0,Xa=0,Ja=0
...
function Yn(e,t){return wt(G(t,e))}function Un(){var e
qn=GameData.player().level,e=n("statbar-character-tooltip-stats"),Gn=Yn(e,P),En=Yn(e,j),jn=Yn(e,F),Pn=Yn(e,R),Fn=Yn(e,_)}const zn=e=>`<td>${e}:&nbsp;</td>`,Qn=e=>`<td width="40%">${e}</td>`
function Xn([e,t,a,n,r]){return[zn(e),Qn(`${t} (your ${a}:<span class="${n}">${r()}</span>)`)]}function Jn(e){return["<tr>",...e,"</tr>"].join("")}function Zn(e,t){return Jn([...Xn(e),...Xn(t)])}const er='<tr><td colspan="4" height="5"></td></tr><tr><td class="header" colspan="4" class="fshCenter">Enhancements</td></tr>'
function tr(e){return`<tr><td colspan="2">${e.name}:</td><td colspan="2">${e.value}</td></tr>`}function ar(e,t,a){return function(e){return`<table><tr><td><img src="${A}creatures/${e.image_id}.png" height="200" width="200"></td><td rowspan="2"><table width="400"><tr><td class="header" colspan="4" class="fshCenter">Statistics</td></tr>`}(e)+function(e,t){return Jn([zn("Class"),Qn(e.creature_class),...Xn(["Level",e.level,"level",t,Rn])])}(e,a)+function(e){return Zn(["Attack",e.attack,"defense","fshYellow",_n],["Defense",e.defense,"attack","fshYellow",On])}(e)+function(e){return Zn(["Armor",e.armor,"damage","fshYellow",In],["Damage",e.damage,"armor","fshYellow",Wn])}(e)+function(e,t){return Jn([zn("HP"),Qn(`${e.hp} (your HP:<span class="fshYellow">${Kn()}</span>)(1H: <span class="fshRed">${t}</span>)`),zn("Gold"),Qn(e.gold)])}(e,t)+er+function(e){return 0===e.enhancements.length?'<tr><td colspan="4">[no enhancements]</td></tr>':e.enhancements.map(tr).join("")}(e)+function(e){return`<tr><td colspan="4" height="5"></td></tr><tr><td class="header" colspan="4" class="fshCenter">Description</td></tr><tr><td colspan="4">${e.description}</td></tr><tr><td colspan="4" height="5"></td></tr></table></td></tr><tr><td class="fshCenter"><b>${e.name}</b></td></tr></table>`}(e)}function nr(e){if(!An(e))return function(e){const a=Math.ceil(e.hp*t.hpVariable+e.armor*t.generalVariable)
let n="fshYellow"
...
return[r,e=>$t(e,"msg").map((({msg:t,type:a})=>({msg:t,type:a,count:e.filter((({msg:e})=>e===t)).length}))),i,e=>i(e)]}class jr extends J{constructor(e){super(),Z(this,e,Pr,Gr,ee,{})}}let Fr=0
...
function Qr(e){var a
An(e)||(a=e.response.data,t.showMonsterLog&&Yr(a))}function Xr(e,t){return e.id===t.id}async function Jr(e,t){if(6!==e.type||function(e){if(zr.find(s(Xr,e.data)))return!0
...
return o(e,Eo()),lt(e,"/"),o(e,Go()),e}function Uo(e){const t=st()
return o(t,e),lt(t,"%"),t}let zo=0,Qo=0,Xo=""
const Jo=()=>Qo,Zo=()=>Xo
function es(){Qo=null,zo&&!B("fshHide",zo)&&(ot(zo,!0),ye("&nbsp;",Vo),ye("&nbsp;",Do),r("",Mo),r("",xo),r("",Ao),r("",So),r("",No),ye("",Ho),ye("",Bo),Ko())}function ts(e){return 0===e.type&&(Qo=e.base_creature_id,Xo=`(${e.x},${e.y})`,!0)}function as(){if(zo)ot(zo,!1)
else{const e=n("actionContainer")
zo=a({className:"fshActionBox titanInfo"}),Oo(),Io=Vt({className:"fshCenter"}),Lo(),so(Io,[[[[5,To,!0],[1,qo,!0]]],[[[2,yo,!0],[4,$o,!0]]],[[[2,Yo],[4,Po]]],[[[2,go,!0],[4,s(Uo,jo())]],!0],[[[2,Co,!0],[4,s(Uo,Fo())]],!0],[[[2,ko,!0],[4,Ro]],!0],[[[6,_o]]],[[[2,bo,!0],[2,vo,!0],[2,wo,!0]]]]),o(zo,Wo()),o(e,zo)}}function ns(e){return e<=0?'<span class="fshGreen cooldown">No active cooldown</span>':`<span class="fshMaroon cooldown">Cooldown until: ${function(e){const t=new Date(At()+1e3*e)
return`${Bt(t.getHours())}:${Bt(t.getMinutes())} ${Bt(t.getDate())}/${Ce[t.getMonth()]}/${t.getFullYear()}`}(e)}</span>`}function rs(e){return ct(xt(e.max_hp-e.current_hp,e.kills),2)}function os(e){return ct(100*e.kills/e.max_hp,2)}function ss(e){!function(e){[[Mt(e.creature.name),To],[Zo(),qo],[e.current_hp,Eo],[e.max_hp,Go],[e.kills,Po],[rs(e),jo],[os(e),Fo]].forEach((([e,t])=>r(e,t())))}(e),ye(function(e){return Dt(e.kills,e.max_hp,e.current_hp)}(e),Ro()),ye(ns(e.cooldown),_o())}function ls(e,t){return[[[2,()=>Fa(t.player.name)],[2,()=>Fa(t.kills.toString())],[2,()=>Fa(`${ct(100*t.kills/e.kills,2)}%`)]]]}function is(e){return e.realm&&e.creature.base_id===Jo()&&e.realm===to()}function cs(e){const t=e.find(is)
...
return a=new qt({props:{$$slots:{default:[bs]},$$scope:{ctx:e}}}),a.$on("click",(function(...t){return e[3](e[5],e[7],...t)})),{c(){t=oe("li"),Ne(a.$$.fragment),n=fe()},m(e,o){ae(e,t,o),He(a,t,null),ie(t,n),r=!0},p(t,n){e=t
const r={}
...
return function(e,t){Ls.forEach(s(Vs,e,t))}(a,e),function(e,t){Ds.forEach(s(Ms,e,t))}(a,t),a.superEliteSlayerMultiplier=it(.002*a.superEliteSlayerLevel,2),jt(a.armorValue)&&function(e){e.attackValue=$s(e.attackBonus,e.levelValue),e.defenseValue=$s(e.defenseBonus,e.levelValue),e.armorValue=$s(e.armorBonus,e.levelValue),e.damageValue=$s(e.damageBonus,e.levelValue),e.hpValue=e.hpBonus}(a),a}const As=Ge(["statusStore","Done."])
let Ss=[]
...
const a=[]
await Pt(e.map((async(e,n)=>{const r=await Gt(e)
...
r&&t({attack:r[0],defense:r[1],armor:r[2],hp:r[3],damage:r[4]}),As.set(["groupStore","Done."])}const Os=Ee(Fs,((e,t)=>{_s(e,t)})),Is=(e,t,a)=>Math.ceil(e*je(t,0)*a),Ws=(e,t)=>Is(e,t,.0025),Ks=(e,t)=>Is(e,t,.001),Ys=Ks,Us=Ks,zs=Ks,Qs=Ks,Xs=Ks,Js=(e,t)=>Math.ceil(e*(1+.001*je(t,0))),Zs=(e,t)=>Math.ceil(e*(1-t*Fe)),el=Ge([]),tl=Ee(el,((e,t)=>{e&&t(Et(e))})),al=Ee([tl,Os],(([e,t],a)=>{if(!e||!t)return
const n=Js(t.defense,e.Constitution),r=Ys(n,e.Fortitude),o=t.hp+r,s=Us(o,e["Chi Strike"])
...
const n=Ws(t.attackValue,e.nightmareVisageLevel),r=Js(t.defenseValue,e.constitutionLevel),o=Ys(r,e.fortitudeLevel),s=t.hpValue+o,l=Us(s,e.chiStrikeLevel),i=t.damageValue+l
...
return{c(){t=oe("button"),t.textContent="Fetch Stats",de(t,"class","custombutton"),de(t,"type","button")},m(r,o){ae(r,t,o),a||(n=be(t,"click",e[12]),a=!0)},p:ne,d(e){e&&re(t),a=!1,n()}}}function Cl(e){let t,a,n,r,o,s,l,i,c,u,f,d,m,p,h,g,v,b,w,k,y,C,$,L,V,D,M,x,A,S,N,H,B,T,q,E,G,P,j,F,R,_,O,I,W,K,Y,U,z,Q,X,J,Z,ee,te,ne,le,ue,me,pe,he,ge,ve,be,we,ke,ye,Ce,$e,Le,Ve,Me,xe,Se,Te,qe,Ee,Ge,Pe,je,Fe,Re,_e,Oe,Ie,We,Ke,Ye,Ue,ze,Qe,Xe,Je,Ze,et,tt,at,nt,rt,ot,st,lt,it,ct,ut,ft,dt,mt,pt,ht,gt,vt,bt,wt,kt,yt,Ct,$t,Lt,Vt,Dt,Mt,xt,At,St,Nt,Ht,Bt=e[3].noOfRelics+"",Tt=e[3].leadDefenderBonus+"",qt=e[5].attackValue+"",Et=e[6].attack+"",Gt=e[5].defenseValue+"",Pt=e[6].defense+"",jt=e[5].armorValue+"",Ft=e[6].armor+"",Rt=e[5].damageValue+"",_t=e[6].damage+"",Ot=e[5].hpValue+"",It=e[6].hp+"",Wt=e[5].cloaked+"",Kt=e[6].dc225+"",Yt=e[6].dc175+"",Ut=e[8].attack+"",zt=e[9].attack+"",Qt=e[8].defense+"",Xt=e[9].defense+"",Jt=e[8].armor+"",Zt=e[9].armor+"",ea=e[8].damage+"",ta=e[9].damage+"",aa=e[8].hp+"",na=e[9].hp+""
return Nt=new bl({props:{members:e[10]}}),{c(){t=oe("div"),a=oe("div"),a.textContent="Defending Guild Stats",n=fe(),r=oe("div"),o=oe("div"),o.textContent="Relic Count:",s=oe("div"),l=se(Bt),i=fe(),c=oe("div"),c.textContent="Lead Defender Bonus:",u=oe("div"),f=se(Tt),d=fe(),m=oe("div"),m.textContent="Lead Defender Cloaked:",p=oe("div"),h=se(e[4]),g=fe(),v=oe("div"),v.textContent="Other Defender Stats",b=fe(),w=oe("div"),k=oe("div"),k.textContent="Raw Attack:",y=oe("div"),C=se(qt),$=fe(),L=oe("div"),L.textContent="Attack w/ buffs:",V=oe("div"),D=se(Et),M=fe(),x=oe("div"),x.textContent="Raw Defense:",A=oe("div"),S=se(Gt),N=fe(),H=oe("div"),H.textContent="Defense w/buffs:",B=oe("div"),T=se(Pt),q=fe(),E=oe("div"),E.textContent="Raw Armor:",G=oe("div"),P=se(jt),j=fe(),F=oe("div"),F.textContent="Armor w/ buffs:",R=oe("div"),_=se(Ft),O=fe(),I=oe("div"),I.textContent="Raw Damage:",W=oe("div"),K=se(Rt),Y=fe(),U=oe("div"),U.textContent="Damage w/ buffs:",z=oe("div"),Q=se(_t),X=fe(),J=oe("div"),J.textContent="Raw HP:",Z=oe("div"),ee=se(Ot),te=fe(),ne=oe("div"),ne.textContent="HP w/ buffs:",le=oe("div"),ue=se(It),me=fe(),pe=oe("div"),pe.textContent="Cloaked:",he=oe("div"),ge=se(Wt),ve=fe(),be=oe("div"),be.textContent="Processed:",we=oe("div"),ke=se(e[7]),ye=fe(),Ce=oe("div"),$e=oe("div"),$e.textContent="Adjusted Defense Values",Le=fe(),Ve=oe("div"),Me=oe("div"),Me.textContent="DC225:",xe=oe("div"),Se=se(Kt),Te=fe(),qe=oe("div"),qe.textContent="DC175:",Ee=oe("div"),Ge=se(Yt),Pe=fe(),je=oe("div"),je.textContent=" ",Fe=fe(),Re=oe("div"),Re.textContent="Attacking Group Stats",_e=fe(),Oe=oe("div"),Ie=oe("div"),Ie.textContent="Raw Group Attack:",We=oe("div"),Ke=se(Ut),Ye=fe(),Ue=oe("div"),Ue.textContent="Group Attack w/ buffs:",ze=oe("div"),Qe=se(zt),Xe=fe(),Je=oe("div"),Je.textContent="Raw Group Defense:",Ze=oe("div"),et=se(Qt),tt=fe(),at=oe("div"),at.textContent="Group Defense w/ buffs:",nt=oe("div"),rt=se(Xt),ot=fe(),st=oe("div"),st.textContent="Raw Group Armor:",lt=oe("div"),it=se(Jt),ct=fe(),ut=oe("div"),ut.textContent="Group Armor w/ buffs:",ft=oe("div"),dt=se(Zt),mt=fe(),pt=oe("div"),pt.textContent="Raw Group Damage:",ht=oe("div"),gt=se(ea),vt=fe(),bt=oe("div"),bt.textContent="Group Damage w/ buffs:",wt=oe("div"),kt=se(ta),yt=fe(),Ct=oe("div"),Ct.textContent="Raw Group HP:",$t=oe("div"),Lt=se(aa),Vt=fe(),Dt=oe("div"),Dt.textContent="Group HP w/ buffs:",Mt=oe("div"),xt=se(na),At=fe(),St=oe("div"),Ne(Nt.$$.fragment),de(a,"class","b-top svelte-1qul0wc"),de(o,"class","svelte-1qul0wc"),de(s,"class","svelte-1qul0wc"),de(c,"class","svelte-1qul0wc"),de(u,"class","svelte-1qul0wc"),de(m,"class","svelte-1qul0wc"),de(p,"class","svelte-1qul0wc"),de(r,"class","stat-grid svelte-1qul0wc"),de(v,"class","b-top svelte-1qul0wc"),de(k,"class","svelte-1qul0wc"),de(y,"class","svelte-1qul0wc"),de(L,"class","svelte-1qul0wc"),de(V,"class","svelte-1qul0wc"),de(x,"class","svelte-1qul0wc"),de(A,"class","svelte-1qul0wc"),de(H,"class","svelte-1qul0wc"),de(B,"class","svelte-1qul0wc"),de(E,"class","svelte-1qul0wc"),de(G,"class","svelte-1qul0wc"),de(F,"class","svelte-1qul0wc"),de(R,"class","svelte-1qul0wc"),de(I,"class","svelte-1qul0wc"),de(W,"class","svelte-1qul0wc"),de(U,"class","svelte-1qul0wc"),de(z,"class","svelte-1qul0wc"),de(J,"class","svelte-1qul0wc"),de(Z,"class","svelte-1qul0wc"),de(ne,"class","svelte-1qul0wc"),de(le,"class","svelte-1qul0wc"),de(pe,"class","svelte-1qul0wc"),de(he,"class","svelte-1qul0wc"),de(be,"class","svelte-1qul0wc"),de(we,"class","svelte-1qul0wc"),de(w,"class","stat-grid svelte-1qul0wc"),de(t,"class","middle svelte-1qul0wc"),de($e,"class","b-top svelte-1qul0wc"),de(Me,"class","svelte-1qul0wc"),de(xe,"class","svelte-1qul0wc"),de(qe,"class","svelte-1qul0wc"),de(Ee,"class","svelte-1qul0wc"),de(je,"class","svelte-1qul0wc"),de(Ve,"class","stat-grid svelte-1qul0wc"),de(Re,"class","b-top svelte-1qul0wc"),de(Ie,"class","svelte-1qul0wc"),de(We,"class","svelte-1qul0wc"),de(Ue,"class","svelte-1qul0wc"),de(ze,"class","svelte-1qul0wc"),de(Je,"class","svelte-1qul0wc"),de(Ze,"class","svelte-1qul0wc"),de(at,"class","svelte-1qul0wc"),de(nt,"class","svelte-1qul0wc"),de(st,"class","svelte-1qul0wc"),de(lt,"class","svelte-1qul0wc"),de(ut,"class","svelte-1qul0wc"),de(ft,"class","svelte-1qul0wc"),de(pt,"class","svelte-1qul0wc"),de(ht,"class","svelte-1qul0wc"),de(bt,"class","svelte-1qul0wc"),de(wt,"class","svelte-1qul0wc"),de(Ct,"class","svelte-1qul0wc"),de($t,"class","svelte-1qul0wc"),de(Dt,"class","svelte-1qul0wc"),de(Mt,"class","svelte-1qul0wc"),de(Oe,"class","stat-grid svelte-1qul0wc"),de(Ce,"class","right svelte-1qul0wc"),de(St,"class","bottom b-top svelte-1qul0wc")},m(e,re){ae(e,t,re),ie(t,a),ie(t,n),ie(t,r),ie(r,o),ie(r,s),ie(s,l),ie(r,i),ie(r,c),ie(r,u),ie(u,f),ie(r,d),ie(r,m),ie(r,p),ie(p,h),ie(t,g),ie(t,v),ie(t,b),ie(t,w),ie(w,k),ie(w,y),ie(y,C),ie(w,$),ie(w,L),ie(w,V),ie(V,D),ie(w,M),ie(w,x),ie(w,A),ie(A,S),ie(w,N),ie(w,H),ie(w,B),ie(B,T),ie(w,q),ie(w,E),ie(w,G),ie(G,P),ie(w,j),ie(w,F),ie(w,R),ie(R,_),ie(w,O),ie(w,I),ie(w,W),ie(W,K),ie(w,Y),ie(w,U),ie(w,z),ie(z,Q),ie(w,X),ie(w,J),ie(w,Z),ie(Z,ee),ie(w,te),ie(w,ne),ie(w,le),ie(le,ue),ie(w,me),ie(w,pe),ie(w,he),ie(he,ge),ie(w,ve),ie(w,be),ie(w,we),ie(we,ke),ae(e,ye,re),ae(e,Ce,re),ie(Ce,$e),ie(Ce,Le),ie(Ce,Ve),ie(Ve,Me),ie(Ve,xe),ie(xe,Se),ie(Ve,Te),ie(Ve,qe),ie(Ve,Ee),ie(Ee,Ge),ie(Ve,Pe),ie(Ve,je),ie(Ce,Fe),ie(Ce,Re),ie(Ce,_e),ie(Ce,Oe),ie(Oe,Ie),ie(Oe,We),ie(We,Ke),ie(Oe,Ye),ie(Oe,Ue),ie(Oe,ze),ie(ze,Qe),ie(Oe,Xe),ie(Oe,Je),ie(Oe,Ze),ie(Ze,et),ie(Oe,tt),ie(Oe,at),ie(Oe,nt),ie(nt,rt),ie(Oe,ot),ie(Oe,st),ie(Oe,lt),ie(lt,it),ie(Oe,ct),ie(Oe,ut),ie(Oe,ft),ie(ft,dt),ie(Oe,mt),ie(Oe,pt),ie(Oe,ht),ie(ht,gt),ie(Oe,vt),ie(Oe,bt),ie(Oe,wt),ie(wt,kt),ie(Oe,yt),ie(Oe,Ct),ie(Oe,$t),ie($t,Lt),ie(Oe,Vt),ie(Oe,Dt),ie(Oe,Mt),ie(Mt,xt),ae(e,At,re),ae(e,St,re),He(Nt,St,null),Ht=!0},p(e,t){(!Ht||8&t)&&Bt!==(Bt=e[3].noOfRelics+"")&&ce(l,Bt),(!Ht||8&t)&&Tt!==(Tt=e[3].leadDefenderBonus+"")&&ce(f,Tt),(!Ht||16&t)&&ce(h,e[4]),(!Ht||32&t)&&qt!==(qt=e[5].attackValue+"")&&ce(C,qt),(!Ht||64&t)&&Et!==(Et=e[6].attack+"")&&ce(D,Et),(!Ht||32&t)&&Gt!==(Gt=e[5].defenseValue+"")&&ce(S,Gt),(!Ht||64&t)&&Pt!==(Pt=e[6].defense+"")&&ce(T,Pt),(!Ht||32&t)&&jt!==(jt=e[5].armorValue+"")&&ce(P,jt),(!Ht||64&t)&&Ft!==(Ft=e[6].armor+"")&&ce(_,Ft),(!Ht||32&t)&&Rt!==(Rt=e[5].damageValue+"")&&ce(K,Rt),(!Ht||64&t)&&_t!==(_t=e[6].damage+"")&&ce(Q,_t),(!Ht||32&t)&&Ot!==(Ot=e[5].hpValue+"")&&ce(ee,Ot),(!Ht||64&t)&&It!==(It=e[6].hp+"")&&ce(ue,It),(!Ht||32&t)&&Wt!==(Wt=e[5].cloaked+"")&&ce(ge,Wt),(!Ht||128&t)&&ce(ke,e[7]),(!Ht||64&t)&&Kt!==(Kt=e[6].dc225+"")&&ce(Se,Kt),(!Ht||64&t)&&Yt!==(Yt=e[6].dc175+"")&&ce(Ge,Yt),(!Ht||256&t)&&Ut!==(Ut=e[8].attack+"")&&ce(Ke,Ut),(!Ht||512&t)&&zt!==(zt=e[9].attack+"")&&ce(Qe,zt),(!Ht||256&t)&&Qt!==(Qt=e[8].defense+"")&&ce(et,Qt),(!Ht||512&t)&&Xt!==(Xt=e[9].defense+"")&&ce(rt,Xt),(!Ht||256&t)&&Jt!==(Jt=e[8].armor+"")&&ce(it,Jt),(!Ht||512&t)&&Zt!==(Zt=e[9].armor+"")&&ce(dt,Zt),(!Ht||256&t)&&ea!==(ea=e[8].damage+"")&&ce(gt,ea),(!Ht||512&t)&&ta!==(ta=e[9].damage+"")&&ce(kt,ta),(!Ht||256&t)&&aa!==(aa=e[8].hp+"")&&ce(Lt,aa),(!Ht||512&t)&&na!==(na=e[9].hp+"")&&ce(xt,na)},i(e){Ht||(De(Nt.$$.fragment,e),Ht=!0)},o(e){Ae(Nt.$$.fragment,e),Ht=!1},d(e){e&&(re(t),re(ye),re(Ce),re(At),re(St)),Be(Nt)}}}function $l(e){let t,a,n,r,o,s=e[0].is_owner&&wl(e)
...
t?.response?.data?.defenders?.length>0&&(a=n("dialog-relic"),r=t.response.data,Dl&&Dl.$destroy(),Dl=new Vl({props:{relicData:r},target:a}))}function xl(e,t){"ACT_REPAIR"===t&&GameData.fetch(Ye+f+Ue+ze)}let Al=!1
...
e&&(c("NewMap","quickBuy"),await Pt(Yt(e,Ol)),GameData.doAction(14,3,{id:Gl.id,item_id:Gl.itemId},0),jl.close())}function Wl(){Fl?r("",_l):function(){Fl=a({className:"fshClear",textContent:"Select how many to quick-buy:"}),Rl=gt({id:"buyAmount",className:"fshNumberInput",min:1,max:99,value:1,type:"number"}),o(Fl,Rl)
...
const e=t.doNotKillList.indexOf(Pi);-1===e?t.doNotKillList.push(Pi):t.doNotKillList.splice(e,1),Ri(),V("doNotKillList",t.doNotKillList.join()),fr()}function Oi(){ji?Ri():function(){ji=mt({className:"fshBl",textContent:Fi()})
...
return t?.actions?.length?(t.actions=t.actions.filter(s(Dc,function(e){return e.realm?.minlevel||GameData.realm().minlevel}(t))),nt(t)):e}function xc(e,a){t.hideSubLvlCreature&&function(e){return e.data?.d&&ta(e.data.d,ze)}(a)&&(e.dataFilter=Mc)}function Ac(e){t[e[0]]=Qt(e[1])}function Sc(e){t[e]=Qt(e)}function Nc(){[["buffs","huntingBuffs"],["buffs2","huntingBuffs2"],["buffs3","huntingBuffs3"]].forEach(Ac),["doNotKillList"].forEach(Sc)}function Hc(e){t[e[0]]=b(e[1])}function Bc(e){t[e]=b(e)}function Tc(){[["buffsName","huntingBuffsName"],["buffs2Name","huntingBuffs2Name"],["buffs3Name","huntingBuffs3Name"],["showHuntingBuffs","showHuntingBuffs"]].forEach(Hc),["enabledHuntingMode","hideSubLvlCreature","showTitanInfo","showBuffInfo","showMonsterLog","showCreatureInfo"].forEach(Bc)}const qc=[function(){kc(),Nc(),Tc()
const e=bc()
$.ajaxPrefilter("JSON",xc),t.hideSubLvlCreature&&GameData.fetch(ze),function(e){mc()
const a=s(Vc,e)
$.subscribe(d,a),t.showHuntingBuffs&&window.initialGameData&&a(null,{b:window.initialGameData.player.buffs})}(e),rc=b("hidePlayerActions"),$.subscribe(z,sc),sc()},function(){Qe(),Xe()&&El()},function(){$.subscribe(at,nc)},function(){Hr.forEach(Br)},function(){b("enableCreatureColoring")&&o(document.body,kt("#actionList .creature-1 {color: green;}\n#actionList .creature-2 {color: yellow;}\n#actionList .creature-3 {color: red;}"))},function(){$.subscribe(z,fr),fr(),function(){const e=GameData.doAction
GameData.doAction=pr(e)}()},function(){Ur(),$.subscribe("-1-success.action-response 4-success.action-response 5-success.action-response 25-success.action-response",Zr),Zr()},function(){$.subscribe(Ke,xl)},async function(){if(b("keepLogs")){!function(e){e&&($n=e),$.subscribe(N,xn)}(await S("fsh_combatLog"))}},function(){window.initialGameData&&gs(0,window.initialGameData),$.subscribe(`${$e} ${Le}`,gs)},function(){$.subscribe(et,Kl)},function(){$.subscribe(We,Ml)},function(){$("#messageCenter").worldMessageCenter({offset:"0 60"})},function(){w("#mapTooltip")},function(){cn(),$.subscribe(p,un),$.subscribe(h,fn)},function(){ja(),$.subscribe(`${d} ${m}`,ja)},function(){v(n("actionList"),"mouseover",ir)},function(){const{body:e}=document
...
//# sourceMappingURL=newMap-DiHCfTTW.js.map
