...
import{ag as t,m as n,g as a,a9 as r,i as o,c as s,v as i,o as l,s as c,aC as u,aE as f,aF as d,aG as m,aH as p,aI as h,y as g,b as v,ai as b,aJ as k,aK as y,aL as w,aM as C,aN as L,ae as D,k as V,aO as M,q as x,aP as A,aQ as S,aR as N,aS as H,D as B,aT as T,aU as E,aV as G,aW as P,aX as j,aY as R,aZ as F,a_ as _,a$ as I,b0 as O,b1 as W,aj as q,a8 as K,b2 as Y,b3 as z,b4 as U,a as Q,$ as J,S as X,L as Z,M as ee,am as te,T as ne,a0 as ae,a1 as re,O as oe,a4 as se,b5 as ie,U as le,a5 as ce,N as ue,P as fe,Q as de,b6 as me,b7 as pe,b8 as he,b9 as ge,Z as ve,_ as be,X as ke,ba as ye,d as we,ap as Ce,bb as $e,bc as Le,bd as De,E as Ve,be as Me,bf as xe,bg as Ae,bh as Se,bi as Ne,bj as He,bk as Be,bl as Te,bm as Ee,bn as Ge,bo as Pe,bp as je,bq as Re,br as Fe,bs as _e,bt as Ie,bu as Oe,bv as We,bw as qe,bx as Ke,by as Ye,bz as ze,bA as Ue,bB as Qe,bC as Je,bD as Xe,bE as Ze,bF as et,bG as tt,bH as nt,bI as at,bJ as rt,bK as ot,bL as st,bM as it,ah as lt}from"./calfSystem-DZGU7L1H.js"
import{i as ct}from"./insertElementAfter-CUi1HR8b.js"
import{t as ut}from"./toggleForce-br4z9gGd.js"
import{c as ft}from"./createSpan-DcQ00sL_.js"
import{i as dt}from"./insertTextBeforeEnd-DuXpByAK.js"
import{r as mt,a as pt}from"./roundToString-Hif1MLyB.js"
import{a as ht}from"./addCommas-C_h2HN8s.js"
import{d as gt,q as vt}from"./quickbuffSuccess-DDO28cbr.js"
import{c as bt}from"./createButton-C7d0pUw-.js"
import{i as kt}from"./isArray-eVldfhw1.js"
import{o as yt}from"./openQuickBuffById-o3Ofe8vo.js"
import{c as wt}from"./createInput-BOcQLUnN.js"
import{c as Ct}from"./createLabel-BOAI-e00.js"
import{r as $t}from"./rnd-D_QmA-Fa.js"
import{v as Lt}from"./valueText-BpUI1ICU.js"
import{c as Dt}from"./createStyle-CswKiwDd.js"
import{h as Vt,u as Mt}from"./await_block-lE4erutR.js"
import{u as xt}from"./uniq-BzSLAdq6.js"
import{g as At}from"./guild-DKwlpiBF.js"
import{c as St}from"./createTable-BdBvDwm6.js"
...
import{L as Gt}from"./LinkButton-DgLPvByR.js"
import{r as Pt}from"./reduceBuffArray-Diy1E3zc.js"
import{p as jt}from"./profile-BoYBOZ74.js"
import{a as Rt}from"./all-YfMtr2SN.js"
import{n as Ft}from"./numberIsNaN-CGkd1jiA.js"
import{r as _t}from"./reliclist-ZAMi1LJr.js"
import{d as It}from"./daGroupStats-BzyP-E7a.js"
import{d as Ot,m as Wt}from"./mercEffect-oTqWkGBq.js"
import{d as qt}from"./daViewGroups-a0Ea5q9_.js"
import{a as Kt}from"./attribsToArray-BPOFsTGt.js"
import{g as Yt}from"./guildMembers-BaGXgi7Q.js"
import{r as zt}from"./remainingPages-BzskAxSU.js"
import{t as Ut}from"./testQuant-CUL735o8.js"
import{m as Qt}from"./myStats-zlyqooKe.js"
import{s as Jt}from"./shouldBeArray-CIWCoW3n.js"
import{s as Xt,j as Zt}from"./simpleCheckbox-BbjKGwmy.js"
import{i as en}from"./isSelected-BWnMzKlW.js"
import{b as tn}from"./bitwiseAnd-C5gmj-aX.js"
import"./buffReportParser-4iK1FRfm.js"
import"./buffObj-BIwiFUIW.js"
import"./guildGroups-C-SQRCGm.js"
import"./view-DpBGY-4J.js"
...
return function(e){Aa(e)||Na.push(e)}(a),a}let Ea=0,Ga=0,Pa=0,ja=0,Ra=0,Fa=0
const _a=()=>Ea,Ia=()=>Ga,Oa=()=>Pa,Wa=()=>ja,qa=()=>Ra,Ka=()=>Fa
function Ya(e,t){return Lt(P(t,e))}function za(){var e
Ea=GameData.player().level,e=a("statbar-character-tooltip-stats"),Pa=Ya(e,j),Ga=Ya(e,R),Ra=Ya(e,F),ja=Ya(e,_),Fa=Ya(e,I)}const Ua=e=>`<td>${e}:&nbsp;</td>`,Qa=e=>`<td width="40%">${e}</td>`
...
return[a,e=>xt(e,"msg").map((({msg:t,type:n})=>({msg:t,type:n,count:e.filter((({msg:e})=>e===t)).length}))),i,e=>i(e)]}class Rr extends X{constructor(e){super(),Z(this,e,jr,Pr,ee,{})}}let Fr=0
function _r(e){Fr[e.name]?Fr[e.name].seen&&(Fr[e.name].seen+=1):(Fr[e.name]={seen:1},function(e,t){t.creature_class=e.creature_class,t.image_id=e.image_id,t.level=Number(e.level),t.type=e.type}(e,Fr[e.name]))}function Ir(e,t,n){return t?e(t,n):n}function Or(e,t){const n=e||{}
return n.min=Ir(Math.min,n.min,t),n.max=Ir(Math.max,n.max,t),n}const Wr=["attack","armor","damage","defense","hp"]
function qr(e,t,n){const a=Or(t[n],Number(e[n]));(function(e,t){return!e||e.min!==t.min||e.max!==t.max})(t[n],a)&&(t[n]=a)}function Kr(e,t){e[t.name]=Or(e[t.name],Number(t.value))}function Yr(e){Fr||(Fr={}),_r(e),function(e,t){Wr.forEach(s(qr,e,t))}(e,Fr[e.name]),function(e,t){(function(e){return e.enhancements&&e.enhancements.length>0})(e)&&(t.enhancements=t.enhancements||{},e.enhancements.forEach(s(Kr,t.enhancements)))}(e,Fr[e.name]),H("fsh_monsterLog",Fr)}async function zr(){!function(e){Fr=e||{}}(await S("fsh_monsterLog"))}const Ur=[]
function Qr(e){var n
...
const go=()=>io,vo=()=>po
function bo(){io=_n("Current"),lo=_n("Kills"),co=_n("Member"),uo=_n("% of Total"),fo=_n("Status"),mo=_n("Titan HP"),po=_n("Total"),ho=_n("Your Guild")}let ko=0,yo=0,wo=0,Co=0,$o=0,Lo=0,Do=0,Vo=0,Mo=0
...
const Ro=()=>jo
function Fo(){for(;jo.rows.length>8;)jo.deleteRow(8)}function _o(e){const t=ft()
return o(t,e),dt(t,"%"),t}const Io=[[[5,xo,!0],[1,Ao,!0]]],Oo=[[[2,()=>mo,!0],[4,()=>ho,!0]]],Wo=[[[2,function(){const e=ft()
return o(e,So()),dt(e,"/"),o(e,No()),e}],[4,Ho]]],qo=()=>[[[2,go,!0],[4,s(_o,Bo())]],!0],Ko=()=>[[[2,vo,!0],[4,s(_o,To())]],!0],Yo=[[[2,()=>fo,!0],[4,Eo]],!0],zo=[[[2,()=>co,!0],[2,()=>lo,!0],[2,()=>uo,!0]]]
let Uo=0,Qo=0,Jo=""
const Xo=()=>Qo,Zo=()=>Jo
function es(){Qo=null,Uo&&!B("fshHide",Uo)&&(ut(Uo,!0),we("&nbsp;",ko),we("&nbsp;",yo),r("",wo),r("",Co),r("",$o),r("",Lo),r("",Do),we("",Vo),we("",Mo),Fo())}function ts(e){return 0===e.type&&(Qo=e.base_creature_id,Jo=`(${e.x},${e.y})`,!0)}function ns(){if(Uo)ut(Uo,!1)
...
return`${Tt(t.getHours())}:${Tt(t.getMinutes())} ${Tt(t.getDate())}/${$e[t.getMonth()]}/${t.getFullYear()}`}(e)}</span>`}function rs(e){return pt(Bt(e.max_hp-e.current_hp,e.kills),2)}function os(e){return pt(100*e.kills/e.max_hp,2)}function ss(e){!function(e){[[Ht(e.creature.name),xo],[Zo(),Ao],[e.current_hp,So],[e.max_hp,No],[e.kills,Ho],[rs(e),Bo],[os(e),To]].forEach((([e,t])=>r(e,t())))}(e),we(function(e){return Nt(e.kills,e.max_hp,e.current_hp)}(e),Eo()),we(as(e.cooldown),Go())}function is(e,t){return[[[2,()=>_n(t.player.name)],[2,()=>_n(t.kills.toString())],[2,()=>_n(`${pt(100*t.kills/e.kills,2)}%`)]]]}function ls(e){return e.realm&&e.creature.base_id===Xo()&&e.realm===to()}function cs(e){const t=e.find(ls)
...
n(a)})),Fs=je(0),_s=e=>e.members[0].name===GameData.player().username
...
return e?.r?.find(_s)?.id}(),a=n&&await async function(e){const t=await It(e)
return Kt(t?.r?.attributes)}(n),r=a&&await async function(e){const t=await Ot(),n=Wt(t)
return e?.map(((e,t)=>e-n[t]))}(a)
r&&t({attack:r[0],defense:r[1],armor:r[2],hp:r[3],damage:r[4]}),As.set(["groupStore","Done."])}const Os=Pe(Fs,((e,t)=>{Is(e,t)})),Ws=(e,t,n)=>Math.ceil(e*Fe(t,0)*n),qs=(e,t)=>Ws(e,t,.0025),Ks=(e,t)=>Ws(e,t,.001),Ys=Ks,zs=Ks,Us=Ks,Qs=Ks,Js=Ks,Xs=(e,t)=>Math.ceil(e*(1+.001*Fe(t,0))),Zs=(e,t)=>Math.ceil(e*(1-t*_e)),ei=je([]),ti=Pe(ei,((e,t)=>{e&&t(Pt(e))})),ni=Pe([ti,Os],(([e,t],n)=>{if(!e||!t)return
...
return{c(){t=oe("button"),t.textContent="Fetch Stats",de(t,"class","custombutton"),de(t,"type","button")},m(r,o){ne(r,t,o),n||(a=ke(t,"click",e[12]),n=!0)},p:ae,d(e){e&&re(t),n=!1,a()}}}function Ci(e){let t,n,a,r,o,s,i,l,c,u,f,d,m,p,h,g,v,b,k,y,w,C,$,L,D,V,M,x,A,S,N,H,B,T,E,G,P,j,R,F,_,I,O,W,q,K,Y,z,U,Q,J,X,Z,ee,te,ae,ie,ue,me,pe,he,ge,ve,be,ke,ye,we,Ce,$e,Le,De,Ve,xe,Ae,Ne,Ee,Ge,Pe,je,Re,Fe,_e,Ie,Oe,We,qe,Ke,Ye,ze,Ue,Qe,Je,Xe,Ze,et,tt,nt,at,rt,ot,st,it,lt,ct,ut,ft,dt,mt,pt,ht,gt,vt,bt,kt,yt,wt,Ct,$t,Lt,Dt,Vt,Mt,xt,At,St,Nt,Ht,Bt,Tt,Et,Gt,Pt,jt,Rt,Ft,_t,It,Ot,Wt,qt,Kt,Yt,zt,Ut,Qt,Jt,Xt,Zt,en,tn,nn,an,rn,on,sn=e[3].noOfRelics+"",ln=e[3].leadDefenderBonus+"",cn=e[5].attackValue+"",un=e[6].attack+"",fn=e[5].defenseValue+"",dn=e[6].defense+"",mn=e[5].armorValue+"",pn=e[6].armor+"",hn=e[5].damageValue+"",gn=e[6].damage+"",vn=e[5].hpValue+"",bn=e[6].hp+"",kn=e[5].cloaked+"",yn=e[6].dc225+"",wn=e[6].dc175+"",Cn=e[8].attack+"",$n=e[9].attack+"",Ln=e[8].defense+"",Dn=e[9].defense+"",Vn=e[8].armor+"",Mn=e[9].armor+"",xn=e[8].damage+"",An=e[9].damage+"",Sn=e[8].hp+"",Nn=e[9].hp+""
return rn=new bi({props:{members:e[10]}}),{c(){t=oe("div"),n=oe("div"),n.textContent="Defending Guild Stats",a=fe(),r=oe("div"),o=oe("div"),o.textContent="Relic Count:",s=fe(),i=oe("div"),l=se(sn),c=fe(),u=oe("div"),u.textContent="Lead Defender Bonus:",f=fe(),d=oe("div"),m=se(ln),p=fe(),h=oe("div"),h.textContent="Lead Defender Cloaked:",g=fe(),v=oe("div"),b=se(e[4]),k=fe(),y=oe("div"),y.textContent="Other Defender Stats",w=fe(),C=oe("div"),$=oe("div"),$.textContent="Raw Attack:",L=fe(),D=oe("div"),V=se(cn),M=fe(),x=oe("div"),x.textContent="Attack w/ buffs:",A=fe(),S=oe("div"),N=se(un),H=fe(),B=oe("div"),B.textContent="Raw Defense:",T=fe(),E=oe("div"),G=se(fn),P=fe(),j=oe("div"),j.textContent="Defense w/buffs:",R=fe(),F=oe("div"),_=se(dn),I=fe(),O=oe("div"),O.textContent="Raw Armor:",W=fe(),q=oe("div"),K=se(mn),Y=fe(),z=oe("div"),z.textContent="Armor w/ buffs:",U=fe(),Q=oe("div"),J=se(pn),X=fe(),Z=oe("div"),Z.textContent="Raw Damage:",ee=fe(),te=oe("div"),ae=se(hn),ie=fe(),ue=oe("div"),ue.textContent="Damage w/ buffs:",me=fe(),pe=oe("div"),he=se(gn),ge=fe(),ve=oe("div"),ve.textContent="Raw HP:",be=fe(),ke=oe("div"),ye=se(vn),we=fe(),Ce=oe("div"),Ce.textContent="HP w/ buffs:",$e=fe(),Le=oe("div"),De=se(bn),Ve=fe(),xe=oe("div"),xe.textContent="Cloaked:",Ae=fe(),Ne=oe("div"),Ee=se(kn),Ge=fe(),Pe=oe("div"),Pe.textContent="Processed:",je=fe(),Re=oe("div"),Fe=se(e[7]),_e=fe(),Ie=oe("div"),Oe=oe("div"),Oe.textContent="Adjusted Defense Values",We=fe(),qe=oe("div"),Ke=oe("div"),Ke.textContent="DC225:",Ye=fe(),ze=oe("div"),Ue=se(yn),Qe=fe(),Je=oe("div"),Je.textContent="DC175:",Xe=fe(),Ze=oe("div"),et=se(wn),tt=fe(),nt=oe("div"),nt.textContent=" ",at=fe(),rt=oe("div"),rt.textContent="Attacking Group Stats",ot=fe(),st=oe("div"),it=oe("div"),it.textContent="Raw Group Attack:",lt=fe(),ct=oe("div"),ut=se(Cn),ft=fe(),dt=oe("div"),dt.textContent="Group Attack w/ buffs:",mt=fe(),pt=oe("div"),ht=se($n),gt=fe(),vt=oe("div"),vt.textContent="Raw Group Defense:",bt=fe(),kt=oe("div"),yt=se(Ln),wt=fe(),Ct=oe("div"),Ct.textContent="Group Defense w/ buffs:",$t=fe(),Lt=oe("div"),Dt=se(Dn),Vt=fe(),Mt=oe("div"),Mt.textContent="Raw Group Armor:",xt=fe(),At=oe("div"),St=se(Vn),Nt=fe(),Ht=oe("div"),Ht.textContent="Group Armor w/ buffs:",Bt=fe(),Tt=oe("div"),Et=se(Mn),Gt=fe(),Pt=oe("div"),Pt.textContent="Raw Group Damage:",jt=fe(),Rt=oe("div"),Ft=se(xn),_t=fe(),It=oe("div"),It.textContent="Group Damage w/ buffs:",Ot=fe(),Wt=oe("div"),qt=se(An),Kt=fe(),Yt=oe("div"),Yt.textContent="Raw Group HP:",zt=fe(),Ut=oe("div"),Qt=se(Sn),Jt=fe(),Xt=oe("div"),Xt.textContent="Group HP w/ buffs:",Zt=fe(),en=oe("div"),tn=se(Nn),nn=fe(),an=oe("div"),He(rn.$$.fragment),de(n,"class","b-top svelte-2rn368"),de(o,"class","svelte-2rn368"),de(i,"class","svelte-2rn368"),de(u,"class","svelte-2rn368"),de(d,"class","svelte-2rn368"),de(h,"class","svelte-2rn368"),de(v,"class","svelte-2rn368"),de(r,"class","stat-grid svelte-2rn368"),de(y,"class","b-top svelte-2rn368"),de($,"class","svelte-2rn368"),de(D,"class","svelte-2rn368"),de(x,"class","svelte-2rn368"),de(S,"class","svelte-2rn368"),de(B,"class","svelte-2rn368"),de(E,"class","svelte-2rn368"),de(j,"class","svelte-2rn368"),de(F,"class","svelte-2rn368"),de(O,"class","svelte-2rn368"),de(q,"class","svelte-2rn368"),de(z,"class","svelte-2rn368"),de(Q,"class","svelte-2rn368"),de(Z,"class","svelte-2rn368"),de(te,"class","svelte-2rn368"),de(ue,"class","svelte-2rn368"),de(pe,"class","svelte-2rn368"),de(ve,"class","svelte-2rn368"),de(ke,"class","svelte-2rn368"),de(Ce,"class","svelte-2rn368"),de(Le,"class","svelte-2rn368"),de(xe,"class","svelte-2rn368"),de(Ne,"class","svelte-2rn368"),de(Pe,"class","svelte-2rn368"),de(Re,"class","svelte-2rn368"),de(C,"class","stat-grid svelte-2rn368"),de(t,"class","middle svelte-2rn368"),de(Oe,"class","b-top svelte-2rn368"),de(Ke,"class","svelte-2rn368"),de(ze,"class","svelte-2rn368"),de(Je,"class","svelte-2rn368"),de(Ze,"class","svelte-2rn368"),de(nt,"class","svelte-2rn368"),de(qe,"class","stat-grid svelte-2rn368"),de(rt,"class","b-top svelte-2rn368"),de(it,"class","svelte-2rn368"),de(ct,"class","svelte-2rn368"),de(dt,"class","svelte-2rn368"),de(pt,"class","svelte-2rn368"),de(vt,"class","svelte-2rn368"),de(kt,"class","svelte-2rn368"),de(Ct,"class","svelte-2rn368"),de(Lt,"class","svelte-2rn368"),de(Mt,"class","svelte-2rn368"),de(At,"class","svelte-2rn368"),de(Ht,"class","svelte-2rn368"),de(Tt,"class","svelte-2rn368"),de(Pt,"class","svelte-2rn368"),de(Rt,"class","svelte-2rn368"),de(It,"class","svelte-2rn368"),de(Wt,"class","svelte-2rn368"),de(Yt,"class","svelte-2rn368"),de(Ut,"class","svelte-2rn368"),de(Xt,"class","svelte-2rn368"),de(en,"class","svelte-2rn368"),de(st,"class","stat-grid svelte-2rn368"),de(Ie,"class","right svelte-2rn368"),de(an,"class","bottom b-top svelte-2rn368")},m(e,re){ne(e,t,re),le(t,n),le(t,a),le(t,r),le(r,o),le(r,s),le(r,i),le(i,l),le(r,c),le(r,u),le(r,f),le(r,d),le(d,m),le(r,p),le(r,h),le(r,g),le(r,v),le(v,b),le(t,k),le(t,y),le(t,w),le(t,C),le(C,$),le(C,L),le(C,D),le(D,V),le(C,M),le(C,x),le(C,A),le(C,S),le(S,N),le(C,H),le(C,B),le(C,T),le(C,E),le(E,G),le(C,P),le(C,j),le(C,R),le(C,F),le(F,_),le(C,I),le(C,O),le(C,W),le(C,q),le(q,K),le(C,Y),le(C,z),le(C,U),le(C,Q),le(Q,J),le(C,X),le(C,Z),le(C,ee),le(C,te),le(te,ae),le(C,ie),le(C,ue),le(C,me),le(C,pe),le(pe,he),le(C,ge),le(C,ve),le(C,be),le(C,ke),le(ke,ye),le(C,we),le(C,Ce),le(C,$e),le(C,Le),le(Le,De),le(C,Ve),le(C,xe),le(C,Ae),le(C,Ne),le(Ne,Ee),le(C,Ge),le(C,Pe),le(C,je),le(C,Re),le(Re,Fe),ne(e,_e,re),ne(e,Ie,re),le(Ie,Oe),le(Ie,We),le(Ie,qe),le(qe,Ke),le(qe,Ye),le(qe,ze),le(ze,Ue),le(qe,Qe),le(qe,Je),le(qe,Xe),le(qe,Ze),le(Ze,et),le(qe,tt),le(qe,nt),le(Ie,at),le(Ie,rt),le(Ie,ot),le(Ie,st),le(st,it),le(st,lt),le(st,ct),le(ct,ut),le(st,ft),le(st,dt),le(st,mt),le(st,pt),le(pt,ht),le(st,gt),le(st,vt),le(st,bt),le(st,kt),le(kt,yt),le(st,wt),le(st,Ct),le(st,$t),le(st,Lt),le(Lt,Dt),le(st,Vt),le(st,Mt),le(st,xt),le(st,At),le(At,St),le(st,Nt),le(st,Ht),le(st,Bt),le(st,Tt),le(Tt,Et),le(st,Gt),le(st,Pt),le(st,jt),le(st,Rt),le(Rt,Ft),le(st,_t),le(st,It),le(st,Ot),le(st,Wt),le(Wt,qt),le(st,Kt),le(st,Yt),le(st,zt),le(st,Ut),le(Ut,Qt),le(st,Jt),le(st,Xt),le(st,Zt),le(st,en),le(en,tn),ne(e,nn,re),ne(e,an,re),Be(rn,an,null),on=!0},p(e,t){(!on||8&t)&&sn!==(sn=e[3].noOfRelics+"")&&ce(l,sn),(!on||8&t)&&ln!==(ln=e[3].leadDefenderBonus+"")&&ce(m,ln),(!on||16&t)&&ce(b,e[4]),(!on||32&t)&&cn!==(cn=e[5].attackValue+"")&&ce(V,cn),(!on||64&t)&&un!==(un=e[6].attack+"")&&ce(N,un),(!on||32&t)&&fn!==(fn=e[5].defenseValue+"")&&ce(G,fn),(!on||64&t)&&dn!==(dn=e[6].defense+"")&&ce(_,dn),(!on||32&t)&&mn!==(mn=e[5].armorValue+"")&&ce(K,mn),(!on||64&t)&&pn!==(pn=e[6].armor+"")&&ce(J,pn),(!on||32&t)&&hn!==(hn=e[5].damageValue+"")&&ce(ae,hn),(!on||64&t)&&gn!==(gn=e[6].damage+"")&&ce(he,gn),(!on||32&t)&&vn!==(vn=e[5].hpValue+"")&&ce(ye,vn),(!on||64&t)&&bn!==(bn=e[6].hp+"")&&ce(De,bn),(!on||32&t)&&kn!==(kn=e[5].cloaked+"")&&ce(Ee,kn),(!on||128&t)&&ce(Fe,e[7]),(!on||64&t)&&yn!==(yn=e[6].dc225+"")&&ce(Ue,yn),(!on||64&t)&&wn!==(wn=e[6].dc175+"")&&ce(et,wn),(!on||256&t)&&Cn!==(Cn=e[8].attack+"")&&ce(ut,Cn),(!on||512&t)&&$n!==($n=e[9].attack+"")&&ce(ht,$n),(!on||256&t)&&Ln!==(Ln=e[8].defense+"")&&ce(yt,Ln),(!on||512&t)&&Dn!==(Dn=e[9].defense+"")&&ce(Dt,Dn),(!on||256&t)&&Vn!==(Vn=e[8].armor+"")&&ce(St,Vn),(!on||512&t)&&Mn!==(Mn=e[9].armor+"")&&ce(Et,Mn),(!on||256&t)&&xn!==(xn=e[8].damage+"")&&ce(Ft,xn),(!on||512&t)&&An!==(An=e[9].damage+"")&&ce(qt,An),(!on||256&t)&&Sn!==(Sn=e[8].hp+"")&&ce(Qt,Sn),(!on||512&t)&&Nn!==(Nn=e[9].hp+"")&&ce(tn,Nn)},i(e){on||(Me(rn.$$.fragment,e),on=!0)},o(e){Se(rn.$$.fragment,e),on=!1},d(e){e&&(re(t),re(_e),re(Ie),re(nn),re(an)),Te(rn)}}}function $i(e){let t,n,a,r,o,s=e[0].is_owner&&ki(e)
...
let p=!1
return Ye((()=>{n(1,p=!1),Hs.set(0),Ts.set([]),Fs.set(0),ei.set([])})),e.$$set=e=>{"relicData"in e&&n(0,d=e.relicData)},[d,p,a,r,o,s,i,l,u,f,m,function(e){c("relic",e.detail)},function(){c("relic","fetchStats"),n(1,p=!0),Hs.set(d.controlled_by.guild_id),Ts.set(m),Fs.set(GameData.player().hasGroup),ei.set(GameData.player().buffs)}]}class Di extends X{constructor(e){super(),Z(this,e,Li,$i,ee,{relicData:0})}}let Vi=0
...
i(Ii,`${a}<br>`)}async function Wi(){const e=Ut(_i.value)
e&&(c("NewMap","quickBuy"),await Rt(zt(e,Oi)),GameData.doAction(14,3,{id:Pi.id,item_id:Pi.itemId},0),Ri.close())}function qi(){Fi?r("",Ii):function(){Fi=n({className:"fshClear",textContent:"Select how many to quick-buy:"}),_i=wt({id:"buyAmount",className:"fshNumberInput",min:1,max:99,value:1,type:"number"}),o(Fi,_i)
const e=bt({textContent:"Quick-buy"})
l(e,Wi),o(Fi,e),Ii=n(),o(Fi,Ii),o(ji,Fi)}()}function Ki(e,t){Pi=t,ji=ji||a("shopDialogConfirm"),ji&&(Ri=Ri||$(ji).data("hcsWorldDialogShopConfirm"),Ri&&qi())}function Yi(e){let t,n
...
function ll(e){return Math.floor(e.creature.defense*e.player.darkCurseLevel*_e)}function cl(e){const t=il(e)
...
let jl=0,Rl=0,Fl=0
function _l(){return cr(Rl)?"Remove from do not kill list":"Add to the do not kill list"}function Il(){r(_l(),Fl)}function Ol(){c("NewMap","doNotKillLink")
const e=t.doNotKillList.indexOf(Rl);-1===e?t.doNotKillList.push(Rl):t.doNotKillList.splice(e,1),Il(),D("doNotKillList",t.doNotKillList.join()),fr()}function Wl(){Fl?Il():function(){Fl=bt({className:"fshBl",textContent:_l()})
const e=n({className:"description",innerHTML:'<span class="ui-helper-hidden-accessible"><input type="text"></span>'})
o(e,Fl),o(jl,e),l(Fl,Ol)}()}function ql(e,t){!function(e){if(!jl){const t=P("body",e)
...
//# sourceMappingURL=newMap-DWRAz7pf.js.map
