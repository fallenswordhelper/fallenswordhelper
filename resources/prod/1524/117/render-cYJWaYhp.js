import{ag as t,s as n,c as s,a$ as e,ai as o,az as f,p as a,a8 as u,aC as c,c7 as r,ar as i,D as l,d as p,g as d,C as b}from"./calfSystem-G1dN925O.js"
import{a as g}from"./roundToString-8wwt6Rp-.js"
import{k as m}from"./keys-fO1nQfVO.js"
...
const n=R(t.target);(function(t){return t.classList&&l("buffLink",t)})(n)&&M(n)}function D(t,n,s){return t.replace(n,`<span id="fshBuff${s}" class="buffLink fshBlue">${n.replace(/(`~)|(~`)|(\{b\})|(\{\/b\})/g,"")}</span>`)}function E(t){let n=t.replace(/\{b\}/g,"`~").replace(/\{\/b\}/g,"~`")
const s=n.match(/`~([^~]|~(?!`))*~`/g)
if(s)return n=s.reduce(D,n),n.indexOf("[cmd]")<0&&(n+="[cmd]"),n=n.replace("[cmd]",'<br><input id="fshSendBuffMsg" class="custombutton" type="button" value="Ask For Buffs"><br><span id="buffCost" class="fshRed">&nbsp;</span>'),n}export{z as b,E as r}
//# sourceMappingURL=render-cYJWaYhp.js.map
