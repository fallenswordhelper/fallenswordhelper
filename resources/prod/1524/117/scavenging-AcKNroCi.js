import{g as n,i as t,b as s,c as e,s as o,d as r,a8 as c,ae as a,cV as i,b1 as u,m as f,p as m,C as l,bs as g}from"./calfSystem-G1dN925O.js"
import{c as p}from"./createSpan-E64hPGZD.js"
import{c as d}from"./closestTable-Ggcgditt.js"
...
return t?V(t):""}(n)}return t}function q(n){return function(s,e,o){n(s,e,o),a("lastScavPage",`${i}scavenging&cave_id=${o}&gold=${e}`),r(_(),(S||(S=f(),t(m(),S)),r("",S),S))}}function w(){!function(){const n=sendRequest
u(n)&&(sendRequest=q(n))}(),function(){const t=n("multiplier_count")
t&&j(t)}()}export{w as default}
//# sourceMappingURL=scavenging-AcKNroCi.js.map
