...
import{ag as t,m as a,g as n,a9 as r,i as o,c as s,v as l,o as i,s as c,aC as u,aD as f,aE as d,aF as m,aG as p,aH as h,y as g,b as v,ai as b,aI as w,aJ as k,aK as y,aL as C,aM as L,ae as V,k as D,aA as M,q as x,aN as A,aO as S,aP as N,aQ as H,D as B,aR as q,aS as T,aT as E,aU as G,aV as j,aW as P,aX as F,aY as R,aZ as _,a_ as O,a$ as I,aj as W,a8 as K,b0 as Y,b1 as z,b2 as U,a as Q,$ as X,S as J,L as Z,M as ee,am as te,T as ae,_ as ne,a0 as re,O as oe,a3 as se,b3 as le,U as ie,a4 as ce,N as ue,P as fe,Q as de,b4 as me,b5 as pe,b6 as he,b7 as ge,Z as ve,X as be,a5 as we,b8 as ke,d as ye,b9 as Ce,ba as $e,bb as Le,E as Ve,bc as De,bd as Me,be as xe,bf as Ae,bg as Se,bh as Ne,bi as He,bj as Be,bk as qe,bl as Te,bm as Ee,bn as Ge,bo as je,bp as Pe,bq as Fe,br as Re,bs as _e,bt as Oe,bu as Ie,bv as We,bw as Ke,bx as Ye,by as ze,bz as Ue,bA as Qe,bB as Xe,bC as Je,bD as Ze,bE as et,bF as tt,bG as at,ah as nt}from"./calfSystem-G1dN925O.js"
import{i as rt}from"./insertElementAfter-Pj5qjSoU.js"
import{t as ot}from"./toggleForce-4Mg38a6N.js"
import{c as st}from"./createSpan-E64hPGZD.js"
import{i as lt}from"./insertTextBeforeEnd-jtp_d9bO.js"
import{r as it,a as ct}from"./roundToString-8wwt6Rp-.js"
import{a as ut}from"./addCommas-olJWnOGa.js"
import{d as ft,q as dt}from"./quickbuffSuccess-CoxezyWJ.js"
import{c as mt}from"./createButton-LCF-b91n.js"
import{i as pt}from"./isArray-bNviZzJA.js"
import{o as ht}from"./openQuickBuffById-thDk1sOL.js"
import{c as gt}from"./createInput-3jwazPKd.js"
import{c as vt}from"./createLabel-LvV0YfxP.js"
import{r as bt}from"./rnd-7E7YIwpb.js"
import{v as wt}from"./valueText-890HKMma.js"
import{c as kt}from"./createStyle-kdSx2xlE.js"
import{h as yt,u as Ct}from"./await_block-nr-x0DeQ.js"
import{u as $t}from"./uniq-GAsQHoVb.js"
import{g as Lt}from"./guild-a4pzzzAR.js"
import{c as Vt}from"./createTable-pGvXv4Gy.js"
import{g as Dt,t as Mt,a as xt}from"./getTitanString-Fx1fxwUU.js"
import{n as At,a as St,s as Nt,r as Ht}from"./now-pQzGw6vd.js"
import{p as Bt}from"./padZ-zYXZ2AFi.js"
import{f as qt}from"./fshOpen-16hNCxKt.js"
import{L as Tt}from"./LinkButton-V4dDaBVi.js"
import{r as Et}from"./reduceBuffArray-twG3MySG.js"
import{p as Gt}from"./profile-YuJ83wb9.js"
import{a as jt}from"./all-TTLWag-d.js"
import{n as Pt}from"./numberIsNaN--k2kVli9.js"
import{r as Ft}from"./reliclist-3aYFJrm0.js"
import{d as Rt}from"./daGroupStats-pPdFXNdV.js"
import{d as _t,m as Ot}from"./mercEffect-Cj9VmWM3.js"
import{d as It}from"./daViewGroups-YuwhlzDy.js"
import{a as Wt}from"./attribsToArray-wxWEDxXi.js"
import{g as Kt}from"./guildMembers-4GuRAnc8.js"
import{r as Yt}from"./remainingPages-B8w0PByy.js"
import{t as zt}from"./testQuant-ornCemKk.js"
import{m as Ut}from"./myStats--KJiIj1a.js"
import{s as Qt}from"./shouldBeArray-Sig5LHGX.js"
import{h as Xt}from"./hideElement-RABq1RME.js"
import{s as Jt,j as Zt}from"./simpleCheckbox-8V_A9jhn.js"
import{i as ea}from"./isSelected-tg-1ZNBk.js"
import{b as ta}from"./bitwiseAnd-b_h0Z7XX.js"
import"./buffReportParser-s3eybPjn.js"
import"./buffObj-QxLUrgH2.js"
import"./guildGroups-sePQlzpt.js"
import"./view-xId1C27Y.js"
import"./intValue-JHhLnq8V.js"
import"./csvSplit-SWeoixMs.js"
import"./isChecked-k2ijSL8v.js"
let aa=0
function na(e){return e}function ra(e){if(function(e){return t.showBuffInfo&&e.some(na)}(e))return function(){if(aa)ot(aa,!1)
else{aa=a({className:"fshActionBox",innerHTML:"<div></div><div></div><div></div><div></div><div></div>"})
const e=n("actionContainer")
rt(aa,e.children[2])}return aa}()
aa&&ot(aa,!0)}function oa(e,t,a,n){t&&(e.className=t),r(a,e)
const s=st()
return o(e,s),lt(e,n),s}let sa=0,la=0
function ia(e,t){sa?ot(sa,!1):function(e){sa=e.children[3],la=oa(sa,"fshBlue","CA "," active")}(e),r(t.level,la)}function ca(e,t){t?ia(e,t):sa&&ot(sa,!0)}let ua=0,fa=0
function da(e,t){ua?ot(ua,!1):function(e){ua=e.children[4],fa=oa(ua,"fshRed","Doubler "," active")}(e),r(t.level,fa)}function ma(e,t){t?da(e,t):ua&&ot(ua,!0)}let pa=0,ha=0
function ga(e,t,a){pa?ot(pa,!1):function(e){pa=e.children[2],ha=oa(pa,"","Damage bonus: ","%")}(e),r(function(e,t){if(e){const a=Math.min(.01*Math.round(Math.floor(t/5)*Number(e.level)),20)
return it(a,2).toString()}return"0"}(t,Number(a)),ha)}function va(e,t,a){t?ga(e,t,a):pa&&ot(pa,!0)}let ba=0,wa=0
function ka(e,t){ba?ot(ba,!1):function(e){ba=e.children[1],wa=oa(ba,"","Kill Streak: ","")}(e),function(e,t){r(ut(e),t)}(t,wa)}function ya(e,t,a,n){t||a?ka(e,n):ba&&ot(ba,!0)}function Ca(e,t){return t.name===e}function $a(e){const{buffs:t}=GameData.player()
if(t)return t.find(s(Ca,e))}const La=["red","orange","yellow"]
let Va=0,Da=0
async function Ma(){if(c("NewMap","recastClick"),$a("Summon Shield Imp"))return
!function(e){dt(e)&&GameData.fetch(f)}(await ft([u()],[55]))}const xa=["imp-0","imp-1","imp-1"]
function Aa(e,t){Va?ot(Va,!1):function(e){[Va]=e.children,r("Shield Imps Remaining: ",Va),Da=st(),o(Va,Da),l(Va,"&nbsp;")
const t=mt({className:"xSmallLink",textContent:"Recast"})
o(Va,t),i(t,Ma)}(e)
const a=function(e){return e?Number(e.stack):0}(t)
Va.className=function(e){return xa[e]??"fshGreen"}(a),r(a,Da)}function Sa(e,t,a){t||a?Aa(e,t):Va&&ot(Va,!0)}function Na(e){return 0===e.type}let Ha=0,Ba=0,qa=0,Ta=0,Ea=0,Ga=0
...
return pt(e)&&e.some(Na)}(),Ga=GameData.player().killStreak}function Pa(){!function(){const e=$("#actionlist-shield-imp")
1===e.length&&e.css("background-color",La[e.text()]||"#ad8043")}(),ja()
const e=ra([Ha,Ba,qa,Ta,Ea])
e&&(Sa(e,Ta,Ha),ya(e,Ha,Ea,Ga),va(e,Ha,Ga),ca(e,qa),ma(e,Ba))}function Fa(e){return st({textContent:e})}function Ra(){window.GameController&&GameController.Realm&&!GameController.Realm.footprintTileList&&(GameController.Realm.footprintTileList=[])}function _a(e,t,a){return vt({className:`fshCurveEle fshCurveLbl fshPoint tip-static ${e}`,dataset:{tipped:t},htmlFor:a})}function Oa(e){const t=a({className:"fshToggle"}),n=gt({checked:e.prefVal,id:e.checkId,type:"checkbox"})
o(t,n)
const r=_a(e.onClass,e.onTip,e.checkId)
o(t,r)
const s=_a(e.offClass,e.offTip,e.checkId)
return o(t,s),o(e.worldName,t),n}let Ia=0,Wa=0,Ka=0,Ya=0,za=0,Ua=0,Qa=0,Xa=0,Ja=0
const Za=e=>Fa(e?e.toString():"?")
function en(e,t,n){const r=a({textContent:`${t} Lvl: `})
o(r,n),o(e,r)}function tn(e,t,a){const n=mt({className:`fshCurveEle fshCurveBtn fshPoint tip-static ${e}`,dataset:{tipped:t}})
...
Ja=Oa({prefVal:a,checkId:"fshHuntCheck",onClass:"huntOn",onTip:"Hunting mode is ON",offClass:"huntOff",offTip:"Hunting mode is OFF",worldName:e})}(Ia)}const rn=[[()=>Xa,function(){c("NewMap","toggleSound"),V("playNewMessageSound",!b("playNewMessageSound"))}],[()=>Ja,function(){c("NewMap","toggleHuntMode"),t.huntingMode=!t.huntingMode,V("huntingMode",t.huntingMode)}]],on=[[()=>Ya,function(e){c("NewMap","doFormGroup"),w(e),GameData.doAction(12,401,{},0)}],[()=>za,function(){c("NewMap","openQuickBuff"),ht(k())}],[()=>Ua,function(){c("NewMap","openRealmMap"),window.open(`${y+C}map`,"fsMap")}],[()=>Qa,function(){c("NewMap","openUfsgMap")
const e=GameData.realm()
window.open(`${L}realms${C}view&realm_id=${e.id}`,"mapUfsg")}]]
function sn(e,t){const{target:a}=t,[,n]=e.find((([e])=>e()===a))??[]
n&&(a.blur(),n(a))}function ln(e){return s(sn,e)}function cn(){Ia||(Ia=a({className:"fshCurveContainer",id:"fshWorldButtonContainer"}),nn(),i(Ia,ln(on)),v(Ia,"change",ln(rn)),g(Ia,n("worldCoord")))}function un(e,t){Wa&&t.b.minlevel&&(Ra(),r(t.b.minlevel,Wa))}function fn(e,t){Ka&&r(t.b,Ka)}const dn=["NORMAL","CHAMPION","ELITE","SUPER ELITE","TITAN","LEGENDARY"],mn=`url("${A}ui/world/icon_action_attack_`
let pn=!1
...
const Rn=()=>Tn,_n=()=>En,On=()=>Gn,In=()=>jn,Wn=()=>Pn,Kn=()=>Fn
function Yn(e,t){return wt(G(t,e))}function zn(){var e
Tn=GameData.player().level,e=n("statbar-character-tooltip-stats"),Gn=Yn(e,j),En=Yn(e,P),Pn=Yn(e,F),jn=Yn(e,R),Fn=Yn(e,_)}const Un=e=>`<td>${e}:&nbsp;</td>`,Qn=e=>`<td width="40%">${e}</td>`
...
function tr(e){return`<tr><td colspan="2">${e.name}:</td><td colspan="2">${e.value}</td></tr>`}function ar(e,t,a){return function(e){return`<table><tr><td><img src="${A}creatures/${e.image_id}.png" height="200" width="200"></td><td rowspan="2"><table width="400"><tr><td class="header" colspan="4" class="fshCenter">Statistics</td></tr>`}(e)+function(e,t){return Jn([Un("Class"),Qn(e.creature_class),...Xn(["Level",e.level,"level",t,Rn])])}(e,a)+function(e){return Zn(["Attack",e.attack,"defense","fshYellow",_n],["Defense",e.defense,"attack","fshYellow",On])}(e)+function(e){return Zn(["Armor",e.armor,"damage","fshYellow",In],["Damage",e.damage,"armor","fshYellow",Wn])}(e)+function(e,t){return Jn([Un("HP"),Qn(`${e.hp} (your HP:<span class="fshYellow">${Kn()}</span>)(1H: <span class="fshRed">${t}</span>)`),Un("Gold"),Qn(e.gold)])}(e,t)+er+function(e){return 0===e.enhancements.length?'<tr><td colspan="4">[no enhancements]</td></tr>':e.enhancements.map(tr).join("")}(e)+function(e){return`<tr><td colspan="4" height="5"></td></tr><tr><td class="header" colspan="4" class="fshCenter">Description</td></tr><tr><td colspan="4">${e.description}</td></tr><tr><td colspan="4" height="5"></td></tr></table></td></tr><tr><td class="fshCenter"><b>${e.name}</b></td></tr></table>`}(e)}function nr(e){if(!An(e))return function(e){const a=Math.ceil(e.hp*t.hpVariable+e.armor*t.generalVariable)
let n="fshYellow"
return zn(),Rn()>e.level&&(n="fshRed"),ar(e,a,n)}(e.response.data)}const rr=["verb","view","tip-static"]
async function or(e,t){const a=function(e){return O(e.parentNode.children).indexOf(e)}(e),n=await qn(GameData.actions()[a].data.id,a)
...
function pr(e){return function(t,a,n,r){const o=mr[t];(function(e){return e&&z(e)})(o)&&function(e){return Y(e)||0===e}(r)?o(e)(t,a,n,r):e(t,a,n,r)}}function hr(){return e={subcmd:"contrib"},Q({cmd:"globalquests",...e})
...
function n(e,a){return 1&a&&(t=null),null==t&&(t=!!pt(e[1])),t?yr:kr}gr(e)
let r=n(e,-1),o=r(e)
...
return yt(a=e[0],n),{c(){t=te(),n.block.c()},m(e,a){ae(e,t,a),n.block.m(e,n.anchor=a),n.mount=()=>t.parentNode,n.anchor=t},p(t,[r]){e=t,n.ctx=e,1&r&&a!==(a=e[0])&&yt(a,n)||Ct(n,e,r)},i:ne,o:ne,d(e){e&&re(t),n.block.d(e),n.token=null,n=null}}}function Dr(e,t,a){let{promise:n}=t
return e.$$set=e=>{"promise"in e&&a(0,n=e.promise)},[n]}class Mr extends J{constructor(e){super(),Z(this,e,Dr,Vr,ee,{promise:0})}}let xr=0
const Ar=()=>({promise:X(hr)})
...
b(e)&&(a=t+1,$.subscribe(U,s(Nr,a)),Nr(t+1))}function qr(e,t,a){const n=e.slice()
return n[10]=t[a].msg,n[11]=t[a].type,n[12]=t[a].count,n}function Tr(e){let t,a,n,r=e[12]+""
return{c(){t=oe("div"),a=se("x"),n=se(r),de(t,"class","count svelte-1leyf3b")},m(e,r){ae(e,t,r),ie(t,a),ie(t,n)},p(e,t){1&t&&r!==(r=e[12]+"")&&ce(n,r)},d(e){e&&re(t)}}}function Er(e,t){let a,n,r,o,s,l,i,c=t[10]+"",u=t[12]>1&&Tr(t)
function f(){return t[3](t[10])}return{key:e,first:null,c(){a=oe("div"),n=se(c),r=fe(),u&&u.c(),o=fe(),de(a,"class",s="fsh-message "+t[11]+" svelte-1leyf3b"),this.first=a},m(e,t){ae(e,a,t),ie(a,n),ie(a,r),u&&u.m(a,null),ie(a,o),l||(i=be(a,"click",f),l=!0)},p(e,r){t=e,1&r&&c!==(c=t[10]+"")&&ce(n,c),t[12]>1?u?u.p(t,r):(u=Tr(t),u.c(),u.m(a,o)):u&&(u.d(1),u=null),1&r&&s!==(s="fsh-message "+t[11]+" svelte-1leyf3b")&&de(a,"class",s)},d(e){e&&re(a),u&&u.d(),l=!1,i()}}}function Gr(e){let t,a=[],n=new Map,r=ue(e[1](e[0]))
const o=e=>e[10]
...
ae(e,t,n)},p(e,[s]){7&s&&(r=ue(e[1](e[0])),a=ve(a,s,o,1,e,r,n,t.parentNode,we,Er,t,qr))},i:ne,o:ne,d(e){e&&re(t)
...
a(0,r=[...r,{msg:e,type:t,expire:o}]),setTimeout((()=>{a(0,r=r.filter((({expire:e})=>e!==o)))}),n),await ke(),l()}
return[r,e=>$t(e,"msg").map((({msg:t,type:a})=>({msg:t,type:a,count:e.filter((({msg:e})=>e===t)).length}))),i,e=>i(e)]}class Pr extends J{constructor(e){super(),Z(this,e,jr,Gr,ee,{})}}let Fr=0
...
function Wr(e,t,a){const n=Or(t[a],Number(e[a]));(function(e,t){return!e||e.min!==t.min||e.max!==t.max})(t[a],n)&&(t[a]=n)}function Kr(e,t){e[t.name]=Or(e[t.name],Number(t.value))}function Yr(e){Fr||(Fr={}),Rr(e),function(e,t){Ir.forEach(s(Wr,e,t))}(e,Fr[e.name]),function(e,t){(function(e){return e.enhancements&&e.enhancements.length>0})(e)&&(t.enhancements=t.enhancements||{},e.enhancements.forEach(s(Kr,t.enhancements)))}(e,Fr[e.name]),H("fsh_monsterLog",Fr)}async function zr(){!function(e){Fr=e||{}}(await S("fsh_monsterLog"))}const Ur=[]
function Qr(e){var a
An(e)||(a=e.response.data,t.showMonsterLog&&Yr(a))}function Xr(e,t){return e.id===t.id}async function Jr(e,t){if(6!==e.type||function(e){if(Ur.find(s(Xr,e.data)))return!0
Ur.push(e.data)}(e))return
Qr(await qn(e.data.id,t))}function Zr(){t.showMonsterLog&&(GameData.actions().forEach(Jr),c("NewMap","MonsterLog"))}let eo=""
const to=()=>eo
function ao(){return Lt({subcmd:"scouttower"})}function no(e,[t,a,n]){const r=e.insertCell(-1)
...
function Oo(){Vo=st({innerHTML:"&nbsp;"}),Do=st({innerHTML:"&nbsp;"}),Mo=st(),xo=st(),Ao=st(),So=st(),No=st(),Ho=st(),Bo=st()}let Io=0
const Wo=()=>Io
function Ko(){for(;Io.rows.length>8;)Io.deleteRow(8)}function Yo(){const e=st()
return o(e,Eo()),lt(e,"/"),o(e,Go()),e}function zo(e){const t=st()
return o(t,e),lt(t,"%"),t}let Uo=0,Qo=0,Xo=""
const Jo=()=>Qo,Zo=()=>Xo
function es(){Qo=null,Uo&&!B("fshHide",Uo)&&(ot(Uo,!0),ye("&nbsp;",Vo),ye("&nbsp;",Do),r("",Mo),r("",xo),r("",Ao),r("",So),r("",No),ye("",Ho),ye("",Bo),Ko())}function ts(e){return 0===e.type&&(Qo=e.base_creature_id,Xo=`(${e.x},${e.y})`,!0)}function as(){if(Uo)ot(Uo,!1)
else{const e=n("actionContainer")
Uo=a({className:"fshActionBox titanInfo"}),Oo(),Io=Vt({className:"fshCenter"}),Lo(),so(Io,[[[[5,qo,!0],[1,To,!0]]],[[[2,yo,!0],[4,$o,!0]]],[[[2,Yo],[4,jo]]],[[[2,go,!0],[4,s(zo,Po())]],!0],[[[2,Co,!0],[4,s(zo,Fo())]],!0],[[[2,ko,!0],[4,Ro]],!0],[[[6,_o]]],[[[2,bo,!0],[2,vo,!0],[2,wo,!0]]]]),o(Uo,Wo()),o(e,Uo)}}function ns(e){return e<=0?'<span class="fshGreen cooldown">No active cooldown</span>':`<span class="fshMaroon cooldown">Cooldown until: ${function(e){const t=new Date(At()+1e3*e)
return`${Bt(t.getHours())}:${Bt(t.getMinutes())} ${Bt(t.getDate())}/${Ce[t.getMonth()]}/${t.getFullYear()}`}(e)}</span>`}function rs(e){return ct(xt(e.max_hp-e.current_hp,e.kills),2)}function os(e){return ct(100*e.kills/e.max_hp,2)}function ss(e){!function(e){[[Mt(e.creature.name),qo],[Zo(),To],[e.current_hp,Eo],[e.max_hp,Go],[e.kills,jo],[rs(e),Po],[os(e),Fo]].forEach((([e,t])=>r(e,t())))}(e),ye(function(e){return Dt(e.kills,e.max_hp,e.current_hp)}(e),Ro()),ye(ns(e.cooldown),_o())}function ls(e,t){return[[[2,()=>Fa(t.player.name)],[2,()=>Fa(t.kills.toString())],[2,()=>Fa(`${ct(100*t.kills/e.kills,2)}%`)]]]}function is(e){return e.realm&&e.creature.base_id===Jo()&&e.realm===to()}function cs(e){const t=e.find(is)
t&&(ss(t),function(e){if(Ko(),!e.contributors)return
const t=e.contributors.map(s(ls,e))
so(Wo(),t)}(t))}let us=null
const fs=e=>e?.s&&pt(e.r),ds=e=>t.showTitanInfo&&pt(e)&&e.some(ts)
async function ms(){!function(e,t){fs(t)&&(cs(t.r),ds(GameData.realm().dynamic)?us=window.setTimeout(e,3e4):es())}(ms,await X(ao))}function ps(e){us&&(window.clearTimeout(us),us=null),ds(e)?(as(),ms()):es()}function hs(e){var t
...
return a=new Tt({props:{$$slots:{default:[bs]},$$scope:{ctx:e}}}),a.$on("click",(function(...t){return e[3](e[5],e[7],...t)})),{c(){t=oe("li"),Ne(a.$$.fragment),n=fe()},m(e,o){ae(e,t,o),He(a,t,null),ie(t,n),r=!0},p(t,n){e=t
const r={}
256&n&&(r.$$scope={dirty:n,ctx:e}),a.$set(r)},i(e){r||(De(a.$$.fragment,e),r=!0)},o(e){Ae(a.$$.fragment,e),r=!1},d(e){e&&re(t),Be(a)}}}function ks(e){let t,a,n=ue(Ve(16,e[0])),r=[]
for(let t=0;t<n.length;t+=1)r[t]=ws(vs(e,n,t))
const o=e=>Ae(r[e],1,1,(()=>{r[e]=null}))
return{c(){t=oe("ul")
for(let e=0;e<r.length;e+=1)r[e].c()
de(t,"class","svelte-1k3xw12")},m(e,n){ae(e,t,n)
for(let e=0;e<r.length;e+=1)r[e]&&r[e].m(t,null)
a=!0},p(e,[a]){if(7&a){let s
for(n=ue(Ve(16,e[0])),s=0;s<n.length;s+=1){const o=vs(e,n,s)
r[s]?(r[s].p(o,a),De(r[s],1)):(r[s]=ws(o),r[s].c(),De(r[s],1),r[s].m(t,null))}for(Me(),s=n.length;s<r.length;s+=1)o(s)
xe()}},i(e){if(!a){for(let e=0;e<n.length;e+=1)De(r[e])
a=!0}},o(e){r=r.filter(Boolean)
for(let e=0;e<r.length;e+=1)Ae(r[e])
a=!1},d(e){e&&re(t),me(r,e)}}}function ys(e,t,a){const n=Se()
let{members:r=[]}=t
const o=e=>`Buff ${qe[e]} 16`
function s(e,t,a){a.target.blur(),qt(`${Te}&players=${e.join(",")}`,"fsQuickBuff",618,1e3,",scrollbars"),n("buffBatch",o(t))}return e.$$set=e=>{"members"in e&&a(0,r=e.members)},[r,o,s,(e,t,a)=>s(e,t,a)]}class Cs extends J{constructor(e){super(),Z(this,e,ys,ks,ee,{members:0})}}function $s(e,t){return e>10*t||e<t?e:10*t}const Ls=[["levelValue","level"],["attackValue","attack"],["attackBonus","bonus_attack"],["defenseValue","defense"],["defenseBonus","bonus_defense"],["armorValue","armor"],["armorBonus","bonus_armor"],["damageValue","damage"],["damageBonus","bonus_damage"],["hpValue","hp"],["hpBonus","bonus_hp"],["killStreakValue","killstreak"]]
...
return function(e,t){Ls.forEach(s(Vs,e,t))}(a,e),function(e,t){Ds.forEach(s(Ms,e,t))}(a,t),a.superEliteSlayerMultiplier=it(.002*a.superEliteSlayerLevel,2),Pt(a.armorValue)&&function(e){e.attackValue=$s(e.attackBonus,e.levelValue),e.defenseValue=$s(e.defenseBonus,e.levelValue),e.armorValue=$s(e.armorBonus,e.levelValue),e.damageValue=$s(e.damageBonus,e.levelValue),e.hpValue=e.hpBonus}(a),a}const As=Ge(["statusStore","Done."])
let Ss=[]
const Ns=Ee(As,((e,t)=>{const a=Ss.find((([t])=>t===e[0]))
a?[,a[1]]=e:Ss=[...Ss,e]
const n=Ss.find((([,e])=>"Done."!==e))
t(n?.[1]??"Done.")})),Hs=Ge(0)
const Bs=Ee(Hs,((e,t)=>{!async function(e,t){if(!e)return
As.set(["relicStore","Processing defending guild relics ... "])
const a=await Ft(e)
if(!a)return void As.set(["relicStore","AJAX Error"])
const n=a.r.relics.length,r=1===n?1.5:it(1-n/10,2)
t({noOfRelics:n,relicMultiplier:r,leadDefenderBonus:`${String(100*r)}%`}),As.set(["relicStore","Done."])}(e,t)})),qs=Ge([])
const Ts=Ee(qs,((e,t)=>{!async function(e,t){if(!e.length)return
As.set(["defendersStore","Processing defending group stats ... "])
const a=[]
await jt(e.map((async(e,n)=>{const r=await Gt(e)
a.push([n,xs(r)]),t(a)}))),As.set(["defendersStore","Done."])}(e,t)})),Es=Ee(Ts,((e,t)=>{const a=e?.find((([e])=>0===e))
a&&t(a[1])})),Gs=(e,t,a)=>Math.ceil(a*(0===t?e:je))
function js(e,t,[a,n]){return{armorValue:t.armorValue+Gs(e,a,n.armorValue),attackValue:t.attackValue+Gs(e,a,n.attackValue),damageValue:t.damageValue+Gs(e,a,n.damageValue),cloaked:t.cloaked+(n.cloakLevel?1:0),defenseValue:t.defenseValue+Gs(e,a,n.defenseValue),hpValue:t.hpValue+Gs(e,a,n.hpValue)}}const Ps=Ee([Bs,Ts],(([e,t],a)=>{if(!e?.relicMultiplier||!t?.length)return
const n=t?.reduce(s(js,e.relicMultiplier),{armorValue:0,attackValue:0,damageValue:0,cloaked:0,defenseValue:0,hpValue:0})
a(n)})),Fs=Ge(0),Rs=e=>e.members[0].name===GameData.player().username
...
r&&t({attack:r[0],defense:r[1],armor:r[2],hp:r[3],damage:r[4]}),As.set(["groupStore","Done."])}const Os=Ee(Fs,((e,t)=>{_s(e,t)})),Is=(e,t,a)=>Math.ceil(e*Pe(t,0)*a),Ws=(e,t)=>Is(e,t,.0025),Ks=(e,t)=>Is(e,t,.001),Ys=Ks,zs=Ks,Us=Ks,Qs=Ks,Xs=Ks,Js=(e,t)=>Math.ceil(e*(1+.001*Pe(t,0))),Zs=(e,t)=>Math.ceil(e*(1-t*Fe)),el=Ge([]),tl=Ee(el,((e,t)=>{e&&t(Et(e))})),al=Ee([tl,Os],(([e,t],a)=>{if(!e||!t)return
const n=Js(t.defense,e.Constitution),r=Ys(n,e.Fortitude),o=t.hp+r,s=zs(o,e["Chi Strike"])
...
const nl=Ee([al,Es,Os],(function([e,t,a],n){if(!e||!t||!a)return
const r=a.attack-e.nmv,o=Qs(r,t.flinchLevel),s=Xs(e.dmgWithChiStrike,t.terrorizeLevel)
n({attack:r-o,defense:e.defWithConst+e.nmv,armor:a.armor+e.sanctuary,hp:e.hpWithFortitude,damage:e.dmgWithChiStrike-s})})),rl=Ee([Es,Ps],(([e,t],a)=>{if(!e||!t)return
const n=Ws(t.attackValue,e.nightmareVisageLevel),r=Js(t.defenseValue,e.constitutionLevel),o=Ys(r,e.fortitudeLevel),s=t.hpValue+o,l=zs(s,e.chiStrikeLevel),i=t.damageValue+l
...
const ol=Ee([tl,rl,Ps],(function([e,t,a],n){if(!e||!t||!a)return
const r=Qs(t.attackWithNmv,e.Flinch),o=t.defWithConst+t.nmv,s=Xs(t.dmgWithChiStrike,e.Terrorize)
n({attack:t.attackWithNmv-r,dc225:Zs(o,225),dc175:Zs(o,175),defense:o,armor:a.armorValue+t.sanctuary,hp:t.hpWithFortitude,damage:t.dmgWithChiStrike-s})})),sl=Ee(Bs,((e,t)=>{t({noOfRelics:e?.noOfRelics??"",leadDefenderBonus:e?.leadDefenderBonus??""})})),ll=Ee(Es,((e,t)=>{if(!e)return t("")
e.cloakLevel?t("Yes"):t("No")})),il=Ee(Ps,((e,t)=>{t({armorValue:e?.armorValue??"",attackValue:e?.attackValue??"",damageValue:e?.damageValue??"",cloaked:e?.cloaked??"",defenseValue:e?.defenseValue??"",hpValue:e?.hpValue??""})})),cl=Ee(Ts,((e,t)=>{t(e?.length??"")})),ul=Ee(ol,((e,t)=>{t({attack:e?.attack??"",dc225:e?.dc225??"",dc175:e?.dc175??"",defense:e?.defense??"",armor:e?.armor??"",hp:e?.hp??"",damage:e?.damage??""})})),fl=e=>({attack:e?.attack??"",defense:e?.defense??"",armor:e?.armor??"",hp:e?.hp??"",damage:e?.damage??""}),dl=Ee(Os,((e,t)=>{t(fl(e))})),ml=Ee(nl,((e,t)=>{t(fl(e))}))
...
const o=[({username:e})=>!n.includes(e),({last_login:e})=>e,({last_login:e})=>e<St(),({last_login:e})=>e>Nt(),({level:e})=>e<400||e>421,({level:e})=>e<441||e>450],s=e=>o.every((t=>t(e))),l=({username:e},{username:t})=>_e(e,t)
return Hs.subscribe((e=>{!async function(e){const t=await Kt(e)
pt(t)&&a(0,r=t.filter(s).sort(l))}(e)})),e.$$set=e=>{"members"in e&&a(1,n=e.members)},[r,n]}class bl extends J{constructor(e){super(),Z(this,e,vl,gl,ee,{members:1})}}function wl(e){let t,a,n
return a=new Cs({props:{members:e[10]}}),a.$on("buffBatch",e[11]),{c(){t=oe("div"),Ne(a.$$.fragment),de(t,"class","buff-links svelte-1qul0wc")},m(e,r){ae(e,t,r),He(a,t,null),n=!0},p:ne,i(e){n||(De(a.$$.fragment,e),n=!0)},o(e){Ae(a.$$.fragment,e),n=!1},d(e){e&&re(t),Be(a)}}}function kl(e){let t,a,n,r,o,s,l,i
...
return{c(){t=oe("button"),t.textContent="Fetch Stats",de(t,"class","custombutton"),de(t,"type","button")},m(r,o){ae(r,t,o),a||(n=be(t,"click",e[12]),a=!0)},p:ne,d(e){e&&re(t),a=!1,n()}}}function Cl(e){let t,a,n,r,o,s,l,i,c,u,f,d,m,p,h,g,v,b,w,k,y,C,$,L,V,D,M,x,A,S,N,H,B,q,T,E,G,j,P,F,R,_,O,I,W,K,Y,z,U,Q,X,J,Z,ee,te,ne,le,ue,me,pe,he,ge,ve,be,we,ke,ye,Ce,$e,Le,Ve,Me,xe,Se,qe,Te,Ee,Ge,je,Pe,Fe,Re,_e,Oe,Ie,We,Ke,Ye,ze,Ue,Qe,Xe,Je,Ze,et,tt,at,nt,rt,ot,st,lt,it,ct,ut,ft,dt,mt,pt,ht,gt,vt,bt,wt,kt,yt,Ct,$t,Lt,Vt,Dt,Mt,xt,At,St,Nt,Ht,Bt=e[3].noOfRelics+"",qt=e[3].leadDefenderBonus+"",Tt=e[5].attackValue+"",Et=e[6].attack+"",Gt=e[5].defenseValue+"",jt=e[6].defense+"",Pt=e[5].armorValue+"",Ft=e[6].armor+"",Rt=e[5].damageValue+"",_t=e[6].damage+"",Ot=e[5].hpValue+"",It=e[6].hp+"",Wt=e[5].cloaked+"",Kt=e[6].dc225+"",Yt=e[6].dc175+"",zt=e[8].attack+"",Ut=e[9].attack+"",Qt=e[8].defense+"",Xt=e[9].defense+"",Jt=e[8].armor+"",Zt=e[9].armor+"",ea=e[8].damage+"",ta=e[9].damage+"",aa=e[8].hp+"",na=e[9].hp+""
return Nt=new bl({props:{members:e[10]}}),{c(){t=oe("div"),a=oe("div"),a.textContent="Defending Guild Stats",n=fe(),r=oe("div"),o=oe("div"),o.textContent="Relic Count:",s=oe("div"),l=se(Bt),i=fe(),c=oe("div"),c.textContent="Lead Defender Bonus:",u=oe("div"),f=se(qt),d=fe(),m=oe("div"),m.textContent="Lead Defender Cloaked:",p=oe("div"),h=se(e[4]),g=fe(),v=oe("div"),v.textContent="Other Defender Stats",b=fe(),w=oe("div"),k=oe("div"),k.textContent="Raw Attack:",y=oe("div"),C=se(Tt),$=fe(),L=oe("div"),L.textContent="Attack w/ buffs:",V=oe("div"),D=se(Et),M=fe(),x=oe("div"),x.textContent="Raw Defense:",A=oe("div"),S=se(Gt),N=fe(),H=oe("div"),H.textContent="Defense w/buffs:",B=oe("div"),q=se(jt),T=fe(),E=oe("div"),E.textContent="Raw Armor:",G=oe("div"),j=se(Pt),P=fe(),F=oe("div"),F.textContent="Armor w/ buffs:",R=oe("div"),_=se(Ft),O=fe(),I=oe("div"),I.textContent="Raw Damage:",W=oe("div"),K=se(Rt),Y=fe(),z=oe("div"),z.textContent="Damage w/ buffs:",U=oe("div"),Q=se(_t),X=fe(),J=oe("div"),J.textContent="Raw HP:",Z=oe("div"),ee=se(Ot),te=fe(),ne=oe("div"),ne.textContent="HP w/ buffs:",le=oe("div"),ue=se(It),me=fe(),pe=oe("div"),pe.textContent="Cloaked:",he=oe("div"),ge=se(Wt),ve=fe(),be=oe("div"),be.textContent="Processed:",we=oe("div"),ke=se(e[7]),ye=fe(),Ce=oe("div"),$e=oe("div"),$e.textContent="Adjusted Defense Values",Le=fe(),Ve=oe("div"),Me=oe("div"),Me.textContent="DC225:",xe=oe("div"),Se=se(Kt),qe=fe(),Te=oe("div"),Te.textContent="DC175:",Ee=oe("div"),Ge=se(Yt),je=fe(),Pe=oe("div"),Pe.textContent=" ",Fe=fe(),Re=oe("div"),Re.textContent="Attacking Group Stats",_e=fe(),Oe=oe("div"),Ie=oe("div"),Ie.textContent="Raw Group Attack:",We=oe("div"),Ke=se(zt),Ye=fe(),ze=oe("div"),ze.textContent="Group Attack w/ buffs:",Ue=oe("div"),Qe=se(Ut),Xe=fe(),Je=oe("div"),Je.textContent="Raw Group Defense:",Ze=oe("div"),et=se(Qt),tt=fe(),at=oe("div"),at.textContent="Group Defense w/ buffs:",nt=oe("div"),rt=se(Xt),ot=fe(),st=oe("div"),st.textContent="Raw Group Armor:",lt=oe("div"),it=se(Jt),ct=fe(),ut=oe("div"),ut.textContent="Group Armor w/ buffs:",ft=oe("div"),dt=se(Zt),mt=fe(),pt=oe("div"),pt.textContent="Raw Group Damage:",ht=oe("div"),gt=se(ea),vt=fe(),bt=oe("div"),bt.textContent="Group Damage w/ buffs:",wt=oe("div"),kt=se(ta),yt=fe(),Ct=oe("div"),Ct.textContent="Raw Group HP:",$t=oe("div"),Lt=se(aa),Vt=fe(),Dt=oe("div"),Dt.textContent="Group HP w/ buffs:",Mt=oe("div"),xt=se(na),At=fe(),St=oe("div"),Ne(Nt.$$.fragment),de(a,"class","b-top svelte-1qul0wc"),de(o,"class","svelte-1qul0wc"),de(s,"class","svelte-1qul0wc"),de(c,"class","svelte-1qul0wc"),de(u,"class","svelte-1qul0wc"),de(m,"class","svelte-1qul0wc"),de(p,"class","svelte-1qul0wc"),de(r,"class","stat-grid svelte-1qul0wc"),de(v,"class","b-top svelte-1qul0wc"),de(k,"class","svelte-1qul0wc"),de(y,"class","svelte-1qul0wc"),de(L,"class","svelte-1qul0wc"),de(V,"class","svelte-1qul0wc"),de(x,"class","svelte-1qul0wc"),de(A,"class","svelte-1qul0wc"),de(H,"class","svelte-1qul0wc"),de(B,"class","svelte-1qul0wc"),de(E,"class","svelte-1qul0wc"),de(G,"class","svelte-1qul0wc"),de(F,"class","svelte-1qul0wc"),de(R,"class","svelte-1qul0wc"),de(I,"class","svelte-1qul0wc"),de(W,"class","svelte-1qul0wc"),de(z,"class","svelte-1qul0wc"),de(U,"class","svelte-1qul0wc"),de(J,"class","svelte-1qul0wc"),de(Z,"class","svelte-1qul0wc"),de(ne,"class","svelte-1qul0wc"),de(le,"class","svelte-1qul0wc"),de(pe,"class","svelte-1qul0wc"),de(he,"class","svelte-1qul0wc"),de(be,"class","svelte-1qul0wc"),de(we,"class","svelte-1qul0wc"),de(w,"class","stat-grid svelte-1qul0wc"),de(t,"class","middle svelte-1qul0wc"),de($e,"class","b-top svelte-1qul0wc"),de(Me,"class","svelte-1qul0wc"),de(xe,"class","svelte-1qul0wc"),de(Te,"class","svelte-1qul0wc"),de(Ee,"class","svelte-1qul0wc"),de(Pe,"class","svelte-1qul0wc"),de(Ve,"class","stat-grid svelte-1qul0wc"),de(Re,"class","b-top svelte-1qul0wc"),de(Ie,"class","svelte-1qul0wc"),de(We,"class","svelte-1qul0wc"),de(ze,"class","svelte-1qul0wc"),de(Ue,"class","svelte-1qul0wc"),de(Je,"class","svelte-1qul0wc"),de(Ze,"class","svelte-1qul0wc"),de(at,"class","svelte-1qul0wc"),de(nt,"class","svelte-1qul0wc"),de(st,"class","svelte-1qul0wc"),de(lt,"class","svelte-1qul0wc"),de(ut,"class","svelte-1qul0wc"),de(ft,"class","svelte-1qul0wc"),de(pt,"class","svelte-1qul0wc"),de(ht,"class","svelte-1qul0wc"),de(bt,"class","svelte-1qul0wc"),de(wt,"class","svelte-1qul0wc"),de(Ct,"class","svelte-1qul0wc"),de($t,"class","svelte-1qul0wc"),de(Dt,"class","svelte-1qul0wc"),de(Mt,"class","svelte-1qul0wc"),de(Oe,"class","stat-grid svelte-1qul0wc"),de(Ce,"class","right svelte-1qul0wc"),de(St,"class","bottom b-top svelte-1qul0wc")},m(e,re){ae(e,t,re),ie(t,a),ie(t,n),ie(t,r),ie(r,o),ie(r,s),ie(s,l),ie(r,i),ie(r,c),ie(r,u),ie(u,f),ie(r,d),ie(r,m),ie(r,p),ie(p,h),ie(t,g),ie(t,v),ie(t,b),ie(t,w),ie(w,k),ie(w,y),ie(y,C),ie(w,$),ie(w,L),ie(w,V),ie(V,D),ie(w,M),ie(w,x),ie(w,A),ie(A,S),ie(w,N),ie(w,H),ie(w,B),ie(B,q),ie(w,T),ie(w,E),ie(w,G),ie(G,j),ie(w,P),ie(w,F),ie(w,R),ie(R,_),ie(w,O),ie(w,I),ie(w,W),ie(W,K),ie(w,Y),ie(w,z),ie(w,U),ie(U,Q),ie(w,X),ie(w,J),ie(w,Z),ie(Z,ee),ie(w,te),ie(w,ne),ie(w,le),ie(le,ue),ie(w,me),ie(w,pe),ie(w,he),ie(he,ge),ie(w,ve),ie(w,be),ie(w,we),ie(we,ke),ae(e,ye,re),ae(e,Ce,re),ie(Ce,$e),ie(Ce,Le),ie(Ce,Ve),ie(Ve,Me),ie(Ve,xe),ie(xe,Se),ie(Ve,qe),ie(Ve,Te),ie(Ve,Ee),ie(Ee,Ge),ie(Ve,je),ie(Ve,Pe),ie(Ce,Fe),ie(Ce,Re),ie(Ce,_e),ie(Ce,Oe),ie(Oe,Ie),ie(Oe,We),ie(We,Ke),ie(Oe,Ye),ie(Oe,ze),ie(Oe,Ue),ie(Ue,Qe),ie(Oe,Xe),ie(Oe,Je),ie(Oe,Ze),ie(Ze,et),ie(Oe,tt),ie(Oe,at),ie(Oe,nt),ie(nt,rt),ie(Oe,ot),ie(Oe,st),ie(Oe,lt),ie(lt,it),ie(Oe,ct),ie(Oe,ut),ie(Oe,ft),ie(ft,dt),ie(Oe,mt),ie(Oe,pt),ie(Oe,ht),ie(ht,gt),ie(Oe,vt),ie(Oe,bt),ie(Oe,wt),ie(wt,kt),ie(Oe,yt),ie(Oe,Ct),ie(Oe,$t),ie($t,Lt),ie(Oe,Vt),ie(Oe,Dt),ie(Oe,Mt),ie(Mt,xt),ae(e,At,re),ae(e,St,re),He(Nt,St,null),Ht=!0},p(e,t){(!Ht||8&t)&&Bt!==(Bt=e[3].noOfRelics+"")&&ce(l,Bt),(!Ht||8&t)&&qt!==(qt=e[3].leadDefenderBonus+"")&&ce(f,qt),(!Ht||16&t)&&ce(h,e[4]),(!Ht||32&t)&&Tt!==(Tt=e[5].attackValue+"")&&ce(C,Tt),(!Ht||64&t)&&Et!==(Et=e[6].attack+"")&&ce(D,Et),(!Ht||32&t)&&Gt!==(Gt=e[5].defenseValue+"")&&ce(S,Gt),(!Ht||64&t)&&jt!==(jt=e[6].defense+"")&&ce(q,jt),(!Ht||32&t)&&Pt!==(Pt=e[5].armorValue+"")&&ce(j,Pt),(!Ht||64&t)&&Ft!==(Ft=e[6].armor+"")&&ce(_,Ft),(!Ht||32&t)&&Rt!==(Rt=e[5].damageValue+"")&&ce(K,Rt),(!Ht||64&t)&&_t!==(_t=e[6].damage+"")&&ce(Q,_t),(!Ht||32&t)&&Ot!==(Ot=e[5].hpValue+"")&&ce(ee,Ot),(!Ht||64&t)&&It!==(It=e[6].hp+"")&&ce(ue,It),(!Ht||32&t)&&Wt!==(Wt=e[5].cloaked+"")&&ce(ge,Wt),(!Ht||128&t)&&ce(ke,e[7]),(!Ht||64&t)&&Kt!==(Kt=e[6].dc225+"")&&ce(Se,Kt),(!Ht||64&t)&&Yt!==(Yt=e[6].dc175+"")&&ce(Ge,Yt),(!Ht||256&t)&&zt!==(zt=e[8].attack+"")&&ce(Ke,zt),(!Ht||512&t)&&Ut!==(Ut=e[9].attack+"")&&ce(Qe,Ut),(!Ht||256&t)&&Qt!==(Qt=e[8].defense+"")&&ce(et,Qt),(!Ht||512&t)&&Xt!==(Xt=e[9].defense+"")&&ce(rt,Xt),(!Ht||256&t)&&Jt!==(Jt=e[8].armor+"")&&ce(it,Jt),(!Ht||512&t)&&Zt!==(Zt=e[9].armor+"")&&ce(dt,Zt),(!Ht||256&t)&&ea!==(ea=e[8].damage+"")&&ce(gt,ea),(!Ht||512&t)&&ta!==(ta=e[9].damage+"")&&ce(kt,ta),(!Ht||256&t)&&aa!==(aa=e[8].hp+"")&&ce(Lt,aa),(!Ht||512&t)&&na!==(na=e[9].hp+"")&&ce(xt,na)},i(e){Ht||(De(Nt.$$.fragment,e),Ht=!0)},o(e){Ae(Nt.$$.fragment,e),Ht=!1},d(e){e&&(re(t),re(ye),re(Ce),re(At),re(St)),Be(Nt)}}}function $l(e){let t,a,n,r,o,s=e[0].is_owner&&wl(e)
function l(e,t){return e[1]?kl:yl}let i=l(e),c=i(e),u=e[1]&&Cl(e)
return{c(){t=oe("div"),a=oe("div"),s&&s.c(),n=fe(),c.c(),r=fe(),u&&u.c(),de(a,"class","left svelte-1qul0wc"),de(t,"class","body svelte-1qul0wc")},m(e,l){ae(e,t,l),ie(t,a),s&&s.m(a,null),ie(a,n),c.m(a,null),ie(t,r),u&&u.m(t,null),o=!0},p(e,[r]){e[0].is_owner?s?(s.p(e,r),1&r&&De(s,1)):(s=wl(e),s.c(),De(s,1),s.m(a,n)):s&&(Me(),Ae(s,1,1,(()=>{s=null})),xe()),i===(i=l(e))&&c?c.p(e,r):(c.d(1),c=i(e),c&&(c.c(),c.m(a,null))),e[1]?u?(u.p(e,r),2&r&&De(u,1)):(u=Cl(e),u.c(),De(u,1),u.m(t,null)):u&&(Me(),Ae(u,1,1,(()=>{u=null})),xe())},i(e){o||(De(s),De(u),o=!0)},o(e){Ae(s),Ae(u),o=!1},d(e){e&&re(t),s&&s.d(),c.d(),u&&u.d()}}}function Ll(e,t,a){let n,r,o,s,l,i,u,f
Oe(e,Ns,(e=>a(2,n=e))),Oe(e,sl,(e=>a(3,r=e))),Oe(e,ll,(e=>a(4,o=e))),Oe(e,il,(e=>a(5,s=e))),Oe(e,ul,(e=>a(6,l=e))),Oe(e,cl,(e=>a(7,i=e))),Oe(e,dl,(e=>a(8,u=e))),Oe(e,ml,(e=>a(9,f=e)))
let{relicData:d={}}=t
const m=d.defenders.map((e=>e.player_name))
let p=!1
return Ie((()=>{a(1,p=!1),Hs.set(0),qs.set([]),Fs.set(0),el.set([])})),e.$$set=e=>{"relicData"in e&&a(0,d=e.relicData)},[d,p,n,r,o,s,l,i,u,f,m,function(e){c("relic",e.detail)},function(){c("relic","fetchStats"),a(1,p=!0),Hs.set(d.controlled_by.guild_id),qs.set(m),Fs.set(GameData.player().hasGroup),el.set(GameData.player().buffs)}]}class Vl extends J{constructor(e){super(),Z(this,e,Ll,$l,ee,{relicData:0})}}let Dl=0
function Ml(e,t){var a,r
t?.response?.data?.defenders?.length>0&&(a=n("dialog-relic"),r=t.response.data,Dl&&Dl.$destroy(),Dl=new Vl({props:{relicData:r},target:a}))}function xl(e,t){"ACT_REPAIR"===t&&GameData.fetch(Ye+f+ze+Ue)}let Al=!1
...
function ql(e){$("#statbar-gold").css("background-color",e)}function Tl(){$("#HelperSendTotal").html(ut(b("currentGoldSentTotal"))),Number(GameData.player().gold)>Bl?ql("red"):ql("inherit")}function El(){Bl=b("goldAmount"),$("#statbar-gold-tooltip-general").append(`<dt class="stat-gold-sendTo">Send To:</dt><dd id="HelperSendTo">${b("goldRecipient")}</dd><dt class="stat-gold-sendAmt">Amount:</dt><dd id="HelperSendAmt">${ut(Bl)}</dd><dt class="stat-gold-sendTo">Send?</dt><dd><input id="HelperSendGold" value="Send!" class="custombutton" type="submit"><input type="hidden" id="xc" value=""</dd><dt class="stat-gold-sendTotal">Total Sent:</dt><dd id="HelperSendTotal">${ut(b("currentGoldSentTotal"))}</dd>`),$("#HelperSendGold").on("click",Je),Tl(),$.subscribe(Ze,Tl)}let Gl=0,jl=0,Pl=0,Fl=0,Rl=0,_l=0
async function Ol(){const e=await Sn({a:14,d:0,id:Gl.id,item_id:Gl.itemId}),t=e.response.response,a=e.response.msg
let n=a
if(0!==t){const e=a.indexOf("<");-1!==e&&(n=a.substring(0,e))}else n=`You purchased ${e.response.data.name} for ${ut(e.response.data.cost)} gold.`
l(_l,`${n}<br>`)}async function Il(){const e=zt(Rl.value)
e&&(c("NewMap","quickBuy"),await jt(Yt(e,Ol)),GameData.doAction(14,3,{id:Gl.id,item_id:Gl.itemId},0),Pl.close())}function Wl(){Fl?r("",_l):function(){Fl=a({className:"fshClear",textContent:"Select how many to quick-buy:"}),Rl=gt({id:"buyAmount",className:"fshNumberInput",min:1,max:99,value:1,type:"number"}),o(Fl,Rl)
const e=mt({textContent:"Quick-buy"})
i(e,Il),o(Fl,e),_l=a(),o(Fl,_l),o(jl,Fl)}()}function Kl(e,t){Gl=t,jl=jl||n("shopDialogConfirm"),jl&&(Pl=Pl||$(jl).data("hcsWorldDialogShopConfirm"),Pl&&Wl())}function Yl(e){let t,a
return{c(){t=oe("div"),a=se(e[0]),de(t,"id","tp-overlay"),de(t,"class","svelte-dcwx64")},m(e,n){ae(e,t,n),ie(t,a)},p(e,t){1&t&&ce(a,e[0])},d(e){e&&re(t)}}}function zl(e){let t,a=e[1]&&Yl(e)
return{c(){a&&a.c(),t=te()},m(e,n){a&&a.m(e,n),ae(e,t,n)},p(e,[n]){e[1]?a?a.p(e,n):(a=Yl(e),a.c(),a.m(t.parentNode,t)):a&&(a.d(1),a=null)},i:ne,o:ne,d(e){e&&re(t),a&&a.d(e)}}}function Ul(e,t,a){let{tpButton:n}=t,r=0,o=0,s=!1
function l(){const e=GameData.player().teleportCooldown
a(0,r=e-Ht()+o),r>0||(clearInterval(s),a(1,s=!1),n.classList.remove("cooldown"))}return window.$.subscribe("stats.player",l),window.$.subscribe(tt,(function(e,t){o=Ht(),l(),s||0!==t.response.response||a(1,s=setInterval((()=>{l()}),1e3))})),e.$$set=e=>{"tpButton"in e&&a(2,n=e.tpButton)},[r,s,n]}class Ql extends J{constructor(e){super(),Z(this,e,Ul,zl,ee,{tpButton:2})}}function Xl(e){return e.numberOfCreatureHitsTillDead-e.numberOfHitsRequired<=1?", dies on miss":", survives a miss"}function Jl(e,t){return"-"===t?e:"-"===e||e>t?"-":e}const Zl=[[e=>"-"===e.playerHits&&"-"===e.creatureHits,()=>"Unresolved"],[e=>"-"===e.playerHits,()=>"Player dies"],[e=>1===e.playerHits,e=>`Player 1 hits${Xl(e)}`],[e=>e.playerHits>1,e=>`Player > 1 hits${Xl(e)}`]]
...
function ii(e){return Math.floor(e.creature.defense*e.player.darkCurseLevel*Fe)}function ci(e){const t=li(e)
...
const e=t.doNotKillList.indexOf(ji);-1===e?t.doNotKillList.push(ji):t.doNotKillList.splice(e,1),Ri(),V("doNotKillList",t.doNotKillList.join()),fr()}function Oi(){Pi?Ri():function(){Pi=mt({className:"fshBl",textContent:Fi()})
const e=a({className:"description",innerHTML:'<span class="ui-helper-hidden-accessible"><input type="text"></span>'})
o(e,Pi),o(Gi,e),i(Pi,_i)}()}function Ii(e,t){!function(e){if(!Gi){const t=G("body",e)
1===t.length&&([Gi]=t)}}(t),Gi&&(ji=I(e),Oi())}let Wi=0,Ki=0,Yi=0,zi=0
function Ui(){Yi||(Ki||(Ki=a(),o(Wi,Ki),o(Wi,a({innerHTML:'<span class="fshFooter">*Does include CA, DD, HF, DC, Flinch, Super Elite Slayer, NMV, Sanctuary, Constitution, Fortitude, Chi Strike and Terrorize (if active) and allow for randomness (1.1053). Constitution, NMV, Fortitude and Chi Strike apply to group stats.</span>'}))),Yi=a(),o(Ki,Yi))}function Qi(e){Ui(),ye(e,Yi)}function Xi(e){zi||(Ui(),zi=a(),o(Ki,zi)),ye(e,zi)}function Ji(e,t){const a={name:e.name,class:e.creature_class,attack:Number(e.attack),defense:Number(e.defense),armor:Number(e.armor),damage:Number(e.damage),hp:Number(e.hp)}
...
r.callback=n,r.player=xs(a),function(e){e.combatEvaluatorBias=t.combatEvaluatorBias,e.attackVariable=1.1053,e.generalVariable=t.generalVariable,e.hpVariable=t.hpVariable}(r),r.creature=Ji(e.response.data,r.player.superEliteSlayerMultiplier),function(e){var t
t=e,[Ci,ci,vi,yi,si,ti,pi].forEach((e=>e(t)))}(r),r.evaluatorHTML=function(e){return`<table width="100%"><tbody>${Ai(e)}${Si(e)}${Ni(e)}${Hi(e)}${Bi(e)}${qi(e)}${Ti(e)}${Ei(e)}</tbody></table>`}(r),n.groupExists?Xi(r.evaluatorHTML):Qi(r.evaluatorHTML)}function ec(e){return e.members[0].name===u()}async function tc(e,t,a){if(a){!function(e,t,a){if(!a.r?.attributes)return
const n=a.r.attributes
Zi(e,t,{groupExists:!0,groupAttackValue:n[0].value,groupDefenseValue:n[1].value,groupArmorValue:n[2].value,groupDamageValue:n[3].value,groupHPValue:n[4].value})}(e,t,await Rt(a))}}async function ac(e,t){const a=function(e){if(pt(e.r))return e.r.find(ec)?.id}(await It())
...
pt(e)&&([cc,uc]=e)}function pc(e){"enabledHuntingMode"===e.target.name&&(c("NewMap","toggleEnabledHuntingMode"),t.enabledHuntingMode=e.target.value,V("enabledHuntingMode",t.enabledHuntingMode),mc(),GameData.fetch(f))}function hc(e){c("NewMap","togglePref"),t[e]=!t[e],V(e,t[e])}const gc={hideSubLvlCreature:function(){hc("hideSubLvlCreature"),GameData.fetch(Ue)},hidePlayerActions:function(){c("NewMap","toggleHidePlayerActions"),rc=!rc,V("hidePlayerActions",rc),GameData.fetch(Ue)},showCreatureInfo:()=>hc("showCreatureInfo"),showHuntingBuffs:function(){hc("showHuntingBuffs"),GameData.fetch(f)},showMonsterLog:()=>hc("showMonsterLog"),showTitanInfo:function(){hc("showTitanInfo"),ps(GameData.realm().dynamic)},showBuffInfo:function(){hc("showBuffInfo"),Pa()}}
function vc(e){const t=gc[e.target.name]
z(t)&&(e.target.blur(),t(e))}function bc(){const e=n("worldPage")
if(!e)return
...
n.length>0?function(e,t){ye(`You are missing some ${dc()} hunting buffs<br>(${t.join(", ")})`,e)}(e,n):$c(e)}function Vc(e,a,n){fc()&&function(e,a){t.showHuntingBuffs?Lc(e,a):$c(e)}(e,n)}function Dc(e,t){return 6!==t.type||(0!==t.data.creature_type||t.data.level>=e)}function Mc(e){const t=T(e)
return t?.actions?.length?(t.actions=t.actions.filter(s(Dc,function(e){return e.realm?.minlevel||GameData.realm().minlevel}(t))),nt(t)):e}function xc(e,a){t.hideSubLvlCreature&&function(e){return e.data?.d&&ta(e.data.d,Ue)}(a)&&(e.dataFilter=Mc)}function Ac(e){t[e[0]]=Qt(e[1])}function Sc(e){t[e]=Qt(e)}function Nc(){[["buffs","huntingBuffs"],["buffs2","huntingBuffs2"],["buffs3","huntingBuffs3"]].forEach(Ac),["doNotKillList"].forEach(Sc)}function Hc(e){t[e[0]]=b(e[1])}function Bc(e){t[e]=b(e)}function qc(){[["buffsName","huntingBuffsName"],["buffs2Name","huntingBuffs2Name"],["buffs3Name","huntingBuffs3Name"],["showHuntingBuffs","showHuntingBuffs"]].forEach(Hc),["enabledHuntingMode","hideSubLvlCreature","showTitanInfo","showBuffInfo","showMonsterLog","showCreatureInfo"].forEach(Bc)}const Tc=[function(){kc(),Nc(),qc()
const e=bc()
$.ajaxPrefilter("JSON",xc),t.hideSubLvlCreature&&GameData.fetch(Ue),function(e){mc()
const a=s(Vc,e)
$.subscribe(d,a),t.showHuntingBuffs&&window.initialGameData&&a(null,{b:window.initialGameData.player.buffs})}(e),rc=b("hidePlayerActions"),$.subscribe(U,sc),sc()},function(){Qe(),Xe()&&El()},function(){$.subscribe(at,nc)},function(){Hr.forEach(Br)},function(){b("enableCreatureColoring")&&o(document.body,kt("#actionList .creature-1 {color: green;}\n#actionList .creature-2 {color: yellow;}\n#actionList .creature-3 {color: red;}"))},function(){$.subscribe(U,fr),fr(),function(){const e=GameData.doAction
GameData.doAction=pr(e)}()},function(){zr(),$.subscribe("-1-success.action-response 4-success.action-response 5-success.action-response 25-success.action-response",Zr),Zr()},function(){$.subscribe(Ke,xl)},async function(){if(b("keepLogs")){!function(e){e&&($n=e),$.subscribe(N,xn)}(await S("fsh_combatLog"))}},function(){window.initialGameData&&gs(0,window.initialGameData),$.subscribe(`${$e} ${Le}`,gs)},function(){$.subscribe(et,Kl)},function(){$.subscribe(We,Ml)},function(){$("#messageCenter").worldMessageCenter({offset:"0 60"})},function(){w("#mapTooltip")},function(){cn(),$.subscribe(p,un),$.subscribe(h,fn)},function(){Pa(),$.subscribe(`${d} ${m}`,Pa)},function(){v(n("actionList"),"mouseover",ir)},function(){const{body:e}=document
...
//# sourceMappingURL=newMap-JdR9p19e.js.map
