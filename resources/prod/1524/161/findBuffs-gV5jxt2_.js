import{bC as t,bZ as e,cv as n,ay as s,b$ as a,aA as r,g as o,d as i,ag as c,m as l,b6 as f,cY as u,q as d,a5 as p,cH as b,r as h,c as m,aO as y,df as g,p as v,o as x,s as w,bz as k,bA as L,av as C,a4 as P,dZ as B,h as I,dg as S,dC as T,d_ as A,aW as E,b8 as N,dy as j,bp as R}from"./calfSystem-Cs6CSxoU.js"
import{o as D}from"./onlinePlayersPage-ORnpdX3j.js"
import{b as F}from"./buffObj-BIwiFUIW.js"
import{h as M}from"./simpleCheckbox-C-dxZ6vG.js"
import{o as H}from"./onlineDot-DmNFHAz9.js"
...
function ut(t,e){i(t,o(e))}async function dt(t){!function(t,e){st(e,{href:t,findBuffNicks:at})}(t,await R(t))}function pt(){ut(ot.length,"potentialBuffers"),ot.length<=0?z("Done.","blue"):(z("Parsing player data ...","green"),ot.forEach(dt))}function bt(t,e){N()!==L(e)&&ot.push(t)}function ht(t,e){if(n=function(t){return parseInt($(t).find("td:eq(2)").text().replace(/,/g,""),10)}(e),n>=rt&&n>=U()){bt($(e).find("td:eq(1) a").attr("href"),$(e).find("td:eq(1) a").text())}var n}async function mt(t,e,n){const s=function(t,e){return 1===t?Math.round(it*e/50):t+1}(t,e)
...
n<s?mt(n,s,yt):pt()}async function gt(){if(it=parseInt(o("onlinePlayers").value,10),0!==it){yt(await D(1))}else pt()}function $t(t){const{tipped:e}=t.dataset,{mins:n}=S(e);(function(t,e,n){return t<5&&e>=rt&&e>=n})(n,Number(h(T,e)),U())&&bt(t.href,l(t))}function vt(t){lt.push(j+t)}async function xt(t){!function(t){const e=c(t)
I('#profileLeftColumn a[data-tipped*="Last Activity"]',e).forEach($t),ft+=1,ft===lt.length&&gt()}(await R(t))}function wt(t){const e=c(t)
o("guildMembers").checked&&I('#pCC a[data-tipped*="<td>VL:</td>"]',e).forEach($t),lt=[],lt.push(A),E(ct).forEach(vt),ft=0,o("alliesEnemies").checked?lt.forEach(xt):gt()}function kt(t,e){return 0!==e}function Lt(t){t.deleteRow(-1)}function Ct(){w("find buffs","clear results"),function(){const t=o("buffTable")
k(t.rows).filter(kt).forEach(m(Lt,t))}(),ut("","buffNicks"),z("Idle.","black"),ut("","potentialBuffers"),ut("0","buffersProcessed")}function Pt(t){P()||(ut(at,"buffNicks"),z(`Gathering list of ${t} ...`,"green"),Q=o("level175").checked,ut("0","buffersProcessed"),ot=[],ct=o("extraProfile").value,C("extraProfile",ct),async function(){wt(await B())}())}function Bt(t,e){return t===e.id}function It(){w("find buffs","findBuffsStart")
...
C("textToSearchFor",t),at=t,rt=1,Pt("profiles to search")}function Tt(){ct=r("extraProfile")}function At(t){x(o("findbuffsbutton"),t,!0)}function Et(){x(o("clearresultsbutton"),Ct,!0)}function Nt(t){const e=t||v()
s.sortBy="name",s.sortAsc=!0,F.sort(q),Tt(),i(J(_,ct),e),Z(),At(It),Et()}function jt(t){const e=t||v()
Tt(),i(J(V,ct),e),Z(),At(St),Et()}export{Nt as injectFindBuffs,jt as injectFindOther}
//# sourceMappingURL=findBuffs-gV5jxt2_.js.map
