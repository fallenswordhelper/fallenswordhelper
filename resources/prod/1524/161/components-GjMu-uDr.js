import{ak as e,el as t,em as s,K as r,J as n,en as a,bV as i,bU as o,y as c,bk as l,aG as u,E as p,H as d,cp as v,N as h,O as f,c4 as m,c5 as g,C as b,D as y,F as k,Q as D,bn as w,T as S,R as C,db as E,bQ as z,s as T,aF as $,G as _,bE as x,ab as Q,eo as I,d7 as N,cq as j,$ as M,a1 as q,e as G,cn as P,c as U,n as V,v as A,a8 as F,a9 as H,h as L,ep as R,q as W,o as J,bj as K,t as O,g as B,bt as X}from"./calfSystem-Cs6CSxoU.js"
import{d as Y}from"./daComponents-pvNpi1mQ.js"
import{c as Z}from"./closestTd-xXERH1TC.js"
...
h(e,s)}}),h(e,t)}
d(x,e=>{r(a)&&e(Q)}),h(t,g),f()}function be(e){return j({subcmd:"destroycomponent",removeIndex:e})}async function ye(e){const t=await G({cmd:"profile",subcmd:"destroycomponent",component_id:e})
...
return t.length>0?{r:t.map(e=>e.c),s:!0}:s.length>0?{e:{message:s[0].m},s:!1}:{e:{message:e[0].m},s:!1}}(await q(e.map(ye)))}function De(e){if(!e)return
...
var r
s?.s?((e=>Ce(e).map(t=>[t,e.filter(([,e])=>e===t).map(Ee)]))(e).forEach(ze),(e=>{e.forEach(([e])=>e?.children[0]?.remove())})(t)):(V(s?.e?.message??"Unknown Error"),function(e){e.forEach(([e,t])=>{t&&e.children[0].replaceWith(t)})}(t))}async function $e(e){const t=Ce(e)
t.forEach(U(we,!0)),await q(ee(30,e).map(Te)),t.forEach(U(we,!1))}function _e(e){const{itemId:t,invId:s}=F(H,e.dataset.tipped)
return[Number(t),Number(s)]}const xe=e=>[Z(e),..._e(e)]
function Qe(e){$e(L("img",e).map(xe))}function Ie(e,t){$e((e=>R(se).get(e).get("del"))(t).map(s=>{return[(r=e,n=s,Z(W(`img[data-tipped*="&inv_id=${n}&"]`,r))),t,s]
var r,n}))}function Ne(e){"IMG"===e.target.tagName&&(e.preventDefault(),T("components","quickDel"),K(e.target),$e([[Z(e.target),..._e(e.target)]]))}function je(e){e.classList.add("fshQuickDel"),J(e,Ne)}function Me(){const e=function(){const e=B("profileRightColumn"),t=X("inventory-table",e)
if(2===t.length)return t[1]}()
e&&O(ge,{props:{dispatchDelete:U(Qe,e),dispatchDelType:U(Ie,e),dispatchQuickDel:U(je,e)},target:e.parentNode})}export{Me as default}
//# sourceMappingURL=components-GjMu-uDr.js.map
