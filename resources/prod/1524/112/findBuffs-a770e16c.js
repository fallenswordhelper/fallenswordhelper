import{g as t}from"./guildManage-3f99b452.js"
import{o as e}from"./onlinePlayersPage-874a472b.js"
import{aV as n,bi as s,bF as a,ab as o,bl as r,ad as i,g as c,s as l,F as f,a3 as u,x as d,bT as p,r as b,c as h,au as m,c0 as g,q as y,cu as v,p as x,o as w,aU as k,a9 as L,aT as P,w as C,j,cN as T,d0 as B,ax as E,a_ as I,aK as S}from"./calfSystem-4830a18d.js"
import{c as A}from"./csvSplit-81e99601.js"
import{l as N}from"./lastActivity-1c838a76.js"
import{b as F}from"./buffObj-18893259.js"
import{h as R}from"./simpleCheckbox-ed7e63fb.js"
...
e.style.verticalAlign="top",l(J(t.doc,t.callback,t.lastActivity,t.bioCellHtml),e),$(".a-reply").on("click",Z)}({newRow:o,doc:n,callback:e,lastActivity:a,bioCellHtml:t}),function(t,e,n,s){const a=t.insertCell(1)
...
l(n+1,t),e===n+1&&Q("Done.","blue")}()}let st=0,at=0,ot=0,rt=0,it=0,ct=0,lt=0
function ft(t,e){l(t,c(e))}async function ut(t){!function(t,e){nt(e,{href:t,findBuffNicks:st})}(t,await S(t))}function dt(){ft(ot.length,"potentialBuffers"),ot.length<=0?Q("Done.","blue"):(Q("Parsing player data ...","green"),ot.forEach(ut))}function pt(t,e){E()!==k(e)&&ot.push(t)}function bt(t,e){if(n=function(t){return parseInt($(t).find("td:eq(2)").text().replace(/,/g,""),10)}(e),n>=at&&n>=W()){pt($(e).find("td:eq(1) a").attr("href"),$(e).find("td:eq(1) a").text())}var n}async function ht(t,n,s){const a=function(t,e){return 1===t?Math.round(rt*e/50):t+1}(t,n)
...
n<s?ht(n,s,mt):dt()}async function gt(){if(rt=parseInt(c("onlinePlayers").value,10),0!==rt){mt(await e(1))}else dt()}function yt(t){const{tipped:e}=t.dataset,{mins:n}=N(e);(function(t,e,n){return t<5&&e>=at&&e>=n})(n,Number(b(T,e)),W())&&pt(t.href,u(t))}function $t(t){ct.push(I+t)}async function vt(t){!function(t){const e=f(t)
j('#profileLeftColumn a[data-tipped*="Last Activity"]',e).forEach(yt),lt+=1,lt===ct.length&&gt()}(await S(t))}function xt(t){const e=f(t)
...
P(t.rows).filter(wt).forEach(h(kt,t))}(),ft("","buffNicks"),Q("Idle.","black"),ft("","potentialBuffers"),ft("0","buffersProcessed")}function Pt(e){C()||(ft(st,"buffNicks"),Q(`Gathering list of ${e} ...`,"green"),U=c("level175").checked,ft("0","buffersProcessed"),ot=[],it=c("extraProfile").value,L("extraProfile",it),async function(){xt(await t())}())}function Ct(t,e){return t===e.id}function jt(){const t=parseInt($("#selectedBuff").val(),10),e=F.find(h(Ct,t))
st=e.nicks,at=e.lvl,Pt("potential buffers")}function Tt(){const t=$("#textToSearchFor").val().split(",").map(k).join(",")
L("textToSearchFor",t),st=t,at=1,Pt("profiles to search")}function Bt(){it=i("extraProfile")}function Et(t){w(c("findbuffsbutton"),t,!0)}function It(){w(c("clearresultsbutton"),Lt,!0)}function St(t){const e=t||x()
o.sortBy="name",o.sortAsc=!0,F.sort(V),Bt(),l(Y(H,it),e),K(),Et(jt),It()}function At(t){const e=t||x()
Bt(),l(Y(O,it),e),K(),Et(Tt),It()}export{St as injectFindBuffs,At as injectFindOther}
//# sourceMappingURL=findBuffs-a770e16c.js.map
