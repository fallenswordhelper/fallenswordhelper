import{ab as t,n,c as s,aU as e,ad as o,au as f,p as a,a3 as u,ax as c,c0 as r,am as i,D as l,s as p,g as b,C as d}from"./calfSystem-4830a18d.js"
...
function N(t){return`<tr><td>${t[0]}</td><td>: ${t[1][0]}${t[1][1]}</td></tr>`}function F(t,n){return t[n[1][1]]+=n[1][0],t}function A(){const t=d(L.buffs),n=(e=t.reduce(F,{k:0,fsp:0,stam:0,unknown:0}),h.map(s($,e)).join(""))
var e
...
let s="unknown",e="1"
n&&(s=function(t){return t[0].includes("k")?"k":t[0].includes("f")?"fsp":"stam"}(n),[e]=r(/[+-]?[.\d]+/,n[0])),L.buffs[u(t)]=[parseFloat(e),s],L.count+=1}(t):(L.count-=1,delete L.buffs[s]),L.count>0?A():(p("&nbsp;",b("buffCost")),L.buffCostTotalText="")}function R(t){return t.tagName&&"SPAN"!==t.tagName?R(t.parentNode):t}function D(t){if("fshSendBuffMsg"===t.target.id)return void function(t){t.count>0&&T(t)}(L)
const n=R(t.target);(function(t){return t.classList&&l("buffLink",t)})(n)&&M(n)}function E(t,n,s){return t.replace(n,`<span id="fshBuff${s}" class="buffLink fshBlue">${n.replace(/(`~)|(~`)|(\{b\})|(\{\/b\})/g,"")}</span>`)}function P(t){let n=t.replace(/\{b\}/g,"`~").replace(/\{\/b\}/g,"~`")
const s=n.match(/`~([^~]|~(?!`))*~`/g)
...
//# sourceMappingURL=render-5caa9350.js.map
