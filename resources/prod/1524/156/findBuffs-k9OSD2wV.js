import{by as t,bY as e,cr as n,ay as s,b$ as a,aA as r,g as o,d as i,ag as c,l,b5 as f,cV as u,q as d,a4 as p,cE as b,r as h,c as m,aN as y,da as g,p as v,o as x,s as w,bv as k,bw as L,av as C,a3 as P,d_ as B,h as S,db as E,dG as I,d$ as T,aV as A,b7 as N,bC as j,bl as F}from"./calfSystem-79LsojAC.js"
import{o as R}from"./onlinePlayersPage-z0CO7_Qh.js"
import{b as D}from"./buffObj-BIwiFUIW.js"
import{h as M}from"./simpleCheckbox-GIXRLUIF.js"
import{o as G}from"./onlineDot-XDIE_fQc.js"
...
function ut(t,e){i(t,o(e))}async function dt(t){!function(t,e){st(e,{href:t,findBuffNicks:at})}(t,await F(t))}function pt(){ut(ot.length,"potentialBuffers"),ot.length<=0?U("Done.","blue"):(U("Parsing player data ...","green"),ot.forEach(dt))}function bt(t,e){N()!==L(e)&&ot.push(t)}function ht(t,e){if(n=function(t){return parseInt($(t).find("td:eq(2)").text().replace(/,/g,""),10)}(e),n>=rt&&n>=J()){bt($(e).find("td:eq(1) a").attr("href"),$(e).find("td:eq(1) a").text())}var n}async function mt(t,e,n){const s=function(t,e){return 1===t?Math.round(it*e/50):t+1}(t,e)
...
n<s?mt(n,s,yt):pt()}async function gt(){if(it=parseInt(o("onlinePlayers").value,10),0!==it){yt(await R(1))}else pt()}function $t(t){const{tipped:e}=t.dataset,{mins:n}=E(e);(function(t,e,n){return t<5&&e>=rt&&e>=n})(n,Number(h(I,e)),J())&&bt(t.href,l(t))}function vt(t){lt.push(j+t)}async function xt(t){!function(t){const e=c(t)
S('#profileLeftColumn a[data-tipped*="Last Activity"]',e).forEach($t),ft+=1,ft===lt.length&&gt()}(await F(t))}function wt(t){const e=c(t)
o("guildMembers").checked&&S('#pCC a[data-tipped*="<td>VL:</td>"]',e).forEach($t),lt=[],lt.push(T),A(ct).forEach(vt),ft=0,o("alliesEnemies").checked?lt.forEach(xt):gt()}function kt(t,e){return 0!==e}function Lt(t){t.deleteRow(-1)}function Ct(){w("find buffs","clear results"),function(){const t=o("buffTable")
k(t.rows).filter(kt).forEach(m(Lt,t))}(),ut("","buffNicks"),U("Idle.","black"),ut("","potentialBuffers"),ut("0","buffersProcessed")}function Pt(t){P()||(ut(at,"buffNicks"),U(`Gathering list of ${t} ...`,"green"),z=o("level175").checked,ut("0","buffersProcessed"),ot=[],ct=o("extraProfile").value,C("extraProfile",ct),async function(){wt(await B())}())}function Bt(t,e){return t===e.id}function St(){w("find buffs","findBuffsStart")
const t=parseInt($("#selectedBuff").val(),10),e=D.find(m(Bt,t))
at=e.nicks,rt=e.lvl,Pt("potential buffers")}function Et(){w("find buffs","findOtherStart")
const t=$("#textToSearchFor").val().split(",").map(L).join(",")
C("textToSearchFor",t),at=t,rt=1,Pt("profiles to search")}function It(){ct=r("extraProfile")}function Tt(t){x(o("findbuffsbutton"),t,!0)}function At(){x(o("clearresultsbutton"),Ct,!0)}function Nt(t){const e=t||v()
s.sortBy="name",s.sortAsc=!0,D.sort(V),It(),i(W(H,ct),e),Q(),Tt(St),At()}function jt(t){const e=t||v()
It(),i(W(_,ct),e),Q(),Tt(Et),At()}export{Nt as injectFindBuffs,jt as injectFindOther}
//# sourceMappingURL=findBuffs-k9OSD2wV.js.map
