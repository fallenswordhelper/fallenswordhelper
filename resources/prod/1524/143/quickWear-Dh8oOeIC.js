import{b as t,a as e}from"./backpackOk-51yZhrvU.js"
import{S as n,O as s,P as i,cI as a,R as r,U as o,W as c,cK as l,cL as u,cM as d,bA as f,bD as h,a4 as p,bE as m,dK as g,dV as x,bY as v,cO as z,Q as y,T as S,bo as k,X as b,_ as I,bB as T,bC as w,a1 as M,dP as q,dW as F,bF as O,bG as B,bH as E,av as H,a7 as R,dX as L,a8 as C,a3 as P,s as W,cJ as j,d0 as Q,bp as N,bu as A,a6 as U,bU as V,dU as D,cf as K,v as X,$ as Y,f as _,am as G,d as J,i as Z,m as tt,c as et,D as nt,dz as st,A as it,o as at,cA as rt,p as ot,w as ct,ao as lt,aj as ut}from"./calfSystem-ChzN4Q-P.js"
import{e as dt,s as ft}from"./selfIdIs-WfPktJTx.js"
import{s as ht}from"./simpleCheckbox-CwefujnB.js"
import{p as pt,a as mt}from"./pubsub-BMEeRQG0.js"
import{d as gt}from"./daUseItem-T66yKS27.js"
import{F as $t}from"./FolderButtons-9IFoeziH.js"
import{I as xt}from"./ItemImg-dgtuongC.js"
import{L as vt}from"./LinkButton-BclPa9W-.js"
import{c as zt}from"./confirm-CJiuwa20.js"
import{c as yt}from"./createInput-DC6X1nzh.js"
import{c as St}from"./createLabel-DQ3CQiAH.js"
import"./isChecked-D_0do7nT.js"
import"./Modal-BueFqMNE.js"
...
return t.$$set=t=>{"data"in t&&n(0,s=t.data)},[s,()=>W("QuickWear","AH Quick Search",s)]}class Zt extends n{constructor(t){super(),s(this,t,Jt,Gt,i,{data:0})}}function te(t){let e
...
return t.$$set=t=>{"itemList"in t&&n(1,s=t.itemList)},[l,s]}class ge extends n{constructor(t){super(),s(this,t,me,pe,i,{itemList:1})}}function $e(t,e){!function(t,e){new ge({props:{itemList:t},target:e})}(t,e)}function xe(t){return K({subcmd:"equipitem",inventory_id:t})}async function ve(t){return{s:0===(await X({cmd:"profile",subcmd:"equipitem",inventory_id:t,ajax:1})).r}}function ze(t){return Y(xe,ve,t)}function ye(t){let e,n,s,i,a,l,u,d
const m=[be,ke],g=[]
...
const i=_(s.folders.filter((({a:t})=>-1!==t)).map((({a:t,n:e})=>[t,e]))),a=(t,e)=>V(t.n,e.n)
let r=s.items.sort(a)
async function o(t,e,s,i){W("QuickWear",`doAction - ${i}`)
const a=r.findIndex((e=>e.a===t))
n(0,r[a][e]=1,r);(await s(t)).s&&n(0,r[a].used=i,r)}function c(t){o(t,"equip",ze,"Worn")}async function l(t){(G.disableQuickWearPrompts||await zt("Are you sure you want to use/extract the item?"))&&o(t,"use",gt,"Used")}return t.$$set=t=>{"appInv"in t&&n(5,s=t.appInv)},[r,i,function(t){W("QuickWear","doFilter")
...
function Ne(){W("QuickWear","Toggle Prompts"),G.disableQuickWearPrompts=!G.disableQuickWearPrompts,ut(Qe,G.disableQuickWearPrompts)}function Ae(t){Z(t,tt({className:"qwPref",innerHTML:ht(Qe)}))}function Ue(t,e){var n,s,i
...
const s=n||ot()
if(!s)return
ct(s,"Getting item list from backpack..."),G.disableQuickWearPrompts=lt(Qe)
!function(t,n){e(n)&&Ue(t,n)}(s,await t())}function De(t){rt()&&Ve(t)}export{De as default}
//# sourceMappingURL=quickWear-Dh8oOeIC.js.map
