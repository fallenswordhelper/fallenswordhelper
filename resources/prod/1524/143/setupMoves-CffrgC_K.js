import{x as t,c as n,cl as o,u as e,y as a,cp as i,r as p,J as c,cn as s,co as u}from"./calfSystem-ChzN4Q-P.js"
...
await e(n),s(`${u}setup`)}async function C(){const t=a("select",v).map(g),n=t.map(h)
await e(n),x(t)}const b=t=>p(l,$(t).attr("src"))??"x"
function y(t,n,o){const e=b(o)
d.push(e)
const a=$(r)
