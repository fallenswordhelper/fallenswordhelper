import{g as t}from"./guildManage-E3LaGC07.js"
import{o as e}from"./onlinePlayersPage-BFfaZFsI.js"
import{b0 as n,bp as s,bN as a,ag as r,bs as o,ai as i,g as c,d as l,H as f,a8 as u,x as d,b$ as p,r as b,c as h,az as m,c8 as g,q as y,cA as v,p as x,o as w,s as k,a$ as L,ae as C,a_ as P,w as B,k as j,cX as E,dg as S,aC as T,b5 as I,aR as A}from"./calfSystem-C4gAE-9q.js"
import{c as N}from"./csvSplit-C7tEPonC.js"
import{l as R}from"./lastActivity-iiyRQxyw.js"
import{b as F}from"./buffObj-BIwiFUIW.js"
import{h as D}from"./simpleCheckbox-D5LhvHMv.js"
import{o as M}from"./onlineDot-DLYQB6RS.js"
...
function ut(t,e){l(t,c(e))}async function dt(t){!function(t,e){st(e,{href:t,findBuffNicks:at})}(t,await A(t))}function pt(){ut(ot.length,"potentialBuffers"),ot.length<=0?Q("Done.","blue"):(Q("Parsing player data ...","green"),ot.forEach(dt))}function bt(t,e){T()!==L(e)&&ot.push(t)}function ht(t,e){if(n=function(t){return parseInt($(t).find("td:eq(2)").text().replace(/,/g,""),10)}(e),n>=rt&&n>=Y()){bt($(e).find("td:eq(1) a").attr("href"),$(e).find("td:eq(1) a").text())}var n}async function mt(t,n,s){const a=function(t,e){return 1===t?Math.round(it*e/50):t+1}(t,n)
...
n<s?mt(n,s,gt):pt()}async function yt(){if(it=parseInt(c("onlinePlayers").value,10),0!==it){gt(await e(1))}else pt()}function $t(t){const{tipped:e}=t.dataset,{mins:n}=R(e);(function(t,e,n){return t<5&&e>=rt&&e>=n})(n,Number(b(E,e)),Y())&&bt(t.href,u(t))}function vt(t){lt.push(I+t)}async function xt(t){!function(t){const e=f(t)
j('#profileLeftColumn a[data-tipped*="Last Activity"]',e).forEach($t),ft+=1,ft===lt.length&&yt()}(await A(t))}function wt(t){const e=f(t)
c("guildMembers").checked&&j('#pCC a[data-tipped*="<td>VL:</td>"]',e).forEach($t),lt=[],lt.push(S),N(ct).forEach(vt),ft=0,c("alliesEnemies").checked?lt.forEach(xt):yt()}function kt(t,e){return 0!==e}function Lt(t){t.deleteRow(-1)}function Ct(){k("find buffs","clear results"),function(){const t=c("buffTable")
P(t.rows).filter(kt).forEach(h(Lt,t))}(),ut("","buffNicks"),Q("Idle.","black"),ut("","potentialBuffers"),ut("0","buffersProcessed")}function Pt(e){B()||(ut(at,"buffNicks"),Q(`Gathering list of ${e} ...`,"green"),X=c("level175").checked,ut("0","buffersProcessed"),ot=[],ct=c("extraProfile").value,C("extraProfile",ct),async function(){wt(await t())}())}function Bt(t,e){return t===e.id}function jt(){k("find buffs","findBuffsStart")
const t=parseInt($("#selectedBuff").val(),10),e=F.find(h(Bt,t))
at=e.nicks,rt=e.lvl,Pt("potential buffers")}function Et(){k("find buffs","findOtherStart")
const t=$("#textToSearchFor").val().split(",").map(L).join(",")
C("textToSearchFor",t),at=t,rt=1,Pt("profiles to search")}function St(){ct=i("extraProfile")}function Tt(t){w(c("findbuffsbutton"),t,!0)}function It(){w(c("clearresultsbutton"),Ct,!0)}function At(t){const e=t||x()
r.sortBy="name",r.sortAsc=!0,F.sort(O),St(),l(J(V,ct),e),z(),Tt(jt),It()}function Nt(t){const e=t||x()
St(),l(J(_,ct),e),z(),Tt(Et),It()}export{At as injectFindBuffs,Nt as injectFindOther}
//# sourceMappingURL=findBuffs-CmEIv3OM.js.map
