...
import{ag as t,m as a,g as n,a9 as r,i as o,c as s,v as l,o as i,s as c,aC as u,aD as f,aE as d,aF as m,aG as p,aH as h,y as g,b as v,ai as b,aI as w,aJ as k,aK as y,aL as C,aM as L,ae as V,k as D,aA as M,q as x,aN as A,aO as S,aP as N,aQ as H,D as B,aR as T,aS as q,aT as E,aU as G,aV as P,aW as j,aX as F,aY as R,aZ as _,a_ as O,a$ as I,aj as W,a8 as K,b0 as Y,b1 as z,b2 as U,a as Q,$ as X,S as J,L as Z,M as ee,am as te,T as ae,_ as ne,a0 as re,O as oe,a3 as se,b3 as le,U as ie,a4 as ce,N as ue,P as fe,Q as de,b4 as me,b5 as pe,b6 as he,b7 as ge,Z as ve,X as be,a5 as we,b8 as ke,d as ye,b9 as Ce,ba as $e,bb as Le,E as Ve,bc as De,bd as Me,be as xe,bf as Ae,bg as Se,bh as Ne,bi as He,bj as Be,bk as Te,bl as qe,bm as Ee,bn as Ge,bo as Pe,bp as je,bq as Fe,br as Re,bs as _e,bt as Oe,bu as Ie,bv as We,bw as Ke,bx as Ye,by as ze,bz as Ue,bA as Qe,bB as Xe,bC as Je,bD as Ze,bE as et,bF as tt,bG as at,bH as nt,ah as rt}from"./calfSystem-C4gAE-9q.js"
import{i as ot}from"./insertElementAfter-3zrWZrLe.js"
import{t as st}from"./toggleForce-br4z9gGd.js"
import{c as lt}from"./createSpan-BrzwDI-q.js"
import{i as it}from"./insertTextBeforeEnd-eQ3lHwuR.js"
import{r as ct,a as ut}from"./roundToString-Hif1MLyB.js"
import{a as ft}from"./addCommas-C_h2HN8s.js"
import{d as dt,q as mt}from"./quickbuffSuccess-KTxks5VJ.js"
import{c as pt}from"./createButton-B-A34pvk.js"
import{i as ht}from"./isArray-eVldfhw1.js"
import{o as gt}from"./openQuickBuffById-BD5VkF0F.js"
import{c as vt}from"./createInput-C0n_hNQT.js"
import{c as bt}from"./createLabel-DKCF09Az.js"
import{r as wt}from"./rnd-D_QmA-Fa.js"
import{v as kt}from"./valueText-CnNJef9J.js"
import{c as yt}from"./createStyle-CNv7Gpcu.js"
import{h as Ct,u as $t}from"./await_block-DmJVVCA7.js"
import{u as Lt}from"./uniq-DcDZ6zXV.js"
import{g as Vt}from"./guild-CfTVed6c.js"
import{c as Dt}from"./createTable-Ck605qvO.js"
import{g as Mt,t as xt,a as At}from"./getTitanString-DvEb_zLX.js"
import{n as St,a as Nt,s as Ht,r as Bt}from"./now-Cx4PsKjI.js"
import{p as Tt}from"./padZ-DFV6JBPu.js"
import{f as qt}from"./fshOpen-AuKioUPF.js"
import{L as Et}from"./LinkButton-Ccne2AMZ.js"
import{r as Gt}from"./reduceBuffArray-Diy1E3zc.js"
import{p as Pt}from"./profile-B_GwU0Ly.js"
import{a as jt}from"./all-YfMtr2SN.js"
import{n as Ft}from"./numberIsNaN-CGkd1jiA.js"
import{r as Rt}from"./reliclist-Doq-AjAs.js"
import{d as _t}from"./daGroupStats-DBtZTkEu.js"
import{d as Ot,m as It}from"./mercEffect-CR05ArOy.js"
import{d as Wt}from"./daViewGroups-DGquai6l.js"
import{a as Kt}from"./attribsToArray-ClbbzfkG.js"
import{g as Yt}from"./guildMembers-DLy8NRhL.js"
import{r as zt}from"./remainingPages-BzskAxSU.js"
import{t as Ut}from"./testQuant-CUL735o8.js"
import{m as Qt}from"./myStats-jkVbx52f.js"
import{s as Xt}from"./shouldBeArray-CMnJOv9c.js"
import{s as Jt,j as Zt}from"./simpleCheckbox-D5LhvHMv.js"
import{i as ea}from"./isSelected-BWnMzKlW.js"
import{b as ta}from"./bitwiseAnd-C5gmj-aX.js"
import"./buffReportParser-6y7uV42I.js"
import"./buffObj-BIwiFUIW.js"
import"./guildGroups-B_9Al7U8.js"
import"./view-FAP_Iok3.js"
import"./intValue-C7nTQec1.js"
import"./csvSplit-C7tEPonC.js"
import"./isChecked-D_0do7nT.js"
let aa=0
function na(e){return e}function ra(e){if(function(e){return t.showBuffInfo&&e.some(na)}(e))return function(){if(aa)st(aa,!1)
else{aa=a({className:"fshActionBox",innerHTML:"<div></div><div></div><div></div><div></div><div></div>"})
const e=n("actionContainer")
ot(aa,e.children[2])}return aa}()
aa&&st(aa,!0)}function oa(e,t,a,n){t&&(e.className=t),r(a,e)
const s=lt()
return o(e,s),it(e,n),s}let sa=0,la=0
function ia(e,t){sa?st(sa,!1):function(e){sa=e.children[3],la=oa(sa,"fshBlue","CA "," active")}(e),r(t.level,la)}function ca(e,t){t?ia(e,t):sa&&st(sa,!0)}let ua=0,fa=0
function da(e,t){ua?st(ua,!1):function(e){ua=e.children[4],fa=oa(ua,"fshRed","Doubler "," active")}(e),r(t.level,fa)}function ma(e,t){t?da(e,t):ua&&st(ua,!0)}let pa=0,ha=0
function ga(e,t,a){pa?st(pa,!1):function(e){pa=e.children[2],ha=oa(pa,"","Damage bonus: ","%")}(e),r(function(e,t){if(e){const a=Math.min(.01*Math.round(Math.floor(t/5)*Number(e.level)),20)
return ct(a,2).toString()}return"0"}(t,Number(a)),ha)}function va(e,t,a){t?ga(e,t,a):pa&&st(pa,!0)}let ba=0,wa=0
function ka(e,t){ba?st(ba,!1):function(e){ba=e.children[1],wa=oa(ba,"","Kill Streak: ","")}(e),function(e,t){r(ft(e),t)}(t,wa)}function ya(e,t,a,n){t||a?ka(e,n):ba&&st(ba,!0)}function Ca(e,t){return t.name===e}function $a(e){const{buffs:t}=GameData.player()
if(t)return t.find(s(Ca,e))}const La=["red","orange","yellow"]
let Va=0,Da=0
async function Ma(){if(c("NewMap","recastClick"),$a("Summon Shield Imp"))return
!function(e){mt(e)&&GameData.fetch(f)}(await dt([u()],[55]))}const xa=["imp-0","imp-1","imp-1"]
function Aa(e,t){Va?st(Va,!1):function(e){[Va]=e.children,r("Shield Imps Remaining: ",Va),Da=lt(),o(Va,Da),l(Va,"&nbsp;")
const t=pt({className:"xSmallLink",textContent:"Recast"})
o(Va,t),i(t,Ma)}(e)
const a=function(e){return e?Number(e.stack):0}(t)
Va.className=function(e){return xa[e]??"fshGreen"}(a),r(a,Da)}function Sa(e,t,a){t||a?Aa(e,t):Va&&st(Va,!0)}function Na(e){return 0===e.type}let Ha=0,Ba=0,Ta=0,qa=0,Ea=0,Ga=0
...
return ht(e)&&e.some(Na)}(),Ga=GameData.player().killStreak}function ja(){!function(){const e=$("#actionlist-shield-imp")
1===e.length&&e.css("background-color",La[e.text()]||"#ad8043")}(),Pa()
const e=ra([Ha,Ba,Ta,qa,Ea])
e&&(Sa(e,qa,Ha),ya(e,Ha,Ea,Ga),va(e,Ha,Ga),ca(e,Ta),ma(e,Ba))}function Fa(e){return lt({textContent:e})}function Ra(){window.GameController&&GameController.Realm&&!GameController.Realm.footprintTileList&&(GameController.Realm.footprintTileList=[])}function _a(e,t,a){return bt({className:`fshCurveEle fshCurveLbl fshPoint tip-static ${e}`,dataset:{tipped:t},htmlFor:a})}function Oa(e){const t=a({className:"fshToggle"}),n=vt({checked:e.prefVal,id:e.checkId,type:"checkbox"})
o(t,n)
...
o(r,n),o(e,r)}function tn(e,t,a){const n=pt({className:`fshCurveEle fshCurveBtn fshPoint tip-static ${e}`,dataset:{tipped:t}})
...
const Rn=()=>qn,_n=()=>En,On=()=>Gn,In=()=>Pn,Wn=()=>jn,Kn=()=>Fn
function Yn(e,t){return kt(G(t,e))}function zn(){var e
qn=GameData.player().level,e=n("statbar-character-tooltip-stats"),Gn=Yn(e,P),En=Yn(e,j),jn=Yn(e,F),Pn=Yn(e,R),Fn=Yn(e,_)}const Un=e=>`<td>${e}:&nbsp;</td>`,Qn=e=>`<td width="40%">${e}</td>`
...
function n(e,a){return 1&a&&(t=null),null==t&&(t=!!ht(e[1])),t?yr:kr}gr(e)
let r=n(e,-1),o=r(e)
...
return Ct(a=e[0],n),{c(){t=te(),n.block.c()},m(e,a){ae(e,t,a),n.block.m(e,n.anchor=a),n.mount=()=>t.parentNode,n.anchor=t},p(t,[r]){e=t,n.ctx=e,1&r&&a!==(a=e[0])&&Ct(a,n)||$t(n,e,r)},i:ne,o:ne,d(e){e&&re(t),n.block.d(e),n.token=null,n=null}}}function Dr(e,t,a){let{promise:n}=t
...
b(e)&&(a=t+1,$.subscribe(U,s(Nr,a)),Nr(t+1))}function Tr(e,t,a){const n=e.slice()
return n[10]=t[a].msg,n[11]=t[a].type,n[12]=t[a].count,n}function qr(e){let t,a,n,r=e[12]+""
return{c(){t=oe("div"),a=se("x"),n=se(r),de(t,"class","count svelte-1leyf3b")},m(e,r){ae(e,t,r),ie(t,a),ie(t,n)},p(e,t){1&t&&r!==(r=e[12]+"")&&ce(n,r)},d(e){e&&re(t)}}}function Er(e,t){let a,n,r,o,s,l,i,c=t[10]+"",u=t[12]>1&&qr(t)
function f(){return t[3](t[10])}return{key:e,first:null,c(){a=oe("div"),n=se(c),r=fe(),u&&u.c(),o=fe(),de(a,"class",s="fsh-message "+t[11]+" svelte-1leyf3b"),this.first=a},m(e,t){ae(e,a,t),ie(a,n),ie(a,r),u&&u.m(a,null),ie(a,o),l||(i=be(a,"click",f),l=!0)},p(e,r){t=e,1&r&&c!==(c=t[10]+"")&&ce(n,c),t[12]>1?u?u.p(t,r):(u=qr(t),u.c(),u.m(a,o)):u&&(u.d(1),u=null),1&r&&s!==(s="fsh-message "+t[11]+" svelte-1leyf3b")&&de(a,"class",s)},d(e){e&&re(a),u&&u.d(),l=!1,i()}}}function Gr(e){let t,a=[],n=new Map,r=ue(e[1](e[0]))
const o=e=>e[10]
...
for(let t=0;t<a.length;t+=1)a[t].d(e)}}}function Pr(e,t,a){const n=document.body.appendChild(document.createElement("iframe"))
...
return[r,e=>Lt(e,"msg").map((({msg:t,type:a})=>({msg:t,type:a,count:e.filter((({msg:e})=>e===t)).length}))),i,e=>i(e)]}class jr extends J{constructor(e){super(),Z(this,e,Pr,Gr,ee,{})}}let Fr=0
...
Qr(await Tn(e.data.id,t))}function Zr(){t.showMonsterLog&&(GameData.actions().forEach(Jr),c("NewMap","MonsterLog"))}let eo=""
const to=()=>eo
function ao(){return Vt({subcmd:"scouttower"})}function no(e,[t,a,n]){const r=e.insertCell(-1)
...
const To=()=>Vo,qo=()=>Do,Eo=()=>Mo,Go=()=>xo,Po=()=>Ao,jo=()=>So,Fo=()=>No,Ro=()=>Ho,_o=()=>Bo
function Oo(){Vo=lt({innerHTML:"&nbsp;"}),Do=lt({innerHTML:"&nbsp;"}),Mo=lt(),xo=lt(),Ao=lt(),So=lt(),No=lt(),Ho=lt(),Bo=lt()}let Io=0
const Wo=()=>Io
function Ko(){for(;Io.rows.length>8;)Io.deleteRow(8)}function Yo(){const e=lt()
return o(e,Eo()),it(e,"/"),o(e,Go()),e}function zo(e){const t=lt()
return o(t,e),it(t,"%"),t}let Uo=0,Qo=0,Xo=""
const Jo=()=>Qo,Zo=()=>Xo
function es(){Qo=null,Uo&&!B("fshHide",Uo)&&(st(Uo,!0),ye("&nbsp;",Vo),ye("&nbsp;",Do),r("",Mo),r("",xo),r("",Ao),r("",So),r("",No),ye("",Ho),ye("",Bo),Ko())}function ts(e){return 0===e.type&&(Qo=e.base_creature_id,Xo=`(${e.x},${e.y})`,!0)}function as(){if(Uo)st(Uo,!1)
else{const e=n("actionContainer")
Uo=a({className:"fshActionBox titanInfo"}),Oo(),Io=Dt({className:"fshCenter"}),Lo(),so(Io,[[[[5,To,!0],[1,qo,!0]]],[[[2,yo,!0],[4,$o,!0]]],[[[2,Yo],[4,Po]]],[[[2,go,!0],[4,s(zo,jo())]],!0],[[[2,Co,!0],[4,s(zo,Fo())]],!0],[[[2,ko,!0],[4,Ro]],!0],[[[6,_o]]],[[[2,bo,!0],[2,vo,!0],[2,wo,!0]]]]),o(Uo,Wo()),o(e,Uo)}}function ns(e){return e<=0?'<span class="fshGreen cooldown">No active cooldown</span>':`<span class="fshMaroon cooldown">Cooldown until: ${function(e){const t=new Date(St()+1e3*e)
return`${Tt(t.getHours())}:${Tt(t.getMinutes())} ${Tt(t.getDate())}/${Ce[t.getMonth()]}/${t.getFullYear()}`}(e)}</span>`}function rs(e){return ut(At(e.max_hp-e.current_hp,e.kills),2)}function os(e){return ut(100*e.kills/e.max_hp,2)}function ss(e){!function(e){[[xt(e.creature.name),To],[Zo(),qo],[e.current_hp,Eo],[e.max_hp,Go],[e.kills,Po],[rs(e),jo],[os(e),Fo]].forEach((([e,t])=>r(e,t())))}(e),ye(function(e){return Mt(e.kills,e.max_hp,e.current_hp)}(e),Ro()),ye(ns(e.cooldown),_o())}function ls(e,t){return[[[2,()=>Fa(t.player.name)],[2,()=>Fa(t.kills.toString())],[2,()=>Fa(`${ut(100*t.kills/e.kills,2)}%`)]]]}function is(e){return e.realm&&e.creature.base_id===Jo()&&e.realm===to()}function cs(e){const t=e.find(is)
t&&(ss(t),function(e){if(Ko(),!e.contributors)return
const t=e.contributors.map(s(ls,e))
so(Wo(),t)}(t))}let us=null
const fs=e=>e?.s&&ht(e.r),ds=e=>t.showTitanInfo&&ht(e)&&e.some(ts)
...
return a=new Et({props:{$$slots:{default:[bs]},$$scope:{ctx:e}}}),a.$on("click",(function(...t){return e[3](e[5],e[7],...t)})),{c(){t=oe("li"),Ne(a.$$.fragment),n=fe()},m(e,o){ae(e,t,o),He(a,t,null),ie(t,n),r=!0},p(t,n){e=t
const r={}
...
return function(e,t){Ls.forEach(s(Vs,e,t))}(a,e),function(e,t){Ds.forEach(s(Ms,e,t))}(a,t),a.superEliteSlayerMultiplier=ct(.002*a.superEliteSlayerLevel,2),Ft(a.armorValue)&&function(e){e.attackValue=$s(e.attackBonus,e.levelValue),e.defenseValue=$s(e.defenseBonus,e.levelValue),e.armorValue=$s(e.armorBonus,e.levelValue),e.damageValue=$s(e.damageBonus,e.levelValue),e.hpValue=e.hpBonus}(a),a}const As=Ge(["statusStore","Done."])
let Ss=[]
...
return e?.r?.find(Rs)?.id}(),n=a&&await async function(e){const t=await _t(e)
return Kt(t?.r?.attributes)}(a),r=n&&await async function(e){const t=await Ot(),a=It(t)
return e?.map(((e,t)=>e-a[t]))}(n)
r&&t({attack:r[0],defense:r[1],armor:r[2],hp:r[3],damage:r[4]}),As.set(["groupStore","Done."])}const Os=Ee(Fs,((e,t)=>{_s(e,t)})),Is=(e,t,a)=>Math.ceil(e*je(t,0)*a),Ws=(e,t)=>Is(e,t,.0025),Ks=(e,t)=>Is(e,t,.001),Ys=Ks,zs=Ks,Us=Ks,Qs=Ks,Xs=Ks,Js=(e,t)=>Math.ceil(e*(1+.001*je(t,0))),Zs=(e,t)=>Math.ceil(e*(1-t*Fe)),el=Ge([]),tl=Ee(el,((e,t)=>{e&&t(Gt(e))})),al=Ee([tl,Os],(([e,t],a)=>{if(!e||!t)return
...
n({attack:r-o,defense:e.defWithConst+e.nmv,armor:a.armor+e.sanctuary,hp:e.hpWithFortitude,damage:e.dmgWithChiStrike-s})})),rl=Ee([Es,js],(([e,t],a)=>{if(!e||!t)return
...
const ol=Ee([tl,rl,js],(function([e,t,a],n){if(!e||!t||!a)return
...
const o=[({username:e})=>!n.includes(e),({last_login:e})=>e,({last_login:e})=>e<Nt(),({last_login:e})=>e>Ht(),({level:e})=>e<400||e>421,({level:e})=>e<441||e>450],s=e=>o.every((t=>t(e))),l=({username:e},{username:t})=>_e(e,t)
return Hs.subscribe((e=>{!async function(e){const t=await Yt(e)
ht(t)&&a(0,r=t.filter(s).sort(l))}(e)})),e.$$set=e=>{"members"in e&&a(1,n=e.members)},[r,n]}class bl extends J{constructor(e){super(),Z(this,e,vl,gl,ee,{members:1})}}function wl(e){let t,a,n
...
let p=!1
return Ie((()=>{a(1,p=!1),Hs.set(0),Ts.set([]),Fs.set(0),el.set([])})),e.$$set=e=>{"relicData"in e&&a(0,d=e.relicData)},[d,p,n,r,o,s,l,i,u,f,m,function(e){c("relic",e.detail)},function(){c("relic","fetchStats"),a(1,p=!0),Hs.set(d.controlled_by.guild_id),Ts.set(m),Fs.set(GameData.player().hasGroup),el.set(GameData.player().buffs)}]}class Vl extends J{constructor(e){super(),Z(this,e,Ll,$l,ee,{relicData:0})}}let Dl=0
...
function Tl(e){$("#statbar-gold").css("background-color",e)}function ql(){$("#HelperSendTotal").html(ft(b("currentGoldSentTotal"))),Number(GameData.player().gold)>Bl?Tl("red"):Tl("inherit")}function El(){Bl=b("goldAmount"),$("#statbar-gold-tooltip-general").append(`<dt class="stat-gold-sendTo">Send To:</dt><dd id="HelperSendTo">${b("goldRecipient")}</dd><dt class="stat-gold-sendAmt">Amount:</dt><dd id="HelperSendAmt">${ft(Bl)}</dd><dt class="stat-gold-sendTo">Send?</dt><dd><input id="HelperSendGold" value="Send!" class="custombutton" type="submit"><input type="hidden" id="xc" value=""</dd><dt class="stat-gold-sendTotal">Total Sent:</dt><dd id="HelperSendTotal">${ft(b("currentGoldSentTotal"))}</dd>`),$("#HelperSendGold").on("click",Je),ql(),$.subscribe(Ze,ql)}let Gl=0,Pl=0,jl=0,Fl=0,Rl=0,_l=0
async function Ol(){const e=await Sn({a:14,d:0,id:Gl.id,item_id:Gl.itemId}),t=e.response.response,a=e.response.msg
let n=a
if(0!==t){const e=a.indexOf("<");-1!==e&&(n=a.substring(0,e))}else n=`You purchased ${e.response.data.name} for ${ft(e.response.data.cost)} gold.`
l(_l,`${n}<br>`)}async function Il(){const e=Ut(Rl.value)
e&&(c("NewMap","quickBuy"),await jt(zt(e,Ol)),GameData.doAction(14,3,{id:Gl.id,item_id:Gl.itemId},0),jl.close())}function Wl(){Fl?r("",_l):function(){Fl=a({className:"fshClear",textContent:"Select how many to quick-buy:"}),Rl=vt({id:"buyAmount",className:"fshNumberInput",min:1,max:99,value:1,type:"number"}),o(Fl,Rl)
const e=pt({textContent:"Quick-buy"})
i(e,Il),o(Fl,e),_l=a(),o(Fl,_l),o(Pl,Fl)}()}function Kl(e,t){Gl=t,Pl=Pl||n("shopDialogConfirm"),Pl&&(jl=jl||$(Pl).data("hcsWorldDialogShopConfirm"),jl&&Wl())}function Yl(e){let t,a
...
let Gi=0,Pi=0,ji=0
function Fi(){return cr(Pi)?"Remove from do not kill list":"Add to the do not kill list"}function Ri(){r(Fi(),ji)}function _i(){c("NewMap","doNotKillLink")
const e=t.doNotKillList.indexOf(Pi);-1===e?t.doNotKillList.push(Pi):t.doNotKillList.splice(e,1),Ri(),V("doNotKillList",t.doNotKillList.join()),fr()}function Oi(){ji?Ri():function(){ji=pt({className:"fshBl",textContent:Fi()})
const e=a({className:"description",innerHTML:'<span class="ui-helper-hidden-accessible"><input type="text"></span>'})
o(e,ji),o(Gi,e),i(ji,_i)}()}function Ii(e,t){!function(e){if(!Gi){const t=G("body",e)
1===t.length&&([Gi]=t)}}(t),Gi&&(Pi=I(e),Oi())}let Wi=0,Ki=0,Yi=0,zi=0
...
t=e,[Ci,ci,vi,yi,si,ti,pi].forEach((e=>e(t)))}(r),r.evaluatorHTML=function(e){return`<table width="100%"><tbody>${Ai(e)}${Si(e)}${Ni(e)}${Hi(e)}${Bi(e)}${Ti(e)}${qi(e)}${Ei(e)}</tbody></table>`}(r),n.groupExists?Xi(r.evaluatorHTML):Qi(r.evaluatorHTML)}function ec(e){return e.members[0].name===u()}async function tc(e,t,a){if(a){!function(e,t,a){if(!a.r?.attributes)return
const n=a.r.attributes
Zi(e,t,{groupExists:!0,groupAttackValue:n[0].value,groupDefenseValue:n[1].value,groupArmorValue:n[2].value,groupDamageValue:n[3].value,groupHPValue:n[4].value})}(e,t,await _t(a))}}async function ac(e,t){const a=function(e){if(ht(e.r))return e.r.find(ec)?.id}(await Wt())
...
1===t.length&&nt(t[0])}function sc(){if(!rc)return
...
return t?.actions?.length?(t.actions=t.actions.filter(s(Dc,function(e){return e.realm?.minlevel||GameData.realm().minlevel}(t))),rt(t)):e}function xc(e,a){t.hideSubLvlCreature&&function(e){return e.data?.d&&ta(e.data.d,Ue)}(a)&&(e.dataFilter=Mc)}function Ac(e){t[e[0]]=Xt(e[1])}function Sc(e){t[e]=Xt(e)}function Nc(){[["buffs","huntingBuffs"],["buffs2","huntingBuffs2"],["buffs3","huntingBuffs3"]].forEach(Ac),["doNotKillList"].forEach(Sc)}function Hc(e){t[e[0]]=b(e[1])}function Bc(e){t[e]=b(e)}function Tc(){[["buffsName","huntingBuffsName"],["buffs2Name","huntingBuffs2Name"],["buffs3Name","huntingBuffs3Name"],["showHuntingBuffs","showHuntingBuffs"]].forEach(Hc),["enabledHuntingMode","hideSubLvlCreature","showTitanInfo","showBuffInfo","showMonsterLog","showCreatureInfo"].forEach(Bc)}const qc=[function(){kc(),Nc(),Tc()
const e=bc()
$.ajaxPrefilter("JSON",xc),t.hideSubLvlCreature&&GameData.fetch(Ue),function(e){mc()
const a=s(Vc,e)
$.subscribe(d,a),t.showHuntingBuffs&&window.initialGameData&&a(null,{b:window.initialGameData.player.buffs})}(e),rc=b("hidePlayerActions"),$.subscribe(U,sc),sc()},function(){Qe(),Xe()&&El()},function(){$.subscribe(at,nc)},function(){Hr.forEach(Br)},function(){b("enableCreatureColoring")&&o(document.body,yt("#actionList .creature-1 {color: green;}\n#actionList .creature-2 {color: yellow;}\n#actionList .creature-3 {color: red;}"))},function(){$.subscribe(U,fr),fr(),function(){const e=GameData.doAction
...
//# sourceMappingURL=newMap-CdRpC-ig.js.map
