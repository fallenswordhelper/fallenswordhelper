import{l as t,b8 as n,ad as e,q as s,h as i,cg as a,$ as r,S as o,P as c,Q as u,U as l,bJ as m,V as p,bD as f,bE as d,dv as v,Z as b,bF as g,bG as h,bp as x,a8 as $,_ as w,a0 as C,bK as k,a1 as I,dM as y,a3 as F,a4 as q,bL as D,a9 as E,a5 as _,dN as j,dO as N,a6 as S,s as A,p as M,A as Q,i as R,r as L,t as O,b6 as P,b5 as T,cD as B}from"./calfSystem-DiXGAkgN.js"
import{i as G}from"./inventing-CfX_Q21D.js"
import{L as U}from"./LinkButton-BZVcIUNH.js"
import{i as z}from"./interceptSubmit-CMErm11z.js"
import{x as J}from"./xPath-eAWw8eHa.js"
import"./formToUrl-pXxOs-cV.js"
function K(t){const[n,i]=e(s("tr:nth-child(2) td",t)).split("/").map((t=>parseInt(t,10)))
return{have:n,need:i}}function V(){return t(`#pCC td[background^="${n}ui/inventory/"]`).map((t=>t.parentElement.parentElement)).map(K).reduce(((t,n)=>Math.min(t,Math.floor(n.have/n.need))),1/0)}function W(t){return G({subcmd:"doinvent",recipe_id:t})}async function Z(t){const n=await i({cmd:"inventing",subcmd:"doinvent",recipe_id:t})
return n?function(t){const n=a(t)
...
const e={}
2048&n&&(e.$$scope={dirty:n,ctx:t}),r.$set(e),t[4]?et?(et.p(t,n),16&n&&d(et,1)):(et=X(t),et.c(),d(et,1),et.m(j,N)):et&&(g(),f(et,1,1,(()=>{et=null})),h()),(!Z||8&n)&&x(A,"width",t[3]+"%"),(!Z||6&n)&&nt!==(nt=t[1]+t[2]+"")&&$(R,nt),(!Z||1&n)&&$(O,t[0]),(!Z||2&n)&&$(z,t[1]),(!Z||4&n)&&$(W,t[2])},i(t){Z||(d(r.$$.fragment,t),d(et),Z=!0)},o(t){f(r.$$.fragment,t),f(et),Z=!1},d(t){t&&l(n),m(r),et&&et.d(),Y=!1,p(tt)}}}function tt(t,n,e){let{max:s}=n,{recipeID:i}=n,a=1,o=0,c=0,u=0,l=""
return t.$$set=t=>{"max"in t&&e(7,s=t.max),"recipeID"in t&&e(8,i=t.recipeID)},[a,o,c,u,l,function(){e(0,a=s),A("inventing","maxInventButton")},async function(){if(A("inventing","quickInvent"),!a)return
e(1,o=0),e(2,c=0),e(3,u=0),e(4,l=""),Array(a).fill(i).reduce((async(t,n)=>{const s=await t
if(!s||!0===s.s){const t=await function(t){return r(W,Z,t)}(n)
return t?.s?t.r.success_count>0?e(1,o+=1):e(2,c+=1):e(4,l=t?.e?.message??"Server Error"),e(3,u=(o+c)/a*100),t}return s}),Promise.resolve())},s,i,function(){a=v(this.value),e(0,a)}]}class nt extends o{constructor(t){super(),c(this,t,tt,Y,u,{max:7,recipeID:8})}}function et(){const t=s('input[name="recipe_id"]')
if(!t)return
...
//# sourceMappingURL=viewRecipe-DDhUhoMy.js.map
