import{aA as e,g as t,ay as s,o,b as i,v as a,i as n,a3 as r,p as l,aE as u,d as c,av as f}from"./calfSystem-HVCiy-VV.js"
import{c as m}from"./createInput-343o8t4v.js"
import{t as p}from"./testQuant-Cxk9MtgP.js"
import{b,r as d}from"./render-I13kZ8ab.js"
import"./roundToString-BFNdgMs_.js"
import"./keys-CFr_h3Bx.js"
let h=0,g=0,y=0,v=0
const w=[[/</g,"&lt"],[/>/g,"&gt"],[/\n/g,"<br>"],[/\[(?<type>\/?[biu])\]/g,"<$1>"],[/\\\\/g,"&#92"],[/\\/g,""]],B=[[/\[(?<type>\/?block)\]/g,"<$1quote>"],[/\[list\]/g,'<ul class="list">'],[/\[\/list\]/g,"</ul>"],[/\[\*\](?<line>[^[]*)/g,"<li>$1</li>"]]
function k(e,t){return e.replace(t[0],t[1])}function N(e,t){return t.reduce(k,e)}function T(){const e=p(v.value)
e&&(h=e,f("bioEditLines",e),g.rows=h)}function S(){const e=function(e){let t=N(e,w)
...
//# sourceMappingURL=bioWidgets-CzZKncWI.js.map
