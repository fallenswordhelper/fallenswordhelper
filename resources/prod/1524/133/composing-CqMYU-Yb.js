import{k as t,p as e,b as n,q as s,a9 as o,v as a,c1 as i,aU as c,d as r,K as l,ae as m,c2 as p,aP as u,m as d,z as f,c as g,s as h,aj as b,c3 as v,i as C,o as S,ag as E,c4 as N,a8 as k,c5 as x,ap as j,e as y,bN as $,$ as L,c6 as q,ai as A,g as w,aW as B,y as I}from"./calfSystem-DKih1pr1.js"
import{d as P,c as T}from"./daComposing-CDxuUjkC.js"
import{s as F}from"./sum-DdZz7_s4.js"
import{a as Q}from"./addCommas-C_h2HN8s.js"
import{c as _}from"./createInput-VVeCYc9A.js"
import{c as G}from"./createTable-C0f_WFVv.js"
import{i as H}from"./insertElementAfter-Mm8QeLSX.js"
import{p as M,s as R}from"./pubsub-CQSQayg_.js"
import{r as U,g as z}from"./rnd-D_QmA-Fa.js"
import{r as K}from"./regExpGroups-BwTAtkeC.js"
import{i as O}from"./insertHtmlAfterBegin-DHhuR2v9.js"
import{i as V}from"./insertHtmlAfterEnd-Djz_O0E4.js"
let W=[]
const X=t=>t.map((({buffs:t,duration:e,id:n})=>({cost:Math.max(t.map((({level:t})=>t)).reduce(F,0)*e,5e3),id:n}))),D=[[(t,e)=>!t&&!e,()=>0],[(t,e)=>!t&&e,(t,e,n)=>n.remove()],[(t,e)=>t&&e,(t,e,n)=>o(`Cost: ${Q(e)}`,n)],[(t,e)=>t&&!e,(t,e)=>a(t.parentNode,`<div class="fshBlue template-cost">Cost: ${Q(e)}</div>`)]]
function J(t){const e=W.find((({id:e})=>e===Number(t.value)))?.cost,n=s(".template-cost",t.parentNode),o=D.find((([t])=>t(e,n)))
o&&o[1](t,e,n)}function Y(t){/^composing-template-\d$/.test(t.target.id)&&J(t.target)}function Z(){const s=t("select[id^=composing-template-]:not(#composing-template-multi)",e())
s.length&&async function(t){const s=await P()
s?.s&&(W=X(s.r.templates),t.forEach(J),n(e(),"change",Y))}(s)}function tt(t,e){r("",t.children[0]),t.children[0].classList.add("fshPot"),t.children[0].style.backgroundImage=`url(${u}composing/${z(1,11)}_${z(1,51)}.png)`,r(`Creating '<span class="fshBold">${e}</span>' Potion`,t.children[2]),r("",t.children[3])}function et(t){const e=t.parentNode
...
n>0?mt(t,e,n):a(t,"No open slots!")}function ut(t){const{h:e,m:n,s:s}=K(x,k(t))
return e&&n&&s?1e3*(3600*e+60*n+Number(s))+j():0}function dt(t){m(p,t)}function ft(t){return T({subcmd:"collect",potion_id:t})}async function gt(t){const e=await y({cmd:"composing",subcmd:"collect",potion_id:t})
if(!e)return{s:!1}
const n=$(e)
return n.includes("collected")?{s:!0}:{s:!1,e:{message:n}}}function ht(t){const e=t.getAttribute("onclick").split("&")[2].split("=")[1]
O(t.parentNode,`[ <span class="fsh-quick-collect"><button class="fshBl fsh-bli" type="button" value="${e}">Quick Collect</button></span> ]&nbsp;`)}const bt=t=>"BUTTON"===t.tagName&&"Quick Collect"===k(t)
...
!function(t,e){t.classList.remove("fshSpinner"),e.s?vt(t,"fshGreen","Collected"):vt(t,"fshRed","Error")}(e,o)}function St(t){bt(t.target)&&Ct(t.target)}function Et(t){V(t,'<span class="quickCreate">[<span class="sendLink">Quick Create</span>]</span>')}const Nt=t=>"SPAN"===t.tagName&&"quickCreate"===t.className
...
const n=B("composing-level",e())[0].parentNode
I(t,n)}(),function(){const t=s("#pCC div.centered")
...
//# sourceMappingURL=composing-CqMYU-Yb.js.map
