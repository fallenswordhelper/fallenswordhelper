import{g as t}from"./guildManage-C2l0iaAj.js"
import{o as e}from"./onlinePlayersPage-CorDGCyw.js"
import{b2 as n,br as s,bT as a,ag as r,bu as o,ai as i,g as c,d as l,H as f,a8 as u,x as d,c3 as p,r as b,c as h,aB as m,cc as g,q as y,cH as v,p as x,o as w,s as k,b1 as L,ae as C,b0 as P,w as T,k as B,d2 as E,dn as S,aC as j,b7 as I,aT as A}from"./calfSystem-CUgWHLtG.js"
import{c as N}from"./csvSplit-j_Yd0L1s.js"
import{l as D}from"./lastActivity-CkJNYBKg.js"
import{b as R}from"./buffObj-BIwiFUIW.js"
import{h as F}from"./simpleCheckbox-BsLxfTBb.js"
import{o as M}from"./onlineDot-Clfoju52.js"
...
function ut(t,e){l(t,c(e))}async function dt(t){!function(t,e){st(e,{href:t,findBuffNicks:at})}(t,await A(t))}function pt(){ut(ot.length,"potentialBuffers"),ot.length<=0?U("Done.","blue"):(U("Parsing player data ...","green"),ot.forEach(dt))}function bt(t,e){j()!==L(e)&&ot.push(t)}function ht(t,e){if(n=function(t){return parseInt($(t).find("td:eq(2)").text().replace(/,/g,""),10)}(e),n>=rt&&n>=z()){bt($(e).find("td:eq(1) a").attr("href"),$(e).find("td:eq(1) a").text())}var n}async function mt(t,n,s){const a=function(t,e){return 1===t?Math.round(it*e/50):t+1}(t,n)
...
c("guildMembers").checked&&B('#pCC a[data-tipped*="<td>VL:</td>"]',e).forEach($t),lt=[],lt.push(S),N(ct).forEach(vt),ft=0,c("alliesEnemies").checked?lt.forEach(xt):yt()}function kt(t,e){return 0!==e}function Lt(t){t.deleteRow(-1)}function Ct(){k("find buffs","clear results"),function(){const t=c("buffTable")
P(t.rows).filter(kt).forEach(h(Lt,t))}(),ut("","buffNicks"),U("Idle.","black"),ut("","potentialBuffers"),ut("0","buffersProcessed")}function Pt(e){T()||(ut(at,"buffNicks"),U(`Gathering list of ${e} ...`,"green"),X=c("level175").checked,ut("0","buffersProcessed"),ot=[],ct=c("extraProfile").value,C("extraProfile",ct),async function(){wt(await t())}())}function Tt(t,e){return t===e.id}function Bt(){k("find buffs","findBuffsStart")
...
C("textToSearchFor",t),at=t,rt=1,Pt("profiles to search")}function St(){ct=i("extraProfile")}function jt(t){w(c("findbuffsbutton"),t,!0)}function It(){w(c("clearresultsbutton"),Ct,!0)}function At(t){const e=t||x()
r.sortBy="name",r.sortAsc=!0,R.sort(O),St(),l(K(V,ct),e),Q(),jt(Bt),It()}function Nt(t){const e=t||x()
St(),l(K(_,ct),e),Q(),jt(Et),It()}export{At as injectFindBuffs,Nt as injectFindOther}
//# sourceMappingURL=findBuffs-CpGE0s3H.js.map
