import{ag as t,s as n,c as s,b1 as e,ai as o,aB as f,p as a,a8 as u,aC as c,cc as r,at as i,D as l,d as p,g as b,C as d}from"./calfSystem-CUgWHLtG.js"
...
function N(t){return`<tr><td>${t[0]}</td><td>: ${t[1][0]}${t[1][1]}</td></tr>`}function A(t,n){return t[n[1][1]]+=n[1][0],t}function D(){const t=d(L.buffs),n=(e=t.reduce(A,{k:0,fsp:0,stam:0,unknown:0}),h.map(s($,e)).join(""))
var e
...
let s="unknown",e="1"
n&&(s=function(t){return t[0].includes("k")?"k":t[0].includes("f")?"fsp":"stam"}(n),[e]=r(/[+-]?[.\d]+/,n[0])),L.buffs[u(t)]=[parseFloat(e),s],L.count+=1}(t):(L.count-=1,delete L.buffs[s]),L.count>0?D():(p("&nbsp;",b("buffCost")),L.buffCostTotalText="")}function M(t){return t.tagName&&"SPAN"!==t.tagName?M(t.parentNode):t}function R(t){if("fshSendBuffMsg"===t.target.id)return void function(t){t.count>0&&T(t)}(L)
...
//# sourceMappingURL=render-Bn6kwHlA.js.map
