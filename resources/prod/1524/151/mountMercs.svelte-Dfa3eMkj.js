import{aq as i,z as e,A as s,al as t,am as v,e5 as a,C as d,D as l,F as n,H as c,K as r,Q as o,R as u,N as b,E as m,aN as g,T as h,bk as f,aG as y,G as p,O as x,s as $,J as D,cp as _,bC as w,u as A}from"./calfSystem-C1X5YxJZ.js"
import{m as k,v as H}from"./view-D8cTUmu8.js"
...
let q=s(d,"visible",15,!0),F=t(1),z=t(0),B=t(0),J=t("?"),K=t("?"),Q=t(v([]))
function U(){D(z,0),D(B,1),D(F,0)}function V(i){let e=Math.floor((i-_())/60)
const s=Math.floor(e/60)
return e%=60,{hours:s,mins:e}}const Y=i=>({...i,...V(i.expires)})
function I(i){D(z,Y(i.r),!0),D(F,0)}async function W(i){var e
$("mercs","doDisband"),D(F,1),await(e=i,k({subcmd2:"disband",merc_id:e})),D(Q,r(Q).filter((({id:e})=>e!==i)),!0),D(F,0)}!async function(){const i=await H()
D(Q,i.r.mercs?.map(Y)||[],!0),D(J,i.r.mercs_available.toString(),!0),D(K,i.r.gold.toString(),!0),i.r.offer?I({r:i.r.offer}):D(F,0)}()
{const e=i=>{var e=w("Merc Hunter")
b(i,e)}
a(i,{close:function(){$("mercs","close"),q(!1)},get visible(){return q()},title:e,children:(i,e)=>{var s=R(),t=n(s),v=l(n(t)),a=n(v),d=l(t,2),x=n(d),$=i=>{var e=S()
e.__click=[C,F,B,U,I]
var s=n(e)
o((()=>{e.disabled=r(F),u(s,`Send Expedition (${r(K)??""}g)`)})),b(i,e)},D=i=>{var e=E(),s=m(e)
s.__click=[T,F,Q,Y,z,J]
var t=l(s,2)
t.__click=[M,F,z],o((()=>{s.disabled=r(F),t.disabled=r(F)})),b(i,e)}
c(x,(i=>{r(z)?i(D,!1):i($)}))
var _=l(d,2),w=n(_),k=n(w),H=i=>{var e=G(),s=m(e),t=n(s),v=n(t),a=n(v),d=l(t,2),c=n(d),y=l(d,2),p=l(n(y),2),x=n(p),$=n(x),D=l(x,2),_=l(p,4),w=n(_),k=n(w),H=l(_,4),M=n(H),T=n(M),C=l(M,2),S=n(C),E=l(s,2),O=l(n(E),2),L=n(O),N=l(O,4),P=n(N),R=l(N,4),q=n(R),F=l(R,4),B=n(F),J=l(F,4),K=n(J),Q=l(J,4),U=n(Q),V=l(Q,4),Y=n(V),I=l(V,4),W=n(I)
o((i=>{u(a,r(z).name),h(c,"src",`${f??""}mercs/${r(z).id??""}.png`),u($,i),h(D,"src",`${f??""}currency/0.png`),u(k,r(z).hire_time/3600),u(T,r(z).hours),u(S,r(z).mins),u(L,r(z).level),u(P,j[r(z).class]),u(q,A[r(z).type]),u(B,r(z).attributes[0].value),u(K,r(z).attributes[1].value),u(U,r(z).attributes[2].value),u(Y,r(z).attributes[3].value),u(W,r(z).attributes[4].value)}),[()=>g(r(z).gold)]),b(i,e)}
c(k,(i=>{r(z)&&i(H)}))
...
//# sourceMappingURL=mountMercs.svelte-Dfa3eMkj.js.map
