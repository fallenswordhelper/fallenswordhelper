import{cu as n,k as t,ab as a,c as e,bJ as s,l as r,s as o,cv as c,aO as i,r as l,cw as f,cx as u,ae as d,a4 as p,a1 as m,bI as h}from"./calfSystem-C1X5YxJZ.js"
import{a as v}from"./arena-CgHFL0T_.js"
import{i as b}from"./interceptSubmit-D-IYqL1u.js"
import{l as g}from"./loadDataTables-vs2_7T4b.js"
import{f as y,a as x,m as L,t as M}from"./assets-DPlwo2nm.js"
import{l as T,p as _}from"./lvlTests-DSEjTSpw.js"
import{c as k}from"./changeMinMax-Dbzryaut.js"
import{s as w}from"./setTipped-_gKWzwad.js"
function j(){return v({subcmd:"view"})}function q(n,t,[a,e]){const s=n.find((([,n])=>n===a))
return s&&(r(s[0]).style.backgroundColor="#ff0000",t[a]=e),t}let F=0,E=0
const C=()=>F,D=()=>E
function N(){s(y,F)}function S(n,t){F=F||{},F.minLvl=n,F.maxLvl=t,N()}function J(){$('#arenaTypeTabs table[width="635"]').DataTable().draw()}function H(){o("arena","changeLvls"),k(S,J)}function O(){o("arena","resetLvls"),S(c.arenaMinLvl,c.arenaMaxLvl),$("#fshMinLvl").val(F.minLvl),$("#fshMaxLvl").val(F.maxLvl),J()}function R(n){o("arena","hideMoves"),F=F||{},F.hideMoves=n.target.checked,N(),$(".moveMax").toggle(!n.target.checked)}function z(n,t){return!C()||function(n){const t=C().minLvl,a=C().maxLvl,e=i(n[7])
return T(_,e,t,a)}(t)}function A(n,t,a,e){return!0}function B(n,t,a,e){$(`#${n}`,t).val(C()?.[a]??c[e])}function G(){const n=function(){const n=$("#pCC > table > tbody > tr:nth-child(4)")
return n.clone().insertBefore(n).find("td").attr("height","2"),n.clone().insertAfter(n).find("td").attr("height","1"),n}(),t=$(x)
!function(n){const t=$("#fshHideMoves",n)
null!=C()?.hideMoves&&(t.prop("checked",C().hideMoves),$(".moveMax").toggle(!C().hideMoves)),t.on("click",R)}(t),function(n){B("fshMinLvl",n,"minLvl","arenaMinLvl")}(t),function(n){B("fshMaxLvl",n,"maxLvl","arenaMaxLvl")}(t),function(n){$("#fshMinLvl, #fshMaxLvl",n).on("keyup",H),$("#fshReset",n).on("click",O)}(t),$("td",n).append(t)}function I(t,a){const e=l(/#\s(?<id>\d+)/,a.eq(0).text())
...
var a}
function Z(n,[t,,a]){a&&Y(n,a)&&X(t)}function nn(n,t,a){w(a.players.map(e(W,n)).join("<br>"),t),t.classList.add("tip-static"),n&&"Join"===t.value&&function(n,t,a){a.players.filter((t=>t.guild_id===n)).length===a.max_players/4&&X(t)}(n,t,a)}const tn=[n,n=>d(n.players),n=>n.players.length>0]
...
$("a",a).contents().unwrap(),$(t).prepend($("<thead/>").append(a))}function cn(){G(),N(),$.fn.dataTable.ext.search.push(z),$.fn.dataTable.ext.search.push(A)}function ln(r,[o,c,i]){const l=$('table[width="635"]',r)
...
1===n.length?async function(n){fn(n,await m([h(y),h("fsh_arenaFull"),j().catch((()=>({}))),g()]))}(n):o("arena","Join error screen ?")}var dn=Object.freeze({__proto__:null,default:un})
export{un as a,dn as b,j as v}
//# sourceMappingURL=arena-YCNDPxtE.js.map
