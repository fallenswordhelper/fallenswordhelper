import{aZ as t,c as e,o as s,aA as a,co as o,aT as n,b0 as c,d as r,cn as i,b6 as l,p as u,cy as f,av as m}from"./calfSystem-CQOGdqPv.js"
import{i as d}from"./interceptSubmit-B-ce898B.js"
import{r as p}from"./replaceDoubleSpace-Bwn6uaSy.js"
import{q as g,g as Q}from"./questEvent-BenFXAue.js"
...
t(n,5,0).forEach(e(h,c)),s(n,g("Quest Book"))}let S=0,b=0,A=0,N=0,j=0,v=0
...
v<3?(y(b,e[v]),C(t,0)):(y(S,e[v]),C(t,3))}function T(){a("storeLastQuestPage")&&(!function(){const t=l("a",u());[S,b,A,N,j]=t,v=q.reduce(e(w,t),0)}(),function(){const t=window.location.search
m("lastActiveQuestPage",t),m(E[v],t)}(),F())}function _(){d(),T()
const t=l(f,u())[5]
t&&P(t)}export{_ as default}
//# sourceMappingURL=injectQuestBookFull-BT4V3Lqk.js.map
