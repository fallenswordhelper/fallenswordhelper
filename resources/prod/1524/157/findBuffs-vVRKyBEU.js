import{bA as t,b_ as e,cw as n,ay as s,c1 as a,aA as r,g as o,d as i,ag as c,l,b6 as f,c_ as u,q as d,a4 as p,cI as b,r as h,c as m,aO as y,dd as g,p as v,o as x,s as w,bx as k,by as L,av as P,a3 as C,d$ as I,h as B,de as E,dI as S,e0 as T,aW as A,b8 as N,bE as j,bn as D}from"./calfSystem-CQOGdqPv.js"
import{o as R}from"./onlinePlayersPage-D4HreKCI.js"
import{b as F}from"./buffObj-BIwiFUIW.js"
import{h as M}from"./simpleCheckbox-BcIXGyya.js"
import{o as O}from"./onlineDot-DGI5IYJJ.js"
...
i(n+1,t),e===n+1&&W("Done.","blue")}()}let at=0,rt=0,ot=0,it=0,ct=0,lt=0,ft=0
function ut(t,e){i(t,o(e))}async function dt(t){!function(t,e){st(e,{href:t,findBuffNicks:at})}(t,await D(t))}function pt(){ut(ot.length,"potentialBuffers"),ot.length<=0?W("Done.","blue"):(W("Parsing player data ...","green"),ot.forEach(dt))}function bt(t,e){N()!==L(e)&&ot.push(t)}function ht(t,e){if(n=function(t){return parseInt($(t).find("td:eq(2)").text().replace(/,/g,""),10)}(e),n>=rt&&n>=Y()){bt($(e).find("td:eq(1) a").attr("href"),$(e).find("td:eq(1) a").text())}var n}async function mt(t,e,n){const s=function(t,e){return 1===t?Math.round(it*e/50):t+1}(t,e)
...
n<s?mt(n,s,yt):pt()}async function gt(){if(it=parseInt(o("onlinePlayers").value,10),0!==it){yt(await R(1))}else pt()}function $t(t){const{tipped:e}=t.dataset,{mins:n}=E(e);(function(t,e,n){return t<5&&e>=rt&&e>=n})(n,Number(h(S,e)),Y())&&bt(t.href,l(t))}function vt(t){lt.push(j+t)}async function xt(t){!function(t){const e=c(t)
B('#profileLeftColumn a[data-tipped*="Last Activity"]',e).forEach($t),ft+=1,ft===lt.length&&gt()}(await D(t))}function wt(t){const e=c(t)
o("guildMembers").checked&&B('#pCC a[data-tipped*="<td>VL:</td>"]',e).forEach($t),lt=[],lt.push(T),A(ct).forEach(vt),ft=0,o("alliesEnemies").checked?lt.forEach(xt):gt()}function kt(t,e){return 0!==e}function Lt(t){t.deleteRow(-1)}function Pt(){w("find buffs","clear results"),function(){const t=o("buffTable")
k(t.rows).filter(kt).forEach(m(Lt,t))}(),ut("","buffNicks"),W("Idle.","black"),ut("","potentialBuffers"),ut("0","buffersProcessed")}function Ct(t){C()||(ut(at,"buffNicks"),W(`Gathering list of ${t} ...`,"green"),X=o("level175").checked,ut("0","buffersProcessed"),ot=[],ct=o("extraProfile").value,P("extraProfile",ct),async function(){wt(await I())}())}function It(t,e){return t===e.id}function Bt(){w("find buffs","findBuffsStart")
const t=parseInt($("#selectedBuff").val(),10),e=F.find(m(It,t))
at=e.nicks,rt=e.lvl,Ct("potential buffers")}function Et(){w("find buffs","findOtherStart")
const t=$("#textToSearchFor").val().split(",").map(L).join(",")
P("textToSearchFor",t),at=t,rt=1,Ct("profiles to search")}function St(){ct=r("extraProfile")}function Tt(t){x(o("findbuffsbutton"),t,!0)}function At(){x(o("clearresultsbutton"),Pt,!0)}function Nt(t){const e=t||v()
s.sortBy="name",s.sortAsc=!0,F.sort(q),St(),i(J(H,ct),e),U(),Tt(Bt),At()}function jt(t){const e=t||v()
St(),i(J(V,ct),e),U(),Tt(Et),At()}export{Nt as injectFindBuffs,jt as injectFindOther}
//# sourceMappingURL=findBuffs-vVRKyBEU.js.map
