import{c as t}from"./closestTable-MoRx7kRV.js"
import{g as s}from"./getId-CEBzpjjo.js"
import{a as n,$ as e,h as a,cg as c,S as r,P as i,Q as o,R as l,T as u,U as p,W as m,X as d,_ as f,a3 as h,a5 as b,au as y,bs as g,a8 as v,dv as z,Z as k,av as x,a0 as q,a1 as S,a4 as j,a9 as w,bp as C,b8 as E,s as G,aj as $,dw as P,p as _,y as B,l as T,q as Y,aC as A,aH as H}from"./calfSystem-BAeDn21M.js"
import{a as I}from"./addCommas-C_h2HN8s.js"
function M(t,s){return n({cmd:"potionbazaar",subcmd:"buyitem",item_id:t,quantity:s})}async function N(t,s){const n=await a({cmd:"potionbazaar",subcmd:"buyitem",item_id:t,quantity:s})
if(!n)return{s:!1}
const e=c(n)
return"You purchased the item!"===e?{r:Array(s),s:!0}:{e:{message:e},s:!1}}function Q(t,s,n){const e=t.slice()
...
for(let t=0;t<n.length;t+=1)n[t].d()}}}function D(t,s,n){let{potions:a=[]}=s
return t.$$set=t=>{"potions"in t&&n(0,a=t.potions)},[a,async function(t){var s,n
G("bazaar","buyButton"),t.promise=(s=t.id,n=t.count,e(M,N,s,n))
const a=await t.promise
a.s?$(`You successfully purchased ${t.count} "${a.r[0].n}"`):$(a.e.message)},function(t,s){t[s].count=z(this.value),n(0,a)}]}class F extends r{constructor(t){super(),i(this,t,D,Z,o,{potions:0})}}const J=s=>({p:s,ccy:Y('img[src*="/currency/"]',t(s).nextElementSibling)})
...
//# sourceMappingURL=bazaar-C6xgH8nl.js.map
