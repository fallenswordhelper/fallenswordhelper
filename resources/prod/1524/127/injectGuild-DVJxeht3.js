import{g as t,c as n}from"./colouredDots-CwDFqM9T.js"
import{x as e,p as s,bZ as o,r as a,cU as i,az as r,bP as c,ai as l,i as u,m as f,b as d,s as p,ae as m,q as g,v as h,d as b,aa as C,bQ as N,k as j,cV as L,K as k,br as w,o as y,G as M,H as S,c as H,c2 as T,a$ as $,bH as x,g as v,D as B,l as P,cW as R,cX as G,aT as I,w as E,cY as X,aC as A,a8 as V,ag as D}from"./calfSystem-DCvZki7i.js"
import{l as F}from"./lastActivity-BZsgwwgs.js"
import{s as _}from"./setTipped-_gKWzwad.js"
import{a as O}from"./addCommas-C_h2HN8s.js"
import{c as W}from"./closestTable-7JTCNZDF.js"
import{s as Q}from"./simpleCheckbox-BkPOj03r.js"
import{c as U}from"./createStyle-BdpbHftM.js"
import{a as Z,g as q,c as z,b as K}from"./levelHighlight-CWxl80ZV.js"
import Y from"./compressBio-BUKAsTCm.js"
import{b as J}from"./batch-BRset9xq.js"
import{g as tt}from"./getPlayerId-C7FtShu8.js"
import{o as nt}from"./openQuickBuffById-xiqV_r-K.js"
import{d as et}from"./dataRows-Z3e6LHLv.js"
import{c as st}from"./createSpan-CyrmgeKx.js"
import{r as ot}from"./regExpGroups-B-1ZBIku.js"
import{c as at}from"./createButton-CsFinh8f.js"
...
import"./createInput-B1uqsO2M.js"
import"./createLabel-DdacF4kV.js"
...
function Lt(t){return Nt&&t>=Z()&&t<=q()}function kt(t){return jt&&t>=z()&&t<=K()}const wt=t=>[t,F(t.dataset.tipped).days],yt=([,t])=>t<7,Mt=([t])=>[t,Number(a(L,t.dataset.tipped))],St=([t,n])=>[t.parentNode.parentNode.rowIndex,Lt(n),kt(n)]
...
t[t.length-1].classList.add("fshHighlight")}}(n,e)}function xt(){Number(C("guild_id"))!==N()&&(Nt||jt)&&$t()}function vt(){Nt=l("highlightPlayersNearMyLvl"),jt=l("highlightGvGPlayersNearMyLvl"),xt(),l("enableHistoryCompressor")&&function(){const t=e(c,s()).slice(-2,-1)[0]
if(!t)return
...
t&&(!function(t){[Ot,Wt,Qt,sn,on].forEach(H(an,t))}(t),l("showBuffLinks")&&I(3,Rt),function(t){E()||(l("detailedConflictInfo")&&I(3,Dt,[t]),I(4,en))}(t),Jt())}function cn(){I(3,n),I(3,Ct),I(3,lt),I(3,gt),["-","manage"].includes(D.subcmd)&&rn(),"view"===D.subcmd&&vt()}export{cn as default}
//# sourceMappingURL=injectGuild-DVJxeht3.js.map
