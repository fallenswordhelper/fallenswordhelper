import{cQ as t,G as e,g as s,c as i,cR as n,w as o,aO as a,d,p as c,o as r,x as l,ai as h,aQ as f,s as u,a9 as p,H as m,q as g,aU as b,v as k,c7 as y,a8 as w,aq as j}from"./calfSystem-hszmVKJw.js"
import{a as L}from"./all-YfMtr2SN.js"
import{c as R}from"./createTable-DpmB0LNC.js"
import{e as G,s as N}from"./selfIdIs-33h6HafJ.js"
...
import{a as P,g as H}from"./guildGroupCombat-3HfDVDsO.js"
import{a as C}from"./addLogColoring-DYC3utnD.js"
import{p as S}from"./parseDateAsTimestamp-BSrGuAIU.js"
...
function ut(){X&&J.sort(ft),p("Loading complete.",q),Q.log=J.filter(i(at,(new Date).setSeconds(0,0))).map(dt),ot(),c()&&function(){Z=R({id:"fshInjectHere",className:"width_full"}),k(Z,O),J.forEach(rt)
const t=s("fshInjectHere")
c().replaceChild(Z,t),C("myGuildLog",1,3),P(),H()}()}async function pt(t){it(t),await function(){let t=[]
...
Q.checks[e]=!Q.checks[e],ot(),J.forEach(i(mt,e,!Q.checks[e]))}function bt(t){t?.classList?.remove("fshHide")}function kt(t){bt(t[5]),bt(t[6])}function yt(t,e,s){u("newGuildLog",t),Q.checks=e.slice(0),ht(),J.forEach(s)}function wt(){yt("selectAll",E,kt)}function jt(t){T(t[5]),T(t[6])}function Lt(){yt("selectNone",D,jt)}async function Rt(){u("newGuildLog","refresh"),Q.log=!1,ot(),p("Loading Page 1 ...",q),J=[],X=!0,d("",s("fshInjectHere"))
pt(await F(1))}function Gt(t){!function(t){Q=t||Q,Q.checks=Q.checks||E.slice(0)}(t),d(A,c()),_=s("fshNewGuildLog"),q=s("fshOutput"),r(_,G([[t=>"INPUT"===t.tagName,gt],[N("fshAll"),wt],[N("fshNone"),Lt],[N("rfsh"),Rt]])),ht(),z=Number(h("newGuildLogHistoryPages")),K=z,async function(){pt(await F(1))}()}async function Nt(){if(o())return
const t=a("fsh_guildLog")
!function(){const t=s("notification-guild-log")
T(t)}(),Gt(await t)}export{Nt as default}
//# sourceMappingURL=newGuildLog-_BYbb0Wg.js.map
