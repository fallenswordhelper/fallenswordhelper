import{bw as t,bW as e,cr as n,az as s,bZ as a,aB as r,g as o,e as i,ah as c,n as l,b3 as f,d1 as u,q as d,a5 as p,cF as b,r as h,c as m,ct as y,dj as g,p as v,o as x,s as w,bt as k,bu as L,aw as C,a4 as P,e7 as B,k as S,dk as I,dQ as T,e8 as E,aS as A,b5 as j,bA as N,bj as F}from"./calfSystem-BlPuMQGT.js"
import{o as R}from"./onlinePlayersPage-C7Zk_SRa.js"
import{b as D}from"./buffObj-BIwiFUIW.js"
import{h as M}from"./simpleCheckbox-W5pog9Qz.js"
import{o as H}from"./onlineDot-BCSSHLUO.js"
...
i(n+1,t),e===n+1&&z("Done.","blue")}()}let at=0,rt=0,ot=0,it=0,ct=0,lt=0,ft=0
function ut(t,e){i(t,o(e))}async function dt(t){!function(t,e){st(e,{href:t,findBuffNicks:at})}(t,await F(t))}function pt(){ut(ot.length,"potentialBuffers"),ot.length<=0?z("Done.","blue"):(z("Parsing player data ...","green"),ot.forEach(dt))}function bt(t,e){j()!==L(e)&&ot.push(t)}function ht(t,e){if(n=function(t){return parseInt($(t).find("td:eq(2)").text().replace(/,/g,""),10)}(e),n>=rt&&n>=Y()){bt($(e).find("td:eq(1) a").attr("href"),$(e).find("td:eq(1) a").text())}var n}async function mt(t,e,n){const s=function(t,e){return 1===t?Math.round(it*e/50):t+1}(t,e)
z(`Parsing online page ${t} ...`)
...
n<s?mt(n,s,yt):pt()}async function gt(){if(it=parseInt(o("onlinePlayers").value,10),0!==it){yt(await R(1))}else pt()}function $t(t){const{tipped:e}=t.dataset,{mins:n}=I(e);(function(t,e,n){return t<5&&e>=rt&&e>=n})(n,Number(h(T,e)),Y())&&bt(t.href,l(t))}function vt(t){lt.push(N+t)}async function xt(t){!function(t){const e=c(t)
S('#profileLeftColumn a[data-tipped*="Last Activity"]',e).forEach($t),ft+=1,ft===lt.length&&gt()}(await F(t))}function wt(t){const e=c(t)
o("guildMembers").checked&&S('#pCC a[data-tipped*="<td>VL:</td>"]',e).forEach($t),lt=[],lt.push(E),A(ct).forEach(vt),ft=0,o("alliesEnemies").checked?lt.forEach(xt):gt()}function kt(t,e){return 0!==e}function Lt(t){t.deleteRow(-1)}function Ct(){w("find buffs","clear results"),function(){const t=o("buffTable")
k(t.rows).filter(kt).forEach(m(Lt,t))}(),ut("","buffNicks"),z("Idle.","black"),ut("","potentialBuffers"),ut("0","buffersProcessed")}function Pt(t){P()||(ut(at,"buffNicks"),z(`Gathering list of ${t} ...`,"green"),U=o("level175").checked,ut("0","buffersProcessed"),ot=[],ct=o("extraProfile").value,C("extraProfile",ct),async function(){wt(await B())}())}function Bt(t,e){return t===e.id}function St(){w("find buffs","findBuffsStart")
const t=parseInt($("#selectedBuff").val(),10),e=D.find(m(Bt,t))
at=e.nicks,rt=e.lvl,Pt("potential buffers")}function It(){w("find buffs","findOtherStart")
const t=$("#textToSearchFor").val().split(",").map(L).join(",")
C("textToSearchFor",t),at=t,rt=1,Pt("profiles to search")}function Tt(){ct=r("extraProfile")}function Et(t){x(o("findbuffsbutton"),t,!0)}function At(){x(o("clearresultsbutton"),Ct,!0)}function jt(t){const e=t||v()
s.sortBy="name",s.sortAsc=!0,D.sort(q),Tt(),i(J(_,ct),e),W(),Et(St),At()}function Nt(t){const e=t||v()
Tt(),i(J(V,ct),e),W(),Et(It),At()}export{jt as injectFindBuffs,Nt as injectFindOther}
//# sourceMappingURL=findBuffs-DEgilXyj.js.map
