import{al as e,eC as t,eD as s,K as r,J as n,eE as a,bS as i,bR as o,z as c,bc as l,aG as u,E as p,H as d,by as v,N as h,O as f,c2 as m,c3 as g,C as b,D as y,F as k,Q as D,bh as w,T as S,R as C,dg as z,bz as E,s as T,aF as $,G as _,bC as x,ab as Q,eF as I,dc as N,cn as j,$ as G,a1 as M,j as q,cl as F,c as P,ad as R,t as A,w as H,a8 as L,a9 as U,k as V,eG as W,q as J,o as K,bb as O,u as Y,g as B,bn as X}from"./calfSystem-BlPuMQGT.js"
import{d as Z}from"./daComponents-DDRm4Sdt.js"
import{c as ee}from"./closestTd-BxsEDZOn.js"
...
d(w,(e=>{r(i)?e(C,!1):e(S)}))
var $=y(w,2),_=k($)
z(_,{onclick:function(){T("components","insertQuickExtract"),I()},children:(e,t)=>{var s=E("Quick Extract")
h(e,s)}})
var x=y($,2),Q=e=>{var t=fe(),s=k(t)
N(s,(()=>({"--button-color":"red"}))),z(s.lastChild,{onclick:m,children:(e,t)=>{var s=E("Delete All Visible")
h(e,s)}}),h(e,t)}
d(x,(e=>{r(a)&&e(Q)})),h(t,g),f()}function be(e){return j({subcmd:"destroycomponent",removeIndex:e})}async function ye(e){const t=await q({cmd:"profile",subcmd:"destroycomponent",component_id:e})
return t?function(e,t){const s=F(t)
...
return t.replaceWith(H({className:"compSumSpin",innerHTML:'<span class="fshSpinner fshSpinner12"></span>'})),t}function we(e,t){!function(e,t,s){se.update((r=>(r.get(e)?.set(t,s),r)))}(t,"delPending",e)}const Se=e=>e.forEach((([e])=>e?.children[0]?.remove())),Ce=e=>e.map((([e])=>[e,De(e)])),ze=([,e])=>e,Ee=e=>x(e.map(ze)),Te=([,,e])=>e,$e=e=>Ee(e).map((t=>[t,e.filter((([,e])=>e===t)).map(Te)])),_e=e=>function(e,t){se.update((s=>(function(e,t){if(!t)return
const s=t.get("del").filter((t=>!e.includes(t)))
t.set("del",s)}(t,s.get(e)),s)))}(...e)
async function xe(e){const t=Ce(e),s=await(r=e.map(Te),G(be,ke,r))
var r
s?.s?($e(e).forEach(_e),Se(t)):(A(s?.e?.message??"Unknown Error"),t.forEach((([e,t])=>{t&&e.children[0].replaceWith(t)})))}async function Qe(e){const t=Ee(e)
t.forEach(P(we,!0)),await M(R(30,e).map(xe)),t.forEach(P(we,!1))}function Ie(e){const{itemId:t,invId:s}=L(U,e.dataset.tipped)
return[Number(t),Number(s)]}const Ne=e=>[ee(e),...Ie(e)]
function je(e){Qe(V("img",e).map(Ne))}const Ge=e=>W(se).get(e).get("del"),Me=(e,t)=>ee(J(`img[data-tipped*="&inv_id=${t}&"]`,e))
function qe(e,t){Qe(Ge(t).map((s=>[Me(e,s),t,s])))}function Fe(e){"IMG"===e.target.tagName&&(e.preventDefault(),T("components","quickDel"),O(e.target),Qe([[ee(e.target),...Ie(e.target)]]))}function Pe(e){e.classList.add("fshQuickDel"),K(e,Fe)}function Re(){const e=function(){const e=B("profileRightColumn"),t=X("inventory-table",e)
if(2===t.length)return t[1]}()
e&&Y(ge,{props:{dispatchDelete:P(je,e),dispatchDelType:P(qe,e),dispatchQuickDel:P(Pe,e)},target:e.parentNode})}export{Re as default}
//# sourceMappingURL=components-DhtSTKzK.js.map
