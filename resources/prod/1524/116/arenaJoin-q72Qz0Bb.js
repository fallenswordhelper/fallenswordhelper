import{S as t,J as e,K as n,L as s,_ as l,M as a,N as r,P as o,Q as i,a0 as c,W as m,X as u,a_ as f,aH as p,O as $,R as g,U as d,aY as h,Y as v,T as b,a1 as w,ah as j,b4 as _,b7 as y,a5 as x,b9 as k,ba as q,b5 as S,b6 as I,bb as N,bA as T,E as A,$ as C,bB as E,bC as H,bD as R,aJ as F,F as M,a3 as B,a4 as P,k as D,q as L,g as U,p as W}from"./calfSystem-ZGMc097r.js"
import{i as Y}from"./interceptSubmit-6P3g4nmT.js"
import{b as G,v as J,a as K}from"./arena-TIMIONhi.js"
import{h as O,u as z}from"./await_block-CsWaGax3.js"
import{a as Q}from"./addCommas-olJWnOGa.js"
import{e as V}from"./each-_TSpIEJe.js"
import{d as X}from"./daLoadInventory-oAtKS8KU.js"
import{h as Z}from"./htmlResult-I4d3X6jZ.js"
import{a as tt}from"./all-TTLWag-d.js"
import{I as et}from"./ItemImg-9wliChrA.js"
import"./formToUrl-2nuKtQzv.js"
import"./loadDataTables-SyZnDOiO.js"
...
return{c(){e=s("img"),r(e,"alt","Move"),f(e.src,n=p+"arena/"+(t[7]?t[7]-1:"x")+".png")||r(e,"src",n)},m(t,n){o(t,e,n)},p(t,s){1&s&&!f(e.src,n=p+"arena/"+(t[7]?t[7]-1:"x")+".png")&&r(e,"src",n)},d(t){t&&u(e)}}}function ut(t){let e,n,l,c,f,p,b=V(t[2]),w=[]
...
for(b=V(t[2]),s=0;s<b.length;s+=1){const l=it(t,b,s)
...
await(t=a,G({subcmd:"usesetup",set_id:t})),n(0,l=r.find((({id:t})=>t===a)))},s,function(){a=w(this),n(1,a),n(2,r)}]}class pt extends t{constructor(t){super(),e(this,t,ft,ut,n,{res:4})}}function $t(t){let e,n,l
...
n=new rt({props:{title:"Players",flag:t[1].players.length+" / "+t[1].max_players}}),c=new rt({props:{title:"Specials",flag:t[1].specials}}),f=new rt({props:{title:"Hell Forge",flag:t[1].hellforge}}),$=new rt({props:{title:"Epic",flag:t[1].epic}}),d=new rt({props:{title:"Max Equip Level",flag:Q(t[1].equip_level)}})
...
const o={}
2&e&&(o.flag=Q(t[1].equip_level)),d.$set(o),t[1].specials?w?(w.p(t,e),2&e&&_(w,1)):(w=dt(t),w.c(),_(w,1),w.m(v.parentNode,v)):w&&(S(),y(w,1,1,(()=>{w=null})),I())},i(t){b||(_(n.$$.fragment,t),_(c.$$.fragment,t),_(f.$$.fragment,t),_($.$$.fragment,t),_(d.$$.fragment,t),_(w),b=!0)},o(t){y(n.$$.fragment,t),y(c.$$.fragment,t),y(f.$$.fragment,t),y($.$$.fragment,t),y(d.$$.fragment,t),y(w),b=!1},d(t){t&&(u(e),u(h),u(v)),N(n),N(c),N(f),N($),N(d),w&&w.d(t)}}}function dt(t){let e,n,l
...
return O(t[2](),s),{c(){e=j(),s.block.c()},m(t,l){o(t,e,l),s.block.m(t,s.anchor=l),s.mount=()=>e.parentNode,s.anchor=e,n=!0},p(e,[n]){z(s,t=e,n)},i(t){n||(_(s.block),n=!0)},o(t){for(let t=0;t<3;t+=1){const e=s.blocks[t]
y(e)}n=!1},d(t){t&&u(e),s.block.d(t),s.token=null,s=null}}}function bt(t,e,n){const s=Number(x("pvp_id"))
let l=0,a=0
return[l,a,async function(){const t=await J()
if(!t.s)throw new Error(t.e.message)
var e
n(0,l=t.r),n(1,(e=t.r,a=e.arenas.find((t=>t.id===s))))}]}class wt extends t{constructor(t){super(),e(this,t,bt,vt,n,{})}}function jt(t){return T({subcmd:"usecombatset",combatSetId:t})}async function _t(t){const e=await A({cmd:"profile",subcmd:"managecombatset",submit:"Use",combatSetId:t})
...
return{c(){e=s("div"),a&&a.c(),r(e,"class",n=E(t[0])+" svelte-dyrqj")},m(t,n){o(t,e,n),a&&a.m(e,null),l=!0},p(t,[s]){t[1]?a?(a.p(t,s),2&s&&_(a,1)):(a=yt(t),a.c(),_(a,1),a.m(e,null)):a&&(S(),y(a,1,1,(()=>{a=null})),I()),(!l||1&s&&n!==(n=E(t[0])+" svelte-dyrqj"))&&r(e,"class",n)},i(t){l||(_(a),l=!0)},o(t){y(a),l=!1},d(t){t&&u(e),a&&a.d()}}}function kt(t,e,n){let{class:s=""}=e,{item:l=0}=e
...
return s[9]=e[n].id,s[10]=e[n].name,s}function At(t){return{c:m,m:m,p:m,i:m,o:m,d:m}}function Ct(t){let e,n,c,m,f,p,b,w,j,x,S=V(t[1]),I=[]
for(let e=0;e<S.length;e+=1)I[e]=Et(Tt(t,S,e))
...
I[n]?I[n].p(s,e):(I[n]=Et(s),I[n].c(),I[n].m(f,null))}for(;n<I.length;n+=1)I[n].d(1)
I.length=S.length}6&e&&g(f,t[2])
const n={}
1&e&&(n.equipment=t[0]),b.$set(n)},i(t){w||(_(b.$$.fragment,t),w=!0)},o(t){y(b.$$.fragment,t),w=!1},d(t){t&&u(e),h(I,t),N(b),j=!1,v(x)}}}function Et(t){let e,n,a,r=t[10]+""
return{c(){e=s("option"),n=l(r),e.__value=a=t[9],b(e,e.__value)},m(t,s){o(t,e,s),i(e,n)},p(t,s){2&s&&r!==(r=t[10]+"")&&c(n,r),2&s&&a!==(a=t[9])&&(e.__value=a,b(e,e.__value))},d(t){t&&u(e)}}}function Ht(t){return{c:m,m:m,p:m,i:m,o:m,d:m}}function Rt(t){let e,n,s={ctx:t,current:null,token:null,hasCatch:!1,pending:Ht,then:Ct,catch:At,blocks:[,,,]}
return O(t[3](),s),{c(){e=j(),s.block.c()},m(t,l){o(t,e,l),s.block.m(t,s.anchor=l),s.mount=()=>e.parentNode,s.anchor=e,n=!0},p(e,[n]){z(s,t=e,n)},i(t){n||(_(s.block),n=!0)},o(t){for(let t=0;t<3;t+=1){const e=s.blocks[t]
y(e)}n=!1},d(t){t&&u(e),s.block.d(t),s.token=null,s=null}}}function Ft(t,e,n){let s=0,l=0,a=0
const r=({a:t})=>s.some((({a:e})=>e===t)),o=({items:t})=>t.every(r)
const i=t=>D('table[width="300"] b',t).slice(1).map((t=>L("td",t.parentNode.nextElementSibling.children[0])))
return[s,l,a,async function(){const[t,e]=await tt([X(),R()])
...
const r=M(e),o=i(r).map((t=>B(t)))
i().forEach(((t,e)=>P(o[e],t)))},function(){a=w(this),n(2,a),n(1,l)}]}class Mt extends t{constructor(t){super(),e(this,t,Ft,Rt,n,{})}}function Bt(t){let e,n,s,l
return e=new wt({}),s=new Mt({}),{c(){k(e.$$.fragment),n=a(),k(s.$$.fragment)},m(t,a){q(e,t,a),o(t,n,a),q(s,t,a),l=!0},p:m,i(t){l||(_(e.$$.fragment,t),_(s.$$.fragment,t),l=!0)},o(t){y(e.$$.fragment,t),y(s.$$.fragment,t),l=!1},d(t){t&&u(n),N(e,t),N(s,t)}}}class Pt extends t{constructor(t){super(),e(this,t,null,Bt,n,{})}}function Dt(){U("arenaTypeTabs")?K():(Y(),new Pt({target:W()}))}export{Dt as default}
//# sourceMappingURL=arenaJoin-q72Qz0Bb.js.map
