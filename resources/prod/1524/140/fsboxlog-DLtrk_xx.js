import{i as t}from"./Modal-Dxm27BSi.js"
import{S as s,L as n,M as e,bj as a,bk as o,be as l,bh as r,bl as c,O as i,P as u,Q as f,T as m,U as b,X as p,a1 as h,a4 as d,s as $,aQ as g,aS as x,m as v,q as k,ax as y,a8 as S,as as j,di as L,a0 as M,N as _,am as C,b6 as q,bt as w,a5 as z}from"./calfSystem-BhNMi9iJ.js"
import{h as B,u as F}from"./await_block-CDfjgofq.js"
import{M as N}from"./ModalTitled-BeMGBD-d.js"
...
e.length=n.length}},d(t){t&&h(s),q(e,t)}}}function O(t){let s,n,e,a,o,l,r,c,p,$,g,x=t[8]+"",v=t[9]+""
return{c(){s=i("br"),n=u(),e=i("span"),a=i("a"),o=d(x),r=d("\n          says:"),c=u(),p=i("q"),$=d(v),g=u(),f(a,"href",l=""+(w+t[7])),f(a,"class","svelte-14ozmrh")},m(t,l){m(t,s,l),m(t,n,l),m(t,e,l),b(e,a),b(a,o),b(e,r),m(t,c,l),m(t,p,l),b(p,$),b(p,g)},p(t,s){2&s&&x!==(x=t[8]+"")&&z(o,x),2&s&&l!==(l=""+(w+t[7]))&&f(a,"href",l),2&s&&v!==(v=t[9]+"")&&z($,v)},d(t){t&&(h(s),h(n),h(e),h(c),h(p))}}}function P(t){return{c:M,m:M,p:M,d:M}}function U(t){let s,n,e,a,o,l,r={ctx:t,current:null,token:null,hasCatch:!1,pending:P,then:H,catch:Q}
return B(t[3](),r),{c(){s=i("div"),n=i("button"),n.textContent="Clear",e=u(),a=i("div"),r.block.c(),f(n,"type","button"),f(s,"class","top svelte-14ozmrh"),f(a,"class","textContainer svelte-14ozmrh")},m(c,i){m(c,s,i),b(s,n),m(c,e,i),m(c,a,i),r.block.m(a,r.anchor=null),r.mount=()=>a,r.anchor=null,o||(l=p(n,"click",t[4]),o=!0)},p(s,n){F(r,t=s,n)},d(t){t&&(h(s),h(e),h(a)),r.block.d(),r.token=null,r=null,o=!1,l()}}}function X(t){let s
...
return[Number(y(n?.href,"player_id")),S(n),j(k("q",s))]}const l=([t,s,n])=>t&&L(s)&&L(n)
...
//# sourceMappingURL=fsboxlog-DLtrk_xx.js.map
