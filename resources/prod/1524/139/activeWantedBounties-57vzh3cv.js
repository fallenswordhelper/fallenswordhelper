import{G as e,ag as n,i as t,dF as s,m as r,a7 as i,d as a,dG as o,v as c,a8 as u,q as l,a3 as f,ai as d,bO as b,ae as p,g as h,as as m,H as L,r as g,w as y,o as w,s as v}from"./calfSystem-B_VkFJhM.js"
import{f as $}from"./functionPasses-BXOT6NCP.js"
import{c as N}from"./createSpan-s_SpXH45.js"
import{s as R}from"./shouldBeArray-CXMC8hic.js"
import"./csvSplit-wR_rfRRJ.js"
function x(n){return e({cmd:"bounty",page:n})}let k=0,T=0
const B=()=>k,A=()=>T
function j(){return r({className:"minibox"})}function W([e,n,s,u,l]){const f=e(),d=s()
if(d)return i(n,d),a("",f),function(e,n,s,i){const a=r({innerHTML:`<a class="fshBountyHeader" href="${o}">${s} Bounties</a> `}),u=N({className:"xxsLink",textContent:"Reset"})
return t(a,u),t(e,a),c(e,function(e,n,t){const s=e.bounty
return 0===s.length?`<div class="xsOrange">[No ${n.toLowerCase()} bounties]</div>`:s.map(t).join("")}(n,s,i)),u}(f,d,u,l)}function P(e,n){return`<a href="${e.link}" class="xsKhaki tip-static" data-tipped="${n(e)}">${e.target}</a><br>`}function S(e){return l("img",e[2]).title}function H(e){const n="A"===(t=e[0]).children[0].tagName?t.children[0]:t.children[0].children[0]
var t
return{target:u(n),link:n.href,lvl:u(n.nextSibling).replace(/[[|\]]/g,""),reward:u(e[2]),rewardType:S(e),xpLoss:u(e[3]),posted:u(e[4])}}let C=0,G={},M={},U=!1,O=!1,q=[]
...
const Q=()=>J
function V(e){return`Level:  ${e.lvl}<br>Reward: ${e.reward} ${e.rewardType}<br>XP Loss Remaining: ${e.xpLoss}<br>Progress:  ${e.progress}`}function Y(e){return P(e,V)}function Z(){J=W([B,"bountyList",E,"Active",Y])}let _=0
const ee=()=>_
...
function oe(e,n){var t;(function(e,n){return"[active]"!==m(n.cells[6])&&ae.some((t=>t(e,n)))})(e,n)&&X().bounty.push({...H(t=n.cells),offerer:m(t[1].children[0].children[0]),tickets:m(t[5]),accept:ie(t)})}let ce=0,ue=0
