import{n as t,b8 as s,aa as n,q as e,$ as i,k as a,ce as r,R as c,X as o,dU as u,bF as v,S as l,Y as d,a0 as p,a7 as m,a2 as f,V as g,a3 as q,a4 as b,W as h,s as $,Z as k,bq as y,dF as I,a8 as C,a6 as _,dV as w,dW as x,ad as j,p as S,C as E,i as F,r as V,v as D,b6 as M,b5 as T,cD as A}from"./calfSystem-BGOTz8de.js"
import{i as N}from"./inventing-arhzwkuy.js"
import{i as O}from"./interceptSubmit-CHnAIuBp.js"
import{x as P}from"./xPath-DutV-yRl.js"
...
Array(g(e)).fill(i.recipeID).reduce(a,Promise.resolve())}var X=o('<div class="qi-error-container svelte-qp9a2g"><div class="qi-error-heading svelte-qp9a2g">INFORMATION</div> <div> </div></div>'),Y=o('<div class="qi-container svelte-qp9a2g"><label for="quick-invent-amount">Select how many to quick invent</label> <input class="custominput svelte-qp9a2g" min="1" required step="1" type="number"> <!> <button class="custombutton svelte-qp9a2g" type="button">Quick Invent</button> <div><!> <div class="composing-progress svelte-qp9a2g"><div class="composing-progress-bar svelte-qp9a2g"></div> <p> </p></div> <div class="qi-results-container svelte-qp9a2g"><div class="qi-result qi-result-success svelte-qp9a2g"> </div> <div class="qi-result qi-result-failure svelte-qp9a2g"> </div></div></div></div>')
function Z(t,s){c(s,!0)
let n=l(void 0),e=l(1),a=l(0),r=l(0),o=l(0),_=l("")
var j=Y(),S=d(k(j),2)
u(S,(t=>h(n,t)),(()=>g(n)))
var E=d(S,2)
v(E,{onclick:function(){h(e,s.max,!0),$("inventing","maxInventButton")},children:(t,s)=>{var n=y("(max)")
q(t,n)},$$slots:{default:!0}})
var F=d(E,2)
F.__click=[Q,n,function(){h(a,0),h(r,0),h(o,0),h(_,"")},e,s,async function(t,s){const n=await t
if(!n||!0===n.s){const t=await function(t){return i(W,B,t)}(s)
return t?.s?t.r.success_count>0?h(a,g(a)+1):h(r,g(r)+1):h(_,t?.e?.message??"Server Error",!0),h(o,(g(a)+g(r))/g(e)*100),t}return n}]
...
m((()=>{I(A,`width: ${g(o)??""}%;`),C(O,`${g(a)+g(r)} / ${g(e)??""}`),C(U,`Successes: ${g(a)??""}`),C(z,`Failures: ${g(r)??""}`)})),f(S,(()=>g(e)),(t=>h(e,t))),q(t,j),b()}function z(t){return`${M}items${T}view&item_id=${t}`}function G(t,s){const n=function(t){if(!t)return
...
export{K as default}
//# sourceMappingURL=viewRecipe-d9akts5d.js.map
