import{g as t}from"./getProfile-CrDirhRE.js"
import{e as n}from"./executeAll-DIAWIge1.js"
import{q as s,aB as e,c as a,a8 as i,n as f,b as c,s as u,g as r,aa as o,aC as l,K as d,ai as b,o as h,ad as p,w as m,e as k}from"./calfSystem-Blt4DbaE.js"
import{i as q}from"./insertHtmlAfterEnd-ZY7WoHPS.js"
import{c as y}from"./createSpan-qOSQqjTl.js"
import{c as S}from"./csvSplit-DCp-KQ1I.js"
import{i as $}from"./insertElementAfter-BiQpTqUp.js"
import{f as g}from"./formatLastActivity-DomOheV5.js"
import{s as v}from"./setTipped-_gKWzwad.js"
import{o as T}from"./outputFormat-CxYfzxHE.js"
import{d as j,q as x}from"./quickbuffSuccess-CFdIM7Kh.js"
...
a(`Last Activity: ${g(t.last_login)}<br>Stamina: ${t.current_stamina} / ${t.stamina} ( ${Math.floor(t.current_stamina/t.stamina*100)}% )`,n)}function E(t){return Number(i(t).replace(/[[\]]/g,""))}function A(t,n,s){if(!n)return void a("",s)
const e=E(t.nextElementSibling.children[0].children[0]),i=function(t,n){if(!n){const n=y({className:"fshPlayer"})
return $(n,t.nextElementSibling),n}return n}(t,s),f=function(t,n){return t>n?"fshRed":"fshGreen"}(e,n)
a(` <span class="${f}">[${n}]</span>`,i)}function C(t,n){return n[0]===t}function L(t,n){const s=function(t,n){const s=n.getAttribute("data-name"),e=t.find(c(C,s))
...
v(s.replace("</center>",`<br>Stamina Cost: ${e}$&`),n)}(t,n),F(t,n)}function G(){f('#buff-outer label[for^="skill-"]').forEach(M)}function O(t){const n=e("h1",r("players"))[0]
!function(t,n){return!t&&n}(n,t)?n&&N(n):setTimeout(O,100,t-1)}function P(){r("targetPlayers").value&&O(9)}function I(t){const n=function(t){const n=Math.floor(t/60),s=t%60
let e=T(n,"m")
...
return n?`<span class="quickbuffActivate" data-buffid="${n.value}">Activate</span>`:'<span class="fshRed;">Off</span>'}(n)}function K(t,n,s){a(Q(t,n),s)}function z(t,n){return t[n.name]=n.duration,t}const J=t=>n=>n.name===t
function U(t,n,s){const e=function(t,n){const s=t.find(J(n))
return s?.value??0}(t,n)
let i="fshLime"
e<100&&(i="fshRed"),a(`<span class="${i}">${e}%</span>`,s)}function V(t){!function(t){if(!t?._enhancements)return
...
K(n,"Guild Buffer",r("fshGB")),K(n,"Buff Master",r("fshBM")),K(n,"Extend",r("fshExt")),K(n,"Reinforce",r("fshRI"))}(t)}function W(t){const n=r(`skill-${t}`)
...
!function(t,n){x(n)&&(t.className="fshLime",a("On",t))}(n,await j([l()],[n.dataset.buffid]))}const st=[]
...
for(const s of st[t])n.appendChild(s)}function it(t){for(let n=1;n<=3;n++)t?et(`block${n}`):at(n)}function ft(t){u("quickbuff","sortBuffs"),p(_,t.target.checked),it(t.target.checked)}function ct(){!function(){for(let t=1;t<=3;t++){const n=`block${t}`
st[t]=d(`#${n} > p`)}}()
const t=r("check-all")
q(t,D)
const n=s(".quickbuffSortCheckbox"),e=b(_)
n.checked=e,e&&it(e),h(n,"change",ft)}function ut(){k(r("helperQBheader"),nt),k(r("players"),R)}function rt(){}async function ot(){if(m())return
const s=r("quickbuff")
if(!s)return
const e=t(l())
...
//# sourceMappingURL=quickBuff-CWwWAvMc.js.map
