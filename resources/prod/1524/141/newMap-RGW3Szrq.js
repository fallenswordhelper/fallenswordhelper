...
import{ag as t,k as n,g as a,a9 as r,i as o,b as s,v as i,e as l,s as c,aC as u,aE as f,aF as d,aG as m,ai as p,aH as h,aI as g,aJ as v,aK as b,aL as k,o as y,ad as w,y as C,aM as L,aN as V,n as D,q as M,aO as x,aP as A,aQ as S,aR as N,aS as H,D as B,aT as T,aU as E,aV as G,aW as P,aX as j,aY as R,aZ as _,a_ as F,a$ as I,b0 as O,b1 as W,aj as q,a8 as K,b2 as Y,b3 as z,b4 as U,a as Q,$ as J,S as X,L as Z,M as ee,O as te,P as ne,R as ae,T as re,U as oe,V as se,b5 as ie,N as le,b6 as ce,X as ue,b7 as fe,b8 as de,W as me,b9 as pe,Z as he,am as ge,a2 as ve,_ as be,a0 as ke,ba as ye,c as we,ap as Ce,bb as $e,bc as Le,bd as Ve,E as De,be as Me,bf as xe,bg as Ae,bh as Se,bi as Ne,bj as He,bk as Be,bl as Te,bm as Ee,bn as Ge,bo as Pe,bp as je,bq as Re,br as _e,bs as Fe,bt as Ie,bu as Oe,bv as We,bw as qe,bx as Ke,by as Ye,bz as ze,bA as Ue,bB as Qe,bC as Je,bD as Xe,bE as Ze,bF as et,bG as tt,bH as nt,bI as at,bJ as rt,bK as ot,bL as st,bM as it,ah as lt}from"./calfSystem-Blt4DbaE.js"
import{i as ct}from"./insertElementAfter-BiQpTqUp.js"
import{t as ut}from"./toggleForce-br4z9gGd.js"
import{c as ft}from"./createSpan-qOSQqjTl.js"
import{i as dt}from"./insertTextBeforeEnd-C2DfAAnt.js"
import{r as mt,a as pt}from"./roundToString-Hif1MLyB.js"
import{a as ht}from"./addCommas-C_h2HN8s.js"
import{d as gt,q as vt}from"./quickbuffSuccess-CFdIM7Kh.js"
import{c as bt}from"./createButton-BLPmyJcZ.js"
import{i as kt}from"./isArray-eVldfhw1.js"
import{o as yt}from"./openQuickBuffById-AG7prqnJ.js"
import{c as wt}from"./createInput-CZBTxG_u.js"
import{c as Ct}from"./createLabel-Ci_22opB.js"
import{r as $t}from"./rnd-D_QmA-Fa.js"
import{v as Lt}from"./valueText-CRDZBw-0.js"
import{c as Vt}from"./createStyle-C5mK_M_l.js"
import{h as Dt,u as Mt}from"./await_block-Bf7EOqQ9.js"
import{u as xt}from"./uniq-D422dDMJ.js"
import{g as At}from"./guild-hKlLzHll.js"
import{c as St}from"./createTable-C810iJm_.js"
import{t as Nt,g as Ht,a as Bt}from"./getTitanString-BJW-Vzfl.js"
import{p as Tt}from"./padZ-DFV6JBPu.js"
import{f as Et}from"./fshOpen-AuKioUPF.js"
import{L as Gt}from"./LinkButton-CTQrdC0s.js"
import{r as Pt}from"./reduceBuffArray-Diy1E3zc.js"
import{p as jt}from"./profile-BPaCJRNe.js"
import{a as Rt}from"./all-YfMtr2SN.js"
import{n as _t}from"./numberIsNaN-CGkd1jiA.js"
import{r as Ft}from"./reliclist-CRYbWQbm.js"
import{d as It}from"./daGroupStats-C487D16H.js"
import{d as Ot,m as Wt}from"./mercEffect-DOR5kBdL.js"
import{d as qt}from"./daViewGroups-BuRscLuJ.js"
import{a as Kt}from"./attribsToArray-3c2SZERK.js"
import{g as Yt}from"./guildMembers-B5MxM4J7.js"
import{r as zt}from"./remainingPages-BzskAxSU.js"
import{t as Ut}from"./testQuant-CUL735o8.js"
import{m as Qt}from"./myStats-CJTu9lO4.js"
import{s as Jt}from"./shouldBeArray-dBGFs5YM.js"
import{s as Xt,j as Zt}from"./simpleCheckbox-CjFtWivg.js"
import{i as en}from"./isSelected-BWnMzKlW.js"
import{b as tn}from"./bitwiseAnd-C5gmj-aX.js"
import"./buffReportParser-Bu4iNjH3.js"
import"./buffObj-BIwiFUIW.js"
import"./guildGroups-N0LSUuYp.js"
import"./view-uKjUIGjF.js"
...
1===e.length&&e.css("background-color",Vn[e.text()]||"#ad8043")}(),Rn()
...
Zn=Wn({prefVal:n,checkId:"fshHuntCheck",onClass:"huntOn",onTip:"Hunting mode is ON",offClass:"huntOff",offTip:"Hunting mode is OFF",worldName:e})}(qn)}const oa=[[()=>Xn,function(){c("NewMap","toggleSound"),w("playNewMessageSound",!p("playNewMessageSound"))}],[()=>Zn,function(){c("NewMap","toggleHuntMode"),t.huntingMode=!t.huntingMode,w("huntingMode",t.huntingMode)}]],sa=[[()=>zn,function(e){c("NewMap","doFormGroup"),h(e),GameData.doAction(12,401,{},0)}],[()=>Un,function(){c("NewMap","openQuickBuff"),yt(g())}],[()=>Qn,function(){c("NewMap","openRealmMap"),window.open(`${v+b}map`,"fsMap")}],[()=>Jn,function(){c("NewMap","openUfsgMap")
const e=GameData.realm()
window.open(`${k}realms${b}view&realm_id=${e.id}`,"mapUfsg")}]]
function ia(e,t){const{target:n}=t,[,a]=e.find((([e])=>e()===n))??[]
a&&(n.blur(),a(n))}function la(e){return s(ia,e)}function ca(){qn||(qn=n({className:"fshCurveContainer",id:"fshWorldButtonContainer"}),ra(),l(qn,la(sa)),y(qn,"change",la(oa)),C(qn,a("worldCoord")))}function ua(e,t){Kn&&t.b.minlevel&&(In(),r(t.b.minlevel,Kn))}function fa(e,t){Yn&&r(t.b,Yn)}const da=["NORMAL","CHAMPION","ELITE","SUPER ELITE","TITAN","LEGENDARY"],ma=`url("${x}ui/world/icon_action_attack_`
let pa=!1
function ha(e){return M(".verb.attack",e)}function ga(e){const t=da.indexOf(e.toUpperCase())
...
t&&(c("NewMap","ChampionAttack"),A(t))}(t[n])}function wa(e){!pa||e.ctrlKey&&e.shiftKey||(pa=!1,ka(!1))}const Ca=["Breaker","Protection","Master Thief","Protect Gold","Disarm","Duelist","Thievery","Master Blacksmith","Master Crafter","Fury Caster","Master Inventor","Sustain"]
let $a=[],La=0
...
function pr(e){return function(t,n,a,r){const o=mr[t];(function(e){return e&&Y(e)})(o)&&function(e){return z(e)||0===e}(r)?o(e)(t,n,a,r):e(t,n,a,r)}}function hr(){return e={subcmd:"contrib"},Q({cmd:"globalquests",...e})
...
return{c(){t=oe("p"),n=se(a),ie(t,"color","red")},m(e,a){ae(e,t,a),re(t,n)},p(e,t){1&t&&a!==(a=e[7].message+"")&&ne(n,a)},d(e){e&&te(t)}}}function kr(e){let t,n
function a(e,n){return 1&n&&(t=null),null==t&&(t=!!kt(e[1])),t?wr:yr}gr(e)
let r=a(e,-1),o=r(e)
return{c(){o.c(),n=ge()},m(e,t){o.m(e,t),ae(e,n,t)},p(e,t){gr(e),r===(r=a(e,t))&&o?o.p(e,t):(o.d(1),o=r(e),o&&(o.c(),o.m(n.parentNode,n)))},d(e){e&&te(n),o.d(e)}}}function yr(e){let t
return{c(){t=se("Server Error")},m(e,n){ae(e,t,n)},p:he,d(e){e&&te(t)}}}function wr(e){let t,n,a,r,o=le(e[1]),s=[]
for(let t=0;t<o.length;t+=1)s[t]=$r(vr(e,o,t))
return{c(){t=oe("table"),n=oe("tbody"),a=oe("tr"),a.innerHTML='<td class="header"></td> <td class="header"></td> <td class="header">Username</td> <td class="header">Kills</td>',r=me()
for(let e=0;e<s.length;e+=1)s[e].c()
ue(a,"class","svelte-2qtc6g"),ue(t,"id","world-event-contrib-table"),ue(t,"class","svelte-2qtc6g")},m(e,o){ae(e,t,o),re(t,n),re(n,a),re(n,r)
for(let e=0;e<s.length;e+=1)s[e]&&s[e].m(n,null)},p(e,t){if(1&t){let a
for(o=le(e[1]),a=0;a<o.length;a+=1){const r=vr(e,o,a)
s[a]?s[a].p(r,t):(s[a]=$r(r),s[a].c(),s[a].m(n,null))}for(;a<s.length;a+=1)s[a].d(1)
s.length=o.length}},d(e){e&&te(t),pe(s,e)}}}function Cr(e){let t,n,a,r
return{c(){t=oe("a"),n=oe("img"),ce(n.src,a=x+"guilds/"+e[3].guild_id+"_mini.png")||ue(n,"src",a),ue(n,"alt","guild logo"),ue(n,"class","svelte-2qtc6g"),ue(t,"href",r=""+(fe+e[3].guild_id))},m(e,a){ae(e,t,a),re(t,n)},p(e,o){1&o&&!ce(n.src,a=x+"guilds/"+e[3].guild_id+"_mini.png")&&ue(n,"src",a),1&o&&r!==(r=""+(fe+e[3].guild_id))&&ue(t,"href",r)},d(e){e&&te(t)}}}function $r(e){let t,n,a,r,o,s,i,l,c,u,f,d,m,p=e[3].name+"",h=e[4]+"",g=e[3].guild_id&&Cr(e)
return{c(){t=oe("tr"),n=oe("td"),n.textContent=`${e[6]+1}`,a=me(),r=oe("td"),g&&g.c(),o=me(),s=oe("td"),i=oe("a"),l=se(p),u=me(),f=oe("td"),d=se(h),m=me(),ue(i,"href",c=""+(de+e[3].name)),ue(t,"class","svelte-2qtc6g")},m(e,c){ae(e,t,c),re(t,n),re(t,a),re(t,r),g&&g.m(r,null),re(t,o),re(t,s),re(s,i),re(i,l),re(t,u),re(t,f),re(f,d),re(t,m)},p(e,t){e[3].guild_id?g?g.p(e,t):(g=Cr(e),g.c(),g.m(r,null)):g&&(g.d(1),g=null),1&t&&p!==(p=e[3].name+"")&&ne(l,p),1&t&&c!==(c=""+(de+e[3].name))&&ue(i,"href",c),1&t&&h!==(h=e[4]+"")&&ne(d,h)},d(e){e&&te(t),g&&g.d()}}}function Lr(e){let t
return{c(){t=se("Loading...")},m(e,n){ae(e,t,n)},p:he,d(e){e&&te(t)}}}function Vr(e){let t,n,a={ctx:e,current:null,token:null,hasCatch:!0,pending:Lr,then:kr,catch:br,value:2,error:7}
return Dt(n=e[0],a),{c(){t=ge(),a.block.c()},m(e,n){ae(e,t,n),a.block.m(e,a.anchor=n),a.mount=()=>t.parentNode,a.anchor=t},p(t,[r]){e=t,a.ctx=e,1&r&&n!==(n=e[0])&&Dt(n,a)||Mt(a,e,r)},i:he,o:he,d(e){e&&te(t),a.block.d(e),a.token=null,a=null}}}function Dr(e,t,n){let{promise:a}=t
...
p(e)&&(n=t+1,$.subscribe(U,s(Nr,n)),Nr(t+1))}function Tr(e,t,n){const a=e.slice()
return a[9]=t[n].msg,a[10]=t[n].type,a[11]=t[n].count,a}function Er(e){let t,n,a,r=e[11]+""
return{c(){t=oe("div"),n=se("x"),a=se(r),ue(t,"class","count svelte-1t9oc1")},m(e,r){ae(e,t,r),re(t,n),re(t,a)},p(e,t){1&t&&r!==(r=e[11]+"")&&ne(a,r)},d(e){e&&te(t)}}}function Gr(e,t){let n,a,r,o,s,i,l,c=t[9]+"",u=t[11]>1&&Er(t)
function f(){return t[3](t[9])}return{key:e,first:null,c(){n=oe("div"),a=se(c),r=me(),u&&u.c(),o=me(),ue(n,"class",s="fsh-message "+t[10]+" svelte-1t9oc1"),this.first=n},m(e,t){ae(e,n,t),re(n,a),re(n,r),u&&u.m(n,null),re(n,o),i||(l=ve(n,"click",f),i=!0)},p(e,r){t=e,1&r&&c!==(c=t[9]+"")&&ne(a,c),t[11]>1?u?u.p(t,r):(u=Er(t),u.c(),u.m(n,o)):u&&(u.d(1),u=null),1&r&&s!==(s="fsh-message "+t[10]+" svelte-1t9oc1")&&ue(n,"class",s)},d(e){e&&te(n),u&&u.d(),i=!1,l()}}}function Pr(e){let t,n=[],a=new Map,r=le(e[1](e[0]))
const o=e=>e[9]
for(let t=0;t<r.length;t+=1){let s=Tr(e,r,t),i=o(s)
a.set(i,n[t]=Gr(i,s))}return{c(){for(let e=0;e<n.length;e+=1)n[e].c()
t=ge()},m(e,a){for(let t=0;t<n.length;t+=1)n[t]&&n[t].m(e,a)
ae(e,t,a)},p(e,[s]){7&s&&(r=le(e[1](e[0])),n=be(n,s,o,1,e,r,a,t.parentNode,ke,Gr,t,Tr))},i:he,o:he,d(e){e&&te(t)
...
const go=()=>io,vo=()=>po
function bo(){io=Fn("Current"),lo=Fn("Kills"),co=Fn("Member"),uo=Fn("% of Total"),fo=Fn("Status"),mo=Fn("Titan HP"),po=Fn("Total"),ho=Fn("Your Guild")}let ko=0,yo=0,wo=0,Co=0,$o=0,Lo=0,Vo=0,Do=0,Mo=0
...
let Uo=0,Qo=0,Jo=""
const Xo=()=>Qo,Zo=()=>Jo
function es(){Qo=null,Uo&&!B("fshHide",Uo)&&(ut(Uo,!0),we("&nbsp;",ko),we("&nbsp;",yo),r("",wo),r("",Co),r("",$o),r("",Lo),r("",Vo),we("",Do),we("",Mo),_o())}function ts(e){return 0===e.type&&(Qo=e.base_creature_id,Jo=`(${e.x},${e.y})`,!0)}function ns(){if(Uo)ut(Uo,!1)
...
return`${Tt(t.getHours())}:${Tt(t.getMinutes())} ${Tt(t.getDate())}/${$e[t.getMonth()]}/${t.getFullYear()}`}(e)}</span>`}function rs(e){return pt(Ht(e.max_hp-e.current_hp,e.kills),2)}function os(e){return pt(100*e.kills/e.max_hp,2)}function ss(e){!function(e){[[Nt(e.creature.name),xo],[Zo(),Ao],[e.current_hp,So],[e.max_hp,No],[e.kills,Ho],[rs(e),Bo],[os(e),To]].forEach((([e,t])=>r(e,t())))}(e),we(function(e){return Bt(e.kills,e.max_hp,e.current_hp)}(e),Eo()),we(as(e.cooldown),Go())}function is(e,t){return[[[2,()=>Fn(t.player.name)],[2,()=>Fn(t.kills.toString())],[2,()=>Fn(`${pt(100*t.kills/e.kills,2)}%`)]]]}function ls(e){return e.realm&&e.creature.base_id===Xo()&&e.realm===to()}function cs(e){const t=e.find(ls)
...
return{c(){t=se(n)},m(e,n){ae(e,t,n)},p:he,d(e){e&&te(t)}}}function ks(e){let t,n,a,r
return n=new Gt({props:{$$slots:{default:[bs]},$$scope:{ctx:e}}}),n.$on("click",(function(...t){return e[3](e[5],e[7],...t)})),{c(){t=oe("li"),Ne(n.$$.fragment),a=me()},m(e,o){ae(e,t,o),Se(n,t,null),re(t,a),r=!0},p(t,a){e=t
const r={}
256&a&&(r.$$scope={dirty:a,ctx:e}),n.$set(r)},i(e){r||(Ae(n.$$.fragment,e),r=!0)},o(e){xe(n.$$.fragment,e),r=!1},d(e){e&&te(t),Me(n)}}}function ys(e){let t,n,a=le(De(16,e[0])),r=[]
for(let t=0;t<a.length;t+=1)r[t]=ks(vs(e,a,t))
const o=e=>xe(r[e],1,1,(()=>{r[e]=null}))
return{c(){t=oe("ul")
for(let e=0;e<r.length;e+=1)r[e].c()
ue(t,"class","svelte-1k3xw12")},m(e,a){ae(e,t,a)
for(let e=0;e<r.length;e+=1)r[e]&&r[e].m(t,null)
n=!0},p(e,[n]){if(7&n){let s
for(a=le(De(16,e[0])),s=0;s<a.length;s+=1){const o=vs(e,a,s)
r[s]?(r[s].p(o,n),Ae(r[s],1)):(r[s]=ks(o),r[s].c(),Ae(r[s],1),r[s].m(t,null))}for(He(),s=a.length;s<r.length;s+=1)o(s)
Be()}},i(e){if(!n){for(let e=0;e<a.length;e+=1)Ae(r[e])
n=!0}},o(e){r=r.filter(Boolean)
for(let e=0;e<r.length;e+=1)xe(r[e])
n=!1},d(e){e&&te(t),pe(r,e)}}}function ws(e,t,n){const a=Te()
let{members:r=[]}=t
...
return{c(){t=oe("a"),n=se(o),r=se(" "),ue(t,"href",a=""+(Ie+e[6])),ue(t,"class","svelte-3priew")},m(e,a){ae(e,t,a),re(t,n),ae(e,r,a)},p(e,r){1&r&&o!==(o=e[7]+"")&&ne(n,o),1&r&&a!==(a=""+(Ie+e[6]))&&ue(t,"href",a)},d(e){e&&(te(t),te(r))}}}function gi(e){let t,n,a,r=(e[0].length||"")+"",o=le(e[0]),s=[]
for(let t=0;t<o.length;t+=1)s[t]=hi(pi(e,o,t))
return{c(){t=se(r),n=se(" Offline guild members not at relic:\n"),a=oe("div")
for(let e=0;e<s.length;e+=1)s[e].c()
ue(a,"class","missing svelte-3priew")},m(e,r){ae(e,t,r),ae(e,n,r),ae(e,a,r)
for(let e=0;e<s.length;e+=1)s[e]&&s[e].m(a,null)},p(e,[n]){if(1&n&&r!==(r=(e[0].length||"")+"")&&ne(t,r),1&n){let t
for(o=le(e[0]),t=0;t<o.length;t+=1){const r=pi(e,o,t)
s[t]?s[t].p(r,n):(s[t]=hi(r),s[t].c(),s[t].m(a,null))}for(;t<s.length;t+=1)s[t].d(1)
s.length=o.length}},i:he,o:he,d(e){e&&(te(t),te(n),te(a)),pe(s,e)}}}function vi(e,t,n){let{members:a=[]}=t,r=[]
const o=[({username:e})=>!a.includes(e),({last_login:e})=>e,({last_login:e})=>e<Oe(),({last_login:e})=>e>We(),({level:e})=>e<400||e>421,({level:e})=>e<441||e>450],s=e=>o.every((t=>t(e))),i=({username:e},{username:t})=>qe(e,t)
...
return n=new Cs({props:{members:e[10]}}),n.$on("buffBatch",e[11]),{c(){t=oe("div"),Ne(n.$$.fragment),ue(t,"class","buff-links svelte-2rn368")},m(e,r){ae(e,t,r),Se(n,t,null),a=!0},p:he,i(e){a||(Ae(n.$$.fragment,e),a=!0)},o(e){xe(n.$$.fragment,e),a=!1},d(e){e&&te(t),Me(n)}}}function yi(e){let t,n,a,r,o,s,i,l
return{c(){t=oe("div"),t.textContent="Processing",n=me(),a=oe("div"),r=se(e[2]),o=me(),s=oe("div"),s.textContent="Assumptions",i=me(),l=oe("div"),l.textContent="Above calculations include Constitution, Fortitude, Nightmare Visage,\n        Chi Strike, Sanctuary, Terrorize and Flinch bonus calculations (in that\n        order) on both the defending group and attacking group.",ue(t,"class","b-top svelte-2rn368"),ue(a,"class","proc-stat svelte-2rn368"),ue(s,"class","b-top svelte-2rn368"),ue(l,"class","assume svelte-2rn368")},m(e,c){ae(e,t,c),ae(e,n,c),ae(e,a,c),re(a,r),ae(e,o,c),ae(e,s,c),ae(e,i,c),ae(e,l,c)},p(e,t){4&t&&ne(r,e[2])},d(e){e&&(te(t),te(n),te(a),te(o),te(s),te(i),te(l))}}}function wi(e){let t,n,a
return{c(){t=oe("button"),t.textContent="Fetch Stats",ue(t,"class","custombutton"),ue(t,"type","button")},m(r,o){ae(r,t,o),n||(a=ve(t,"click",e[12]),n=!0)},p:he,d(e){e&&te(t),n=!1,a()}}}function Ci(e){let t,n,a,r,o,s,i,l,c,u,f,d,m,p,h,g,v,b,k,y,w,C,$,L,V,D,M,x,A,S,N,H,B,T,E,G,P,j,R,_,F,I,O,W,q,K,Y,z,U,Q,J,X,Z,ee,ie,le,ce,fe,de,pe,he,ge,ve,be,ke,ye,we,Ce,$e,Le,Ve,De,He,Be,Te,Ee,Ge,Pe,je,Re,_e,Fe,Ie,Oe,We,qe,Ke,Ye,ze,Ue,Qe,Je,Xe,Ze,et,tt,nt,at,rt,ot,st,it,lt,ct,ut,ft,dt,mt,pt,ht,gt,vt,bt,kt,yt,wt,Ct,$t,Lt,Vt,Dt,Mt,xt,At,St,Nt,Ht,Bt,Tt,Et,Gt,Pt,jt,Rt,_t,Ft,It,Ot,Wt,qt,Kt,Yt,zt,Ut,Qt,Jt,Xt,Zt,en,tn,nn,an,rn,on,sn=e[3].noOfRelics+"",ln=e[3].leadDefenderBonus+"",cn=e[5].attackValue+"",un=e[6].attack+"",fn=e[5].defenseValue+"",dn=e[6].defense+"",mn=e[5].armorValue+"",pn=e[6].armor+"",hn=e[5].damageValue+"",gn=e[6].damage+"",vn=e[5].hpValue+"",bn=e[6].hp+"",kn=e[5].cloaked+"",yn=e[6].dc225+"",wn=e[6].dc175+"",Cn=e[8].attack+"",$n=e[9].attack+"",Ln=e[8].defense+"",Vn=e[9].defense+"",Dn=e[8].armor+"",Mn=e[9].armor+"",xn=e[8].damage+"",An=e[9].damage+"",Sn=e[8].hp+"",Nn=e[9].hp+""
return rn=new bi({props:{members:e[10]}}),{c(){t=oe("div"),n=oe("div"),n.textContent="Defending Guild Stats",a=me(),r=oe("div"),o=oe("div"),o.textContent="Relic Count:",s=me(),i=oe("div"),l=se(sn),c=me(),u=oe("div"),u.textContent="Lead Defender Bonus:",f=me(),d=oe("div"),m=se(ln),p=me(),h=oe("div"),h.textContent="Lead Defender Cloaked:",g=me(),v=oe("div"),b=se(e[4]),k=me(),y=oe("div"),y.textContent="Other Defender Stats",w=me(),C=oe("div"),$=oe("div"),$.textContent="Raw Attack:",L=me(),V=oe("div"),D=se(cn),M=me(),x=oe("div"),x.textContent="Attack w/ buffs:",A=me(),S=oe("div"),N=se(un),H=me(),B=oe("div"),B.textContent="Raw Defense:",T=me(),E=oe("div"),G=se(fn),P=me(),j=oe("div"),j.textContent="Defense w/buffs:",R=me(),_=oe("div"),F=se(dn),I=me(),O=oe("div"),O.textContent="Raw Armor:",W=me(),q=oe("div"),K=se(mn),Y=me(),z=oe("div"),z.textContent="Armor w/ buffs:",U=me(),Q=oe("div"),J=se(pn),X=me(),Z=oe("div"),Z.textContent="Raw Damage:",ee=me(),ie=oe("div"),le=se(hn),ce=me(),fe=oe("div"),fe.textContent="Damage w/ buffs:",de=me(),pe=oe("div"),he=se(gn),ge=me(),ve=oe("div"),ve.textContent="Raw HP:",be=me(),ke=oe("div"),ye=se(vn),we=me(),Ce=oe("div"),Ce.textContent="HP w/ buffs:",$e=me(),Le=oe("div"),Ve=se(bn),De=me(),He=oe("div"),He.textContent="Cloaked:",Be=me(),Te=oe("div"),Ee=se(kn),Ge=me(),Pe=oe("div"),Pe.textContent="Processed:",je=me(),Re=oe("div"),_e=se(e[7]),Fe=me(),Ie=oe("div"),Oe=oe("div"),Oe.textContent="Adjusted Defense Values",We=me(),qe=oe("div"),Ke=oe("div"),Ke.textContent="DC225:",Ye=me(),ze=oe("div"),Ue=se(yn),Qe=me(),Je=oe("div"),Je.textContent="DC175:",Xe=me(),Ze=oe("div"),et=se(wn),tt=me(),nt=oe("div"),nt.textContent=" ",at=me(),rt=oe("div"),rt.textContent="Attacking Group Stats",ot=me(),st=oe("div"),it=oe("div"),it.textContent="Raw Group Attack:",lt=me(),ct=oe("div"),ut=se(Cn),ft=me(),dt=oe("div"),dt.textContent="Group Attack w/ buffs:",mt=me(),pt=oe("div"),ht=se($n),gt=me(),vt=oe("div"),vt.textContent="Raw Group Defense:",bt=me(),kt=oe("div"),yt=se(Ln),wt=me(),Ct=oe("div"),Ct.textContent="Group Defense w/ buffs:",$t=me(),Lt=oe("div"),Vt=se(Vn),Dt=me(),Mt=oe("div"),Mt.textContent="Raw Group Armor:",xt=me(),At=oe("div"),St=se(Dn),Nt=me(),Ht=oe("div"),Ht.textContent="Group Armor w/ buffs:",Bt=me(),Tt=oe("div"),Et=se(Mn),Gt=me(),Pt=oe("div"),Pt.textContent="Raw Group Damage:",jt=me(),Rt=oe("div"),_t=se(xn),Ft=me(),It=oe("div"),It.textContent="Group Damage w/ buffs:",Ot=me(),Wt=oe("div"),qt=se(An),Kt=me(),Yt=oe("div"),Yt.textContent="Raw Group HP:",zt=me(),Ut=oe("div"),Qt=se(Sn),Jt=me(),Xt=oe("div"),Xt.textContent="Group HP w/ buffs:",Zt=me(),en=oe("div"),tn=se(Nn),nn=me(),an=oe("div"),Ne(rn.$$.fragment),ue(n,"class","b-top svelte-2rn368"),ue(o,"class","svelte-2rn368"),ue(i,"class","svelte-2rn368"),ue(u,"class","svelte-2rn368"),ue(d,"class","svelte-2rn368"),ue(h,"class","svelte-2rn368"),ue(v,"class","svelte-2rn368"),ue(r,"class","stat-grid svelte-2rn368"),ue(y,"class","b-top svelte-2rn368"),ue($,"class","svelte-2rn368"),ue(V,"class","svelte-2rn368"),ue(x,"class","svelte-2rn368"),ue(S,"class","svelte-2rn368"),ue(B,"class","svelte-2rn368"),ue(E,"class","svelte-2rn368"),ue(j,"class","svelte-2rn368"),ue(_,"class","svelte-2rn368"),ue(O,"class","svelte-2rn368"),ue(q,"class","svelte-2rn368"),ue(z,"class","svelte-2rn368"),ue(Q,"class","svelte-2rn368"),ue(Z,"class","svelte-2rn368"),ue(ie,"class","svelte-2rn368"),ue(fe,"class","svelte-2rn368"),ue(pe,"class","svelte-2rn368"),ue(ve,"class","svelte-2rn368"),ue(ke,"class","svelte-2rn368"),ue(Ce,"class","svelte-2rn368"),ue(Le,"class","svelte-2rn368"),ue(He,"class","svelte-2rn368"),ue(Te,"class","svelte-2rn368"),ue(Pe,"class","svelte-2rn368"),ue(Re,"class","svelte-2rn368"),ue(C,"class","stat-grid svelte-2rn368"),ue(t,"class","middle svelte-2rn368"),ue(Oe,"class","b-top svelte-2rn368"),ue(Ke,"class","svelte-2rn368"),ue(ze,"class","svelte-2rn368"),ue(Je,"class","svelte-2rn368"),ue(Ze,"class","svelte-2rn368"),ue(nt,"class","svelte-2rn368"),ue(qe,"class","stat-grid svelte-2rn368"),ue(rt,"class","b-top svelte-2rn368"),ue(it,"class","svelte-2rn368"),ue(ct,"class","svelte-2rn368"),ue(dt,"class","svelte-2rn368"),ue(pt,"class","svelte-2rn368"),ue(vt,"class","svelte-2rn368"),ue(kt,"class","svelte-2rn368"),ue(Ct,"class","svelte-2rn368"),ue(Lt,"class","svelte-2rn368"),ue(Mt,"class","svelte-2rn368"),ue(At,"class","svelte-2rn368"),ue(Ht,"class","svelte-2rn368"),ue(Tt,"class","svelte-2rn368"),ue(Pt,"class","svelte-2rn368"),ue(Rt,"class","svelte-2rn368"),ue(It,"class","svelte-2rn368"),ue(Wt,"class","svelte-2rn368"),ue(Yt,"class","svelte-2rn368"),ue(Ut,"class","svelte-2rn368"),ue(Xt,"class","svelte-2rn368"),ue(en,"class","svelte-2rn368"),ue(st,"class","stat-grid svelte-2rn368"),ue(Ie,"class","right svelte-2rn368"),ue(an,"class","bottom b-top svelte-2rn368")},m(e,te){ae(e,t,te),re(t,n),re(t,a),re(t,r),re(r,o),re(r,s),re(r,i),re(i,l),re(r,c),re(r,u),re(r,f),re(r,d),re(d,m),re(r,p),re(r,h),re(r,g),re(r,v),re(v,b),re(t,k),re(t,y),re(t,w),re(t,C),re(C,$),re(C,L),re(C,V),re(V,D),re(C,M),re(C,x),re(C,A),re(C,S),re(S,N),re(C,H),re(C,B),re(C,T),re(C,E),re(E,G),re(C,P),re(C,j),re(C,R),re(C,_),re(_,F),re(C,I),re(C,O),re(C,W),re(C,q),re(q,K),re(C,Y),re(C,z),re(C,U),re(C,Q),re(Q,J),re(C,X),re(C,Z),re(C,ee),re(C,ie),re(ie,le),re(C,ce),re(C,fe),re(C,de),re(C,pe),re(pe,he),re(C,ge),re(C,ve),re(C,be),re(C,ke),re(ke,ye),re(C,we),re(C,Ce),re(C,$e),re(C,Le),re(Le,Ve),re(C,De),re(C,He),re(C,Be),re(C,Te),re(Te,Ee),re(C,Ge),re(C,Pe),re(C,je),re(C,Re),re(Re,_e),ae(e,Fe,te),ae(e,Ie,te),re(Ie,Oe),re(Ie,We),re(Ie,qe),re(qe,Ke),re(qe,Ye),re(qe,ze),re(ze,Ue),re(qe,Qe),re(qe,Je),re(qe,Xe),re(qe,Ze),re(Ze,et),re(qe,tt),re(qe,nt),re(Ie,at),re(Ie,rt),re(Ie,ot),re(Ie,st),re(st,it),re(st,lt),re(st,ct),re(ct,ut),re(st,ft),re(st,dt),re(st,mt),re(st,pt),re(pt,ht),re(st,gt),re(st,vt),re(st,bt),re(st,kt),re(kt,yt),re(st,wt),re(st,Ct),re(st,$t),re(st,Lt),re(Lt,Vt),re(st,Dt),re(st,Mt),re(st,xt),re(st,At),re(At,St),re(st,Nt),re(st,Ht),re(st,Bt),re(st,Tt),re(Tt,Et),re(st,Gt),re(st,Pt),re(st,jt),re(st,Rt),re(Rt,_t),re(st,Ft),re(st,It),re(st,Ot),re(st,Wt),re(Wt,qt),re(st,Kt),re(st,Yt),re(st,zt),re(st,Ut),re(Ut,Qt),re(st,Jt),re(st,Xt),re(st,Zt),re(st,en),re(en,tn),ae(e,nn,te),ae(e,an,te),Se(rn,an,null),on=!0},p(e,t){(!on||8&t)&&sn!==(sn=e[3].noOfRelics+"")&&ne(l,sn),(!on||8&t)&&ln!==(ln=e[3].leadDefenderBonus+"")&&ne(m,ln),(!on||16&t)&&ne(b,e[4]),(!on||32&t)&&cn!==(cn=e[5].attackValue+"")&&ne(D,cn),(!on||64&t)&&un!==(un=e[6].attack+"")&&ne(N,un),(!on||32&t)&&fn!==(fn=e[5].defenseValue+"")&&ne(G,fn),(!on||64&t)&&dn!==(dn=e[6].defense+"")&&ne(F,dn),(!on||32&t)&&mn!==(mn=e[5].armorValue+"")&&ne(K,mn),(!on||64&t)&&pn!==(pn=e[6].armor+"")&&ne(J,pn),(!on||32&t)&&hn!==(hn=e[5].damageValue+"")&&ne(le,hn),(!on||64&t)&&gn!==(gn=e[6].damage+"")&&ne(he,gn),(!on||32&t)&&vn!==(vn=e[5].hpValue+"")&&ne(ye,vn),(!on||64&t)&&bn!==(bn=e[6].hp+"")&&ne(Ve,bn),(!on||32&t)&&kn!==(kn=e[5].cloaked+"")&&ne(Ee,kn),(!on||128&t)&&ne(_e,e[7]),(!on||64&t)&&yn!==(yn=e[6].dc225+"")&&ne(Ue,yn),(!on||64&t)&&wn!==(wn=e[6].dc175+"")&&ne(et,wn),(!on||256&t)&&Cn!==(Cn=e[8].attack+"")&&ne(ut,Cn),(!on||512&t)&&$n!==($n=e[9].attack+"")&&ne(ht,$n),(!on||256&t)&&Ln!==(Ln=e[8].defense+"")&&ne(yt,Ln),(!on||512&t)&&Vn!==(Vn=e[9].defense+"")&&ne(Vt,Vn),(!on||256&t)&&Dn!==(Dn=e[8].armor+"")&&ne(St,Dn),(!on||512&t)&&Mn!==(Mn=e[9].armor+"")&&ne(Et,Mn),(!on||256&t)&&xn!==(xn=e[8].damage+"")&&ne(_t,xn),(!on||512&t)&&An!==(An=e[9].damage+"")&&ne(qt,An),(!on||256&t)&&Sn!==(Sn=e[8].hp+"")&&ne(Qt,Sn),(!on||512&t)&&Nn!==(Nn=e[9].hp+"")&&ne(tn,Nn)},i(e){on||(Ae(rn.$$.fragment,e),on=!0)},o(e){xe(rn.$$.fragment,e),on=!1},d(e){e&&(te(t),te(Fe),te(Ie),te(nn),te(an)),Me(rn)}}}function $i(e){let t,n,a,r,o,s=e[0].is_owner&&ki(e)
function i(e,t){return e[1]?yi:wi}let l=i(e),c=l(e),u=e[1]&&Ci(e)
return{c(){t=oe("div"),n=oe("div"),s&&s.c(),a=me(),c.c(),r=me(),u&&u.c(),ue(n,"class","left svelte-2rn368"),ue(t,"class","body svelte-2rn368")},m(e,i){ae(e,t,i),re(t,n),s&&s.m(n,null),re(n,a),c.m(n,null),re(t,r),u&&u.m(t,null),o=!0},p(e,[r]){e[0].is_owner?s?(s.p(e,r),1&r&&Ae(s,1)):(s=ki(e),s.c(),Ae(s,1),s.m(n,a)):s&&(He(),xe(s,1,1,(()=>{s=null})),Be()),l===(l=i(e))&&c?c.p(e,r):(c.d(1),c=l(e),c&&(c.c(),c.m(n,null))),e[1]?u?(u.p(e,r),2&r&&Ae(u,1)):(u=Ci(e),u.c(),Ae(u,1),u.m(t,null)):u&&(He(),xe(u,1,1,(()=>{u=null})),Be())},i(e){o||(Ae(s),Ae(u),o=!0)},o(e){xe(s),xe(u),o=!1},d(e){e&&te(t),s&&s.d(),c.d(),u&&u.d()}}}function Li(e,t,n){let a,r,o,s,i,l,u,f
...
e.color=p("footprintColor"),e.Draw=Si,Ai=!0}}function Hi(){GameController?.Realm?.footprintTexture&&(Ni(),$.unsubscribe("fixed.realm",Hi))}let Bi=0
function Ti(e){$("#statbar-gold").css("background-color",e)}function Ei(){$("#HelperSendTotal").html(ht(p("currentGoldSentTotal"))),Number(GameData.player().gold)>Bi?Ti("red"):Ti("inherit")}function Gi(){Bi=p("goldAmount"),$("#statbar-gold-tooltip-general").append(`<dt class="stat-gold-sendTo">Send To:</dt><dd id="HelperSendTo">${p("goldRecipient")}</dd><dt class="stat-gold-sendAmt">Amount:</dt><dd id="HelperSendAmt">${ht(Bi)}</dd><dt class="stat-gold-sendTo">Send?</dt><dd><input id="HelperSendGold" value="Send!" class="custombutton" type="submit"><input type="hidden" id="xc" value=""</dd><dt class="stat-gold-sendTotal">Total Sent:</dt><dd id="HelperSendTotal">${ht(p("currentGoldSentTotal"))}</dd>`),$("#HelperSendGold").on("click",tt),Ei(),$.subscribe(nt,Ei)}let Pi=0,ji=0,Ri=0,_i=0,Fi=0,Ii=0
...
return{c(){t=oe("div"),n=se(e[0]),ue(t,"id","tp-overlay"),ue(t,"class","svelte-1lrosbw")},m(e,a){ae(e,t,a),re(t,n)},p(e,t){1&t&&ne(n,e[0])},d(e){e&&te(t)}}}function zi(e){let t,n=e[1]&&Yi(e)
return{c(){n&&n.c(),t=ge()},m(e,a){n&&n.m(e,a),ae(e,t,a)},p(e,[a]){e[1]?n?n.p(e,a):(n=Yi(e),n.c(),n.m(t.parentNode,t)):n&&(n.d(1),n=null)},i:he,o:he,d(e){e&&te(t),n&&n.d(e)}}}function Ui(e,t,n){let{tpButton:a}=t,r=0,o=0,s=!1
function i(){const e=GameData.player().teleportCooldown
n(0,r=e-rt()+o),r>0||(clearInterval(s),n(1,s=!1),a.classList.remove("cooldown"))}return window.$.subscribe("stats.player",i),window.$.subscribe(ot,(function(e,t){o=rt(),i(),s||0!==t.response.response||n(1,s=setInterval((()=>{i()}),1e3))})),e.$$set=e=>{"tpButton"in e&&n(2,a=e.tpButton)},[r,s,a]}class Qi extends X{constructor(e){super(),Z(this,e,Ui,zi,ee,{tpButton:2})}}function Ji(e){return e.numberOfCreatureHitsTillDead-e.numberOfHitsRequired<=1?", dies on miss":", survives a miss"}function Xi(e,t){return"-"===t?e:"-"===e||e>t?"-":e}const Zi=[[e=>"-"===e.playerHits&&"-"===e.creatureHits,()=>"Unresolved"],[e=>"-"===e.playerHits,()=>"Player dies"],[e=>1===e.playerHits,e=>`Player 1 hits${Ji(e)}`],[e=>e.playerHits>1,e=>`Player > 1 hits${Ji(e)}`]]
...
const e=t.doNotKillList.indexOf(Rl);-1===e?t.doNotKillList.push(Rl):t.doNotKillList.splice(e,1),Il(),w("doNotKillList",t.doNotKillList.join()),fr()}function Wl(){_l?Il():function(){_l=bt({className:"fshBl",textContent:Fl()})
...
const n=s(Dc,e)
$.subscribe(d,n),t.showHuntingBuffs&&window.initialGameData&&n(null,{b:window.initialGameData.player.buffs})}(e),oc=p("hidePlayerActions"),$.subscribe(U,ic),ic()},function(){Ze(),et()&&Gi()},function(){$.subscribe(st,rc)},function(){Hr.forEach(Br)},function(){p("enableCreatureColoring")&&o(document.body,Vt("#actionList .creature-1 {color: green;}\n#actionList .creature-2 {color: yellow;}\n#actionList .creature-3 {color: red;}"))},function(){$.subscribe(U,fr),fr(),function(){const e=GameData.doAction
GameData.doAction=pr(e)}()},function(){zr(),$.subscribe("-1-success.action-response 4-success.action-response 5-success.action-response 25-success.action-response",Zr),Zr()},function(){$.subscribe(Ue,xi)},async function(){if(p("keepLogs")){!function(e){e&&($a=e),$.subscribe(N,xa)}(await S("fsh_combatLog"))}},function(){window.initialGameData&&gs(0,window.initialGameData),$.subscribe(`${Le} ${Ve}`,gs)},function(){$.subscribe(at,Ki)},function(){$.subscribe(ze,Mi)},function(){$("#messageCenter").worldMessageCenter({offset:"0 60"})},function(){h("#mapTooltip")},function(){ca(),$.subscribe(L,ua),$.subscribe(V,fa)},function(){_n(),$.subscribe(`${d} ${m}`,_n)},function(){y(a("actionList"),"mouseover",lr)},function(){const{body:e}=document
y(e,"keydown",ya),y(e,"keyup",wa)},function(){const e=$("#world-event-badge")
e.length&&(e.off(),l(e[0],Sr))},function(){const e=M(".actionListHeaderButton.teleport")
!function(e,t){new Qi({target:e,props:t})}(e,{tpButton:e})},function(){var e
p("messageStack")&&(e=a("messageCenter"),new Rr({target:e}))},function(){GameController?.Realm?.footprintTexture?Ni():$.subscribe("fixed.realm",Hi)}]
function Pc(){e(Gc)}export{Pc as default}
//# sourceMappingURL=newMap-RGW3Szrq.js.map
