...
import{ax as t,u as a,g as n,b5 as r,k as s,aP as o,i,aC as l,aL as c,c as u,a1 as d,ap as f,o as m,s as v,b6 as p,b7 as h,ac as b,b8 as g,b9 as k,ba as y,bb as w,a4 as L,b as C,az as D,bc as V,aS as M,bd as A,be as S,bf as N,bg as H,au as B,h as x,bh as T,q as E,bi as G,bj as P,f as R,aa as F,bk as _,bl as O,bm as I,bn as j,bo as W,bp as q,bq as K,br as Y,bs as z,bt as U,bu as Q,bv as J,aA as X,l as Z,bw as ee,bx as te,by as ae,U as ne,$ as re,x as se,aE as oe,C as ie,aD as le,A as ce,O as ue,P as de,I as fe,D as me,K as ve,F as pe,bz as he,B as be,E as ge,bA as ke,L as ye,R as we,bB as $e,bC as Le,ak as Ce,n as De,ao as Ve,aj as Me,bD as Ae,H as Se,bE as Ne,bF as He,bG as Be,bH as xe,bI as Te,d as Ee,aI as Ge,bJ as Pe,bK as Re,bL as Fe,bM as _e,y as Oe,bN as Ie,ab as je,bO as We,bP as qe,bQ as Ke,bR as Ye,av as ze,bS as Ue,bT as Qe,_ as Je,bU as Xe,bV as Ze,bW as et,bX as tt,bY as at,bZ as nt,b_ as rt,b$ as st,c0 as ot,c1 as it,c2 as lt,c3 as ct,c4 as ut,c5 as dt,c6 as ft,c7 as mt,c8 as vt,c9 as pt,ca as ht,cb as bt,cc as gt,cd as kt,ce as yt,cf as wt,cg as $t,ch as Lt,ci as Ct,cj as Dt,ck as Vt,ay as Mt,cl as At}from"./calfSystem-UyQ_FKFu.js"
import{t as St}from"./toggleForce-br4z9gGd.js"
import{r as Nt,a as Ht}from"./roundToString-C-C1er7O.js"
import{d as Bt,q as xt}from"./quickbuffSuccess-aY3QedOF.js"
import{c as Tt}from"./createInput-B13zWypd.js"
import{c as Et}from"./createLabel-BjAqmNH0.js"
import{c as Gt}from"./idbLogger-EimdfDvd.js"
import{r as Pt}from"./rnd-D_QmA-Fa.js"
import{c as Rt}from"./createStyle-BGl-LDQE.js"
import{c as Ft}from"./createTable-G8d3zByz.js"
import{t as _t,g as Ot,a as It}from"./getTitanString-DrmoKrfx.js"
import{r as jt}from"./reduceBuffArray-Diy1E3zc.js"
import{r as Wt}from"./reliclist-DXsP1Yis.js"
import{d as qt}from"./daGroupStats-Dc8IDNHK.js"
import{d as Kt,m as Yt}from"./mercEffect-ea-09CIU.js"
import{a as zt}from"./attribsToArray-eOBu3Asu.js"
import{r as Ut}from"./remainingPages-BUotk4St.js"
import{t as Qt}from"./testQuant-Bt3ot4ij.js"
import{s as Jt,j as Xt}from"./simpleCheckbox-C_yEWmPy.js"
import{i as Zt}from"./isSelected-BWnMzKlW.js"
import{b as ea}from"./bitwiseAnd-C5gmj-aX.js"
import"./buffReportParser-tKQU5Jtr.js"
import"./buffObj-BIwiFUIW.js"
import"./view-DONKmy1W.js"
...
An=GameData.player().level,e=n("statbar-character-tooltip-stats"),Nn=Fn(e,q),Sn=Fn(e,K),Bn=Fn(e,Y),Hn=Fn(e,z),xn=Fn(e,U)}const On=e=>`<td>${e}:&nbsp;</td>`,In=e=>`<td width="40%">${e}</td>`
function jn([e,t,a,n,r]){return[On(e),In(`${t} (your ${a}:<span class="${n}">${r()}</span>)`)]}function Wn(e){return["<tr>",...e,"</tr>"].join("")}function qn(e,t){return Wn([...jn(e),...jn(t)])}function Kn(e){return`<tr><td colspan="2">${e.name}:</td><td colspan="2">${e.value}</td></tr>`}function Yn(e,t,a){return function(e){return`<table><tr><td><img src="${G}creatures/${e.image_id}.png" height="200" width="200"></td><td rowspan="2"><table width="400"><tr><td class="header" colspan="4" class="fshCenter">Statistics</td></tr>`}(e)+function(e,t){return Wn([On("Class"),In(e.creature_class),...jn(["Level",e.level,"level",t,Tn])])}(e,a)+function(e){return qn(["Attack",e.attack,"defense","fshYellow",En],["Defense",e.defense,"attack","fshYellow",Gn])}(e)+function(e){return qn(["Armor",e.armor,"damage","fshYellow",Pn],["Damage",e.damage,"armor","fshYellow",Rn])}(e)+function(e,t){return Wn([On("HP"),In(`${e.hp} (your HP:<span class="fshYellow">${xn}</span>)(1H: <span class="fshRed">${t}</span>)`),On("Gold"),In(e.gold)])}(e,t)+'<tr><td colspan="4" height="5"></td></tr><tr><td class="header" colspan="4" class="fshCenter">Enhancements</td></tr>'+function(e){return 0===e.enhancements.length?'<tr><td colspan="4">[no enhancements]</td></tr>':e.enhancements.map(Kn).join("")}(e)+function(e){return`<tr><td colspan="4" height="5"></td></tr><tr><td class="header" colspan="4" class="fshCenter">Description</td></tr><tr><td colspan="4">${e.description}</td></tr><tr><td colspan="4" height="5"></td></tr></table></td></tr><tr><td class="fshCenter"><b>${e.name}</b></td></tr></table>`}(e)}function zn(e){if(!$n(e))return function(e){const a=Math.ceil(e.hp*t.hpVariable+e.armor*t.generalVariable)
let n="fshYellow"
...
return a&&(n.className="fshBlue"),function(e,t){t.forEach(u(Fr,e))}(n,t),n}function Or(e,t){_r(e,t[0],t[1])}function Ir(e,t){t.forEach(u(Or,e))}let jr=0,Wr=0,qr=0,Kr=0,Yr=0,zr=0,Ur=0,Qr=0
const Jr=()=>jr,Xr=()=>Ur
...
As=a({className:"fshActionBox titanInfo"}),gs(),ks=Ft({className:"fshCenter"}),Zr(),Ir(ks,[Ls,Cs,Ds,[[[2,Jr,!0],[4,u($s,vs())]],!0],[[[2,Xr,!0],[4,u($s,ps())]],!0],Vs,[[[6,bs]]],Ms]),i(As,ys()),i(e,As)}}function Ts(e){return e<=0?'<span class="fshGreen cooldown">No active cooldown</span>':`<span class="fshMaroon cooldown">Cooldown until: ${function(e){const t=new Date(Ge()+1e3*e)
return`${Pe(t.getHours())}:${Pe(t.getMinutes())} ${Pe(t.getDate())}/${Re[t.getMonth()]}/${t.getFullYear()}`}(e)}</span>`}function Es(e){return Ht(It(e.max_hp-e.current_hp,e.kills),2)}function Gs(e){return Ht(100*e.kills/e.max_hp,2)}function Ps(e){!function(e){[[_t(e.creature.name),cs],[Ns,us],[e.current_hp,ds],[e.max_hp,fs],[e.kills,ms],[Es(e),vs],[Gs(e),ps]].forEach(([e,t])=>s(e,t()))}(e),Ee(function(e){return Ot(e.kills,e.max_hp,e.current_hp)}(e),hs()),Ee(Ts(e.cooldown),bs())}function Rs(e,t){return[[[2,()=>Fa(t.player.name)],[2,()=>Fa(t.kills.toString())],[2,()=>Fa(`${Ht(100*t.kills/e.kills,2)}%`)]]]}function Fs(e){return e.realm&&e.creature.base_id===Ss&&e.realm===Pr}function _s(e){const t=e.find(Fs)
...
function js(e,t){(e=>e?.s&&b(e.r))(t)&&(_s(t.r),Is(GameData.realm().dynamic)?Os=window.setTimeout(e,3e4):Hs())}async function Ws(){js(Ws,await re(Rr))}function qs(e){Os&&(window.clearTimeout(Os),Os=null),Is(e)?(xs(),Ws()):Hs()}function Ks(e){var t
...
const[a,n]=ct(),r=()=>ut(Eo,"$relicDisplay",a),s=()=>ut(Po,"$rawDefDisplay",a),o=()=>ut(Fo,"$defBuffedDisplay",a),i=()=>ut(Oo,"$rawGroupDisplay",a),l=()=>ut(Io,"$buffResultDisplay",a)
...
var w=be(p,2),$=e=>{var t=Qo(),n=ie(t),c=be(me(n),2),d=be(me(c),2),f=me(d),m=be(d,4),v=me(m),p=be(m,4),h=me(p),b=be(c,4),g=be(me(b),2),k=me(g),y=be(g,4),w=me(y),$=be(y,4),L=me($),C=be($,4),D=me(C),V=be(C,4),M=me(V),A=be(V,4),S=me(A),N=be(A,4),H=me(N),B=be(N,4),x=me(B),T=be(B,4),E=me(T),G=be(T,4),P=me(G),R=be(G,4),F=me(R),_=be(R,4),O=me(_),I=be(n,2),j=be(me(I),2),W=be(me(j),2),q=me(W),K=be(W,4),Y=me(K),z=be(j,4),U=be(me(z),2),Q=me(U),J=be(U,4),X=me(J),Z=be(J,4),ee=me(Z),te=be(Z,4),ae=me(te),ne=be(te,4),re=me(ne),se=be(ne,4),oe=me(se),le=be(se,4),ce=me(le),fe=be(le,4),pe=me(fe),he=be(fe,4),ge=me(he),ke=be(he,4),ye=me(ke),we=be(I,2)
qo(me(we),{get members(){return u}}),ue(()=>{de(f,r().noOfRelics),de(v,r().leadDefenderBonus),de(h,ut(Go,"$ldcloak",a)),de(k,s().attackValue),de(w,o().attack),de(L,s().defenseValue),de(D,o().defense),de(M,s().armorValue),de(S,o().armor),de(H,s().damageValue),de(x,o().damage),de(E,s().hpValue),de(P,o().hp),de(F,s().cloaked),de(O,ut(Ro,"$processed",a)),de(q,o().dc225),de(Y,o().dc175),de(Q,i().attack),de(X,l().attack),de(ee,i().defense),de(ae,l().defense),de(re,i().armor),de(oe,l().armor),de(ce,i().damage),de(pe,l().damage),de(ge,i().hp),de(ye,l().hp)}),ve(e,t)}
...
n.length>0?Pl(e,n):Rl(e)}(e,a):Rl(e)}function _l(e,t,a){Vl()&&Fl(e,a)}function Ol(e,t){return 6!==t.type||(0!==t.data.creature_type||t.data.level>=e)}function Il(e){const t=O(e)
...
//# sourceMappingURL=newMap-4rkwZM3z.js.map
