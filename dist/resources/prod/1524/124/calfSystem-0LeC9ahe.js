...
var L=i,E=function(){function e(e,t){this.contents=e,this.breadcrumbsLimit=t}return e.create=function(t,n){return new e(t,n)},e.prototype.available=function(){return!0},e.prototype.getContents=function(e){var t=e?this.contents[e]:this.contents
...
var F=i,W=S,Q=O,z=N,J=/,|\s+/,K=/\S/,X=function(){function e(e,t){void 0===e&&(e={}),this.__pluginsLoaded=!1,this.__store=null,this.__beforeNotifyHandlers=[],this.__afterNotifyHandlers=[],this.__notifier={name:"@honeybadger-io/core",url:"https://github.com/honeybadger-io/honeybadger-js/tree/master/packages/core",version:"6.9.3"},this.config=U(U({},z.CONFIG),e),this.__initStore(),this.__transport=t,this.__eventsLogger=new Q.ThrottledEventsLogger(this.config,this.__transport),this.logger=(0,F.logger)(this)}return e.prototype.getVersion=function(){return this.__notifier.version},e.prototype.getNotifier=function(){return this.__notifier},e.prototype.setNotifier=function(e){this.__notifier=e},e.prototype.configure=function(e){for(var t in void 0===e&&(e={}),e)this.config[t]=e[t]
...
function Te(e){return void 0===e&&(e=Ce()),{load:function(t){function n(e){return!0===t.config.breadcrumbsEnabled||(e?!0===t.config.breadcrumbsEnabled[e]:!1!==t.config.breadcrumbsEnabled)}!function(){function o(e){return Array.isArray(e)?e.map((function(e){try{return String(e)}catch(e){return"[unknown]"}})).join(" "):""}n("console")&&Pe(e,(function(e,n){var r=o(n),a={category:"log",metadata:{level:e,arguments:Ee(n,3)}}
...
this.__hb_xhr={type:"xhr",method:r,url:o,message:a},"function"==typeof e&&e.apply(t,arguments)}})),Oe(XMLHttpRequest.prototype,"send",(function(e){return function(){var n=this
...
var u=r,l=Y,f=fe,d=c(we),p=c($e),g=c(Ne),m=c(Re),h=qe,y=u.Util.merge,b=u.Util.filter,v=u.Util.objectIsExtensible,w=u.Util.globalThisOrWindow,_=function(){var e=w(),t=""
...
var t=n.call(this,a({userFeedbackEndpoint:"https://api.honeybadger.io/v2/feedback",async:!0,maxErrors:null,projectRoot:_()},e),new h.BrowserTransport({"User-Agent":$()}))||this
...
throw o.__lastWrapErr=e,(0,f.ignoreNextOnError)(),o.addBreadcrumb(t.component?"".concat(t.component,": ").concat(e.name):e.name,{category:"error",metadata:{message:e.message,name:e.name,stack:e.stack}}),o.config.enableUncaught&&o.notify(e),e}}}return n.___hb.___hb=n.___hb,n.___hb}catch(e){return n}},r.prototype.__incrementErrorsCount=function(){return this.__errorsSent++},r.prototype.__exceedsMaxErrors=function(){return this.config.maxErrors&&this.__errorsSent>=this.config.maxErrors},r}(u.Client),x={name:"@honeybadger-io/js",url:"https://github.com/honeybadger-io/honeybadger-js/tree/master/packages/js",version:"6.9.3"},$=function(){return"undefined"!=typeof navigator?"Honeybadger JS Browser Client ".concat(x.version,"; ").concat(navigator.userAgent):"Honeybadger JS Browser Client ".concat(x.version,"; n/a; n/a")},S=new j({__plugins:[(0,f.onError)(),(0,d.default)(),(0,g.default)(),(0,m.default)(),(0,p.default)(),u.Plugins.events()]})
S.setNotifier(x)
var L=r
Object.defineProperty(t,"Types",{enumerable:!0,get:function(){return L.Types}}),t.default=S}(o)
var Ve=t(o)
return Ve}()
var E=S(L.exports)
...
const r=Tt(o,window),a=Tt(n,[])
Rt(t.bind(r,...a),e),Dt&&Gt()}}function Qt(e,t){return new URLSearchParams(e).get(t)}function zt(e){try{return Qt(decodeURIComponent(window.location.search),e)}catch(e){return N(e),""}}function Jt(){}const Kt=e=>e
...
return e}return t.dirty|r}return t.dirty}function fn(e,t,n,o,r,a){if(r){const i=un(t,n,o,a)
e.p(i,r)}}function dn(e){if(e.ctx.length>32){const t=[],n=e.ctx.length/32
...
let Yn,Zn=0
function eo(e,t,n,o,r,a,i,s=0){const c=16.666/o
let u="{\n"
...
return Yn}function ro(e){oo().$$.on_mount.push(e)}function ao(e){oo().$$.after_update.push(e)}function io(e){oo().$$.on_destroy.push(e)}function so(){const e=oo()
return(t,n,{cancelable:o=!1}={})=>{const r=e.$$.callbacks[t]
if(r){const a=Kn(t,n,{cancelable:o})
return r.slice().forEach((t=>{t.call(e,a)})),!a.defaultPrevented}return!0}}function co(e,t){const n=e.$$.callbacks[t.type]
...
function No(e,t,n,o){let r,a=t(e,n,{direction:"both"}),i=o?0:1,s=null,c=null,u=null
function l(){u&&to(e,u)}function f(e,t){const n=e.b-i
return t*=Math.abs(n),{a:i,b:e.b,d:n,duration:t,start:e.start,end:e.start+t,group:e.group}}function d(t){const{delay:n=0,duration:o=300,easing:d=Kt,tick:p=Jt,css:g}=a||To,m={start:vn()+n,b:t}
t||(m.group=Lo,Lo.r+=1),"inert"in e&&(t?void 0!==r&&(e.inert=r):(r=e.inert,e.inert=!0)),s||c?c=m:(g&&(l(),u=eo(e,i,t,o,n,d,g)),t&&p(0,1),s=f(m,o),bo((()=>$o(e,t,"start"))),function(e){let t
0===_n.size&&wn(kn),new Promise((n=>{_n.add(t={c:e,f:n})}))}((t=>{if(c&&t>c.start&&(s=f(c,o),c=null,$o(e,s.b,"start"),g&&(l(),u=eo(e,i,s.b,s.duration,0,d,a.css))),s)if(t>=s.end)p(i=s.b,1-i),$o(e,s.b,"end"),c||(s.b?l():--s.group.r||Zt(s.group.c)),s=null
else if(t>=s.start){const e=t-s.start
i=s.a+s.d*d(e/s.duration),p(i,1-i)}return!(!s&&!c)})))}return{run(e){en(a)?(_o||(_o=Promise.resolve(),_o.then((()=>{_o=null}))),_o).then((()=>{a=a({direction:e?"in":"out"}),d(e)})):d(e)},end(){l(),s=c=null}}}function Ao(e){return void 0!==e?.length?e:Array.from(e)}function Mo(e,t){e.d(1),t.delete(e.key)}function Bo(e,t){Co(e,1,1,(()=>{t.delete(e.key)}))}function Ho(e,t,n,o,r,a,i,s,c,u,l,f){let d=e.length,p=a.length,g=d
const m={}
for(;g--;)m[e[g].key]=g
...
function k(e){Po(e,1),e.m(s,l),i.set(e.key,e),l=e.first,p--}for(;d&&p;){const t=h[p-1],n=e[d-1],o=t.key,r=n.key
...
fo.forEach((o=>-1===e.indexOf(o)?t.push(o):n.push(o))),n.forEach((e=>e())),fo=t}(n.after_update),Zt(n.on_destroy),n.fragment&&n.fragment.d(t),n.on_destroy=n.fragment=null,n.ctx=[])}function Go(e,t,n,o,r,a,i=null,s=[-1]){const c=Yn
no(e)
const u=e.$$={fragment:null,ctx:[],props:a,update:Jt,not_equal:r,bound:Yt(),on_mount:[],on_destroy:[],on_disconnect:[],before_update:[],after_update:[],context:new Map(t.context||(c?c.$$.context:[])),callbacks:Yt(),dirty:s,skip_bound:!1,root:t.target||c.$$.root}
i&&i(u.root)
let l=!1
if(u.ctx=n?n(e,t.props||{},((t,n,...o)=>{const a=o.length?o[0]:n
return u.ctx&&r(u.ctx[t],u.ctx[t]=a)&&(!u.skip_bound&&u.bound[t]&&u.bound[t](a),l&&function(e,t){-1===e.$$.dirty[0]&&(uo.push(e),ho(),e.$$.dirty.fill(0)),e.$$.dirty[t/31|0]|=1<<t%31}(e,t)),n})):[],u.update(),l=!0,Zt(u.before_update),u.fragment=!!o&&o(u.ctx),t.target){if(t.hydrate){const e=function(e){return Array.from(e.childNodes)}(t.target)
...
Fo.length=0}}}function a(t){r(t(e))}return{set:r,update:a,subscribe:function(i,s=Jt){const c=[i,s]
return o.add(c),1===o.size&&(n=t(r,a)||Jt),i(e),()=>{o.delete(c),0===o.size&&n&&(n(),n=null)}}}}function Qo(e,t,n){const o=!Array.isArray(e),r=o?[e]:e
if(!r.every(Boolean))throw new Error("derived() expects stores as input, got a falsy value")
const a=t.length<2
return i=(e,n)=>{let i=!1
const s=[]
let c=0,u=Jt
const l=()=>{if(c)return
u()
const r=t(o?s[0]:s,e,n)
a?e(r):u=en(r)?r:Jt},f=r.map(((e,t)=>rn(e,(e=>{s[t]=e,c&=~(1<<t),i&&l()}),(()=>{c|=1<<t}))))
return i=!0,l(),function(){Zt(f),u(),i=!1}},{subscribe:Wo(n,i).subscribe}
var i}const zo=Wo("")
...
return{delay:t,duration:n,easing:o,css:e=>"opacity: "+e*r}}function Xo(e,{delay:t=0,duration:n=400,easing:o=Jo,x:r=0,y:a=0,opacity:i=0}={}){const s=getComputedStyle(e),c=+s.opacity,u="none"===s.transform?"":s.transform,l=c*(1-i),[f,d]=yn(r),[p,g]=yn(a)
return{delay:t,duration:n,easing:o,css:(e,t)=>`\n\t\t\ttransform: ${u} translate(${(1-e)*f}${d}, ${(1-e)*p}${g});\n\t\t\topacity: ${c-l*t}`}}function Vo(e,{delay:t=0,duration:n=400,easing:o=Jo,axis:r="y"}={}){const a=getComputedStyle(e),i=+a.opacity,s="y"===r?"height":"width",c=parseFloat(a[s]),u="y"===r?["top","bottom"]:["left","right"],l=u.map((e=>`${e[0].toUpperCase()}${e.slice(1)}`)),f=parseFloat(a[`padding${l[0]}`]),d=parseFloat(a[`padding${l[1]}`]),p=parseFloat(a[`margin${l[0]}`]),g=parseFloat(a[`margin${l[1]}`]),m=parseFloat(a[`border${l[0]}Width`]),h=parseFloat(a[`border${l[1]}Width`])
return{delay:t,duration:n,easing:o,css:e=>`overflow: hidden;opacity: ${Math.min(20*e,1)*i};${s}: ${e*c}px;padding-${u[0]}: ${e*f}px;padding-${u[1]}: ${e*d}px;margin-${u[0]}: ${e*p}px;margin-${u[1]}: ${e*g}px;border-${u[0]}-width: ${e*m}px;border-${u[1]}-width: ${e*h}px;`}}function Yo(e){let t,n,o,r,a,i,s
return{c(){t=On("div"),n=On("p"),o=Pn(e[0]),Bn(n,"class","svelte-zbl6pg"),Bn(t,"role","alert"),Bn(t,"class","svelte-zbl6pg"),Gn(t,"transform",e[2])},m(r,c){Sn(r,t,c),jn(t,n),jn(n,o),a=!0,i||(s=Nn(t,"click",e[4]),i=!0)},p(e,n){(!a||1&n)&&In(o,e[0]),4&n&&Gn(t,"transform",e[2])},i(e){a||(e&&bo((()=>{a&&(r||(r=No(t,Xo,{delay:250,duration:300,x:0,y:-100,opacity:.5},!0)),r.run(1))})),a=!0)},o(e){e&&(r||(r=No(t,Xo,{delay:250,duration:300,x:0,y:-100,opacity:.5},!1)),r.run(0)),a=!1},d(e){e&&Ln(t),e&&r&&r.end(),i=!1,s()}}}function Zo(e){let t,n=e[1]&&Yo(e)
...
n(1,a=!1),o="",e=o,zo.set(e)}),t))):n(1,a=!1)}
io((()=>clearTimeout(i)))
...
function or(e){e&&(!function(){if(!nr)nr=!0,new tr({target:document.body})}(),zo.set(e))}function rr(e,t){return Array.from(e,t)}function ar(e,t){return t?t.getElementsByTagName(e):document.getElementsByTagName(e)}function ir(e,t){return rr(ar(e,t))}function sr(e){return"string"==typeof e}function cr(e){return e.trim()}function ur(e){const t=o(e)
...
function _r(){return br||(br=n("pCL")),br}function kr(){return vr||(vr=n("pCC")),vr}function jr(){const e=ir("a",_r()).filter(function(e){return fr(lr,e)}("message"))
...
t?qr("",t):(t=Dr({id:"content",style:{display:"none"}}),Gr(document.body,t)),$(t).dialog({width:640,modal:!0,position:{my:"top",at:"top",offset:"0 60",collision:"none"},resizable:!1}),Ur("ui-dialog-titlebar-close").forEach((e=>e.blur())),e(t)}async function Wr(e){(await e).default()}function Qr(){Wr(import("./buffLog-Cz7hO1Oq.js"))}function zr(){Wr(import("./combatLog-DG8c0zj8.js"))}function Jr(){Wr(import("./creatureLog-mFoP1Cz7.js"))}function Kr(){Wr(import("./fsboxlog-Td-QA409.js"))}function Xr(){Wr(import("./guildLog-DX-HhR0d.js"))}function Vr(){Wr(import("./guildTracker-BIIhfqRA.js"))}async function Yr(e){(await import("./injectAuctionSearch-Z-fxW4lB.js")).default(e)}async function Zr(e){(await import("./findBuffs-DGclbxlg.js")).injectFindBuffs(e)}async function ea(e){(await import("./findBuffs-DGclbxlg.js")).injectFindOther(e)}async function ta(e){(await import("./injectOnlinePlayers-3esFgTZE.js")).default(e)}function na(){Wr(import("./potReport-DdpISNok.js"))}function oa(){Wr(import("./quickExtract-CVwbl6V9.js"))}function ra(){Wr(import("./quickLinksManager-_yekdw0D.js"))}async function aa(e){(await import("./quickWear-BCj9snT6.js")).default(e)}function ia(){Wr(import("./recipeMgr-DW__N7cm.js"))}function sa(){Wr(import("./reliclist-Ccwn6uef.js"))}function ca(){Wr(import("./superelite-bXWz_Yab.js"))}function ua(e){return new Promise((t=>{setTimeout(t,e)}))}function la(e){return e.data?(delete e.data.fshrnd,$.param(e.data)):e.url}class fa extends Error{constructor([e,t,n,o],...r){super(function(e,t,n,o){const r=`${t.status} ${t.statusText} - `
if(t.statusText===o.toString())return r+la(e)
const a=`${r+n} ${o} - ${la(e)}`
return"parsererror"===n?`${a} - ${t.responseText}`:a}(e,t,n,o),...r),Error.captureStackTrace&&Error.captureStackTrace(this,fa),this.jqSettings=e,this.jqXhr=t,this.jqTextStatus=n,this.jqErrorThrown=o}}function da(e){A(window,"beforeunload",(()=>e.abort()))}const pa=900
let ma=0
const ha=5
let ya=0
async function ba(){ya<ha-$.active&&performance.now()-ma>=pa?(ya=ha-$.active,ma=performance.now()):await ua(100)}async function va(e,t=10){await async function(){for(;ya<1;)await ba()
ya-=1}()
let n=null
try{n=await function(e){const t=function(e){return"string"==typeof e?{url:e}:e}(e)
return t.beforeSend=da,$.ajax(t).fail(((e,t,n)=>{e.textStatus=t,e.errorThrown=n}))}(e)}catch(n){if(t&&n.status>500)return va(e,t-1)
!function(e,t){if(0!==t.status)throw new fa([e,t,t.textStatus,t.errorThrown])}(e,n)}return n}function wa(e){return Hr(e,{url:X,data:{no_mobile:1}}),va(e)}async function _a(e){return _(await wa({data:e,dataType:"text"}))??{r:1,m:"Server Error"}}function ka(e){return _a({cmd:"export",...e})}function ja(){return ka({inc_tagged:"1",subcmd:"guild_store"})}let xa,$a=0
function Sa(e){const t=a(/\sguildId: (?<id>\d{1,6}),/,o(e))
t&&($a=Number(t))}function La(){return $a||ir("script",document.body).forEach(Sa),$a}function Ea(e){return Rr("a",e)}function Oa(e){e instanceof Element&&e.click()}function Pa(e,t){const n=URL.createObjectURL(e),o=Ea({download:t,href:n,style:{display:"none"}})
Gr(document.body,o),Oa(o),document.body.removeChild(o),setTimeout((()=>{URL.revokeObjectURL(n)}),0)}async function Ca(e,t){return _(await va({url:"app.php",data:{browser:1,v:9,...e},dataType:"text",...t}))??{e:{code:0,message:"Server Error"},s:!1}}function Ta(e){return Ca(e,{method:"POST"})}function Na(e,t){const n=[]
for(let o=0;o<t.length;o+=e)n.push(t.slice(o,o+e))
return n}function Aa(e){return new Promise(((t,n)=>{e.oncomplete=e.onsuccess=()=>t(e.result),e.onabort=e.onerror=()=>n(e.error)}))}function Ma(){return xa||(xa=function(e,t){const n=indexedDB.open(e)
n.onupgradeneeded=()=>n.result.createObjectStore(t)
const o=Aa(n)
return(e,n)=>o.then((o=>n(o.transaction(t,e).objectStore(t))))}("keyval-store","keyval")),xa}const Ba=e=>{e&&"NotFoundError"!==e.name&&E.notify(e)}
async function Ha(e,t){try{return await function(e,t=Ma()){return t("readonly",(t=>Aa(t.get(e))))}(e,t)}catch(e){Ba(e)}}async function Ra(e,t,n){try{return await function(e,t,n=Ma()){return n("readwrite",(n=>(n.put(t,e),Aa(n.transaction))))}(e,t,n)}catch(e){Ba(e)}}const Da=({folder_id:e})=>-2!==(e??-2),Ia=({folder_id:e})=>-2===e,Ua=({player_id:e})=>-1!==(e??-1),Ga=({player_id:e})=>e,qa=({player_id:e})=>-1===e,Fa=([e,t,n])=>Na(20,e).map((e=>[e,t,n])),Wa=e=>({inv_id:t})=>t===e.inv_id,Qa=(e,t)=>e.attributes.find((({id:e})=>e===t))?.value??0,za=(e,t)=>({...t,armor:Qa(e,2),attack:Qa(e,0),damage:Qa(e,4),defense:Qa(e,1),hp:Qa(e,3),set_name:e.set_name??""}),Ja=(e,t)=>t.forge||t.stats?.set_name,Ka=e=>e?.s?e.r.items:[],Xa=e=>[[e.filter(Da),s,0],[e.filter(Ia),s,1],[e.filter(Ua),Ga,7],[e.filter(qa),s,4]].flatMap(Fa)
function Va(e){return function(){const t=this.data(),n=e.find(Wa(t))
n?.attributes&&(t.stats=za(n,t.stats),this.invalidate())}}const Ya=async()=>await Ha(`fsh_${f.subcmd}_cache`)??[],Za=e=>Ra(`fsh_${f.subcmd}_cache`,e),ei=e=>t=>e.every((e=>e.inv_id!==t.inv_id))
async function ti(e,t,n){const o=await(r={item_id:e.map((({item_id:e})=>e)),inv_id:e.map((({inv_id:e})=>e)),p:e.map(t),t:e.map((()=>n))},Ta({cmd:"fetchitem",compare:0,...r}))
var r
return o?.s&&(o.r.items=((e,t)=>t.map(((t,n)=>({...t,inv_id:e[n].inv_id}))))(e,o.r.items),await async function(e){const t=(await Ya()).filter(ei(e))
await Za(t.concat(e))}(o.r.items)),o}const ni=(e,t)=>{return t.filter((n=rr(e.data()),e=>n.some((t=>e.inv_id===t.inv_id))))
var n}
async function oi(e){const t=e.rows(Ja),n=await async function(e){const t=await Ya(),n=ni(e,t)
return await Za(n),n}(t)
t.every(Va(n))}async function ri(e){const t=new DataTable(e)
await oi(t),t.draw()}const ai=e=>[e.item_id,e.inv_id,e.item_name,e.rarity,e.type,e.durability,e.max_durability,e.guild_tag,e.in_guide,e.player_id,e.equipped,e.craft,e.forge],ii=e=>{return[...ai(e),...(t=e.stats,[t?.attack??"",t?.defense??"",t?.armor??"",t?.hp??"",t?.damage??"",t?.stamina??"",t?.min_level??"",t?.set_name??"",t?.set_attack??"",t?.set_defense??"",t?.set_armor??"",t?.set_hp??"",t?.set_damage??""]),e.cached].join(",")
var t}
function si(e){return()=>Fr(e)}var ci=[{section:"Character",menu:[{label:"Buff Log",fn:Qr},{label:"Combat Log",fn:zr},{label:"Creature Log",fn:Jr},{label:"Recipe Manager",fn:ia},{label:"Quick Links",fn:ra},{label:"Inventory Manager",href:`${fe}invmanagernew`}]},{section:"Actions",menu:[{label:"Find Buffs",fn:si(Zr)},{label:"Find Other",fn:si(ea)},{label:"Online Players",fn:si(ta)},{label:"AH Quick Search",fn:si(Yr)}]},{section:"Guild",menu:[{label:"Guild Inventory",href:`${fe}guildinvmgr`},{label:"New Guild Log",fn:Xr},{label:"Merc Hunter",fn:function(){Wr(import("./mercs-C0xOSGy7.js"))}},{label:"Pot Report",fn:na},{label:"Guild Tracker",fn:Vr}]},{section:"Extra",menu:[{label:"Quick Extract",fn:oa},{label:"Quick Wear",fn:si(aa)},{label:"FS Box Log",fn:Kr},{label:"SE Tracker",fn:ca}]},{section:"Beta Features",menu:[{label:"Relic List",fn:sa,beta:!0},{label:"GS Export",fn:async function(){if(!La())return
const e=await ja(),t=await Ha("fsh_guildinvmgr_cache")??[],n=e.items.map((e=>t=>{const n=e.find((({inv_id:e})=>e===t.inv_id))
return n?.attributes?{...t,stats:{...t.stats,armor:Qa(n,2),attack:Qa(n,0),damage:Qa(n,4),defense:Qa(n,1),hp:Qa(n,3),set_name:n.set_name??"",...n.set_name&&{set_armor:Qa(n.set_bonuses,2)},...n.set_name&&{set_attack:Qa(n.set_bonuses,0)},...n.set_name&&{set_damage:Qa(n.set_bonuses,4)},...n.set_name&&{set_defense:Qa(n.set_bonuses,1)},...n.set_name&&{set_hp:Qa(n.set_bonuses,3)}},cached:!0}:{...t,cached:!1}})(t))
var o
Pa((o=`item_id,inv_id,item_name,rarity,type,durability,max_durability,guild_tag,in_guide,player_id,equipped,craft,forge,attack,defense,armor,hp,damage,stamina,min_level,set_name,set_attack,set_defense,set_armor,set_hp,set_damage,cached\n${(e=>e.map(ii).join("\n"))(n)}\n`,new Blob([o],{type:"text/csv"})),"gs_export.csv")},beta:!0}]},{section:"Dev Links",menu:[{label:"Combat Set Manager",fn:function(){Wr(import("./setmgr-CD7iH8Jd.js"))},beta:!0},{label:"Quest Book",fn:function(){Wr(import("./questbook-B8DrRC31.js"))}},{label:"New Quick Wear",fn:function(){Wr(import("./quickwear-rvaMuEEk.js"))}}]},{section:"FSH developer quick links",menu:[{playerId:1963510,playerName:"PointyHair"},{playerId:1674838,playerName:"Lusterless"}]}]
function ui(e,t,n){const o=e.slice()
return o[7]=t[n],o}function li(e,t,n){const o=e.slice()
return o[10]=t[n],o}function fi(e){let t,n,o,r,a
function i(){return e[5](e[10])}return{c(){t=On("button"),t.textContent="PM",n=Cn(),o=On("a"),o.textContent=`${e[10].playerName}`,Bn(t,"type","button"),Bn(t,"class","helperDevBtn svelte-1f5kv75"),Bn(o,"href",ie+"menuItem.playerId"),Bn(o,"class","svelte-1f5kv75")},m(e,s){Sn(e,t,s),Sn(e,n,s),Sn(e,o,s),r||(a=Nn(t,"click",i),r=!0)},p(t,n){e=t},d(e){e&&(Ln(t),Ln(n),Ln(o)),r=!1,a()}}}function di(e){let t,n,o
function r(){return e[4](e[10])}return{c(){t=On("a"),t.textContent=`${e[10].label}`,Bn(t,"href",e[10].href),Bn(t,"class","svelte-1f5kv75")},m(e,a){Sn(e,t,a),n||(o=Nn(t,"click",r),n=!0)},p(t,n){e=t},d(e){e&&Ln(t),n=!1,o()}}}function pi(e){let t,n,o
function r(){return e[3](e[10])}return{c(){t=On("button"),t.textContent=`${e[10].label}`,Bn(t,"type","button"),Bn(t,"class","svelte-1f5kv75")},m(e,a){Sn(e,t,a),n||(o=Nn(t,"click",r),n=!0)},p(t,n){e=t},d(e){e&&Ln(t),n=!1,o()}}}function gi(e){let t,n
let o=function(e,t){return e[10].fn?pi:e[10].href?di:e[10].playerName?fi:void 0}(e),r=o&&o(e),a=e[10].beta&&function(e){let t
return{c(){t=On("sup"),t.textContent="beta",Bn(t,"class","fshRed")},m(e,n){Sn(e,t,n)},d(e){e&&Ln(t)}}}()
return{c(){t=On("li"),r&&r.c(),n=Cn(),a&&a.c()},m(e,o){Sn(e,t,o),r&&r.m(t,null),jn(t,n),a&&a.m(t,null)},p(e,t){r&&r.p(e,t)},d(e){e&&Ln(t),r&&r.d(),a&&a.d()}}}function mi(e){let t,n,o,r,a=Ao(e[7].menu),i=[]
for(let t=0;t<a.length;t+=1)i[t]=gi(li(e,a,t))
return{c(){t=On("h2"),t.textContent=`${e[7].section}`,n=Cn(),o=On("ul")
for(let e=0;e<i.length;e+=1)i[e].c()
r=Cn(),Bn(t,"class","svelte-1f5kv75")},m(e,a){Sn(e,t,a),Sn(e,n,a),Sn(e,o,a)
for(let e=0;e<i.length;e+=1)i[e]&&i[e].m(o,null)
jn(o,r)},p(e,t){if(7&t){let n
for(a=Ao(e[7].menu),n=0;n<a.length;n+=1){const s=li(e,a,n)
i[n]?i[n].p(s,t):(i[n]=gi(s),i[n].c(),i[n].m(o,r))}for(;n<i.length;n+=1)i[n].d(1)
i.length=a.length}},d(e){e&&(Ln(t),Ln(n),Ln(o)),En(i,e)}}}function hi(e){let t,n=Ao(ci),o=[]
for(let t=0;t<n.length;t+=1)o[t]=mi(ui(e,n,t))
return{c(){for(let e=0;e<o.length;e+=1)o[e].c()
t=Tn()},m(e,n){for(let t=0;t<o.length;t+=1)o[t]&&o[t].m(e,n)
Sn(e,t,n)},p(e,[r]){if(7&r){let a
for(n=Ao(ci),a=0;a<n.length;a+=1){const i=ui(e,n,a)
o[a]?o[a].p(i,r):(o[a]=mi(i),o[a].c(),o[a].m(t.parentNode,t))}for(;a<o.length;a+=1)o[a].d(1)
o.length=n.length}},i:Jt,o:Jt,d(e){e&&Ln(t),En(o,e)}}}function yi(e){const t=so()
function n(e){Ar("helperMenu",e)}function o(e,o){v(o)&&(n(e),t("toggle"),o())}function r(e){t("toggle"),n("sendMsg"),openQuickMsgDialog(e)}return[n,o,r,e=>o(e.label,e.fn),e=>n(e.label),e=>r(e.playerName)]}class bi extends qo{constructor(e){super(),Go(this,e,yi,hi,tn,{})}}function vi(e){let t,n,o,r
return n=new bi({}),n.$on("toggle",e[5]),{c(){t=On("div"),Do(n.$$.fragment),Bn(t,"class","modal svelte-vem4gq")},m(e,o){Sn(e,t,o),Io(n,t,null),r=!0},p:Jt,i(e){r||(Po(n.$$.fragment,e),e&&bo((()=>{r&&(o||(o=No(t,Ko,{duration:100},!0)),o.run(1))})),r=!0)},o(e){Co(n.$$.fragment,e),e&&(o||(o=No(t,Ko,{duration:100},!1)),o.run(0)),r=!1},d(e){e&&Ln(t),Uo(n),e&&o&&o.end()}}}function wi(e){let t,n,o
return n=new bi({}),n.$on("toggle",e[5]),{c(){t=On("div"),Do(n.$$.fragment),Bn(t,"class","modal svelte-vem4gq")},m(e,r){Sn(e,t,r),Io(n,t,null),o=!0},p:Jt,i(e){o||(Po(n.$$.fragment,e),o=!0)},o(e){Co(n.$$.fragment,e),o=!1},d(e){e&&Ln(t),Uo(n)}}}function _i(e){let t,n,o,r,a,i,s,c
const u=[wi,vi],l=[]
function f(e,t){return e[1]&&e[4]?0:e[1]?1:-1}return~(r=f(e))&&(a=l[r]=u[r](e)),{c(){t=On("div"),n=On("button"),n.textContent="Helper Menu",o=Cn(),a&&a.c(),Bn(n,"type","button"),Bn(n,"class","toggle svelte-vem4gq"),Jn(n,"helper-menu-move",e[3]),Bn(t,"class","helper-menu svelte-vem4gq"),Jn(t,"helper-menu-fixed",e[2])},m(a,u){Sn(a,t,u),jn(t,n),jn(t,o),~r&&l[r].m(t,null),e[6](t),i=!0,s||(c=Nn(n,"click",e[5]),s=!0)},p(e,[n]){let o=r
r=f(e),r===o?~r&&l[r].p(e,n):(a&&(Eo(),Co(l[o],1,1,(()=>{l[o]=null})),Oo()),~r?(a=l[r],a?a.p(e,n):(a=l[r]=u[r](e),a.c()),Po(a,1),a.m(t,null)):a=null)},i(e){i||(Po(a),i=!0)},o(e){Co(a),i=!1},d(n){n&&Ln(t),~r&&l[r].d(),e[6](null),s=!1,c()}}}function ki(e,t,o){const r=Pt("keepHelperMenuOnScreen"),a=Pt("draggableHelperMenu"),i=Nr()&&n("worldPage")&&window.GameData
let s=0
ro((()=>{a&&Tr(s)}))
let c=!1
return[s,c,r,a,i,function(){o(1,c=!c)},function(e){lo[e?"unshift":"push"]((()=>{s=e,o(0,s)}))}]}class ji extends qo{constructor(e){super(),Go(this,e,ki,_i,tn,{})}}function xi(){const e=k(".mainbody")
e&&function(e,t){new ji({target:t.parentElement,props:{props:e}})}({},e)}function $i(e){return(new DOMParser).parseFromString(e,"text/html")}function Si(e){return wa({data:e})}async function Li(e){const t=await Si(e)
if(t)return $i(t)}function Ei(e){const t=n("info-msg",e)
if(t){const e=t.innerHTML
return e?e.replace(/<br.*/,""):""}}function Oi(e,t,n){window.Modernizr?.localstorage&&window.localStorage.setItem(bt+e,t+n)}const Pi=[[sr,(e,t)=>{Oi(e,"S]",t)}],[function(e){return"number"==typeof e},(e,t)=>{t.toString().indexOf(".")<0&&Oi(e,"N]",t)}],[xr,(e,t)=>{Oi(e,"B]",t)}]]
function Ci(e,t){const n=Pi.find((e=>e[0](t)))
n&&n[1](e,t)}let Ti=0
const Ni=()=>Ti
function Ai(){Ti=Pt("sendGoldonWorld")}async function Mi(){if(!Ni())return
Ar("NewMap","doSendGold")
const e=await Li({cmd:"trade",subcmd:"sendgold",xc:window.ajaxXC,target_username:$("#HelperSendTo").html(),gold_amount:$("#HelperSendAmt").html().replace(/[^\d]/g,"")})
e&&function(e){const t=Ei(e)
"You successfully sent gold!"!==t&&""!==t||(Ci("currentGoldSentTotal",parseInt(Pt("currentGoldSentTotal"),10)+parseInt(Pt("goldAmount"),10)),GameData.fetch(Ke))}(e)}function Bi(e){window.location=e}function Hi(e){Pt("expandMenuOnKeyPress")&&localStorage.setItem("hcs.nav.openIndex",e)}function Ri(e){Ar("keyHandler",e)}function Di(e){return e?.toLowerCase?.()}function Ii(e,t){return Di(e)<Di(t)?-1:Di(e)>Di(t)?1:0}function Ui(e){return Ca(e,{method:"GET"})}function Gi(e){return Ui({cmd:"profile",...e})}async function qi(){const e=await Gi({subcmd:"viewcombatset"})
return e?.r?{...e,r:e.r.sort(((e,t)=>Ii(e.name,t.name)))}:e}function Fi(e,t,...n){return e(...n)}function Wi(){return Fi(qi)}const Qi=[e=>e?.s,(e,t)=>e.r?.length>t]
async function zi(e){const t=await Wi()
if(((e,t)=>Qi.every((n=>n(t,e))))(e,t)){Ri("changeCombatSet")
const n=t.r[e].id
Hi("2"),Bi(`${ae+Z}managecombatset&submit=Use&combatSetId=${n}`)}}function Ji(e,t){n("worldPage")||(Ri(e),Bi(t))}function Ki(){f.enableMaxGroupSizeToJoin?Bi(_e):Bi(we)}function Xi(){Ri("logPage"),Hi("2"),Bi(oe)}function Vi(e){const t=k(`#pCC input[value="${e}"]`)
t&&(Ri("movePage"),Oa(t))}const Yi=[["!",zi,0],["@",zi,1],['"',zi,1],["#",zi,2],["£",zi,2],["$",zi,3],["%",zi,4],["^",zi,5],["&",zi,6],["*",zi,7],["(",zi,8],["0",function(){Ji("toWorld",ke)}],["<",Vi,"<"],[">",Vi,">"],["G",function(){Ri("createGroup"),Hi("4"),Bi(`${ye}create`)}],["L",Xi],["b",function(){Ri("backpack"),Hi("2"),Bi(se)}],["g",function(){Ri("gotoGuild"),Hi("4"),Bi(`${ge}manage`)}],["j",function(){Ri("joinAllGroup"),Hi("4"),Ki()}],["l",Xi],["p",function(){Ri("profile"),Hi("2"),Bi(ae)}],["r",function(){Ji("doRepair",`${$e+Z}repairall&fromworld=1`)}],["v",function(){"dialogIsClosed"in f&&!f.dialogIsClosed()||(Ri("insertQuickWear"),Fr(aa))}],["y",Mi]]
const Zi=[e=>["HTML","BODY"].every((t=>e.target.tagName!==t)),e=>e.ctrlKey,e=>e.metaKey,e=>e.altKey]
function es(e){var t;(t=e,Zi.some((e=>e(t))))||function(e){const t=Yi.find((([t])=>e===t))
t&&t[1](t[2])}(e.key)}function ts(){A(document,"keyup",es)}function ns(e,t){return ur(t)===e}function os(e){return fr(ns,e)}function rs(e,t,n){A(e,"click",t,n)}function as(e,t){return t?t.querySelectorAll(e):document.querySelectorAll(e)}function is(e,t){return rr(as(e,t))}function ss(e){rs(e,(()=>{Ar("chrome","Game Help link")})),qr(`<a href="${Y}settings">Game Help</a>`,e)}function cs(){is("#pCR h3").filter(os("Game Help")).forEach(ss)}function us(e){f[e]=Pt(e)}function ls(e,t){if(t instanceof Element)return t.closest(e)}function fs(e){e?.classList&&e.classList.add("fshHide")}function ds(e){const t=ls("a",e.target)
...
r?o(r):function(e,t,n,o){$(e).on(`${Di(t)}create`,(()=>{o(vs(e,t,n))}))}(e,t,n,o)}))}const _s=[[e=>!w(e),()=>Ct("$('#nav').data('hcsNav') is not an object")],[e=>!("heights"in e),()=>Ct("$('#nav').data('hcsNav').heights does not exist")]]
...
n.some((([,e])=>e))&&(await import("./injectItems-DmcI19_l.js")).default(e,t,ms(n))}(e,t),function(e){const t=e._saveState
...
if(t)return _(t,Fs)}function Qs(e,t,n){return JSON.stringify(e,t,n)}function zs(e,t){Ci(e,Qs(t))}let Js=0,Ks=0,Xs=0
...
t&&(t.classList.add("pCR"),Gr(_r(),t))}function ac(e,t){if(function(e){return e instanceof Node&&e.parentNode instanceof Node}(t))return t.parentNode.insertBefore(e,t)}function ic(e,t){if(e instanceof Element)return function(e,t){return e.firstChild instanceof Node?ac(t,e.firstChild):Gr(e,t)}(e,t)}function sc(e){const t=n(e)
t&&ic((wr||(wr=n("pCR")),wr),t)}const cc=[function(){Pt("moveGuildList")&&sc("minibox-guild")},function(){Pt("moveOnlineAlliesList")&&sc("minibox-allies")},function(){Pt("moveXmasBox")&&rc("minibox-xmas")},function(){Pt("moveDailyQuest")&&rc("minibox-daily-quest")},function(){Pt("moveFSBox")&&rc("minibox-fsbox")},function(){(f.enableAllyOnlineList||f.enableEnemyOnlineList)&&Wr(import("./allyEnemy-PEGzxkbY.js"))},function(){(f.enableWantedList||f.enableActiveBountyList)&&Wr(import("./activeWantedBounties-Bqw3TXBW.js"))},function(){f.enableGuildInfoWidgets&&Wr(import("./addGuildInfoWidgets-DlXCcIVF.js"))},function(){f.enableOnlineAlliesWidgets&&Wr(import("./addOnlineAlliesWidgets-D7Q4SDPb.js"))},function(){f.enableTempleAlert&&Wr(import("./injectTempleAlert-Di4Rpk5V.js"))},function(){f.enableUpgradeAlert&&Wr(import("./injectUpgradeAlert-snY-1qo2.js"))},function(){f.enableComposingAlert&&Wr(import("./injectComposeAlert-xA0woAlh.js"))},function(){_r()&&!hs()&&xs()},function(){hs()||(window.openQuickMsgDialog=oc)},function(){Pt("statBarLinks")&&Wr(import("./statBar-D0RiK2cc.js"))},function(){Pt("staminaCalculator")&&Wr(import("./injectStaminaCalculator-vdtj2l4N.js"))},function(){Pt("levelUpCalculator")&&Wr(import("./injectLevelupCalculator-IOc3eU6v.js"))},function(){Pt("fsboxlog")&&Wr(import("./fsbox-DQ4hZtMA.js"))},function(){Pt("resizeQuickBuff")&&Wr(import("./interceptQuickBuff-C5bpSRIX.js"))},function(){Pt("joinAllLink")&&Wr(import("./injectJoinAllLink-B7m_L898.js"))},function(){Pt("addServerNode")&&Wr(import("./injectServerNode-C16ZTpsf.js"))},function(){Pt("addScoutTowerLink")&&Wr(import("./scoutTowerLink-B5Ue_B4P.js"))},function(){Nr()&&Pt(ot)&&Wr(import("./guildActivity-f-8FtSXH.js"))},async function(){if(Nr()&&f.enableSeTracker){(await import("./trackerPrefStore-BldH3MTz.js").then((function(e){return e.a}))).default.set(f.enableSeTracker)}}]
...
t?.["new-ui"]&&(Pt("gameHelpLink")&&Wt(3,cs),f.huntingMode=Pt("huntingMode"),Wt(3,ts),lc(),Pt("hideHelperMenu")||Wt(3,xi))}function dc(){const e=function(){const e=n("html")
if(e?.dataset)return e.dataset.hcs}()
e&&fc(e)}function pc(){Nr()&&n("worldPage")&&window.GameData&&Wr(import("./newMap-BGBGkTix.js"))}function gc(e){$(e).qtip("hide")}function mc(e){Ci("needToPray",e),Ci("lastTempleCheck",(new Date).setUTCHours(23,59,59,999)+1)}let hc=0
...
t&&(Ar("notification","prayToGods"),gc(e.target),await Si({cmd:"temple",subcmd:"pray",type:t}),hc.outerHTML=yc,mc(!1))}function wc(){qs(n("notifications"),bc),hc=n("helperPrayToGods"),$r(hc,"click",vc)}async function _c(){if(!f.enableTempleAlert)return
const e="temple"===f.cmd?document:await Li({cmd:"temple"})
if(!e)return
const t=k("#pCC",e)
if(!t)return
const n="You are currently praying at the temple."!==ur(t)
n&&wc(),mc(n)}function kc(){Wr(import("./bioWidgets-CcK0bkrJ.js"))}function jc(){Wr(import("./injectGuild-d_L_kKD9.js"))}const xc=()=>{Wr(import("./guildAdvisor-BY-I_UQQ.js"))}
const $c=()=>{Wr(import("./groups-BTLFL5Gj.js"))}
const Sc=()=>{Wr(import("./addRemoveTags-B702I_MC.js"))}
const Lc=()=>{Wr(import("./guildChat-DWd3ov4Z.js"))}
function Ec(){Wr(import("./viewRecipe-JJZtcixn.js"))}function Oc(){Wr(import("./ufsgAllowBack-Bxm5LErz.js"))}function Pc(){Wr(import("./profile-BTdkvsIo.js").then((function(e){return e.p})))}function Cc(){Wr(import("./news-BGtgVhPS.js"))}function Tc(){Wr(import("./viewArchive-DJWaQBrS.js"))}const Nc=()=>{Wr(import("./inventory-C03itYpQ.js"))},Ac=()=>{Wr(import("./bazaar-Di2gvIre.js"))}
function Mc(){Wr(import("./injectQuestBookFull-COVgz-EN.js"))}const Bc=()=>{Wr(import("./scavenging-Cq7VL4li.js"))}
const Hc=()=>{Wr(import("./toprated-CT5aDU0D.js"))}
const Rc=()=>{Wr(import("./trade-DAj54nJ8.js"))}
var Dc={creatures:{"-":{"-":Oc}},items:{"-":{"-":Oc},view:{"-":()=>{Wr(import("./itemsView-C06cJwSW.js"))}}},masterrealms:{"-":{"-":Oc}},quests:{"-":{"-":Oc},view:{"-":()=>{Wr(import("./showAllQuestSteps-Blej92or.js"))}}},realms:{"-":{"-":Oc}},relics:{"-":{"-":Oc}},shops:{"-":{"-":Oc}},"-":{news:{"-":Cc},viewupdatearchive:{"-":Tc},viewarchive:{"-":Tc},"-":{"-":()=>{Wr(import("./unknownPage-cRADRxB7.js"))}}},arena:{"-":{"-":()=>{Wr(import("./arena-Dgfga-P8.js").then((function(e){return e.c})))}},dojoin:{"-":()=>{Wr(import("./arenaDoJoin-Dm3rP5oM.js"))}},join:{"-":()=>{Wr(import("./arenaJoin-BAZsHQDt.js"))}},completed:{"-":()=>{Wr(import("./completedArenas-Bjll2SrR.js"))}},pickmove:{"-":()=>{Wr(import("./storeMoves-DYXMv1BB.js"))}},setup:{"-":()=>{Wr(import("./setupMoves-DloSuT3G.js"))}}},auctionhouse:{"-":{"-":()=>{Wr(import("./injectAuctionHouse-CWPsW32o.js"))}},quickcreate:{"-":()=>{Wr(import("./quickCreate-JZYdPe4K.js"))}}},bank:{"-":{"-":()=>{Wr(import("./injectBank-Bhnafao7.js"))}}},blacksmith:{repairall:{"-":function(){zt("fromworld")&&pc()}}},buffmarket:{"-":{"-":()=>{Wr(import("./injectBuffmarket-DaJzVAk6.js"))}}},combat:{attackplayer:{"-":Pc}},composing:{"-":{"-":()=>{Wr(import("./composing-DI849swj.js"))}},breakdown:{"-":()=>{Wr(import("./breakdown-C41YVYYa.js"))}},create:{"-":()=>{Wr(import("./composingCreate-Cg3ns0Ss.js"))}}},findplayer:{"-":{"-":()=>{Wr(import("./findplayer-C_7t4Zi4.js"))}}},guild:{inventory:{report:()=>{Wr(import("./guildReport-COPfObaV.js"))},addtags:Sc,removetags:Sc,storeitems:()=>{Wr(import("./storeitems-fG1q_zb5.js"))}},chat:{"-":Lc},dochat:{"-":Lc},log:{"-":()=>{Wr(import("./guildLog-CUACwTbv.js"))}},groups:{viewstats:()=>{Wr(import("./injectGroupStats-DesEPoxj.js"))},joinallgroupsundersize:$c,joinall:$c,"-":$c},manage:{"-":jc},advisor:{"-":xc,weekly:xc},history:{"-":kc},view:{"-":jc},scouttower:{"-":()=>{Wr(import("./injectScouttower-DLtzHpYw.js"))}},mailbox:{"-":()=>{Wr(import("./guildMailbox-D-ykoohP.js"))}},ranks:{"-":()=>{Wr(import("./rank-PXwB4z5r.js"))}},conflicts:{rpupgrades:()=>{Wr(import("./injectRPUpgrades-CL1L2D44.js"))}},bank:{"-":()=>{Wr(import("./injectGuildBank-jb3hxlyv.js"))}},hall:{"-":()=>{Wr(import("./hall-D5f5_xMJ.js"))},post:kc},"-":{"-":jc}},hellforge:{"-":{"-":()=>{Wr(import("./hellforge-BkY_7xes.js"))}}},inventing:{"-":{"-":function(){Wr(import("./inventing-DyRU6sdV.js"))}},doinvent:{"-":Ec},viewrecipe:{"-":Ec}},log:{"-":{"-":()=>{Wr(import("./playerLog-ZyJxX-Ok.js"))}}},marketplace:{createreq:{"-":()=>{Wr(import("./marketplace-BNQa4crG.js"))}}},news:{fsbox:{"-":()=>{Wr(import("./newsFsbox-DPyCR5dn.js"))}},"-":{"-":Cc},shoutbox:{"-":()=>{Wr(import("./newsShoutbox-Byxonp3f.js"))}},viewupdatearchive:{"-":Tc},viewarchive:{"-":Tc}},notepad:{showlogs:{"-":zr},invmanagernew:{"-":Nc},guildinvmgr:{"-":Nc},recipemanager:{"-":ia},auctionsearch:{"-":Yr},onlineplayers:{"-":ta},quicklinkmanager:{"-":ra},monsterlog:{"-":Jr},quickextract:{"-":oa},quickwear:{"-":aa},fsboxcontent:{"-":Kr},bufflogcontent:{"-":Qr},newguildlog:{"-":Xr},findbuffs:{"-":Zr},findother:{"-":ea},savesettings:{"-":()=>{Wr(import("./load-DvBQL9PY.js"))}},reliclist:{"-":sa},whosgotwhat:{"-":()=>{}}},points:{"-":{"-":()=>{Wr(import("./points-DsBBlRiA.js"))}}},potionbazaar:{"-":{"-":Ac},buyitem:{"-":Ac}},privatemessage:{"-":{"-":()=>{Wr(import("./privateMsg-BWnUlH2L.js"))}}},profile:{"-":{"-":Pc},managecombatset:{"-":Pc},report:{"-":Pc},equipitem:{"-":Pc},useitem:{"-":Pc},changebio:{"-":kc},dropitems:{"-":function(){Wr(import("./injectProfileDropItems-BNNvJu5O.js"))}}},pvpladder:{"-":{"-":()=>{Wr(import("./ladder-CjVPumIf.js"))}}},questbook:{"-":{"-":Mc},atoz:{"-":Mc},viewquest:{"-":()=>{Wr(import("./injectQuestTracker-CxyHu1Be.js"))}}},quickbuff:{"-":{"-":()=>{Wr(import("./quickBuff-C0A4gkZW.js"))}}},scavenging:{"-":{"-":Bc},process:{"-":Bc}},settings:{"-":{"-":()=>{Wr(import("./injectSettings-CdBGcxQ7.js"))}}},skills:{"-":{"-":()=>{}}},superelite:{"-":{"-":()=>{Wr(import("./superelite-BRhgNhBu.js"))}}},tempinv:{"-":{"-":()=>{Wr(import("./mailbox-DIYqn2dD.js"))}}},temple:{"-":{"-":_c}},titan:{"-":{"-":()=>{Wr(import("./injectTitan-D7dBWG-h.js"))}}},toprated:{xp:{"-":Hc},monthlyxp:{"-":Hc},gold:{"-":Hc},killstreak:{"-":Hc},bounties:{"-":Hc},risingstars:{"-":Hc},arena:{"-":Hc},superelites:{"-":Hc},smasher:{"-":Hc},globalquest:{"-":()=>{Wr(import("./globalQuest-3q92wUw1.js"))}}},trade:{"-":{"-":Rc},sendgold:{"-":Rc},createsecure:{"-":Rc},docreatesecure:{"-":Rc}},world:{"-":{"-":pc}}}
...
e.filter(qc).forEach((e=>{Gr(Gr(n,Ic()),function(e){const t=Ea({href:e.url,...e.newWindow&&{target:"new"},text:e.name})
...
function au(e,t){if(ru.some((e=>e())))return
const n=j("https://fallenswordhelper.github.io/fallenswordhelper/resources/prod/1524/calfSystem.min.css")
T(),function(e,t){f.gmInfo=_(decodeURIComponent(t)),f.gmInfo?f.fshVer=e:f.fshVer=`${e}_native`,f.calfVer="124"}(e,t),h(),ou(n)}export{Fi as $,G as A,Uc as B,Mr as C,$s as D,Na as E,Ta as F,Si as G,$i as H,$t as I,St as J,as as K,Go as L,tn as M,Ao as N,On as O,Cn as P,Bn as Q,bo as R,qo as S,Sn as T,jn as U,qn as V,Un as W,Nn as X,Mn as Y,Ho as Z,Jt as _,Ui as a,cr as a$,Ln as a0,Zt as a1,Ws as a2,Pn as a3,In as a4,Mo as a5,Fn as a6,zs as a7,o as a8,Ss as a9,Oa as aA,ca as aB,l as aC,Ve as aD,Me as aE,Be as aF,Ue as aG,He as aH,gc as aI,s as aJ,ke as aK,Z as aL,Ne as aM,H as aN,Ha as aO,We as aP,Ra as aQ,va as aR,_ as aS,Wt as aT,Ir as aU,pt as aV,dt as aW,mt as aX,gt as aY,ht as aZ,rr as a_,zt as aa,or as ab,zr as ac,Jr as ad,Ci as ae,ws as af,f as ag,Qs as ah,Pt as ai,Ur as aj,he as ak,xr as al,Tn as am,rt as an,B as ao,Y as ap,ur as aq,Di as ar,Ds as as,ce as at,ue as au,Qt as av,Ee as aw,re as ax,kt as ay,ar as az,A as b,U as b$,e as b0,v as b1,Ae as b2,Gn as b3,En as b4,xe as b5,on as b6,ve as b7,yo as b8,I as b9,Ai as bA,Ni as bB,Mi as bC,Re as bD,De as bE,Je as bF,Fe as bG,fs as bH,Ei as bI,Gi as bJ,mn as bK,wt as bL,Wi as bM,w as bN,Lt as bO,it as bP,La as bQ,Bi as bR,le as bS,_t as bT,ic as bU,Ct as bV,Le as bW,wa as bX,et as bY,os as bZ,tt as b_,qe as ba,ze as bb,Po as bc,Eo as bd,Oo as be,Co as bf,so as bg,Do as bh,Io as bi,Uo as bj,D as bk,Se as bl,Qo as bm,Wo as bn,J as bo,Tt as bp,xt as bq,ie as br,Ii as bs,sn as bt,io as bu,Qe as bv,Ie as bw,Xe as bx,Ye as by,Ze as bz,fr as c,W as c$,Nr as c0,Rr as c1,ge as c2,nt as c3,ft as c4,X as c5,r as c6,ct as c7,Is as c8,cn as c9,ut as cA,b as cB,Cc as cC,Mc as cD,Ec as cE,N as cF,ja as cG,R as cH,ri as cI,Ja as cJ,Xa as cK,Va as cL,Ka as cM,ti as cN,vt as cO,bt as cP,Dn as cQ,en as cR,V as cS,q as cT,Q as cU,z as cV,ot as cW,Vr as cX,be as cY,K as cZ,Us as c_,Jn as ca,fn as cb,dn as cc,ln as cd,co as ce,lo as cf,Ro as cg,vo as ch,Xt as ci,oo as cj,no as ck,jo as cl,Gs as cm,ka as cn,pe as co,Ic as cp,t as cq,j as cr,st as cs,Wr as ct,hn as cu,ns as cv,ne as cw,M as cx,yt as cy,F as cz,qr as d,na as d0,jc as d1,An as d2,No as d3,Vo as d4,Oe as d5,Pe as d6,ro as d7,Tr as d8,sr as d9,Kr as dA,Pa as dB,we as dC,_e as dD,lt as dE,ua as dF,$e as dG,se as dH,Rn as dI,an as dJ,Ki as dK,te as dL,gn as dM,oa as dN,aa as dO,au as dP,Hn as da,zn as db,Bo as dc,me as dd,ae as de,Xn as df,de as dg,ao as dh,pn as di,Te as dj,gs as dk,Fr as dl,ia as dm,fe as dn,Qr as dp,ra as dq,Yr as dr,ta as ds,ea as dt,Zr as du,Xr as dv,_r as dw,Ce as dx,_c as dy,wc as dz,Li as e,ms as f,n as g,ls as h,Gr as i,at as j,is as k,jt as l,Dr as m,Ea as n,rs as o,kr as p,k as q,a as r,Ar as s,je as t,_a as u,qs as v,hs as w,ir as x,ac as y,$r as z}
//# sourceMappingURL=calfSystem-0LeC9ahe.js.map
