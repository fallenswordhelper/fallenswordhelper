import{b0 as t,o as e,D as n,v as s,cE as a,s as c,a8 as l,S as o,L as r,M as i,N as u,O as f,P as h,Q as m,T as d,U as p,_ as g,a0 as b,b6 as $,C as T,ap as k,a3 as v,X as w,be as y,bh as N,a1 as x,bj as j,bk as S,bl as R,a4 as C,aQ as B,f as H,bu as L,aS as E,w as _,aB as F,p as I,bV as M,d as A,aO as O,n as D,i as P,q as Q}from"./calfSystem-CyLCrHqa.js"
import{d as U}from"./dataRows-DUhbhXmo.js"
import{g as X}from"./getTitle-C1xil_UC.js"
import{a as q,g as K,t as V}from"./getTitanString-DvEb_zLX.js"
import{g as J}from"./getPlayerId-HyP308MI.js"
import{o as z}from"./openQuickBuffById-DWItz6gs.js"
import{a as G}from"./roundToString-Hif1MLyB.js"
import{u as W}from"./uniq-DXRxPJJ2.js"
import{p as Y}from"./parseDateAsTimestamp-CUlScXmd.js"
import{h as Z,u as tt}from"./await_block-kKTPWHQa.js"
import{c as et}from"./closestTable-DUYDcoD9.js"
import{L as nt}from"./LinkButtonBracketed-BYkuHk0R.js"
...
return{c(){e=v("Select None")},m(t,n){d(t,e,n)},d(t){t&&b(e)}}}function yt(t){return{c:g,m:g,p:g,i:g,o:g,d:g}}function Nt(t){let e,n,s,a,c,l,o,r,i,u,g,$,T,k,j,S,R,C,B,H,L,E,_,F,I,M,A,O={ctx:t,current:null,token:null,hasCatch:!1,pending:yt,then:Tt,catch:$t,blocks:[,,,]}
return Z(t[4](),O),{c(){e=f("table"),n=f("tbody"),s=f("tr"),s.innerHTML='<td class="header svelte-1s0h251" colspan="3"></td>',a=h(),c=f("tr"),l=f("td"),o=f("label"),r=f("input"),i=v("\n          Current"),u=h(),g=f("label"),$=f("input"),T=v("\n          History"),k=h(),j=f("label"),S=f("input"),R=v("\n          Securable"),C=h(),B=f("tr"),B.innerHTML='<td class="header svelte-1s0h251" colspan="3"></td>',H=h(),L=f("tr"),E=f("td"),O.block.c(),_=h(),F=f("tr"),F.innerHTML='<td class="header svelte-1s0h251" colspan="3"></td>',m(r,"type","checkbox"),m(o,"class","svelte-1s0h251"),m($,"type","checkbox"),m(g,"class","svelte-1s0h251"),m(S,"type","checkbox"),m(j,"class","svelte-1s0h251"),m(l,"colspan","3"),m(l,"class","svelte-1s0h251"),m(E,"colspan","3"),m(E,"class","svelte-1s0h251"),m(e,"class","svelte-1s0h251")},m(f,h){d(f,e,h),p(e,n),p(n,s),p(n,a),p(n,c),p(c,l),p(l,o),p(o,r),r.checked=t[0],p(o,i),p(l,u),p(l,g),p(g,$),$.checked=t[1],p(g,T),p(l,k),p(l,j),p(j,S),S.checked=t[2],p(j,R),p(n,C),p(n,B),p(n,H),p(n,L),p(L,E),O.block.m(E,O.anchor=null),O.mount=()=>E,O.anchor=null,p(n,_),p(n,F),I=!0,M||(A=[w(r,"change",t[13]),w(r,"change",t[5]),w($,"change",t[14]),w($,"change",t[6]),w(S,"change",t[15]),w(S,"change",t[7])],M=!0)},p(e,n){t=e,1&n[0]&&(r.checked=t[0]),2&n[0]&&($.checked=t[1]),4&n[0]&&(S.checked=t[2]),tt(O,t,n)},i(t){I||(y(O.block),I=!0)},o(t){for(let t=0;t<3;t+=1){const e=O.blocks[t]
N(e)}I=!1},d(t){t&&b(e),O.block.d(),O.token=null,O=null,M=!1,x(A)}}}const xt="fsh_titanFilter"
...
A(`<a href="${O}realms&search_name=${s}" target="_blank">${s}</a>`,n),e(n,Ft)}(t)}const At=t=>{return{guildKills:Number(l(t.cells[3])),hp:l(t.cells[2]),titanName:V((e=t,X(Q("img",e)))),tr:t,visible:!0}
...
if(!t?.length)return
ut(t)
const e=(t=>U(t[1],4,0)?.map(At).map(Ot).map(Dt))(t)
e&&(e.forEach(Mt),_t(t,e))}export{Pt as default}
//# sourceMappingURL=injectScouttower-MRPzV74F.js.map
