...
import{ay as t,v as a,g as n,b7 as s,l as r,aR as o,i,aE as c,aN as l,c as u,a3 as f,aq as d,o as m,s as v,b8 as p,bd as h,ad as b,be as g,bf as k,bg as y,bh as w,a6 as C,b as L,aA as D,bi as V,aU as M,bj as A,bk as S,bc as N,bb as H,av as j,h as B,bl as x,q as T,bm as E,bn as G,f as P,ac as R,bo as F,bp as _,bq as O,br as I,bs as W,bt as q,bu as K,bv as z,bw as Y,bx as U,by as Q,bz as J,aB as X,m as Z,bA as ee,bB as te,bC as ae,W as ne,$ as se,y as re,aG as oe,E as ie,aF as ce,C as le,Q as ue,R as fe,K as de,F as me,N as ve,H as pe,bD as he,D as be,G as ge,bE as ke,O as ye,T as we,bF as $e,bG as Ce,al as Le,t as De,ap as Ve,ak as Me,bH as Ae,J as Se,bI as Ne,bJ as He,bK as je,bL as Be,bM as xe,d as Te,aK as Ee,bN as Ge,bO as Pe,bP as Re,bQ as Fe,z as _e,bR as Oe,bS as Ie,bT as We,bU as qe,bV as Ke,aw as ze,bW as Ye,bX as Ue,a1 as Qe,bY as Je,bZ as Xe,b_ as Ze,b$ as et,c0 as tt,c1 as at,c2 as nt,c3 as st,c4 as rt,c5 as ot,c6 as it,c7 as ct,c8 as lt,c9 as ut,ca as ft,cb as dt,cc as mt,cd as vt,ce as pt,cf as ht,cg as bt,ch as gt,ci as kt,cj as yt,ck as wt,cl as $t,cm as Ct,cn as Lt,az as Dt,co as Vt}from"./calfSystem-CIdPz3EO.js"
import{t as Mt}from"./toggleForce-br4z9gGd.js"
import{r as At,a as St}from"./roundToString-BsfZkzT8.js"
import{d as Nt,q as Ht}from"./quickbuffSuccess-DV6-BHa1.js"
import{c as jt}from"./createInput-aJbr7AXf.js"
import{c as Bt}from"./createLabel-CrgD_1iS.js"
import{c as xt}from"./idbLogger-Cr4HtKi5.js"
import{r as Tt}from"./rnd-D_QmA-Fa.js"
import{c as Et}from"./createStyle-C-OOcRjs.js"
...
import{r as It}from"./reliclist-z6sKPAvC.js"
import{d as Wt}from"./daGroupStats-2x-rRPcb.js"
import{d as qt,m as Kt}from"./mercEffect-CQaz0GPn.js"
import{a as zt}from"./attribsToArray-Da8OBolo.js"
import{g as Yt}from"./guildMembers-BxoIaGju.js"
import{r as Ut}from"./remainingPages-BUotk4St.js"
import{t as Qt}from"./testQuant-CsJQFYLh.js"
import{s as Jt,j as Xt}from"./simpleCheckbox-cwzWQeYd.js"
...
ue(()=>{we(t,"href",`${Ce??""}${n().guild_id??""}`),we(a,"src",`${E??""}guilds/${n().guild_id??""}_mini.png`)}),ve(e,t)}
...
ue(()=>fe(n,de(t).message)),ve(e,a)}),ve(e,a),ye()}const ds=Le({promise:Promise.resolve()})
let ms=0
...
let Cs=0
function Ls(e){Cs[e.name]?Cs[e.name].seen&&(Cs[e.name].seen+=1):(Cs[e.name]={seen:1},function(e,t){t.creature_class=e.creature_class,t.image_id=e.image_id,t.level=Number(e.level),t.type=e.type}(e,Cs[e.name]))}function Ds(e,t,a){return t?e(t,a):a}function Vs(e,t){const a=e||{}
return a.min=Ds(Math.min,a.min,t),a.max=Ds(Math.max,a.max,t),a}const Ms=["attack","armor","damage","defense","hp"]
function As(e,t,a){const n=Vs(t[a],Number(e[a]));(function(e,t){return!e||e.min!==t.min||e.max!==t.max})(t[a],n)&&(t[a]=n)}function Ss(e,t){e[t.name]=Vs(e[t.name],Number(t.value))}function Ns(e){Cs||(Cs={}),Ls(e),function(e,t){Ms.forEach(u(As,e,t))}(e,Cs[e.name]),function(e,t){(function(e){return e.enhancements&&e.enhancements.length>0})(e)&&(t.enhancements=t.enhancements||{},e.enhancements.forEach(u(Ss,t.enhancements)))}(e,Cs[e.name]),Be("fsh_monsterLog",Cs)}async function Hs(){!function(e){Cs=e||{}}(await je("fsh_monsterLog"))}const js=[]
function Bs(e){var a
$n(e)||(a=e.response.data,t.showMonsterLog&&Ns(a))}function xs(e,t){return e.id===t.id}async function Ts(e,t){if(6!==e.type||function(e){if(js.find(u(xs,e.data)))return!0
js.push(e.data)}(e))return
Bs(await Mn(e.data.id,t))}function Es(){t.showMonsterLog&&(GameData.actions().forEach(Ts),v("NewMap","MonsterLog"))}let Gs=""
function Ps(){return xe({subcmd:"scouttower"})}function Rs(e,[t,a,n]){const s=e.insertCell(-1)
return s.colSpan=t,n&&(s.className="header"),i(s,a()),s}function Fs(e,t,a){const n=e.insertRow(-1)
return a&&(n.className="fshBlue"),function(e,t){t.forEach(u(Rs,e))}(n,t),n}function _s(e,t){Fs(e,t[0],t[1])}function Os(e,t){t.forEach(u(_s,e))}let Is=0,Ws=0,qs=0,Ks=0,zs=0,Ys=0,Us=0,Qs=0
const Js=()=>Is,Xs=()=>Us
function Zs(){Is=Ra("Current"),Ws=Ra("Kills"),qs=Ra("Member"),Ks=Ra("% of Total"),zs=Ra("Status"),Ys=Ra("Titan HP"),Us=Ra("Total"),Qs=Ra("Your Guild")}let er=0,tr=0,ar=0,nr=0,sr=0,rr=0,or=0,ir=0,cr=0
...
return i(t,e),c(t,"%"),t}const Cr=[[[5,lr,!0],[1,ur,!0]]],Lr=[[[2,()=>Ys,!0],[4,()=>Qs,!0]]],Dr=[[[2,function(){const e=o()
return i(e,fr()),c(e,"/"),i(e,dr()),e}],[4,mr]]],Vr=[[[2,()=>zs,!0],[4,hr]],!0],Mr=[[[2,()=>qs,!0],[2,()=>Ws,!0],[2,()=>Ks,!0]]]
let Ar=0,Sr=0,Nr="",Hr=""
function jr(){Sr=null,Ar&&!R("fshHide",Ar)&&(Mt(Ar,!0),Te("&nbsp;",er),Te("&nbsp;",tr),r("",ar),r("",nr),r("",sr),r("",rr),r("",or),Te("",ir),Te("",cr),wr())}function Br(e){return 0===e.type&&(Sr=e.base_creature_id,Nr=`(${e.x},${e.y})`,Hr=Gt(e.name),!0)}function xr(){if(Ar)Mt(Ar,!1)
else{const e=n("actionContainer")
Ar=a({className:"fshActionBox titanInfo"}),gr(),kr=Ft({className:"fshCenter"}),Zs(),Os(kr,[Cr,Lr,Dr,[[[2,Js,!0],[4,u($r,vr())]],!0],[[[2,Xs,!0],[4,u($r,pr())]],!0],Vr,[[[6,br]]],Mr]),i(Ar,yr()),i(e,Ar)}}function Tr(e){return e<=0?'<span class="fshGreen cooldown">No active cooldown</span>':`<span class="fshMaroon cooldown">Cooldown until: ${function(e){const t=new Date(Ee()+1e3*e)
return`${Ge(t.getHours())}:${Ge(t.getMinutes())} ${Ge(t.getDate())}/${Pe[t.getMonth()]}/${t.getFullYear()}`}(e)}</span>`}function Er(e){return St(Rt(e.max_hp-e.current_hp,e.kills),2)}function Gr(e){return St(100*e.kills/e.max_hp,2)}function Pr(e){!function(e){for(const[t,a]of[[Hr,lr],[Nr,ur],[e.current_hp,fr],[e.max_hp,dr],[e.kills,mr],[Er(e),vr],[Gr(e),pr]])r(t,a())}(e),Te(function(e){return Pt(e.kills,e.max_hp,e.current_hp)}(e),hr()),Te(Tr(e.cooldown),br())}function Rr(e,t){return[[[2,()=>Ra(t.player.name)],[2,()=>Ra(t.kills.toString())],[2,()=>Ra(`${St(100*t.kills/e.kills,2)}%`)]]]}function Fr(e){return e.realm&&e.creature===Sr&&e.realm===Gs}function _r(e){const t=e.find(Fr)
t&&(Pr(t),function(e){if(wr(),!e.contributors)return
const t=e.contributors.map(u(Rr,e))
Os(yr(),t)}(t))}let Or=null
const Ir=e=>t.showTitanInfo&&b(e)&&e.some(Br)
function Wr(e,t){(e=>e?.s&&b(e.r))(t)&&(_r(t.r),Ir(GameData.realm().dynamic)?Or=window.setTimeout(e,3e4):jr())}async function qr(){Wr(qr,await se(Ps))}function Kr(e){Or&&(window.clearTimeout(Or),Or=null),Ir(e)?(xr(),qr()):jr()}function zr(e){var t
e.dynamic&&(t=e.name,Gs=t,Kr(e.dynamic))}function Yr(e,t){t.realm?.name&&zr(t.realm)}var Ur=le("<li><!></li>"),Qr=le('<ul class="svelte-bwtg9x"></ul>')
function Jr(e,t){re(t,!0)
let a=_e(t,"members",19,()=>[])
const n=e=>`Buff ${We[e]} 16`
var s=Qr()
ge(s,21,()=>_t(16,a()),Oe,(e,a,s)=>{var r=Ur(),o=me(r)
Ie(o,{onclick:e=>function(e,a,s){s.target.blur(),qe(`${Ke}&players=${e.join(",")}`,"fsQuickBuff",618,1e3,",scrollbars"),t.emitBuffBatch(n(a))}(de(a),s,e),children:(e,t)=>{var a=ke()
...
return function(e,t){Zr.forEach(u(eo,e,t))}(a,e),function(e,t){to.forEach(u(ao,e,t))}(a,t),a.superEliteSlayerMultiplier=At(.002*a.superEliteSlayerLevel,2),ze(a.armorValue)&&function(e){e.attackValue=Xr(e.attackBonus,e.levelValue),e.defenseValue=Xr(e.defenseBonus,e.levelValue),e.armorValue=Xr(e.armorBonus,e.levelValue),e.damageValue=Xr(e.damageBonus,e.levelValue),e.hpValue=e.hpBonus}(a),a}const so=Ue(["statusStore","Done."])
let ro=[]
const oo=Ye(so,(e,t)=>{const a=ro.find(([t])=>t===e[0])
a?[,a[1]]=e:ro=[...ro,e]
const n=ro.find(([,e])=>"Done."!==e)
t(n?.[1]??"Done.")}),io=Ue(0)
const co=Ye(io,(e,t)=>{!async function(e,t){if(!e)return
...
return e?.r?.find(bo)?.id}(),n=a&&await async function(e){const t=await Wt(e)
return zt(t?.r?.attributes)}(a),s=n&&await async function(e){const t=await qt(),a=Kt(t)
return e?.map((e,t)=>e-a[t])}(n)
s&&t({attack:s[0],defense:s[1],armor:s[2],hp:s[3],damage:s[4]}),so.set(["groupStore","Done."])}const ko=Ye(ho,(e,t)=>{go(e,t)}),yo=(e,t,a)=>Math.ceil(e*et(t,0)*a),wo=(e,t)=>yo(e,t,.0025),$o=(e,t)=>yo(e,t,.001),Co=$o,Lo=$o,Do=$o,Vo=$o,Mo=$o,Ao=(e,t)=>Math.ceil(e*(1+.001*et(t,0))),So=(e,t)=>Math.ceil(e*(1-t*tt)),No=Ue([]),Ho=Ye(No,(e,t)=>{e&&t(Ot(e))}),jo=Ye([Ho,ko],([e,t],a)=>{if(!e||!t)return
const n=Ao(t.defense,e.Constitution),s=t.hp+Co(n,e.Fortitude)
a({dmgWithChiStrike:t.damage+Lo(s,e["Chi Strike"]),defWithConst:n,hpWithFortitude:s,nmv:wo(t.attack,e["Nightmare Visage"]),sanctuary:Do(t.armor,e.Sanctuary)})})
const Bo=Ye([jo,fo,ko],function([e,t,a],n){if(!e||!t||!a)return
...
e&&(v("NewMap","quickBuy"),await Qe(Ut(e,bi)),GameData.doAction(14,3,{id:fi.id,item_id:fi.itemId},0),mi.close())}function ki(){vi?r("",hi):function(){vi=a({className:"fshClear",textContent:"Select how many to quick-buy:"}),pi=jt({id:"buyAmount",className:"fshNumberInput",min:1,max:99,value:1,type:"number"}),i(vi,pi)
...
Se(a,e-wt()+n),de(a)>0||(clearInterval(de(s)),Se(s,!1),t.tpButton.classList.remove("cooldown"))}window.$.subscribe("stats.player",r),window.$.subscribe(yt,function(e,t){n=wt(),r(),de(s)||0!==t.response.response||Se(s,setInterval(()=>{r()},1e3),!0)})
var o=oe(),i=ie(o),c=e=>{var t=wi(),n=me(t)
ue(()=>fe(n,de(a))),ve(e,t)}
pe(i,e=>{de(s)&&e(c)}),ve(e,o),ye()}function Ci(e){return e.numberOfCreatureHitsTillDead-e.numberOfHitsRequired<=1?", dies on miss":", survives a miss"}function Li(e,t){return"-"===t?e:"-"===e||e>t?"-":e}const Di=[[e=>"-"===e.playerHits&&"-"===e.creatureHits,()=>"Unresolved"],[e=>"-"===e.playerHits,()=>"Player dies"],[e=>1===e.playerHits,e=>`Player 1 hits${Ci(e)}`],[e=>e.playerHits>1,e=>`Player > 1 hits${Ci(e)}`]]
function Vi(e,t){return t[0](e)}function Mi(e){e.playerHits=Li(e.numberOfHitsRequired,e.numberOfCreatureHitsTillDead),e.creatureHits=Li(e.numberOfCreatureHitsTillDead,e.numberOfHitsRequired),e.fightStatus=function(e){const t=Di.find(u(Vi,e))
...
function qi(e){e.overallDefenseValue=Oi(e)+Ii(e)+e.nightmareVisageAttackMovedToDefense,function(e){e.player.constitutionLevel>0&&(e.extraNotes+=`Constitution Bonus Defense = ${Ii(e)}<br>`)}(e),function(e){Si(e,e.player.flinchLevel,"Flinch Bonus Attack Reduction",e.creature.attack)}(e),e.creatureHitByHowMuch=Math.floor(e.attackVariable*Wi(e)),3===e.combatEvaluatorBias&&(e.creatureHitByHowMuch=Math.floor(Wi(e)-50))}function Ki(e){e.extraNotes="",function(e){e.player.superEliteSlayerLevel>0&&(e.extraNotes+=`SES Stat Reduction Multiplier = ${e.player.superEliteSlayerMultiplier}<br>`)}(e),function(e){e.holyFlameBonusDamage=0,"Undead"===e.creature.class&&(e.holyFlameBonusDamage=Math.max(Math.floor((e.player.damageValue-e.creature.armor)*e.player.holyFlameLevel*.002),0),e.player.holyFlameLevel>0&&(e.extraNotes+=`HF Bonus Damage = ${e.holyFlameBonusDamage}<br>`))}(e),function(e){e.deathDealerBonusDamage=Math.floor(e.player.damageValue*(Math.min(.01*Math.floor(e.player.killStreakValue/5)*e.player.deathDealerLevel,20)/100))}(e),function(e){e.counterAttackBonusAttack=Math.floor(.0025*e.player.attackValue*e.player.counterAttackLevel),e.counterAttackBonusDamage=Math.floor(.0025*e.player.damageValue*e.player.counterAttackLevel)}(e),function(e){e.extraStaminaPerHit=0,e.player.counterAttackLevel>0&&(e.extraStaminaPerHit=Math.ceil(.0025*(1+e.player.doublerLevel/50)*e.player.counterAttackLevel))}(e),function(e){e.player.deathDealerLevel>0&&(e.extraNotes+=`DD Bonus Damage = ${e.deathDealerBonusDamage}<br>`)}(e),function(e){e.player.counterAttackLevel>0&&(e.extraNotes+=`CA Bonus Attack/Damage = ${e.counterAttackBonusAttack} / ${e.counterAttackBonusDamage}<br>CA Extra Stam Used = ${e.extraStaminaPerHit}<br>`)}(e)}const zi=e=>e.creatureHitByHowMuch>=0?"Yes":"No",Yi=e=>e.hitByHowMuch>0?"Yes":"No",Ui=e=>`<span style="color:#333333">${e}</span>`,Qi=e=>`<tr>${e}</tr>`,Ji=(e,t)=>`<td${t%2?"":' class="fshRight"'}>${e}</td>`,Xi=e=>Qi(e.map(Ji).join(""))
function Zi(e){return`<table width="100%"><tbody>${(e=>Qi(`<td bgcolor="#CD9E4B" colspan="4" align="center">${(e=>e.callback.groupExists?"Group ":"")(e)}Combat Evaluation</td>`))(e)}${(e=>Xi([Ui("Will I hit it?"),Yi(e),Ui("Extra Attack:"),`( ${e.hitByHowMuch} )`]))(e)}${(e=>Xi([Ui("# Hits to kill it?"),e.numberOfHitsRequired,Ui("Extra Damage:"),`( ${e.damageDone} )`]))(e)}${(e=>Xi([Ui("Will I be hit?"),zi(e),Ui("Extra Defense:"),`( ${-1*e.creatureHitByHowMuch} )`]))(e)}${(e=>Xi([Ui("# Hits to kill me?"),e.numberOfCreatureHitsTillDead,Ui("Extra Armor + HP:"),`( ${-1*e.creatureDamageDone} )`]))(e)}${(e=>Xi([Ui("# Player Hits?"),e.playerHits,Ui("# Creature Hits?"),e.creatureHits]))(e)}${(e=>Qi(`${Ji(Ui("Fight Status:"),0)}<td colspan="3"><span>${e.fightStatus}</span></td>`))(e)}${(e=>Qi(`${Ji(Ui("Notes:"),0)}<td colspan="3"><span style="font-size:x-small;">${e.extraNotes}</span></td>`))(e)}</tbody></table>`}let ec=0,tc=0,ac=0
...
t=e,[Ki,xi,_i,qi,ji,Mi,Ri].forEach(e=>e(t))}(s),s.evaluatorHTML=Zi(s),n.groupExists?vc(s.evaluatorHTML):mc(s.evaluatorHTML)}function bc(e){return e.members[0].name===p()}async function gc(e,t,a){if(a){!function(e,t,a){if(!a.r?.attributes)return
const n=a.r.attributes
hc(e,t,{groupExists:!0,groupAttackValue:n[0].value,groupDefenseValue:n[1].value,groupArmorValue:n[2].value,groupDamageValue:n[3].value,groupHPValue:n[4].value})}(e,t,await Wt(a))}}async function kc(e,t){const a=function(e){if(b(e.r))return e.r.find(bc)?.id}(await Ze())
...
1===t.length&&Lt(t[0])}function Cc(){if(!wc)return
const e=n("actionList")
X("player",e).forEach($c)}function Lc(){return`${Jt("showHuntingBuffs")} ${Xt("enabledHuntingMode")}<select name="enabledHuntingMode"><option value="1"${Zt(t.enabledHuntingMode,"1")}>${t.buffsName}</option><option value="2"${Zt(t.enabledHuntingMode,"2")}>${t.buffs2Name}</option><option value="3"${Zt(t.enabledHuntingMode,"3")}>${t.buffs3Name}</option></select>`}let Dc=0,Vc=""
const Mc=()=>Dc
function Ac(){const e=[null,[t.buffs,t.buffsName],[t.buffs2,t.buffs2Name],[t.buffs3,t.buffs3Name]][t.enabledHuntingMode]
b(e)&&([Dc,Vc]=e)}function Sc(e){"enabledHuntingMode"===e.target.name&&(v("NewMap","toggleEnabledHuntingMode"),t.enabledHuntingMode=e.target.value,j("enabledHuntingMode",t.enabledHuntingMode),Ac(),GameData.fetch(h))}function Nc(e){v("NewMap","togglePref"),t[e]=!t[e],j(e,t[e])}const Hc={hideSubLvlCreature:function(){Nc("hideSubLvlCreature"),GameData.fetch(vt)},hidePlayerActions:function(){v("NewMap","toggleHidePlayerActions"),wc=!wc,j("hidePlayerActions",wc),GameData.fetch(vt)},showCreatureInfo:()=>Nc("showCreatureInfo"),showHuntingBuffs:function(){Nc("showHuntingBuffs"),GameData.fetch(h)},showMonsterLog:()=>Nc("showMonsterLog"),showTitanInfo:function(){Nc("showTitanInfo"),Kr(GameData.realm().dynamic)},showBuffInfo:function(){Nc("showBuffInfo"),Pa()}}
function jc(e){const t=Hc[e.target.name]
ee(t)&&(e.target.blur(),t(e))}function Bc(){const e=n("worldPage")
if(!e)return
const t=a({className:"fshCenter fshFten"}),s=a({id:"fshWorldPrefs",innerHTML:`${Jt("showCreatureInfo")}&nbsp;&nbsp;${Jt("showMonsterLog")}&nbsp;&nbsp;${Jt("showTitanInfo")}&nbsp;&nbsp;${Jt("showBuffInfo")}<br>${Jt("hideSubLvlCreature")}&nbsp;&nbsp;${Jt("hidePlayerActions")}&nbsp;&nbsp;${Lc()}`})
m(s,jc),L(s,"change",Sc),i(t,s)
const r=a()
return i(t,r),i(e,t),r}const xc=[{generalVariable:1.1053,hpVariable:1.1},{generalVariable:1.1,hpVariable:1.053},{generalVariable:1.053,hpVariable:1},{generalVariable:1.1053,hpVariable:1}]
function Tc(){var e
t.combatEvaluatorBias=D("combatEvaluatorBias"),t.generalVariable=(e=t.combatEvaluatorBias,xc[e]?xc[e].generalVariable:1.1053),t.hpVariable=function(e){return xc[e]?xc[e].hpVariable:1.1}(t.combatEvaluatorBias)}function Ec(e,t){return e[t.name]=!0,e}function Gc(e,t,a){return e[J(a)]||t.push(a),t}function Pc(e,t){Te(`You are missing some ${Vc} hunting buffs<br>(${t.join(", ")})`,e)}function Rc(e){Te("",e)}function Fc(e,a){t.showHuntingBuffs?function(e,t){const a=t.b.reduce(Ec,{}),n=Mc().reduce(u(Gc,a),[])
...
return t?.actions?.length?(t.actions=t.actions.filter(u(Oc,function(e){return e.realm?.minlevel||GameData.realm().minlevel}(t))),Dt(t)):e}function Wc(e,a){t.hideSubLvlCreature&&function(e){return e.data?.d&&ea(e.data.d,vt)}(a)&&(e.dataFilter=Ic)}function qc(e){t[e[0]]=Vt(e[1])}function Kc(e){t[e]=Vt(e)}function zc(){[["buffs","huntingBuffs"],["buffs2","huntingBuffs2"],["buffs3","huntingBuffs3"]].forEach(qc),["doNotKillList"].forEach(Kc)}function Yc(e){t[e[0]]=D(e[1])}function Uc(e){t[e]=D(e)}function Qc(){[["buffsName","huntingBuffsName"],["buffs2Name","huntingBuffs2Name"],["buffs3Name","huntingBuffs3Name"],["showHuntingBuffs","showHuntingBuffs"]].forEach(Yc),["enabledHuntingMode","hideSubLvlCreature","showTitanInfo","showBuffInfo","showMonsterLog","showCreatureInfo"].forEach(Uc)}const Jc=[function(){let e=0
window.requestAnimationFrame=t=>{const a=window.performance.now(),n=Math.max(e+16,a)
return e=n,setTimeout(()=>{t(e)},n-a)},window.cancelAnimationFrame=clearTimeout},function(){Tc(),zc(),Qc()
const e=Bc()
$.ajaxPrefilter("JSON",Wc),t.hideSubLvlCreature&&GameData.fetch(vt),function(e){Ac()
const a=u(_c,e)
$.subscribe(g,a),t.showHuntingBuffs&&window.initialGameData&&a(null,{b:window.initialGameData.player.buffs})}(e),wc=D("hidePlayerActions"),$.subscribe(ae,Cc),Cc()},function(){pt(),ht()&&ui()},function(){$.subscribe($t,yc)},function(){bs.forEach(gs)},function(){D("enableCreatureColoring")&&i(document.body,Et("#actionList .creature-1 {color: green;}\n#actionList .creature-2 {color: yellow;}\n#actionList .creature-3 {color: red;}"))},function(){$.subscribe(ae,as),as(),function(){const e=GameData.doAction
GameData.doAction=rs(e)}()},function(){Hs(),$.subscribe("-1-success.action-response 4-success.action-response 5-success.action-response 25-success.action-response",Es),Es()},function(){$.subscribe(ft,ai)},function(){D("keepLogs")&&$.subscribe(G,wn)},function(){window.initialGameData&&Yr(0,window.initialGameData),$.subscribe(`${Re} ${Fe}`,Yr)},function(){$.subscribe(kt,yi)},function(){$.subscribe(lt,ti)},function(){$("#messageCenter").worldMessageCenter({offset:"0 60"})},function(){V("#mapTooltip")},function(){cn(),$.subscribe(y,ln),$.subscribe(w,un)},function(){Pa(),$.subscribe(`${g} ${k}`,Pa)},function(){L(n("actionList"),"mouseover",Zn)},function(){const{body:e}=document
...
//# sourceMappingURL=newMap-CKomjYLH.js.map
