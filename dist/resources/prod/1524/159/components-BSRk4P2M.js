import{ak as e,ek as t,el as s,K as r,J as n,em as a,bX as i,bW as o,y as c,bj as l,aG as u,E as p,H as d,bD as v,N as h,O as f,c6 as m,c7 as g,C as b,D as y,F as k,Q as D,bm as w,T as S,R as C,da as E,bE as z,s as T,aF as $,G as _,bH as x,ab as Q,en as I,d7 as N,cr as j,$ as M,a1 as G,e as H,cp as P,c as W,n as q,v as A,a8 as F,a9 as L,h as R,eo as U,q as V,o as J,bi as K,t as O,g as X,bs as B}from"./calfSystem-CIdPz3EO.js"
import{d as Y}from"./daComponents-Dg3C-sEL.js"
import{c as Z}from"./closestTd-Cte_STWk.js"
...
var e},()=>r(a).get("del").length]),h(e,t)},Q=e=>{var t=oe()
h(e,t)}
d(_,e=>{r(a).get("del").length?e(x):e(Q,!1)}),h(e,$),f(),n()}var le=b('<div><table class="fshTblCenter"><thead><tr><th colspan="3">Component Summary</th></tr><tr><th>Total:</th><th colspan="2"> </th></tr></thead><tbody></tbody></table></div>'),ue=b('<p style="color: red"> </p>'),pe=b('<div class="compSumSpin"><span class="fshSpinner fshSpinner12"></span></div>')
...
return t}(Y)
return{rollup:function(e){const t=new te(x(e,"b").map(t=>{return[t.b,(s={...t,del:e.filter(({b:e})=>e===t.b).map(({a:e})=>e),delPending:!1},new te(Q(s)))]
var s}))
...
d(w,e=>{r(i)?e(C,!1):e(S)})
var $=y(w,2),_=k($)
E(_,{onclick:function(){T("components","insertQuickExtract"),I()},children:(e,t)=>{var s=z("Quick Extract")
h(e,s)}})
var x=y($,2),Q=e=>{var t=fe(),s=k(t)
N(s,()=>({"--button-color":"red"})),E(s.lastChild,{onclick:m,children:(e,t)=>{var s=z("Delete All Visible")
h(e,s)}}),h(e,t)}
d(x,e=>{r(a)&&e(Q)}),h(t,g),f()}function be(e){return j({subcmd:"destroycomponent",removeIndex:e})}async function ye(e){const t=await H({cmd:"profile",subcmd:"destroycomponent",component_id:e})
...
return t.length>0?{r:t.map(e=>e.c),s:!0}:s.length>0?{e:{message:s[0].m},s:!1}:{e:{message:e[0].m},s:!1}}(await G(e.map(ye)))}function De(e){if(!e)return
const t=e.children[0]
return t.replaceWith(A({className:"compSumSpin",innerHTML:'<span class="fshSpinner fshSpinner12"></span>'})),t}function we(e,t){!function(e,t,s){se.update(r=>(r.get(e)?.set(t,s),r))}(t,"delPending",e)}const Se=([,e])=>e,Ce=e=>x(e.map(Se)),Ee=([,,e])=>e,ze=e=>function(e,t){se.update(s=>(function(e,t){if(!t)return
const s=t.get("del").filter(t=>!e.includes(t))
t.set("del",s)}(t,s.get(e)),s))}(...e)
async function Te(e){const t=e.map(([e])=>[e,De(e)])
const s=await(r=e.map(Ee),M(be,ke,r))
var r
s?.s?((e=>Ce(e).map(t=>[t,e.filter(([,e])=>e===t).map(Ee)]))(e).forEach(ze),(e=>{e.forEach(([e])=>e?.children[0]?.remove())})(t)):(q(s?.e?.message??"Unknown Error"),function(e){e.forEach(([e,t])=>{t&&e.children[0].replaceWith(t)})}(t))}async function $e(e){const t=Ce(e)
t.forEach(W(we,!0)),await G(ee(30,e).map(Te)),t.forEach(W(we,!1))}function _e(e){const{itemId:t,invId:s}=F(L,e.dataset.tipped)
return[Number(t),Number(s)]}const xe=e=>[Z(e),..._e(e)]
function Qe(e){$e(R("img",e).map(xe))}function Ie(e,t){$e((e=>U(se).get(e).get("del"))(t).map(s=>{return[(r=e,n=s,Z(V(`img[data-tipped*="&inv_id=${n}&"]`,r))),t,s]
var r,n}))}function Ne(e){"IMG"===e.target.tagName&&(e.preventDefault(),T("components","quickDel"),K(e.target),$e([[Z(e.target),..._e(e.target)]]))}function je(e){e.classList.add("fshQuickDel"),J(e,Ne)}function Me(){const e=function(){const e=X("profileRightColumn"),t=B("inventory-table",e)
if(2===t.length)return t[1]}()
e&&O(ge,{props:{dispatchDelete:W(Qe,e),dispatchDelType:W(Ie,e),dispatchQuickDel:W(je,e)},target:e.parentNode})}export{Me as default}
//# sourceMappingURL=components-BSRk4P2M.js.map
