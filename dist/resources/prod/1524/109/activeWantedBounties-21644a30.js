import{G as e,ad as n,i as t,dk as s,l as r,a4 as i,s as a,dl as o,v as c,a5 as u,q as l,a0 as f,af as d,ab as b,g as p,an as h,H as m,r as L,w,o as y}from"./calfSystem-2f15e074.js"
import{f as g}from"./functionPasses-d78c6fe2.js"
import{c as v}from"./createSpan-14f0ab30.js"
import{b as $}from"./now-6f22aec9.js"
import{s as N}from"./shouldBeArray-fbeee315.js"
...
var t
return{target:u(n),link:n.href,lvl:u(n.nextSibling).replace(/[[|\]]/g,""),reward:u(e[2]),rewardType:S(e),xpLoss:u(e[3]),posted:u(e[4])}}let P=0,C={},M={},U=!1,G=!1,q=[]
const E=()=>C,O=()=>M,X=()=>U,K=()=>q
...
const I=()=>F
function J(e){return`Level:  ${e.lvl}<br>Reward: ${e.reward} ${e.rewardType}<br>XP Loss Remaining: ${e.xpLoss}<br>Progress:  ${e.progress}`}function Q(e){return W(e,J)}function Y(){F=B([A,"bountyList",E,"Active",Q])}let Z=0
const _=()=>Z
...
if(le(t),n.enableWantedList)if(ue(t),oe<ce){fe(await x(oe+1))}else se()}const de=[()=>!E(),()=>!O(),()=>G]
async function be(e,n){if(function(e,n){C=f("bountyList"),M=f("wantedList"),P=d("bountyListRefreshTime"),G=d("bwNeedsRefresh"),G||D(e,n)&&(G=!0)}(e,n),de.some(g)){M={},M.bounty=[],M.isRefreshed=!0,M.lastUpdate=$(),U=!1,q=N("wantedNames"),b("bwNeedsRefresh",!1)
fe(await x(1))}else!function(e,n){n&&(O().isRefreshed=!1,se()),e&&(E().isRefreshed=!1,Y())}(e,n)}function pe(e){e.target===I()&&(i("bountyList",null),be(n.enableActiveBountyList,n.enableWantedList)),e.target===_()&&(i("wantedList",null),be(n.enableActiveBountyList,n.enableWantedList))}function he(){w()||(n.enableActiveBountyList&&(R=j(),t(s(),R)),n.enableWantedList&&(k=j(),t(s(),k)),A()&&y(A(),pe),T()&&y(T(),pe),be(n.enableActiveBountyList,n.enableWantedList))}export{he as default}
//# sourceMappingURL=activeWantedBounties-21644a30.js.map
