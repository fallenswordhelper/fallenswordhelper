import{C as t,bo as n,bp as e,S as o,L as s,M as c,am as r,T as l,bf as a,bh as i,bg as u,be as p,a0 as m,bx as d,bi as f,aL as $,aP as g,s as h,O as b,_ as k,P as y,a3 as x,b8 as v,Q as w,U as S,a4 as C,dV as T,bj as E,bk as D,bl as L,ck as j,b5 as M,N as I,b6 as N,dW as Q,bP as P,e as _,bN as A,$ as B,c as H,E as V,ab as q,m as U,A as W,k as G,dS as J,q as K,o as O,aK as R,g as X,aW as z}from"./calfSystem-B-q5dZfX.js"
import{L as F}from"./LinkButtonBracketed-DPYhT5F9.js"
import{h as Y,u as Z}from"./await_block-C0N0_odL.js"
import{d as tt}from"./daComponents-Cy9zLUS0.js"
import{u as nt}from"./uniq-DgIs0Nu2.js"
import{c as et}from"./closestTd-BFOQcwlW.js"
import{a as ot}from"./all-YfMtr2SN.js"
import{r as st}from"./regExpGroups-CG1jsUnt.js"
...
const c=f()
return[o,s,function(){h("components","enableQuickDel"),e(0,o=!0),c("enableQuickDel")},function(){h("components","countComponents"),e(1,s=!0)},function(){h("components","insertQuickExtract"),Q()},function(){h("components","deleteAllVisible"),c("deleteAllVisible")},function(n){j.call(this,t,n)}]}class Qt extends o{constructor(t){super(),s(this,t,Nt,It,c,{})}}function Pt(t){return P({subcmd:"destroycomponent",removeIndex:t})}async function _t(t){const n=await _({cmd:"profile",subcmd:"destroycomponent",component_id:t})
...
//# sourceMappingURL=components-DGeN2KJL.js.map
