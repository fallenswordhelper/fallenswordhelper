import{S as s,L as e,M as t,cb as l,O as o,Q as i,cc as n,T as c,X as a,Y as d,cd as $,ce as u,cf as r,bc as f,bf as m,a0 as p,cg as b,bg as v,k as y,ch as g,bh as h,bi as x,bj as w,ci as k,cj as I,ag as C}from"./calfSystem-C4gAE-9q.js"
function L(s){let e,t,b,v
const y=s[2].default,g=l(y,s,s[1],null)
return{c(){e=o("div"),g&&g.c(),i(e,"class","svelte-6wd0xo"),n(e,"visible",s[0])},m(l,o){c(l,e,o),g&&g.m(e,null),t=!0,b||(v=a(e,"click",d(s[3])),b=!0)},p(s,[l]){g&&g.p&&(!t||2&l)&&$(g,y,s,s[1],t?r(y,s[1],l,null):u(s[1]),null),(!t||1&l)&&n(e,"visible",s[0])},i(s){t||(f(g,s),t=!0)},o(s){m(g,s),t=!1},d(s){s&&p(e),g&&g.d(s),b=!1,v()}}}function j(s,e,t){let l,o,i,{$$slots:n={},$$scope:c}=e,{visible:a=!0}=e
return s.$$set=s=>{"visible"in s&&t(0,a=s.visible),"$$scope"in s&&t(1,c=s.$$scope)},s.$$.update=()=>{1&s.$$.dirty&&(a?document.body.classList.contains("noscroll")||(l=!0,o=window.scrollY,i=document.body.style.top,document.body.classList.add("noscroll"),document.body.style.top=`-${o}px`):l&&(document.body.classList.remove("noscroll"),document.body.style.top=i||"",window.scrollTo(0,o)))},[a,c,n,function(e){b.call(this,s,e)}]}class E extends s{constructor(s){super(),e(this,s,j,L,t,{visible:0})}}function T(s){let e,t,d,b
...
//# sourceMappingURL=Modal-seireTkf.js.map
