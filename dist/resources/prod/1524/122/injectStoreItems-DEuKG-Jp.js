import{ag as t,bJ as e,$ as n,S as s,L as o,M as a,N as i,O as r,P as c,Q as u,R as l,T as d,U as m,V as f,X as p,_ as h,a0 as $,b4 as k,a1 as g,bg as w,a3 as b,W as L,a4 as x,a6 as _,D as v,f as S,s as y,a8 as D,k as E,bh as Q,am as N,b3 as C,bi as T,bc as j,bf as I,bj as A,ae as H,C as O,aq as B,aT as M,c as R,cJ as U,cy as F,aM as G,aL as P,w as J,ai as V,o as W,p as q}from"./calfSystem-C4gAE-9q.js"
import{m as K,e as X,a as Y,d as z}from"./dropItem-C7rgTn_j.js"
import{d as Z}from"./doStatTotal-Bhm6O3Og.js"
import{c as tt}from"./closestTr-DcbdgdML.js"
import{e as et}from"./errorDialog-B4_TjdGG.js"
import{a as nt}from"./arrayFromRadioNodeList-BEK7MItB.js"
import{d as st}from"./daLoadInventory-CrkuA4Ey.js"
import{b as ot}from"./basicItem-CQKM8zr0.js"
import{f as at}from"./flattenItems-C4pfIrZn.js"
import{L as it}from"./LinkButtonBracketed-jMU7wdWi.js"
import{b as rt}from"./batch-CkGMyLju.js"
let ct=0,ut=0
...
return e?.items?S(O(e.items).map((([e,n])=>[e,{...n,item_name:Ft(t,n)}]))):{}}(t)),Ut}function Pt(t,e){return t[e]=(t[e]||0)+1,t}const Jt=(t,e,n)=>` [<button class="fshStoreItemsButton ${t}"${e}>${n}</button>]`,Vt=(t,e,n)=>Jt(`${t} actionButton tooltip-multiline fshNoWrap`,(t=>` data-tooltip="INSTANTLY ${t} THE ITEM. NO REFUNDS OR DO-OVERS! Use at own risk."`)(e),`Quick ${n}`),Wt=(t,e,n)=>`[<a href="${t}"${e}>${n}</a>]`
const qt=t=>Wt(`${G}items${P}view&item_id=${t.item_id}`,' target="_blank"',"UFSG"),Kt=(t,e,n)=>t[Tt]&&e[n.item_id]>1,Xt=(t,e)=>t[3]&&(!e.bound||-1!==e.guild_tag),Yt=(t,e)=>t[jt]&&-1===e.guild_tag
function zt(t,e){return e[0]()?t+e[1]():t}function Zt(t,e,n){return[[()=>t[Nt],()=>`${function(t){return t.bound?'<span class="aHSpacer"></span>':Wt(`${F}${encodeURIComponent(t.item_name)}`,"","AH")}(n)} ${qt(n)}`],[()=>!0,()=>`&nbsp;${n.item_name}`],[()=>Kt(t,e,n),()=>Jt("fshBlack","","Check All")],[()=>Xt(t,n),()=>Vt("fshBlue","SENDS","Send")],[()=>Yt(t,n),()=>Vt("fshRed","DROP","Drop")]]}function te(t,e,[n,s]){const o=n
...
if(!t.length)return
const e=await xt()
e.items&&t.map((t=>[t,e.items[t.value]])).filter((([,t])=>t)).forEach((([t,e])=>{t.checked=!t.disabled&&-1!==e.guild_tag}))}()}))}function se(){if(J())return
if(!lt())return
const t=It.map((t=>V(t)))
Z(),ne(t),t.some((t=>t))&&ee(t),W(q(),Qt)}export{wt as M,xt as a,bt as b,St as c,pt as d,lt as e,dt as g,se as i}
//# sourceMappingURL=injectStoreItems-DEuKG-Jp.js.map
