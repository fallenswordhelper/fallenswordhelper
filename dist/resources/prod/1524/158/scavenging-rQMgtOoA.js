import{g as n,c as t,b as s,aQ as e,i as o,s as a,d as c,av as i,aN as r,l as u,au as f,dx as l,by as g,u as d,p as m,aa as p,c0 as v}from"./calfSystem-CIuUjh4H.js"
import{c as b}from"./closestTable-CAaKFM8t.js"
function $(n,t,s){a("scavenging","redrawMaxTimes"),c("",n)
const e=Number(s.value)
i(e)||0===e||function(n,t,s){const e=r(u(t)),o=Math.floor(e/s).toString()
c(`&nbsp;&nbsp;Max: ${o} times`,n)}(n,t,e)}function h(n,t,s){n&&$(n,t,s)}function x(a){!function(n){b(n).removeAttribute("width")}(a),function(n,e,o){const a=t(h,n,e,o)
...
return n[s]=(n[s]??0)+1,n}function q([n],[t]){return v(n,t)}function y([n,t]){return`<br>${t} ${n}(s), `}function N(n){const t=function(n){return n.reduce(j,{})}(n)
return`<br>${n.length} item(s):${p(t).sort(q).map(y).join("")}`}function R(){a("scavenging","multiScav")
let t=""
...
//# sourceMappingURL=scavenging-rQMgtOoA.js.map
