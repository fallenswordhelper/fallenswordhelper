import{h as a,a$ as e,a0 as n,b0 as t,o as s,l as r,s as o,Y as i,j as c,a2 as l,b1 as f,aS as u,q as p,b2 as d,i as m,u as g,aM as h,k as y,aa as $,az as b,b3 as w,au as L,aL as P,a3 as j,c as k}from"./calfSystem-CIuUjh4H.js"
import{i as v}from"./insertHtmlAfterEnd-BNBx3698.js"
import{i as A,r as I}from"./relatePlayer-XZTYuRJp.js"
import{g as E}from"./getId-CEBzpjjo.js"
import{i as _}from"./insertHtmlAfterBegin-DCUmpZPb.js"
import{g as T}from"./getLogTime-CZGXW1gy.js"
import{c as Y}from"./createStyle-Co3Q_8M9.js"
import{g as G}from"./addLogColoring-Cl_8Twpy.js"
import{p as S}from"./parseDateAsTimestamp-hdeGukFZ.js"
const B=a=>[a,e(a.href,"target_username")],C=async([a,e])=>[a,e,await A(e)]
function H(a,[e,n]){l(n.cells[1],`<font size="1"><br>[ ${((a,e)=>`<a${(a=>a?' class="pmIgnoreUrl"':"")(a)} href="${f}${u(e)}" data-tooltip="Add to Ignore List">Ignore</a>`)(a,e)} ]</font>`),a||s(n.cells[1],a=>{"Ignore"===r(a.target)&&o("playerLogWidgets","Ignore")})}const x="fshGreen",z="fshRed",M=([,a])=>p(i,a),R=async([a,e,n])=>[e,n,await d(T(e),E(a))],W=([,,a])=>a?.s,D=a=>[18,21,31].includes(a.id),F=a=>`<span class="fshRed fshBold">${a}.</span>`
...
function ea(a){return aa.test(r(a.cells[2]))}function na(a){const e=S(u(a.cells[1]))
e>Z&&(L(P,e),Z=e)}const ta=[["addIgnoreLink",function(e,n){const t=a(i,e)
if(0===t.length)return
t.map(a=>[a,c(a)]).forEach(a=>H(n,a))}],["colorPlayerNames",async function(e,t){const s=a(i,e)
if(!s.length)return
V(e,await n(s.map(X)),t)}],["addAttackLinkToLog",async function(e,i){const c=a('a[href*="=createsecure&"]',e)
if(!c.length)return
const l=c.map(B);(await n(l.map(C))).filter(([,,a])=>!a).forEach(a=>function(a,[e,n]){v(e,` | <a${(a=>a?' class="pmAttackUrl"':"")(a)} href="${t}${n}">Attack</a>`),a||s(e.parentNode,a=>{"Attack"===r(a.target)&&o("playerLogWidgets","Attack")})}(i,a))}],["changeButtonLabels",function(n){a('a[href*="=trade&"]',n).filter(a=>!e(a.href,"subcmd")).forEach(a=>y("Trade",a)),a('a[href*="=createsecure&"]',n).forEach(a=>y("ST",a))}],["trackLadderReset",function(e){Z=b(P),a(w,e).map(c).filter(ea).forEach(na)}],["showPvPSummaryInLog",async function(e){const t=a('a[href*="&combat_id="]',e)
...
function sa(a,e,[n,t]){b(n)&&t(a,e)}function ra(a){if(j())return
const e=G()
e&&function(a,e){ta.forEach(k(sa,a,e))}(e,a)}export{ra as a}
//# sourceMappingURL=addLogWidgets-CbQoc0--.js.map
