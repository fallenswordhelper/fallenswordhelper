import{g as n,i as t,b as s,c as e,s as o,d as r,a8 as c,ae as i,c$ as a,b3 as u,m as f,p as m,C as l,bu as g}from"./calfSystem-DZGU7L1H.js"
import{c as d}from"./createSpan-DcQ00sL_.js"
...
return n[s]=(n[s]??0)+1,n}function R([n],[t]){return g(n,t)}function q([n,t]){return`<br>${t} ${n}(s), `}function x(n){const t=function(n){return n.reduce(N,{})}(n)
return`<br>${n.length} item(s):${l(t).sort(R).map(q).join("")}`}function T(){o("scavenging","multiScav")
let t=""
...
return t?x(t):""}(n)}return t}function _(n){return function(s,e,o){n(s,e,o),i("lastScavPage",`${a}scavenging&cave_id=${o}&gold=${e}`),r(T(),(S||(S=f(),t(m(),S)),r("",S),S))}}function w(){!function(){if(!sendRequest)return
const n=sendRequest
u(n)&&(sendRequest=_(n))}(),function(){const t=n("multiplier_count")
t&&j(t)}()}export{w as default}
//# sourceMappingURL=scavenging-rBDBF70u.js.map
