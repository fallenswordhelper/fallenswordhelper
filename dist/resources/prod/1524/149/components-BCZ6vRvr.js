import{W as e,ey as t,V as s,bL as r,bK as n,R as a,bp as i,bY as o,b3 as c,at as l,au as p,a0 as u,a3 as d,a4 as v,bX as f,X as h,Y as m,Z as g,a7 as b,b8 as y,br as k,a8 as D,da as S,bq as w,s as z,as as C,_ as E,bu as $,H as T,S as x,ez as _,d7 as I,cg as Q,$ as N,x as q,k as M,ce as V,e as j,J as A,ah as L,u as P,E as W,F as H,n as R,eA as U,q as X,o as Y,b2 as F,ad as G,g as J,be as K}from"./calfSystem-BGW9cdWN.js"
import{d as Z}from"./daComponents-Dq9heAbF.js"
import{c as B}from"./closestTd-CEEZyrDn.js"
...
const[r,n]=f()
let h=i((()=>o(te,"$compStore",r).get(t.itemId))),C=!0
const E=c()
function $(){C&&(C=!1,z("components","delType"),t.dispatchDelType(t.itemId))}var T=l(),x=p(T),_=e=>{var t=ae(),r=g(t),n=g(r),a=m(r),i=g(a),o=m(a),c=e=>{var t=re()
d(e,t)},l=e=>{var t=ne(),s=g(t)
S(s,{onclick:$,children:(e,t)=>{var s=w("Del")
d(e,s)}}),d(e,t)}
u(o,(e=>{s(h).get("delPending")?e(c):e(l,!1)})),b(((e,t,s)=>{k(n,"src",e),k(n,"data-tipped",t),D(i,s)}),[()=>{return e=s(h),`${y}items/${e.get("b")}.gif`
var e},()=>{return`fetchitem.php?item_id=${(e=s(h)).get("b")}&inv_id=${e.get("a")}&t=2&p=${E}&vcode=${e.get("v")}`
var e},()=>s(h).get("del").length]),d(e,t)},I=e=>{var t=ie()
d(e,t)}
u(x,(e=>{s(h).get("del").length?e(_):e(I,!1)})),d(e,T),v(),n()}var ce=h('<div><table class="fshTblCenter"><thead><tr><th colspan="3">Component Summary</th></tr><tr><th>Total:</th><th colspan="2"> </th></tr></thead><tbody></tbody></table></div>'),le=h('<p style="color: red"> </p>'),pe=h('<div class="compSumSpin"><span class="fshSpinner fshSpinner12"></span></div>')
function ue(e,t){a(t,!0)
const[r,n]=f()
var c=l(),u=p(c)
C(u,(async function(){const e=await async function(e){const t=await e()
...
d(e,t)}),((e,n)=>{var a=i((()=>{var{rollup:e,maxComp:t}=s(n)
return{rollup:e,maxComp:t}})),c=i((()=>s(a).rollup)),l=i((()=>s(a).maxComp)),p=ce(),u=g(p),v=g(u),f=m(g(v)),h=m(g(f)),y=g(h),k=m(v)
E(k,20,(()=>s(c)),(e=>e),((e,s)=>{oe(e,{get dispatchDelType(){return t.dispatchDelType},get itemId(){return s}})})),b((()=>D(y,`${o(se,"$total",r)??""} / ${s(l)??""}`))),d(e,p)}),((e,t)=>{var r=le(),n=g(r)
b((()=>D(n,s(t).message))),d(e,r)})),d(e,c),v(),n()}var de=h("<div><!></div>"),ve=h("<div><!></div>"),fe=h('<div><svelte-css-wrapper style="display: contents"><!></svelte-css-wrapper></div>'),he=h('<div class="fshCenter"><!> <!> <div><!></div> <!></div>')
function me(t,r){a(r,!0)
let n=x(void 0),i=x(void 0),o=!0,c=!0,l=!0
function p(){o&&(o=!1,z("components","enableQuickDel"),e(n,!0),r.dispatchQuickDel())}function f(){c&&(c=!1,z("components","countComponents"),e(i,!0))}function h(){l&&(l=!1,z("components","deleteAllVisible"),r.dispatchDelete())}var b=he(),y=g(b),k=e=>{var t=de(),s=g(t)
S(s,{onclick:p,children:(e,t)=>{var s=w("Enable Quick Del")
d(e,s)}}),d(e,t)}
u(y,(e=>{s(n)||e(k)}))
var D=m(y,2),C=e=>{var t=ve(),s=g(t)
S(s,{onclick:f,children:(e,t)=>{var s=w("Count Components")
d(e,s)}}),d(e,t)},E=e=>{ue(e,{get dispatchDelType(){return r.dispatchDelType}})}
u(D,(e=>{s(i)?e(E,!1):e(C)}))
var $=m(D,2),T=g($)
S(T,{onclick:function(){z("components","insertQuickExtract"),_()},children:(e,t)=>{var s=w("Quick Extract")
d(e,s)}})
var Q=m($,2),N=e=>{var t=fe(),s=g(t)
I(s,(()=>({"--button-color":"red"}))),S(s.lastChild,{onclick:h,children:(e,t)=>{var s=w("Delete All Visible")
d(e,s)}}),d(e,t)}
u(Q,(e=>{s(n)&&e(N)})),d(t,b),v()}function ge(e){return Q({subcmd:"destroycomponent",removeIndex:e})}async function be(e){const t=await M({cmd:"profile",subcmd:"destroycomponent",component_id:e})
...
//# sourceMappingURL=components-BCZ6vRvr.js.map
