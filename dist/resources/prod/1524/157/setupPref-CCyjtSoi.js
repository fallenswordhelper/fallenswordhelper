import{bx as o,c as n,o as t,g as e,b as s,s as a,av as c,b_ as r,bz as f,cn as i,u,i as l}from"./calfSystem-CQOGdqPv.js"
import{t as p}from"./toggleForce-br4z9gGd.js"
import{s as h}from"./simpleCheckbox-BcIXGyya.js"
const d=[]
let m=0,w=0
...
d[e]=r(d[e],{})
const s=d[e]
s.rows=s.rows||[],P(n,t,s,o)}function v(o){o.header.classList.toggle("fshPoint")}function A(o){a("collapse","togglePref",o),m=!m,c(o,m),m?E(o):function(o){d.forEach(n=>{n.open||T(o,n)})}(o),d.forEach(v)}function k(a){w=a.headInd,function(o){const t=e(o)
...
//# sourceMappingURL=setupPref-CCyjtSoi.js.map
