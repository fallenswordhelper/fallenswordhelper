import{V as t,$ as a,a0 as n,a1 as e,a2 as s,a3 as i,p as c,a4 as r,a5 as o,a6 as u,c as f,s as l,a7 as m,a8 as d,i as p,u as k,a9 as h,o as g,aa as b,ab as v,d as T,ac as x,ad as y,g as I}from"./calfSystem-CQOGdqPv.js"
import{c as L}from"./createInput-CL-XaKKe.js"
import{c as C}from"./createLabel-EkLn6Kxi.js"
...
return o(e,n),e}function w(t,a){const n=a.children[0],{tipped:e}=n.dataset,{itemId:s,invId:i}=m(d,e)
...
a&&T("",a)}function O(t,a){N(a,t)||y(a.r)&&function(t,a){a.r.forEach(H),q(`${a.r.length.toString()} item(s) taken.`,t)}(t,a)}async function R(t,n){var e
O(t,await(e=n,a(M,j,e)))}function _(t,a,n){v("fshBls",n.target)&&function(t,a,n){l("mailbox","takeSimilar")
...
o(n,a),u(n,"change",f(F,t,a))}(t,a),S("qtOff","Quick Take",a)}export{G as default}
//# sourceMappingURL=mailbox-CJqFFfEN.js.map
