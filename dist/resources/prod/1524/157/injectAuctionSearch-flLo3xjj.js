import{am as t,db as e,p as s,d as a,az as n,g as i,ao as c,o as r,s as d,bo as l,cx as o,ad as u}from"./calfSystem-CQOGdqPv.js"
import{e as h,s as f}from"./selfIdIs-PWCsXJ1f.js"
...
i(p.id)&&(a(t,i(p.id)),c(p.gmname,p.currentItems))}function I(t){d("injectAuctionSearch","deleteQuickItem")
const e=t.getAttribute("data-itemId")
p.currentItems.splice(e,1),k()}const x=t=>i(`fshIn${p.fields[t]}`)
function A(){d("injectAuctionSearch","addQuickItem")
const t=0===p.fields.length?i("fshIn0").value:function(){const t={}
for(let e=0;e<p.fields.length;e+=1)t[p.fields[e]]="checkbox"===p.tags[e]?x(e).checked:x(e).value
return t}()
p.currentItems.push(t),k()}function $(){d("injectAuctionSearch","saveRawEditor")
const t=l(i("fshEd").value)
u(t)&&(p.currentItems=t,k())}function v(){d("injectAuctionSearch","resetRawEditor"),"fshAso"===p.id?p.currentItems=l(o.quickSearchList):p.currentItems=[],k()}function w(t){r(t,h([[f("fshReset"),v],[f("fshSave"),$],[f("fshAdd"),A],[t=>t.id.startsWith("fshDel"),I]]))}function S(n){const i=n||s()
a(`<table width=100%><tbody><tr class="fshHeader"><td width="90%"><b>&nbsp;${"Trade Hub Quick Search"}</b><td width="10%" class="fshBtnBox"></td></tr><tbody></table><div>This screen allows you to set up some quick search templates for the Auction House. The Display on AH column indicates if the quick search will show on the short list on the Auction House main screen. A maximum of 36 items can show on this list (It will not show more than 36 even if you have more than 36 flagged). To edit items, either use the large text area below, or add a new entry and delete the old one. You can always reset the list to the default values.</div><div class="fshSmall" id="fshAso"></div>`,i),p={id:"fshAso",headers:["Category","Nickname","Quick Search Text","Display in AH?"],fields:["category","nickname","searchname","displayOnAH"],tags:["text","text","text","checkbox"],url:["","",`${e}@replaceme@`,""],currentItems:t("quickSearchList")||[],gmname:"quickSearchList",categoryField:"category"},k(),w(i)}export{S as default}
//# sourceMappingURL=injectAuctionSearch-flLo3xjj.js.map
