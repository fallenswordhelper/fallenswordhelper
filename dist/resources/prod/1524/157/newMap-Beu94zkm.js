...
import{ay as t,u as a,g as n,b7 as r,k as s,aR as o,i,aE as l,aN as c,c as u,a2 as d,aq as f,o as m,s as v,b8 as p,bc as h,ad as b,bd as g,be as k,bf as y,bg as w,a5 as C,b as L,aA as D,bh as V,aU as M,bi as A,bj as S,bb as N,ba as H,av as B,h as x,bk as T,q as E,bl as G,bm as P,f as R,ab as F,bn as _,bo as I,bp as O,bq as j,br as W,bs as q,bt as K,bu as Y,bv as z,bw as U,bx as Q,by as J,aB as X,l as Z,bz as ee,bA as te,bB as ae,V as ne,$ as re,x as se,aG as oe,D as ie,aF as le,B as ce,P as ue,Q as de,J as fe,E as me,L as ve,G as pe,bC as he,C as be,F as ge,bD as ke,N as ye,S as we,bE as $e,bF as Ce,al as Le,n as De,ap as Ve,ak as Me,bG as Ae,I as Se,bH as Ne,bI as He,bJ as Be,bK as xe,bL as Te,d as Ee,aK as Ge,bM as Pe,bN as Re,bO as Fe,bP as _e,y as Ie,bQ as Oe,ac as je,bR as We,bS as qe,bT as Ke,bU as Ye,aw as ze,bV as Ue,bW as Qe,a0 as Je,bX as Xe,bY as Ze,bZ as et,b_ as tt,b$ as at,c0 as nt,c1 as rt,c2 as st,c3 as ot,c4 as it,c5 as lt,c6 as ct,c7 as ut,c8 as dt,c9 as ft,ca as mt,cb as vt,cc as pt,cd as ht,ce as bt,cf as gt,cg as kt,ch as yt,ci as wt,cj as $t,ck as Ct,cl as Lt,cm as Dt,cn as Vt,az as Mt,co as At}from"./calfSystem-CQOGdqPv.js"
import{t as St}from"./toggleForce-br4z9gGd.js"
import{r as Nt,a as Ht}from"./roundToString-DBxc6kHT.js"
import{d as Bt,q as xt}from"./quickbuffSuccess-BnL9ocTi.js"
import{c as Tt}from"./createInput-CL-XaKKe.js"
import{c as Et}from"./createLabel-EkLn6Kxi.js"
import{c as Gt}from"./idbLogger-B37td9AD.js"
import{r as Pt}from"./rnd-D_QmA-Fa.js"
import{c as Rt}from"./createStyle--h4yDzB1.js"
import{c as Ft}from"./createTable-ZYcS2hxf.js"
import{t as _t,g as It,a as Ot}from"./getTitanString-DrmoKrfx.js"
import{r as jt}from"./reduceBuffArray-Diy1E3zc.js"
import{r as Wt}from"./reliclist-B7l169y3.js"
import{d as qt}from"./daGroupStats-BwTHtlcH.js"
import{d as Kt,m as Yt}from"./mercEffect-K4BXJXGT.js"
import{a as zt}from"./attribsToArray-C3uhrkff.js"
import{r as Ut}from"./remainingPages-BUotk4St.js"
import{t as Qt}from"./testQuant-CkRKAmqT.js"
import{s as Jt,j as Xt}from"./simpleCheckbox-BcIXGyya.js"
...
const Tn=()=>An,En=()=>Sn,Gn=()=>Nn,Pn=()=>Hn,Rn=()=>Bn
function Fn(e,t){return j(W(t,e))}function _n(){var e
An=GameData.player().level,e=n("statbar-character-tooltip-stats"),Nn=Fn(e,q),Sn=Fn(e,K),Bn=Fn(e,Y),Hn=Fn(e,z),xn=Fn(e,U)}const In=e=>`<td>${e}:&nbsp;</td>`,On=e=>`<td width="40%">${e}</td>`
function jn([e,t,a,n,r]){return[In(e),On(`${t} (your ${a}:<span class="${n}">${r()}</span>)`)]}function Wn(e){return["<tr>",...e,"</tr>"].join("")}function qn(e,t){return Wn([...jn(e),...jn(t)])}function Kn(e){return`<tr><td colspan="2">${e.name}:</td><td colspan="2">${e.value}</td></tr>`}function Yn(e,t,a){return function(e){return`<table><tr><td><img src="${G}creatures/${e.image_id}.png" height="200" width="200"></td><td rowspan="2"><table width="400"><tr><td class="header" colspan="4" class="fshCenter">Statistics</td></tr>`}(e)+function(e,t){return Wn([In("Class"),On(e.creature_class),...jn(["Level",e.level,"level",t,Tn])])}(e,a)+function(e){return qn(["Attack",e.attack,"defense","fshYellow",En],["Defense",e.defense,"attack","fshYellow",Gn])}(e)+function(e){return qn(["Armor",e.armor,"damage","fshYellow",Pn],["Damage",e.damage,"armor","fshYellow",Rn])}(e)+function(e,t){return Wn([In("HP"),On(`${e.hp} (your HP:<span class="fshYellow">${xn}</span>)(1H: <span class="fshRed">${t}</span>)`),In("Gold"),On(e.gold)])}(e,t)+'<tr><td colspan="4" height="5"></td></tr><tr><td class="header" colspan="4" class="fshCenter">Enhancements</td></tr>'+function(e){return 0===e.enhancements.length?'<tr><td colspan="4">[no enhancements]</td></tr>':e.enhancements.map(Kn).join("")}(e)+function(e){return`<tr><td colspan="4" height="5"></td></tr><tr><td class="header" colspan="4" class="fshCenter">Description</td></tr><tr><td colspan="4">${e.description}</td></tr><tr><td colspan="4" height="5"></td></tr></table></td></tr><tr><td class="fshCenter"><b>${e.name}</b></td></tr></table>`}(e)}function zn(e){if(!$n(e))return function(e){const a=Math.ceil(e.hp*t.hpVariable+e.armor*t.generalVariable)
let n="fshYellow"
...
n&&Qn(t,n)}function Xn(e,t){return a=e,Un.every(e=>F(e,a))&&!F("fshTip",e)&&F("creature",t)
...
ue(()=>de(n,fe(t).message)),ve(e,a)}),ve(e,a),ye()}const fr=Le({promise:Promise.resolve()})
let mr=0
...
let Cr=0
function Lr(e){Cr[e.name]?Cr[e.name].seen&&(Cr[e.name].seen+=1):(Cr[e.name]={seen:1},function(e,t){t.creature_class=e.creature_class,t.image_id=e.image_id,t.level=Number(e.level),t.type=e.type}(e,Cr[e.name]))}function Dr(e,t,a){return t?e(t,a):a}function Vr(e,t){const a=e||{}
return a.min=Dr(Math.min,a.min,t),a.max=Dr(Math.max,a.max,t),a}const Mr=["attack","armor","damage","defense","hp"]
function Ar(e,t,a){const n=Vr(t[a],Number(e[a]));(function(e,t){return!e||e.min!==t.min||e.max!==t.max})(t[a],n)&&(t[a]=n)}function Sr(e,t){e[t.name]=Vr(e[t.name],Number(t.value))}function Nr(e){Cr||(Cr={}),Lr(e),function(e,t){Mr.forEach(u(Ar,e,t))}(e,Cr[e.name]),function(e,t){(function(e){return e.enhancements&&e.enhancements.length>0})(e)&&(t.enhancements=t.enhancements||{},e.enhancements.forEach(u(Sr,t.enhancements)))}(e,Cr[e.name]),xe("fsh_monsterLog",Cr)}async function Hr(){!function(e){Cr=e||{}}(await Be("fsh_monsterLog"))}const Br=[]
function xr(e){var a
...
function Rr(){return Te({subcmd:"scouttower"})}function Fr(e,[t,a,n]){const r=e.insertCell(-1)
return r.colSpan=t,n&&(r.className="header"),i(r,a()),r}function _r(e,t,a){const n=e.insertRow(-1)
return a&&(n.className="fshBlue"),function(e,t){t.forEach(u(Fr,e))}(n,t),n}function Ir(e,t){_r(e,t[0],t[1])}function Or(e,t){t.forEach(u(Ir,e))}let jr=0,Wr=0,qr=0,Kr=0,Yr=0,zr=0,Ur=0,Qr=0
const Jr=()=>jr,Xr=()=>Ur
function Zr(){jr=Fa("Current"),Wr=Fa("Kills"),qr=Fa("Member"),Kr=Fa("% of Total"),Yr=Fa("Status"),zr=Fa("Titan HP"),Ur=Fa("Total"),Qr=Fa("Your Guild")}let es=0,ts=0,as=0,ns=0,rs=0,ss=0,os=0,is=0,ls=0
...
return i(t,e),l(t,"%"),t}const Cs=[[[5,cs,!0],[1,us,!0]]],Ls=[[[2,()=>zr,!0],[4,()=>Qr,!0]]],Ds=[[[2,function(){const e=o()
return i(e,ds()),l(e,"/"),i(e,fs()),e}],[4,ms]]],Vs=[[[2,()=>Yr,!0],[4,hs]],!0],Ms=[[[2,()=>qr,!0],[2,()=>Wr,!0],[2,()=>Kr,!0]]]
let As=0,Ss=0,Ns=""
function Hs(){Ss=null,As&&!F("fshHide",As)&&(St(As,!0),Ee("&nbsp;",es),Ee("&nbsp;",ts),s("",as),s("",ns),s("",rs),s("",ss),s("",os),Ee("",is),Ee("",ls),ws())}function Bs(e){return 0===e.type&&(Ss=e.base_creature_id,Ns=`(${e.x},${e.y})`,!0)}function xs(){if(As)St(As,!1)
else{const e=n("actionContainer")
As=a({className:"fshActionBox titanInfo"}),gs(),ks=Ft({className:"fshCenter"}),Zr(),Or(ks,[Cs,Ls,Ds,[[[2,Jr,!0],[4,u($s,vs())]],!0],[[[2,Xr,!0],[4,u($s,ps())]],!0],Vs,[[[6,bs]]],Ms]),i(As,ys()),i(e,As)}}function Ts(e){return e<=0?'<span class="fshGreen cooldown">No active cooldown</span>':`<span class="fshMaroon cooldown">Cooldown until: ${function(e){const t=new Date(Ge()+1e3*e)
return`${Pe(t.getHours())}:${Pe(t.getMinutes())} ${Pe(t.getDate())}/${Re[t.getMonth()]}/${t.getFullYear()}`}(e)}</span>`}function Es(e){return Ht(Ot(e.max_hp-e.current_hp,e.kills),2)}function Gs(e){return Ht(100*e.kills/e.max_hp,2)}function Ps(e){!function(e){[[_t(e.creature.name),cs],[Ns,us],[e.current_hp,ds],[e.max_hp,fs],[e.kills,ms],[Es(e),vs],[Gs(e),ps]].forEach(([e,t])=>s(e,t()))}(e),Ee(function(e){return It(e.kills,e.max_hp,e.current_hp)}(e),hs()),Ee(Ts(e.cooldown),bs())}function Rs(e,t){return[[[2,()=>Fa(t.player.name)],[2,()=>Fa(t.kills.toString())],[2,()=>Fa(`${Ht(100*t.kills/e.kills,2)}%`)]]]}function Fs(e){return e.realm&&e.creature.base_id===Ss&&e.realm===Pr}function _s(e){const t=e.find(Fs)
t&&(Ps(t),function(e){if(ws(),!e.contributors)return
const t=e.contributors.map(u(Rs,e))
Or(ys(),t)}(t))}let Is=null
const Os=e=>t.showTitanInfo&&b(e)&&e.some(Bs)
function js(e,t){(e=>e?.s&&b(e.r))(t)&&(_s(t.r),Os(GameData.realm().dynamic)?Is=window.setTimeout(e,3e4):Hs())}async function Ws(){js(Ws,await re(Rr))}function qs(e){Is&&(window.clearTimeout(Is),Is=null),Os(e)?(xs(),Ws()):Hs()}function Ks(e){var t
...
var r=Us()
ge(r,21,()=>je(16,a()),Oe,(e,a,r)=>{var s=zs(),o=me(s)
...
r&&t({attack:r[0],defense:r[1],armor:r[2],hp:r[3],damage:r[4]}),no.set(["groupStore","Done."])}const go=Ue(po,(e,t)=>{bo(e,t)}),ko=(e,t,a)=>Math.ceil(e*tt(t,0)*a),yo=(e,t)=>ko(e,t,.0025),wo=(e,t)=>ko(e,t,.001),$o=wo,Co=wo,Lo=wo,Do=wo,Vo=wo,Mo=(e,t)=>Math.ceil(e*(1+.001*tt(t,0))),Ao=(e,t)=>Math.ceil(e*(1-t*at)),So=Qe([]),No=Ue(So,(e,t)=>{e&&t(jt(e))}),Ho=Ue([No,go],([e,t],a)=>{if(!e||!t)return
const n=Mo(t.defense,e.Constitution),r=t.hp+$o(n,e.Fortitude)
a({dmgWithChiStrike:t.damage+Co(r,e["Chi Strike"]),defWithConst:n,hpWithFortitude:r,nmv:yo(t.attack,e["Nightmare Visage"]),sanctuary:Lo(t.armor,e.Sanctuary)})})
...
!function([e,t,a,n,r,s]){a({attackWithNmv:t.attackValue-n,chiStrike:e.chiStrikeLevel,cloak:e.cloakLevel?"Yes":"No",dmgWithChiStrike:t.damageValue+Co(s,e.chiStrikeLevel),defWithConst:r,hpWithFortitude:s,nmv:n,sanctuary:Lo(t.armorValue,e.sanctuaryLevel)})}([e,t,a,n,r,t.hpValue+$o(r,e.fortitudeLevel)])})
...
e.cloakLevel?t("Yes"):t("No")}),Po=Ue(vo,(e,t)=>{t({armorValue:e?.armorValue??"",attackValue:e?.attackValue??"",damageValue:e?.damageValue??"",cloaked:e?.cloaked??"",defenseValue:e?.defenseValue??"",hpValue:e?.hpValue??""})}),Ro=Ue(co,(e,t)=>{t(e?.length??"")}),Fo=Ue(To,(e,t)=>{t({attack:e?.attack??"",dc225:e?.dc225??"",dc175:e?.dc175??"",defense:e?.defense??"",armor:e?.armor??"",hp:e?.hp??"",damage:e?.damage??""})}),_o=e=>({attack:e?.attack??"",defense:e?.defense??"",armor:e?.armor??"",hp:e?.hp??"",damage:e?.damage??""}),Io=Ue(go,(e,t)=>{t(_o(e))}),Oo=Ue(Bo,(e,t)=>{t(_o(e))})
var jo=ce('<a class="svelte-3priew"> </a> ',1),Wo=ce(' <div class="missing svelte-3priew"></div>',1)
function qo(e,t){se(t,!0)
let a=Ie(t,"members",19,()=>[]),n=Me(Le([]))
...
const[a,n]=ct(),r=()=>ut(Eo,"$relicDisplay",a),s=()=>ut(Po,"$rawDefDisplay",a),o=()=>ut(Fo,"$defBuffedDisplay",a),i=()=>ut(Io,"$rawGroupDisplay",a),l=()=>ut(Oo,"$buffResultDisplay",a)
...
var w=be(p,2),$=e=>{var t=Qo(),n=ie(t),c=be(me(n),2),d=be(me(c),2),f=me(d),m=be(d,4),v=me(m),p=be(m,4),h=me(p),b=be(c,4),g=be(me(b),2),k=me(g),y=be(g,4),w=me(y),$=be(y,4),C=me($),L=be($,4),D=me(L),V=be(L,4),M=me(V),A=be(V,4),S=me(A),N=be(A,4),H=me(N),B=be(N,4),x=me(B),T=be(B,4),E=me(T),G=be(T,4),P=me(G),R=be(G,4),F=me(R),_=be(R,4),I=me(_),O=be(n,2),j=be(me(O),2),W=be(me(j),2),q=me(W),K=be(W,4),Y=me(K),z=be(j,4),U=be(me(z),2),Q=me(U),J=be(U,4),X=me(J),Z=be(J,4),ee=me(Z),te=be(Z,4),ae=me(te),ne=be(te,4),re=me(ne),se=be(ne,4),oe=me(se),le=be(se,4),ce=me(le),fe=be(le,4),pe=me(fe),he=be(fe,4),ge=me(he),ke=be(he,4),ye=me(ke),we=be(O,2)
qo(me(we),{get members(){return u}}),ue(()=>{de(f,r().noOfRelics),de(v,r().leadDefenderBonus),de(h,ut(Go,"$ldcloak",a)),de(k,s().attackValue),de(w,o().attack),de(C,s().defenseValue),de(D,o().defense),de(M,s().armorValue),de(S,o().armor),de(H,s().damageValue),de(x,o().damage),de(E,s().hpValue),de(P,o().hp),de(F,s().cloaked),de(I,ut(Ro,"$processed",a)),de(q,o().dc225),de(Y,o().dc175),de(Q,i().attack),de(X,l().attack),de(ee,i().defense),de(ae,l().defense),de(re,i().armor),de(oe,l().armor),de(ce,i().damage),de(pe,l().damage),de(ge,i().hp),de(ye,l().hp)}),ve(e,t)}
...
async function hi(){const e=await Cn({a:14,d:0,id:ui.id,item_id:ui.itemId}),t=e.response.response,a=e.response.msg
let n=a
...
ue(()=>de(n,fe(a))),ve(e,t)}
pe(i,e=>{fe(r)&&e(l)}),ve(e,o),ye()}function $i(e){return e.numberOfCreatureHitsTillDead-e.numberOfHitsRequired<=1?", dies on miss":", survives a miss"}function Ci(e,t){return"-"===t?e:"-"===e||e>t?"-":e}const Li=[[e=>"-"===e.playerHits&&"-"===e.creatureHits,()=>"Unresolved"],[e=>"-"===e.playerHits,()=>"Player dies"],[e=>1===e.playerHits,e=>`Player 1 hits${$i(e)}`],[e=>e.playerHits>1,e=>`Player > 1 hits${$i(e)}`]]
function Di(e,t){return t[0](e)}function Vi(e){e.playerHits=Ci(e.numberOfHitsRequired,e.numberOfCreatureHitsTillDead),e.creatureHits=Ci(e.numberOfCreatureHitsTillDead,e.numberOfHitsRequired),e.fightStatus=function(e){const t=Li.find(u(Di,e))
...
t=e,[qi,xi,_i,Wi,Hi,Vi,Ri].forEach(e=>e(t))}(r),r.evaluatorHTML=Xi(r),n.groupExists?ml(r.evaluatorHTML):fl(r.evaluatorHTML)}function hl(e){return e.members[0].name===p()}async function bl(e,t,a){if(a){!function(e,t,a){if(!a.r?.attributes)return
...
const a=u(_l,e)
$.subscribe(g,a),t.showHuntingBuffs&&window.initialGameData&&a(null,{b:window.initialGameData.player.buffs})}(e),yl=D("hidePlayerActions"),$.subscribe(ae,$l),$l()},function(){bt(),gt()&&ci()},function(){$.subscribe(Lt,kl)},function(){br.forEach(gr)},function(){D("enableCreatureColoring")&&i(document.body,Rt("#actionList .creature-1 {color: green;}\n#actionList .creature-2 {color: yellow;}\n#actionList .creature-3 {color: red;}"))},function(){$.subscribe(ae,ar),ar(),function(){const e=GameData.doAction
GameData.doAction=sr(e)}()},function(){Hr(),$.subscribe("-1-success.action-response 4-success.action-response 5-success.action-response 25-success.action-response",Gr),Gr()},function(){$.subscribe(mt,ti)},function(){D("keepLogs")&&$.subscribe(P,wn)},function(){window.initialGameData&&Ys(0,window.initialGameData),$.subscribe(`${Fe} ${_e}`,Ys)},function(){$.subscribe(wt,ki)},function(){$.subscribe(dt,ei)},function(){$("#messageCenter").worldMessageCenter({offset:"0 60"})},function(){V("#mapTooltip")},function(){ln(),$.subscribe(y,cn),$.subscribe(w,un)},function(){Ra(),$.subscribe(`${g} ${k}`,Ra)},function(){L(n("actionList"),"mouseover",Zn)},function(){const{body:e}=document
...
//# sourceMappingURL=newMap-Beu94zkm.js.map
