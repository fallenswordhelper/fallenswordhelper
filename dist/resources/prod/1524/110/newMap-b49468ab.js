...
import{ac as t,l as n,g as a,a5 as r,i as o,c as s,v as l,o as i,ay as c,az as u,aA as f,aB as d,aC as m,aD as p,y as h,b as g,ae as v,aE as b,aF as w,aG as y,aH as k,aI as C,aa as L,j as V,n as D,aw as x,q as A,aJ as S,aK as M,D as N,aL as H,aM as B,aN as q,aO as T,aP as E,aQ as G,aR as j,aS as P,aT as F,aU as R,aV as _,af as O,a4 as I,aW as W,aX as Y,aY as K,a as z,$ as U,S as Q,K as X,L as J,ai as Z,Q as ee,X as te,Y as ne,M as ae,a0 as re,aZ as oe,R as se,a1 as le,N as ie,O as ce,a_ as ue,a$ as fe,b0 as de,b1 as me,V as pe,b2 as he,s as ge,b3 as ve,b4 as be,b5 as we,b6 as ye,b7 as ke,b8 as Ce,b9 as $e,ba as Le,bb as Ve,bc as De,bd as xe,be as Ae,bf as Se,bg as Me,bh as Ne,bi as He,bj as Be,bk as qe,bl as Te,bm as Ee,bn as Ge,bo as je,bp as Pe,bq as Fe,br as Re,bs as _e,bt as Oe,bu as Ie,bv as We,bw as Ye,bx as Ke,by as ze,bz as Ue,bA as Qe,ad as Xe}from"./calfSystem-929ac228.js"
import{i as Je}from"./insertElementAfter-7e99ee43.js"
import{t as Ze}from"./toggleForce-6124e333.js"
import{c as et}from"./createSpan-6761e587.js"
import{i as tt}from"./insertTextBeforeEnd-0452315b.js"
import{r as nt,a as at}from"./roundToString-b56b87fd.js"
import{a as rt}from"./addCommas-47d6aaa1.js"
import{d as ot,q as st}from"./quickbuffSuccess-1d8074ee.js"
import{c as lt}from"./createButton-5ae9113e.js"
import{i as it}from"./isArray-09a53da7.js"
import{o as ct}from"./openQuickBuffById-85e39f39.js"
import{c as ut}from"./createInput-c66459c1.js"
import{c as ft}from"./createLabel-7740ab51.js"
import{g as dt,s as mt}from"./idb-8fd6b5d1.js"
import{r as pt}from"./rnd-6f762303.js"
import{v as ht}from"./valueText-2acfe155.js"
import{c as gt}from"./createStyle-ebd85b35.js"
import{h as vt,u as bt}from"./await_block-1344c2da.js"
import{e as wt,u as yt,d as kt}from"./each-bac91e63.js"
import{u as Ct}from"./uniq-a9975ce0.js"
import{g as $t}from"./guild-5e30924d.js"
import{c as Lt}from"./createTable-6b9603d1.js"
...
import{L as Tt}from"./LinkButton-abc10b8a.js"
import{r as Et}from"./reduceBuffArray-e31428bc.js"
import{p as Gt}from"./profile-ceb86d3e.js"
import{a as jt}from"./all-414e0607.js"
import{n as Pt}from"./numberIsNaN-a40c3bbb.js"
import{r as Ft}from"./reliclist-45a5f58e.js"
import{d as Rt}from"./daGroupStats-6e7cf053.js"
import{d as _t,m as Ot}from"./mercEffect-7727d3f6.js"
import{d as It}from"./daViewGroups-004c61a2.js"
import{a as Wt}from"./attribsToArray-82e70568.js"
import{g as Yt}from"./guildMembers-ec6b013f.js"
import{r as Kt}from"./remainingPages-9b4c19bf.js"
import{t as zt}from"./testQuant-69a26f83.js"
import{m as Ut}from"./myStats-439c5e74.js"
import{s as Qt}from"./shouldBeArray-5710399f.js"
import{h as Xt}from"./hideElement-baffa60f.js"
import{s as Jt,j as Zt}from"./simpleCheckbox-9dbdc695.js"
...
Jn=In({prefVal:t,checkId:"fshSoundCheck",onClass:"soundOn",onTip:"Turn Off Sound when you have a new log message",offClass:"soundOff",offTip:"Turn On Sound when you have a new log message",worldName:e})}}(Wn),function(e){const n=t.huntingMode
Zn=In({prefVal:n,checkId:"fshHuntCheck",onClass:"huntOn",onTip:"Hunting mode is ON",offClass:"huntOff",offTip:"Hunting mode is OFF",worldName:e})}(Wn)}const oa=[[()=>Jn,function(){L("playNewMessageSound",!v("playNewMessageSound"))}],[()=>Zn,function(){t.huntingMode=!t.huntingMode,L("huntingMode",t.huntingMode)}]],sa=[[()=>zn,function(e){b(e),GameData.doAction(12,401,{},0)}],[()=>Un,function(){ct(w())}],[()=>Qn,function(){window.open(`${y+k}map`,"fsMap")}],[()=>Xn,function(){const e=GameData.realm()
...
const Ra=()=>Ta,_a=()=>Ea,Oa=()=>Ga,Ia=()=>ja,Wa=()=>Pa,Ya=()=>Fa
...
function tr(e){return`<tr><td colspan="2">${e.name}:</td><td colspan="2">${e.value}</td></tr>`}function nr(e,t,n){return function(e){return`<table><tr><td><img src="${S}creatures/${e.image_id}.png" height="200" width="200"></td><td rowspan="2"><table width="400"><tr><td class="header" colspan="4" class="fshCenter">Statistics</td></tr>`}(e)+function(e,t){return Ja([Ua("Class"),Qa(e.creature_class),...Xa(["Level",e.level,"level",t,Ra])])}(e,n)+function(e){return Za(["Attack",e.attack,"defense","fshYellow",_a],["Defense",e.defense,"attack","fshYellow",Oa])}(e)+function(e){return Za(["Armor",e.armor,"damage","fshYellow",Ia],["Damage",e.damage,"armor","fshYellow",Wa])}(e)+function(e,t){return Ja([Ua("HP"),Qa(`${e.hp} (your HP:<span class="fshYellow">${Ya()}</span>)(1H: <span class="fshRed">${t}</span>)`),Ua("Gold"),Qa(e.gold)])}(e,t)+er+function(e){return 0===e.enhancements.length?'<tr><td colspan="4">[no enhancements]</td></tr>':e.enhancements.map(tr).join("")}(e)+function(e){return`<tr><td colspan="4" height="5"></td></tr><tr><td class="header" colspan="4" class="fshCenter">Description</td></tr><tr><td colspan="4">${e.description}</td></tr><tr><td colspan="4" height="5"></td></tr></table></td></tr><tr><td class="fshCenter"><b>${e.name}</b></td></tr></table>`}(e)}function ar(e){if(!Sa(e))return function(e){const n=Math.ceil(e.hp*t.hpVariable+e.armor*t.generalVariable)
let a="fshYellow"
...
lr(n,a)&&sr(n,a)}function cr(e){return t.doNotKillList.includes(_(e))}function ur(e){e.classList.toggle("fshBlue",cr(I(e)))}function fr(){const e=a("actionList")
...
return e.$$set=e=>{"promise"in e&&n(0,a=e.promise)},[a]}class xr extends Q{constructor(e){super(),X(this,e,Dr,Vr,J,{promise:0})}}let Ar=0
...
return[r,e=>Ct(e,"msg").map((({msg:t,type:n})=>({msg:t,type:n,count:e.filter((({msg:e})=>e===t)).length}))),i,e=>i(e)]}class Pr extends Q{constructor(e){super(),X(this,e,jr,Gr,J,{})}}let Fr=0
function Rr(e){Fr[e.name]?Fr[e.name].seen&&(Fr[e.name].seen+=1):(Fr[e.name]={seen:1},function(e,t){t.creature_class=e.creature_class,t.image_id=e.image_id,t.level=Number(e.level),t.type=e.type}(e,Fr[e.name]))}function _r(e,t,n){return t?e(t,n):n}function Or(e,t){const n=e||{}
return n.min=_r(Math.min,n.min,t),n.max=_r(Math.max,n.max,t),n}const Ir=["attack","armor","damage","defense","hp"]
function Wr(e,t,n){const a=Or(t[n],Number(e[n]));(function(e,t){return!e||e.min!==t.min||e.max!==t.max})(t[n],a)&&(t[n]=a)}function Yr(e,t){e[t.name]=Or(e[t.name],Number(t.value))}function Kr(e){Fr||(Fr={}),Rr(e),function(e,t){Ir.forEach(s(Wr,e,t))}(e,Fr[e.name]),function(e,t){(function(e){return e.enhancements&&e.enhancements.length>0})(e)&&(t.enhancements=t.enhancements||{},e.enhancements.forEach(s(Yr,t.enhancements)))}(e,Fr[e.name]),mt("fsh_monsterLog",Fr)}async function zr(){!function(e){Fr=e||{}}(await dt("fsh_monsterLog"))}const Ur=[]
function Qr(e){var n
Sa(e)||(n=e.response.data,t.showMonsterLog&&Kr(n))}function Xr(e,t){return e.id===t.id}async function Jr(e,t){if(6!==e.type||function(e){if(Ur.find(s(Xr,e.data)))return!0
Ur.push(e.data)}(e))return
Qr(await qa(e.data.id,t))}function Zr(){t.showMonsterLog&&(GameData.actions().forEach(Jr),D("NewMap","MonsterLog"))}let eo=""
const to=()=>eo
...
e.dynamic&&(t=e.name,eo=t,ps(e.dynamic))}function gs(e,t){(function(e){return e.realm&&e.realm.name})(t)&&hs(t.realm)}function vs(e,t,n){const a=e.slice()
...
function s(e,t,n){n.target.blur(),Bt(`${Se}&players=${e.join(",")}`,"fsQuickBuff",618,1e3,",scrollbars"),a("buffBatch",o(t))}return e.$$set=e=>{"members"in e&&n(0,r=e.members)},[r,o,s,(e,t,n)=>s(e,t,n)]}class Cs extends Q{constructor(e){super(),X(this,e,ks,ys,J,{members:0})}}function $s(e,t){return e>10*t||e<t?e:10*t}const Ls=[["levelValue","level"],["attackValue","attack"],["attackBonus","bonus_attack"],["defenseValue","defense"],["defenseBonus","bonus_defense"],["armorValue","armor"],["armorBonus","bonus_armor"],["damageValue","damage"],["damageBonus","bonus_damage"],["hpValue","hp"],["hpBonus","bonus_hp"],["killStreakValue","killstreak"]]
...
const n=await async function(){const e=await It()
return e?.r?.find(Rs)?.id}(),a=n&&await async function(e){const t=await Rt(e)
return Wt(t?.r?.attributes)}(n),r=a&&await async function(e){const t=await _t(),n=Ot(t)
return e?.map(((e,t)=>e-n[t]))}(a)
r&&t({attack:r[0],defense:r[1],armor:r[2],hp:r[3],damage:r[4]}),Ss.set(["groupStore","Done."])}const Os=Me(Fs,((e,t)=>{_s(e,t)})),Is=(e,t,n)=>Math.ceil(e*Be(t,0)*n),Ws=(e,t)=>Is(e,t,.0025),Ys=(e,t)=>Is(e,t,.001),Ks=Ys,zs=Ys,Us=Ys,Qs=Ys,Xs=Ys,Js=(e,t)=>Math.ceil(e*(1+.001*Be(t,0))),Zs=(e,t)=>Math.ceil(e*(1-t*qe)),el=Ne([]),tl=Me(el,((e,t)=>{e&&t(Et(e))})),nl=Me([tl,Os],(([e,t],n)=>{if(!e||!t)return
const a=Js(t.defense,e.Constitution),r=Ks(a,e.Fortitude),o=t.hp+r,s=zs(o,e["Chi Strike"])
...
const al=Me([nl,Es,Os],(function([e,t,n],a){if(!e||!t||!n)return
...
const a=Ws(t.attackValue,e.nightmareVisageLevel),r=Js(t.defenseValue,e.constitutionLevel),o=Ks(r,e.fortitudeLevel),s=t.hpValue+o,l=zs(s,e.chiStrikeLevel),i=t.damageValue+l
...
it(t)&&n(0,r=t.filter(s).sort(l))}(e)})),e.$$set=e=>{"members"in e&&n(1,a=e.members)},[r,a]}class bl extends Q{constructor(e){super(),X(this,e,vl,gl,J,{members:1})}}function wl(e){let t,n,a
...
return{c(){t=ae("button"),t.textContent="Fetch Stats",ce(t,"class","custombutton"),ce(t,"type","button")},m(r,o){ee(r,t,o),n||(a=pe(t,"click",e[12]),n=!0)},p:te,d(e){e&&ne(t),n=!1,a()}}}function Cl(e){let t,n,a,r,o,s,l,i,c,u,f,d,m,p,h,g,v,b,w,y,k,C,$,L,V,D,x,A,S,M,N,H,B,q,T,E,G,j,P,F,R,_,O,I,W,Y,K,z,U,Q,X,J,Z,te,oe,ue,fe,de,me,pe,he,ge,ve,be,we,ke,Ce,Le,Ae,Se,Me,Ne,He,Be,qe,Te,Ee,Ge,je,Pe,Fe,Re,_e,Oe,Ie,We,Ye,Ke,ze,Ue,Qe,Xe,Je,Ze,et,tt,nt,at,rt,ot,st,lt,it,ct,ut,ft,dt,mt,pt,ht,gt,vt,bt,wt,yt,kt,Ct,$t,Lt,Vt,Dt,xt,At,St,Mt,Nt,Ht,Bt=e[3].noOfRelics+"",qt=e[3].leadDefenderBonus+"",Tt=e[5].attackValue+"",Et=e[6].attack+"",Gt=e[5].defenseValue+"",jt=e[6].defense+"",Pt=e[5].armorValue+"",Ft=e[6].armor+"",Rt=e[5].damageValue+"",_t=e[6].damage+"",Ot=e[5].hpValue+"",It=e[6].hp+"",Wt=e[5].cloaked+"",Yt=e[6].dc225+"",Kt=e[6].dc175+"",zt=e[8].attack+"",Ut=e[9].attack+"",Qt=e[8].defense+"",Xt=e[9].defense+"",Jt=e[8].armor+"",Zt=e[9].armor+"",en=e[8].damage+"",tn=e[9].damage+"",nn=e[8].hp+"",an=e[9].hp+""
return Nt=new bl({props:{members:e[10]}}),{c(){t=ae("div"),n=ae("div"),n.textContent="Defending Guild Stats",a=ie(),r=ae("div"),o=ae("div"),o.textContent="Relic Count:",s=ae("div"),l=re(Bt),i=ie(),c=ae("div"),c.textContent="Lead Defender Bonus:",u=ae("div"),f=re(qt),d=ie(),m=ae("div"),m.textContent="Lead Defender Cloaked:",p=ae("div"),h=re(e[4]),g=ie(),v=ae("div"),v.textContent="Other Defender Stats",b=ie(),w=ae("div"),y=ae("div"),y.textContent="Raw Attack:",k=ae("div"),C=re(Tt),$=ie(),L=ae("div"),L.textContent="Attack w/ buffs:",V=ae("div"),D=re(Et),x=ie(),A=ae("div"),A.textContent="Raw Defense:",S=ae("div"),M=re(Gt),N=ie(),H=ae("div"),H.textContent="Defense w/buffs:",B=ae("div"),q=re(jt),T=ie(),E=ae("div"),E.textContent="Raw Armor:",G=ae("div"),j=re(Pt),P=ie(),F=ae("div"),F.textContent="Armor w/ buffs:",R=ae("div"),_=re(Ft),O=ie(),I=ae("div"),I.textContent="Raw Damage:",W=ae("div"),Y=re(Rt),K=ie(),z=ae("div"),z.textContent="Damage w/ buffs:",U=ae("div"),Q=re(_t),X=ie(),J=ae("div"),J.textContent="Raw HP:",Z=ae("div"),te=re(Ot),oe=ie(),ue=ae("div"),ue.textContent="HP w/ buffs:",fe=ae("div"),de=re(It),me=ie(),pe=ae("div"),pe.textContent="Cloaked:",he=ae("div"),ge=re(Wt),ve=ie(),be=ae("div"),be.textContent="Processed:",we=ae("div"),ke=re(e[7]),Ce=ie(),Le=ae("div"),Ae=ae("div"),Ae.textContent="Adjusted Defense Values",Se=ie(),Me=ae("div"),Ne=ae("div"),Ne.textContent="DC225:",He=ae("div"),Be=re(Yt),qe=ie(),Te=ae("div"),Te.textContent="DC175:",Ee=ae("div"),Ge=re(Kt),je=ie(),Pe=ae("div"),Pe.textContent=" ",Fe=ie(),Re=ae("div"),Re.textContent="Attacking Group Stats",_e=ie(),Oe=ae("div"),Ie=ae("div"),Ie.textContent="Raw Group Attack:",We=ae("div"),Ye=re(zt),Ke=ie(),ze=ae("div"),ze.textContent="Group Attack w/ buffs:",Ue=ae("div"),Qe=re(Ut),Xe=ie(),Je=ae("div"),Je.textContent="Raw Group Defense:",Ze=ae("div"),et=re(Qt),tt=ie(),nt=ae("div"),nt.textContent="Group Defense w/ buffs:",at=ae("div"),rt=re(Xt),ot=ie(),st=ae("div"),st.textContent="Raw Group Armor:",lt=ae("div"),it=re(Jt),ct=ie(),ut=ae("div"),ut.textContent="Group Armor w/ buffs:",ft=ae("div"),dt=re(Zt),mt=ie(),pt=ae("div"),pt.textContent="Raw Group Damage:",ht=ae("div"),gt=re(en),vt=ie(),bt=ae("div"),bt.textContent="Group Damage w/ buffs:",wt=ae("div"),yt=re(tn),kt=ie(),Ct=ae("div"),Ct.textContent="Raw Group HP:",$t=ae("div"),Lt=re(nn),Vt=ie(),Dt=ae("div"),Dt.textContent="Group HP w/ buffs:",xt=ae("div"),At=re(an),St=ie(),Mt=ae("div"),Ve(Nt.$$.fragment),ce(n,"class","b-top svelte-1qul0wc"),ce(o,"class","svelte-1qul0wc"),ce(s,"class","svelte-1qul0wc"),ce(c,"class","svelte-1qul0wc"),ce(u,"class","svelte-1qul0wc"),ce(m,"class","svelte-1qul0wc"),ce(p,"class","svelte-1qul0wc"),ce(r,"class","stat-grid svelte-1qul0wc"),ce(v,"class","b-top svelte-1qul0wc"),ce(y,"class","svelte-1qul0wc"),ce(k,"class","svelte-1qul0wc"),ce(L,"class","svelte-1qul0wc"),ce(V,"class","svelte-1qul0wc"),ce(A,"class","svelte-1qul0wc"),ce(S,"class","svelte-1qul0wc"),ce(H,"class","svelte-1qul0wc"),ce(B,"class","svelte-1qul0wc"),ce(E,"class","svelte-1qul0wc"),ce(G,"class","svelte-1qul0wc"),ce(F,"class","svelte-1qul0wc"),ce(R,"class","svelte-1qul0wc"),ce(I,"class","svelte-1qul0wc"),ce(W,"class","svelte-1qul0wc"),ce(z,"class","svelte-1qul0wc"),ce(U,"class","svelte-1qul0wc"),ce(J,"class","svelte-1qul0wc"),ce(Z,"class","svelte-1qul0wc"),ce(ue,"class","svelte-1qul0wc"),ce(fe,"class","svelte-1qul0wc"),ce(pe,"class","svelte-1qul0wc"),ce(he,"class","svelte-1qul0wc"),ce(be,"class","svelte-1qul0wc"),ce(we,"class","svelte-1qul0wc"),ce(w,"class","stat-grid svelte-1qul0wc"),ce(t,"class","middle svelte-1qul0wc"),ce(Ae,"class","b-top svelte-1qul0wc"),ce(Ne,"class","svelte-1qul0wc"),ce(He,"class","svelte-1qul0wc"),ce(Te,"class","svelte-1qul0wc"),ce(Ee,"class","svelte-1qul0wc"),ce(Pe,"class","svelte-1qul0wc"),ce(Me,"class","stat-grid svelte-1qul0wc"),ce(Re,"class","b-top svelte-1qul0wc"),ce(Ie,"class","svelte-1qul0wc"),ce(We,"class","svelte-1qul0wc"),ce(ze,"class","svelte-1qul0wc"),ce(Ue,"class","svelte-1qul0wc"),ce(Je,"class","svelte-1qul0wc"),ce(Ze,"class","svelte-1qul0wc"),ce(nt,"class","svelte-1qul0wc"),ce(at,"class","svelte-1qul0wc"),ce(st,"class","svelte-1qul0wc"),ce(lt,"class","svelte-1qul0wc"),ce(ut,"class","svelte-1qul0wc"),ce(ft,"class","svelte-1qul0wc"),ce(pt,"class","svelte-1qul0wc"),ce(ht,"class","svelte-1qul0wc"),ce(bt,"class","svelte-1qul0wc"),ce(wt,"class","svelte-1qul0wc"),ce(Ct,"class","svelte-1qul0wc"),ce($t,"class","svelte-1qul0wc"),ce(Dt,"class","svelte-1qul0wc"),ce(xt,"class","svelte-1qul0wc"),ce(Oe,"class","stat-grid svelte-1qul0wc"),ce(Le,"class","right svelte-1qul0wc"),ce(Mt,"class","bottom b-top svelte-1qul0wc")},m(e,ne){ee(e,t,ne),se(t,n),se(t,a),se(t,r),se(r,o),se(r,s),se(s,l),se(r,i),se(r,c),se(r,u),se(u,f),se(r,d),se(r,m),se(r,p),se(p,h),se(t,g),se(t,v),se(t,b),se(t,w),se(w,y),se(w,k),se(k,C),se(w,$),se(w,L),se(w,V),se(V,D),se(w,x),se(w,A),se(w,S),se(S,M),se(w,N),se(w,H),se(w,B),se(B,q),se(w,T),se(w,E),se(w,G),se(G,j),se(w,P),se(w,F),se(w,R),se(R,_),se(w,O),se(w,I),se(w,W),se(W,Y),se(w,K),se(w,z),se(w,U),se(U,Q),se(w,X),se(w,J),se(w,Z),se(Z,te),se(w,oe),se(w,ue),se(w,fe),se(fe,de),se(w,me),se(w,pe),se(w,he),se(he,ge),se(w,ve),se(w,be),se(w,we),se(we,ke),ee(e,Ce,ne),ee(e,Le,ne),se(Le,Ae),se(Le,Se),se(Le,Me),se(Me,Ne),se(Me,He),se(He,Be),se(Me,qe),se(Me,Te),se(Me,Ee),se(Ee,Ge),se(Me,je),se(Me,Pe),se(Le,Fe),se(Le,Re),se(Le,_e),se(Le,Oe),se(Oe,Ie),se(Oe,We),se(We,Ye),se(Oe,Ke),se(Oe,ze),se(Oe,Ue),se(Ue,Qe),se(Oe,Xe),se(Oe,Je),se(Oe,Ze),se(Ze,et),se(Oe,tt),se(Oe,nt),se(Oe,at),se(at,rt),se(Oe,ot),se(Oe,st),se(Oe,lt),se(lt,it),se(Oe,ct),se(Oe,ut),se(Oe,ft),se(ft,dt),se(Oe,mt),se(Oe,pt),se(Oe,ht),se(ht,gt),se(Oe,vt),se(Oe,bt),se(Oe,wt),se(wt,yt),se(Oe,kt),se(Oe,Ct),se(Oe,$t),se($t,Lt),se(Oe,Vt),se(Oe,Dt),se(Oe,xt),se(xt,At),ee(e,St,ne),ee(e,Mt,ne),De(Nt,Mt,null),Ht=!0},p(e,t){(!Ht||8&t)&&Bt!==(Bt=e[3].noOfRelics+"")&&le(l,Bt),(!Ht||8&t)&&qt!==(qt=e[3].leadDefenderBonus+"")&&le(f,qt),(!Ht||16&t)&&le(h,e[4]),(!Ht||32&t)&&Tt!==(Tt=e[5].attackValue+"")&&le(C,Tt),(!Ht||64&t)&&Et!==(Et=e[6].attack+"")&&le(D,Et),(!Ht||32&t)&&Gt!==(Gt=e[5].defenseValue+"")&&le(M,Gt),(!Ht||64&t)&&jt!==(jt=e[6].defense+"")&&le(q,jt),(!Ht||32&t)&&Pt!==(Pt=e[5].armorValue+"")&&le(j,Pt),(!Ht||64&t)&&Ft!==(Ft=e[6].armor+"")&&le(_,Ft),(!Ht||32&t)&&Rt!==(Rt=e[5].damageValue+"")&&le(Y,Rt),(!Ht||64&t)&&_t!==(_t=e[6].damage+"")&&le(Q,_t),(!Ht||32&t)&&Ot!==(Ot=e[5].hpValue+"")&&le(te,Ot),(!Ht||64&t)&&It!==(It=e[6].hp+"")&&le(de,It),(!Ht||32&t)&&Wt!==(Wt=e[5].cloaked+"")&&le(ge,Wt),(!Ht||128&t)&&le(ke,e[7]),(!Ht||64&t)&&Yt!==(Yt=e[6].dc225+"")&&le(Be,Yt),(!Ht||64&t)&&Kt!==(Kt=e[6].dc175+"")&&le(Ge,Kt),(!Ht||256&t)&&zt!==(zt=e[8].attack+"")&&le(Ye,zt),(!Ht||512&t)&&Ut!==(Ut=e[9].attack+"")&&le(Qe,Ut),(!Ht||256&t)&&Qt!==(Qt=e[8].defense+"")&&le(et,Qt),(!Ht||512&t)&&Xt!==(Xt=e[9].defense+"")&&le(rt,Xt),(!Ht||256&t)&&Jt!==(Jt=e[8].armor+"")&&le(it,Jt),(!Ht||512&t)&&Zt!==(Zt=e[9].armor+"")&&le(dt,Zt),(!Ht||256&t)&&en!==(en=e[8].damage+"")&&le(gt,en),(!Ht||512&t)&&tn!==(tn=e[9].damage+"")&&le(yt,tn),(!Ht||256&t)&&nn!==(nn=e[8].hp+"")&&le(Lt,nn),(!Ht||512&t)&&an!==(an=e[9].hp+"")&&le(At,an)},i(e){Ht||(ye(Nt.$$.fragment,e),Ht=!0)},o(e){$e(Nt.$$.fragment,e),Ht=!1},d(e){e&&(ne(t),ne(Ce),ne(Le),ne(St),ne(Mt)),xe(Nt)}}}function $l(e){let t,n,a,r,o,s=e[0].is_owner&&wl(e)
...
let m=!1
return je((()=>{n(1,m=!1),Hs.set(0),qs.set([]),Fs.set(0),el.set([])})),e.$$set=e=>{"relicData"in e&&n(0,f=e.relicData)},[f,m,a,r,o,s,l,i,c,u,d,function(e){D("relic",e.detail)},function(){D("relic","fetchStats"),n(1,m=!0),Hs.set(f.controlled_by.guild_id),qs.set(d),Fs.set(GameData.player().hasGroup),el.set(GameData.player().buffs)}]}class Vl extends Q{constructor(e){super(),X(this,e,Ll,$l,J,{relicData:0})}}let Dl=0
function xl(e,t){var n,r
t?.response?.data?.defenders?.length>0&&(n=a("dialog-relic"),r=t.response.data,Dl&&Dl.$destroy(),Dl=new Vl({props:{relicData:r},target:n}))}function Al(e,t){"ACT_REPAIR"===t&&GameData.fetch(Re+u+_e+Oe)}let Sl=!1
...
async function Ol(){const e=await Ma({a:14,d:0,id:Gl.id,item_id:Gl.itemId}),t=e.response.response,n=e.response.msg
let a=n
...
l(_l,`${a}<br>`)}async function Il(){const e=zt(Rl.value)
e&&(await jt(Kt(e,Ol)),GameData.doAction(14,3,{id:Gl.id,item_id:Gl.itemId},0),Pl.close())}function Wl(){Fl?r("",_l):function(){Fl=n({className:"fshClear",textContent:"Select how many to quick-buy:"}),Rl=ut({id:"buyAmount",className:"fshNumberInput",min:1,max:99,value:1,type:"number"}),o(Fl,Rl)
const e=lt({textContent:"Quick-buy"})
i(e,Il),o(Fl,e),_l=n(),o(Fl,_l),o(jl,Fl)}()}function Yl(e,t){Gl=t,jl=jl||a("shopDialogConfirm"),jl&&(Pl=Pl||$(jl).data("hcsWorldDialogShopConfirm"),Pl&&Wl())}function Kl(e){let t,n
...
r.callback=a,r.player=As(n),function(e){e.combatEvaluatorBias=t.combatEvaluatorBias,e.attackVariable=1.1053,e.generalVariable=t.generalVariable,e.hpVariable=t.hpVariable}(r),r.creature=Ji(e.response.data,r.player.superEliteSlayerMultiplier),function(e){var t
t=e,[Ci,ci,vi,ki,si,ti,pi].forEach((e=>e(t)))}(r),r.evaluatorHTML=function(e){return`<table width="100%"><tbody>${Si(e)}${Mi(e)}${Ni(e)}${Hi(e)}${Bi(e)}${qi(e)}${Ti(e)}${Ei(e)}</tbody></table>`}(r),a.groupExists?Xi(r.evaluatorHTML):Qi(r.evaluatorHTML)}function ec(e){return e.members[0].name===c()}async function tc(e,t,n){if(n){!function(e,t,n){if(!n.r||!n.r.attributes)return
const a=n.r.attributes
Zi(e,t,{groupExists:!0,groupAttackValue:a[0].value,groupDefenseValue:a[1].value,groupArmorValue:a[2].value,groupDamageValue:a[3].value,groupHPValue:a[4].value})}(e,t,await Rt(n))}}async function nc(e,t){const n=function(e){if(it(e.r))return e.r.find(ec).id}(await It())
tc(e,t,n)}async function ac(e,t){if(Wi||(Wi=a("dialog-viewcreature")),Wi&&(Qi(""),Xi(""),t?.response?.data)){Ii(t.response.data.name,Wi)
const e=await Ut(!0)
...
function ic(){return`${Jt(lc)} ${Zt("enabledHuntingMode")}<select name="enabledHuntingMode"><option value="1"${en(t.enabledHuntingMode,"1")}>${t.buffsName}</option><option value="2"${en(t.enabledHuntingMode,"2")}>${t.buffs2Name}</option><option value="3"${en(t.enabledHuntingMode,"3")}>${t.buffs3Name}</option></select>`}let cc=0,uc=""
const fc=()=>cc,dc=()=>uc
...
if(!e)return
const t=n({className:"fshCenter fshFten"}),r=n({id:"fshWorldPrefs",innerHTML:`${Jt("showCreatureInfo")}&nbsp;&nbsp;${Jt("showMonsterLog")}&nbsp;&nbsp;${Jt("showTitanInfo")}&nbsp;&nbsp;${Jt("showBuffInfo")}<br>${Jt("hideSubLvlCreature")}&nbsp;&nbsp;${Jt("hidePlayerActions")}&nbsp;&nbsp;${ic()}`})
...
//# sourceMappingURL=newMap-b49468ab.js.map
