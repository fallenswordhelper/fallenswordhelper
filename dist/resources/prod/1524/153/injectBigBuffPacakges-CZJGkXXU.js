...
import{v as e,w as a,$ as t,a as l,x as c,y as n,z as o,A as f,B as i,C as d,D as r,E as v,F as u,G as m,H as p,I as b,J as k,K as g,L as j,N as y,O as h,P as w,s as _,Q as x,R as C,S as B,T as P,q as S,u as $,o as I,i as L,n as N,h as E,l as F}from"./calfSystem-CT1aM4VG.js"
import"./legacy-BQk1-_ZQ.js"
import{i as G}from"./lifecycle-Dl_sxbSE.js"
import{b as q}from"./buffmarket-Din7nnVi.js"
...
function I(){p($,!0)}let L=()=>{p(Q,""),p($,!1)},N=k(),E=k(),F=k(),q=k([]),O=k(!1),Q=k()
function R(s){let e={gold_cost:b(N),point_cost:b(E),casts:b(F),package_name:s.name,buff_type_0:s.value,buff_level_0:s.max_level}
...
const s=await b(q).map((s=>S()[s])).reduce(T,Promise.resolve())
s?.s?x("https://www.fallensword.com/index.php?cmd=buffmarket&subcmd=manage&m=1"):p(O,!1)}return G(),o(s,{close:L,get visible(){return b($)},children:(s,e)=>{var a=M(),t=i(d(a),4),l=i(r(t),2),c=i(l,4),n=i(c,4),o=i(t,4)
v(o,7,S,(s=>s.value),((s,e,a)=>{var t,l=D(),c=r(l),n=r(c),o=i(n,2),d=i(o,2),v=r(d)
h((()=>{t!==(t=b(a))&&(n.value=(n.__value=b(a))??""),C(o,"src",`https://cdn2.fallensword.com/skills/${b(e),B((()=>b(e).value))??""}.png`),C(o,"alt",(b(e),B((()=>b(e).name)))),w(v,(b(e),B((()=>b(e).name))))})),P(f,[],n,(()=>(b(a),b(q))),(s=>p(q,s))),g(s,l)}))
...
h((()=>w(a,b(Q)))),g(s,e)}
u(x,(s=>{b(Q)&&s($)})),m(l,(()=>b(N)),(s=>p(N,s))),m(c,(()=>b(E)),(s=>p(E,s))),m(n,(()=>b(F)),(s=>p(F,s))),g(s,a)},$$slots:{default:!0}}),function(s,t,l){var c=e(s,t)
...
//# sourceMappingURL=injectBigBuffPacakges-CZJGkXXU.js.map
