import{ax as t,s as n,c as s,bv as e,az as f,b4 as o,p as a,l as u,b6 as c,dG as r,c_ as i,aV as l,aa as b,d as p,g as d,a9 as g}from"./calfSystem-CT1aM4VG.js"
import{a as m}from"./roundToString-y0z7QatG.js"
...
let s="unknown",e="1"
n&&(s=function(t){return t[0].includes("k")?"k":t[0].includes("f")?"fsp":"stam"}(n),[e]=i(/[+-]?[.\d]+/,n[0])),L.buffs[u(t)]=[parseFloat(e),s],L.count+=1}(t):(L.count-=1,delete L.buffs[s]),L.count>0?F():(p("&nbsp;",d("buffCost")),L.buffCostTotalText="")}function P(t){return t.tagName&&"SPAN"!==t.tagName?P(t.parentNode):t}function R(t){if("fshSendBuffMsg"===t.target.id)return void function(t){t.count>0&&T(t)}(L)
const n=P(t.target);(function(t){return t.classList&&b("buffLink",t)})(n)&&M(n)}function z(t,n,s){return t.replace(n,`<span id="fshBuff${s}" class="buffLink fshBlue">${n.replace(/(`~)|(~`)|(\{b\})|(\{\/b\})/g,"")}</span>`)}function E(t){let n=t.replace(/\{b\}/g,"`~").replace(/\{\/b\}/g,"~`")
const s=n.match(/`~([^~]|~(?!`))*~`/g)
...
//# sourceMappingURL=render-DAwUrVsp.js.map
