import{a as n,bF as t,j as a,C as e,c as s,bG as r,r as o,bH as i,bI as c,w as f,n as l,bJ as u,bK as d}from"./calfSystem-4830a18d.js"
import{a as m}from"./all-414e0607.js"
import{i as p}from"./interceptSubmit-0ca01d03.js"
import{l as h}from"./loadDataTables-893ea24d.js"
import{s as v,g as b}from"./idb-7e56faaa.js"
import{c as g}from"./closestTr-a662daf2.js"
...
const D=()=>E,N=()=>J
function z(){v(y,E)}function A(n,t){E=E||{},E.minLvl=n,E.maxLvl=t,z()}function G(){$('#arenaTypeTabs table[width="635"]').DataTable().draw()}function H(){k(A,G)}function K(){A(r.arenaMinLvl,r.arenaMaxLvl),$("#fshMinLvl").val(E.minLvl),$("#fshMaxLvl").val(E.maxLvl),G()}function P(n){E=E||{},E.hideMoves=n.target.checked,z(),$(".moveMax").toggle(!n.target.checked)}function R(n,t){return!D()||function(n){const t=D().minLvl,a=D().maxLvl,e=_(n[7])
...
null!=D()?.hideMoves&&(t.prop("checked",D().hideMoves),$(".moveMax").toggle(!D().hideMoves)),t.on("click",P)}(t),function(n){I("fshMinLvl",n,"minLvl","arenaMinLvl")}(t),function(n){I("fshMaxLvl",n,"maxLvl","arenaMaxLvl")}(t),function(n){$("#fshMinLvl, #fshMaxLvl",n).on("keyup",H),$("#fshReset",n).on("click",K)}(t),$("td",n).append(t)}function V(n,a){const e=o(/#\s(?<id>\d+)/,a.eq(0).text())
...
$("a",a).contents().unwrap(),$(t).prepend($("<thead/>").append(a))}function un(){O(),z(),$.fn.dataTable.ext.search.push(R),$.fn.dataTable.ext.search.push(B)}function dn(n,[r,o,i]){const c=$('table[width="635"]',n)
...
//# sourceMappingURL=arena-872c1bc3.js.map
