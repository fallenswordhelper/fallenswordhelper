import{ak as e,ek as t,el as s,K as r,J as n,em as a,bX as i,bW as o,y as c,bj as l,aG as u,E as p,H as d,bD as v,N as h,O as f,c6 as m,c7 as g,C as b,D as y,F as k,P as D,bm as S,Q as w,S as C,da as z,bG as E,s as $,aF as T,G as _,bI as x,ab as I,en as Q,d7 as N,cr as j,$ as G,a1 as M,e as P,cp as W,c as q,n as A,v as F,a8 as H,a9 as L,h as U,eo as V,q as J,o as K,bi as O,t as R,g as X,bs as B}from"./calfSystem-HVCiy-VV.js"
import{d as Y}from"./daComponents-BE5UHaNX.js"
import{c as Z}from"./closestTd-COGdzJp7.js"
...
d(S,e=>{r(i)?e(C,!1):e(w)})
var T=y(S,2),_=k(T)
z(_,{onclick:function(){$("components","insertQuickExtract"),Q()},children:(e,t)=>{var s=E("Quick Extract")
h(e,s)}})
var x=y(T,2),I=e=>{var t=fe(),s=k(t)
N(s,()=>({"--button-color":"red"})),z(s.lastChild,{onclick:m,children:(e,t)=>{var s=E("Delete All Visible")
h(e,s)}}),h(e,t)}
d(x,e=>{r(a)&&e(I)}),h(t,g),f()}function be(e){return j({subcmd:"destroycomponent",removeIndex:e})}async function ye(e){const t=await P({cmd:"profile",subcmd:"destroycomponent",component_id:e})
return t?function(e,t){const s=W(t)
...
return t.replaceWith(F({className:"compSumSpin",innerHTML:'<span class="fshSpinner fshSpinner12"></span>'})),t}function Se(e,t){!function(e,t,s){se.update(r=>(r.get(e)?.set(t,s),r))}(t,"delPending",e)}const we=([,e])=>e,Ce=e=>x(e.map(we)),ze=([,,e])=>e,Ee=e=>function(e,t){se.update(s=>(function(e,t){if(!t)return
const s=t.get("del").filter(t=>!e.includes(t))
t.set("del",s)}(t,s.get(e)),s))}(...e)
async function $e(e){const t=e.map(([e])=>[e,De(e)])
const s=await(r=e.map(ze),G(be,ke,r))
var r
s?.s?((e=>Ce(e).map(t=>[t,e.filter(([,e])=>e===t).map(ze)]))(e).forEach(Ee),(e=>{e.forEach(([e])=>e?.children[0]?.remove())})(t)):(A(s?.e?.message??"Unknown Error"),function(e){e.forEach(([e,t])=>{t&&e.children[0].replaceWith(t)})}(t))}async function Te(e){const t=Ce(e)
t.forEach(q(Se,!0)),await M(ee(30,e).map($e)),t.forEach(q(Se,!1))}function _e(e){const{itemId:t,invId:s}=H(L,e.dataset.tipped)
return[Number(t),Number(s)]}const xe=e=>[Z(e),..._e(e)]
function Ie(e){Te(U("img",e).map(xe))}function Qe(e,t){Te((e=>V(se).get(e).get("del"))(t).map(s=>{return[(r=e,n=s,Z(J(`img[data-tipped*="&inv_id=${n}&"]`,r))),t,s]
var r,n}))}function Ne(e){"IMG"===e.target.tagName&&(e.preventDefault(),$("components","quickDel"),O(e.target),Te([[Z(e.target),..._e(e.target)]]))}function je(e){e.classList.add("fshQuickDel"),K(e,Ne)}function Ge(){const e=function(){const e=X("profileRightColumn"),t=B("inventory-table",e)
if(2===t.length)return t[1]}()
e&&R(ge,{props:{dispatchDelete:q(Ie,e),dispatchDelType:q(Qe,e),dispatchQuickDel:q(je,e)},target:e.parentNode})}export{Ge as default}
//# sourceMappingURL=components-D6h4MrtF.js.map
