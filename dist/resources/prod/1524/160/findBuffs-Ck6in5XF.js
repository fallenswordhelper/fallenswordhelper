import{bB as t,b$ as e,cw as n,ay as s,c2 as a,aA as r,g as o,d as i,ag as c,m as l,b6 as f,c_ as u,q as d,a5 as p,cI as b,r as h,c as m,aO as y,de as g,p as v,o as x,s as w,by as k,bz as L,av as C,a4 as P,dZ as B,h as I,df as E,dC as S,d_ as T,aW as A,b8 as N,bE as j,bo as F}from"./calfSystem-HVCiy-VV.js"
import{o as R}from"./onlinePlayersPage-BUQG8hCd.js"
import{b as D}from"./buffObj-BIwiFUIW.js"
import{h as M}from"./simpleCheckbox-CEHi-xtc.js"
import{o as O}from"./onlineDot-Dmf4LgP_.js"
...
n<s?mt(n,s,yt):pt()}async function gt(){if(it=parseInt(o("onlinePlayers").value,10),0!==it){yt(await R(1))}else pt()}function $t(t){const{tipped:e}=t.dataset,{mins:n}=E(e);(function(t,e,n){return t<5&&e>=rt&&e>=n})(n,Number(h(S,e)),W())&&bt(t.href,l(t))}function vt(t){lt.push(j+t)}async function xt(t){!function(t){const e=c(t)
I('#profileLeftColumn a[data-tipped*="Last Activity"]',e).forEach($t),ft+=1,ft===lt.length&&gt()}(await F(t))}function wt(t){const e=c(t)
o("guildMembers").checked&&I('#pCC a[data-tipped*="<td>VL:</td>"]',e).forEach($t),lt=[],lt.push(T),A(ct).forEach(vt),ft=0,o("alliesEnemies").checked?lt.forEach(xt):gt()}function kt(t,e){return 0!==e}function Lt(t){t.deleteRow(-1)}function Ct(){w("find buffs","clear results"),function(){const t=o("buffTable")
...
C("textToSearchFor",t),at=t,rt=1,Pt("profiles to search")}function St(){ct=r("extraProfile")}function Tt(t){x(o("findbuffsbutton"),t,!0)}function At(){x(o("clearresultsbutton"),Ct,!0)}function Nt(t){const e=t||v()
s.sortBy="name",s.sortAsc=!0,D.sort(q),St(),i(Z(H,ct),e),K(),Tt(It),At()}function jt(t){const e=t||v()
St(),i(Z(V,ct),e),K(),Tt(Et),At()}export{Nt as injectFindBuffs,jt as injectFindOther}
//# sourceMappingURL=findBuffs-Ck6in5XF.js.map
