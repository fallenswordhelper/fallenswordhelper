...
var D=a,U=k,F=S,q=P,W=/,|\s+/,Q=/\S/,J=function(){function e(e,t){void 0===e&&(e={}),this.__pluginsLoaded=!1,this.__store=null,this.__beforeNotifyHandlers=[],this.__afterNotifyHandlers=[],this.__notifier={name:"@honeybadger-io/core",url:"https://github.com/honeybadger-io/honeybadger-js/tree/master/packages/core",version:"6.8.2"},this.config=R(R({},q.CONFIG),e),this.__initStore(),this.__transport=t,this.__eventsLogger=new F.ThrottledEventsLogger(this.config,this.__transport),this.logger=(0,D.logger)(this)}return e.prototype.getVersion=function(){return this.__notifier.version},e.prototype.getNotifier=function(){return this.__notifier},e.prototype.setNotifier=function(e){this.__notifier=e},e.prototype.configure=function(e){for(var t in void 0===e&&(e={}),e)this.config[t]=e[t]
...
null!=t&&null!=n&&(o[String(t)]=String(n))})),r={method:e.method,headers:o},"POST"===e.method&&t&&(r.body="string"==typeof t?t:JSON.stringify(qe(t,e.maxObjectDepth))),[4,(0,Fe.globalThisOrWindow)().fetch(e.endpoint,r)]
...
if(It(t,e))break
Gt(t,e),t=e}}(1)),e}function Ft(e,t){!function(e){let t=e
for(;t>1;){const e=t>>1
if(!It(t,e))break
Gt(t,e),t=e}}(Rt.push({data:e,priority:t})-1)}let qt=!0
const Wt="fshMessage"
let Qt=0
function Jt(){Rt.length-1==0?qt=!0:(qt=!1,window.postMessage(Wt,window.location.origin))}function zt(){const t=Ut()
var n
...
Ft(t.bind(r,...i),e),qt&&Jt()}}function Vt(e,t){return new URLSearchParams(e).get(t)}function Yt(e){return Vt(decodeURIComponent(window.location.search),e)}function Zt(){}const en=e=>e
...
return{p(...n){t=n,t.forEach((t=>e.push(t)))},r(){t.forEach((t=>e.splice(e.indexOf(t),1)))}}}function Fn(e){return""===e?null:+e}function qn(e,t){t=""+t,e.data!==t&&(e.data=t)}function Wn(e,t){e.value=null==t?"":t}function Qn(e,t,n,o){null==n?e.style.removeProperty(t):e.style.setProperty(t,n,o?"important":"")}function Jn(e,t,n){for(let n=0;n<e.options.length;n+=1){const o=e.options[n]
...
po.forEach((o=>-1===e.indexOf(o)?t.push(o):n.push(o))),n.forEach((e=>e())),po=t}(n.after_update),rn(n.on_destroy),n.fragment&&n.fragment.d(t),n.on_destroy=n.fragment=null,n.ctx=[])}function Fo(e,t,n,o,r,i,a=null,s=[-1]){const c=Zn
oo(e)
...
t.intro&&Co(e.$$.fragment),Do(e,t.target,t.anchor),xo()}oo(c)}class qo{$$=void 0
$$set=void 0
...
class nr extends qo{constructor(e){super(),Fo(this,e,tr,er,sn,{ms:3})}}let or
...
return t&&Hr(n,t),n}function Ir(e){return Rr("div",e)}function Gr(e,t){return t?t.getElementsByClassName(e):document.getElementsByClassName(e)}function Dr(e,t){return ir(Gr(e,t))}function Ur(e,t){return e instanceof Node&&t instanceof Node&&e.appendChild(t),t}function Fr(e,t){t instanceof Element&&(t.innerHTML=String(e))}function qr(e){let t=n("content")
t?Fr("",t):(t=Ir({id:"content",style:{display:"none"}}),Ur(document.body,t)),$(t).dialog({width:640,modal:!0,position:{my:"top",at:"top",offset:"0 60",collision:"none"},resizable:!1}),Dr("ui-dialog-titlebar-close").forEach((e=>e.blur())),e(t)}async function Wr(e){(await e).default()}function Qr(){Wr(import("./buffLog-z4an8BL6.js"))}function Jr(){Wr(import("./combatLog-k9mcRNGB.js"))}function zr(){Wr(import("./creatureLog-f-iX98KE.js"))}function Kr(){Wr(import("./fsboxlog-6ulTiIRu.js"))}function Xr(){Wr(import("./guildTracker-P8s4P8n3.js"))}async function Vr(e){(await import("./injectAuctionSearch-F35F7foy.js")).default(e)}async function Yr(e){(await import("./findBuffs-K0yGHSFA.js")).injectFindBuffs(e)}async function Zr(e){(await import("./findBuffs-K0yGHSFA.js")).injectFindOther(e)}async function ei(e){(await import("./injectOnlinePlayers-pUJVEg94.js")).default(e)}function ti(){Wr(import("./potReport-NQ0IanPb.js"))}function ni(){Wr(import("./quickExtract-sj9o2d8n.js"))}function oi(){Wr(import("./quickLinksManager-dW2LpOKK.js"))}async function ri(e){(await import("./quickWear-WbqMRWfJ.js")).default(e)}function ii(){Wr(import("./recipeMgr-XHS8sOOG.js"))}function ai(){Wr(import("./reliclist-cH-lT0of.js"))}function si(){Wr(import("./superelite-9aQH0l-_.js"))}function ci(e){return new Promise((t=>{setTimeout(t,e)}))}function ui(e){return e.data?(delete e.data.fshrnd,$.param(e.data)):e.url}class li extends Error{constructor([e,t,n,o],...r){super(function(e,t,n,o){const r=`${t.status} ${t.statusText} - `
...
async function Mi(e,t){try{return await function(e,t=Ni()){return t("readonly",(t=>Ti(t.get(e))))}(e,t)}catch(e){Ai(e)}}async function Bi(e,t,n){try{return await function(e,t,n=Ni()){return n("readwrite",(n=>(n.put(t,e),Ti(n.transaction))))}(e,t,n)}catch(e){Ai(e)}}const Hi=({folder_id:e})=>-2!==(e??-2),Ri=({folder_id:e})=>-2===e,Ii=({player_id:e})=>-1!==(e??-1),Gi=({player_id:e})=>e,Di=({player_id:e})=>-1===e,Ui=([e,t,n])=>Ci(20,e).map((e=>[e,t,n])),Fi=e=>({inv_id:t})=>t===e.inv_id,qi=(e,t)=>e.attributes.find((({id:e})=>e===t))?.value??0,Wi=(e,t)=>({...t,armor:qi(e,2),attack:qi(e,0),damage:qi(e,4),defense:qi(e,1),hp:qi(e,3),set_name:e.set_name??""}),Qi=(e,{forge:t})=>t,Ji=e=>e?.s?e.r.items:[],zi=e=>[[e.filter(Hi),s,0],[e.filter(Ri),s,1],[e.filter(Ii),Gi,7],[e.filter(Di),s,4]].flatMap(Ui)
function Ki(e){return function(){const t=this.data(),n=e.find(Fi(t))
...
var t}
function ia(e){return()=>qr(e)}var aa=[{section:"Character",menu:[{label:"Buff Log",fn:Qr},{label:"Combat Log",fn:Jr},{label:"Creature Log",fn:zr},{label:"Recipe Manager",fn:ii},{label:"Quick Links",fn:oi},{label:"Inventory Manager",href:`${me}invmanagernew`}]},{section:"Actions",menu:[{label:"Find Buffs",fn:ia(Zr)},{label:"Find Other",fn:ia(Yr)},{label:"Online Players",fn:ia(ei)},{label:"AH Quick Search",fn:ia(Vr)}]},{section:"Guild",menu:[{label:"Guild Inventory",href:`${me}guildinvmgr`},{label:"New Guild Log",href:`${ie}`},{label:"Merc Hunter",fn:function(){Wr(import("./mercs-MHqJ7unK.js"))}},{label:"Pot Report",fn:ti},{label:"Guild Tracker",fn:Xr}]},{section:"Extra",menu:[{label:"Quick Extract",fn:ni},{label:"Quick Wear",fn:ia(ri)},{label:"FS Box Log",fn:Kr},{label:"SE Tracker",fn:si}]},{section:"Beta Features",menu:[{label:"Relic List",fn:ai,beta:!0},{label:"GS Export",fn:async function(){if(!Si())return
const e=await _i(),t=await Mi("fsh_guildinvmgr_cache")??[],n=e.items.map((e=>t=>{const n=e.find((({inv_id:e})=>e===t.inv_id))
return n?.attributes?{...t,stats:{...t.stats,armor:qi(n,2),attack:qi(n,0),damage:qi(n,4),defense:qi(n,1),hp:qi(n,3),set_name:n.set_name??""},cached:!0}:{...t,cached:!1}})(t))
var o
Ei((o=`item_id,inv_id,item_name,rarity,type,durability,max_durability,guild_tag,in_guide,player_id,equipped,craft,forge,attack,defense,armor,hp,damage,stamina,min_level,set_name,cached\n${(e=>e.map(ra).join("\n"))(n)}\n`,new Blob([o],{type:"text/csv"})),"gs_export.csv")},beta:!0}]},{section:"Dev Links",menu:[{label:"Combat Set Manager",fn:function(){Wr(import("./setmgr-nsvloSnr.js"))},beta:!0},{label:"Quest Book",fn:function(){Wr(import("./questbook-BtLG0j15.js"))}}]},{section:"FSH developer quick links",menu:[{playerId:1963510,playerName:"PointyHair"},{playerId:1674838,playerName:"Lusterless"}]}]
...
Dn(t,"id","modal"),Dn(t,"class","svelte-f79wx0")},m(e,n){Cn(e,t,n)
...
function a(){return e[9](e[13])}return{c(){t=An("button"),t.textContent="PM",n=Bn(),o=An("a"),o.textContent=`${e[13].playerName}`,Dn(t,"type","button"),Dn(t,"class","helperDevBtn svelte-f79wx0"),Dn(o,"href",fe+"menuItem.playerId"),Dn(o,"class","svelte-f79wx0")},m(e,s){Cn(e,t,s),Cn(e,n,s),Cn(e,o,s),r||(i=Rn(t,"click",a),r=!0)},p(t,n){e=t},d(e){e&&(Tn(t),Tn(n),Tn(o)),r=!1,i()}}}function fa(e){let t,n,o
function r(){return e[8](e[13])}return{c(){t=An("a"),t.textContent=`${e[13].label}`,Dn(t,"href",e[13].href),Dn(t,"class","svelte-f79wx0")},m(e,i){Cn(e,t,i),n||(o=Rn(t,"click",r),n=!0)},p(t,n){e=t},d(e){e&&Tn(t),n=!1,o()}}}function da(e){let t,n,o
function r(){return e[7](e[13])}return{c(){t=An("button"),t.textContent=`${e[13].label}`,Dn(t,"type","button"),Dn(t,"class","svelte-f79wx0")},m(e,i){Cn(e,t,i),n||(o=Rn(t,"click",r),n=!0)},p(t,n){e=t},d(e){e&&Tn(t),n=!1,o()}}}function pa(e){let t,n
...
r=Bn(),Dn(t,"class","svelte-f79wx0")},m(e,i){Cn(e,t,i),Cn(e,n,i),Cn(e,o,i)
...
return{c(){t=An("div"),n=An("button"),n.textContent="Helper Menu",o=Bn(),a&&a.c(),Dn(n,"type","button"),Dn(n,"id","toggle"),Dn(n,"class","svelte-f79wx0"),Kn(n,"helperMenuMove",e[2]),Dn(t,"id","helperMenu"),Dn(t,"class","svelte-f79wx0"),Kn(t,"helperMenuFixed",e[1])},m(s,c){Cn(s,t,c),En(t,n),En(t,o),a&&a.m(t,null),r||(i=Rn(n,"click",e[3]),r=!0)},p(e,[n]){e[0]?a?(a.p(e,n),1&n&&Co(a,1)):(a=ua(e),a.c(),Co(a,1),a.m(t,null)):a&&(Oo(),To(a,1,1,(()=>{a=null})),Po())},i(e){Co(a)},o(e){To(a)},d(e){e&&Tn(t),a&&a.d(),r=!1,i()}}}function ya(e,t,n){const o=Mt("keepHelperMenuOnScreen"),r=Mt("draggableHelperMenu")
io((()=>{r&&Ar(S("#helperMenu"))}))
let i=!1
function a(){n(0,i=!i)}function s(e){Sr("helperMenu",e)}function c(e,t){k(t)&&(s(e),a(),t())}function u(e){a(),s("sendMsg"),openQuickMsgDialog(e)}return[i,o,r,a,s,c,u,e=>c(e.label,e.fn),e=>s(e.label),e=>u(e.playerName)]}class ba extends qo{constructor(e){super(),Fo(this,e,ya,ma,sn,{})}}function va(){const e=S(".mainbody")
...
const n=t.r[e].id
Ta("2"),Ca(`${le+ne}managecombatset&submit=Use&combatSetId=${n}`)}}function Fa(e,t){n("worldPage")||(Na(e),Ca(t))}function qa(){f.enableMaxGroupSizeToJoin?Ca($e):Ca(Se)}function Wa(){Na("logPage"),Ta("2"),Ca(ce)}function Qa(e){const t=S(`#pCC input[value="${e}"]`)
t&&(Na("movePage"),Li(t))}const Ja=[["!",Ua,0],["@",Ua,1],['"',Ua,1],["#",Ua,2],["£",Ua,2],["$",Ua,3],["%",Ua,4],["^",Ua,5],["&",Ua,6],["*",Ua,7],["(",Ua,8],["0",function(){Fa("toWorld",Le)}],["<",Qa,"<"],[">",Qa,">"],["G",function(){Na("createGroup"),Ta("4"),Ca(`${ke}create`)}],["L",Wa],["b",function(){Na("backpack"),Ta("2"),Ca(de)}],["g",function(){Na("gotoGuild"),Ta("4"),Ca(`${ve}manage`)}],["j",function(){Na("joinAllGroup"),Ta("4"),qa()}],["l",Wa],["p",function(){Na("profile"),Ta("2"),Ca(le)}],["r",function(){Fa("doRepair",`${Pe+ne}repairall&fromworld=1`)}],["v",function(){"dialogIsClosed"in f&&!f.dialogIsClosed()||(Na("insertQuickWear"),qr(ri))}],["y",Pa]]
...
n.some((([,e])=>e))&&(await import("./injectItems-Qe-YuAsg.js")).default(e,t,ls(n))}(e,t),function(e){const t=e._saveState
...
if(t)return x(t,Gs)}function Us(e,t,n){return JSON.stringify(e,t,n)}function Fs(e,t){$a(e,Us(t))}let qs=0,Ws=0,Qs=0
...
Ws.deleteRow(t),qs.splice(t-2,1),Fs("quickMsg",qs)}],["add-button",function(e){Sr("messaging","addNewTemplate")
const t=e.parentNode.nextElementSibling.children[0],n=t.value
if(""!==n){Ks(e.parentNode.parentNode.rowIndex,n),t.value="",qs.push(n),Fs("quickMsg",qs)}}],["add-template",function(e){Sr("messaging","insertTemplate"),Es().value+=`${o(e).replace(/\{playername\}/g,Os)}`}]]
function Vs(e){Ks(-1,e)}function Ys(){Mt("enableMessageTemplates")&&!Qs&&(Za((Ws||(Ws=xs().lastElementChild),Ws),Hs(Xs)),(qs||(qs=Ds("quickMsg")),qs).forEach(Vs),Js(-1,zs("add","Add"),'<input id="newTmpl" class="ui-widget-content fshTmpl">'),Qs=!0)}function Zs(e,t,o){const r=xs()
...
t&&nc((_r||(_r=n("pCR")),_r),t)}const rc=[function(){Mt("moveGuildList")&&oc("minibox-guild")},function(){Mt("moveOnlineAlliesList")&&oc("minibox-allies")},function(){Mt("moveXmasBox")&&ec("minibox-xmas")},function(){Mt("moveDailyQuest")&&ec("minibox-daily-quest")},function(){Mt("moveFSBox")&&ec("minibox-fsbox")},function(){(f.enableAllyOnlineList||f.enableEnemyOnlineList)&&Wr(import("./allyEnemy-d8jM2ZlN.js"))},function(){(f.enableWantedList||f.enableActiveBountyList)&&Wr(import("./activeWantedBounties-aam_by8g.js"))},function(){f.enableGuildInfoWidgets&&Wr(import("./addGuildInfoWidgets-5BlQtM3u.js"))},function(){f.enableOnlineAlliesWidgets&&Wr(import("./addOnlineAlliesWidgets-tp93pAQq.js"))},function(){f.enableTempleAlert&&Wr(import("./injectTempleAlert-vCEFbr7W.js"))},function(){f.enableUpgradeAlert&&Wr(import("./injectUpgradeAlert-tFvj-Zq-.js"))},function(){f.enableComposingAlert&&Wr(import("./injectComposeAlert-0M-hTlbQ.js"))},function(){kr()&&!ds()&&ws()},function(){ds()||(window.openQuickMsgDialog=Zs)},function(){Mt("statBarLinks")&&Wr(import("./statBar-BJM_AXDT.js"))},function(){Mt("staminaCalculator")&&Wr(import("./injectStaminaCalculator-jctqMfg6.js"))},function(){Mt("levelUpCalculator")&&Wr(import("./injectLevelupCalculator-rlNsNOdF.js"))},function(){Mt("fsboxlog")&&Wr(import("./fsbox-HmnnDWsz.js"))},function(){Mt("resizeQuickBuff")&&Wr(import("./interceptQuickBuff-9vVs7fTA.js"))},function(){Mt("joinAllLink")&&Wr(import("./injectJoinAllLink-4pz3rSJg.js"))},function(){Mt("addServerNode")&&Wr(import("./injectServerNode-nC3eh-Tu.js"))},function(){Mt("addScoutTowerLink")&&Wr(import("./scoutTowerLink-TZGMMyua.js"))},function(){fs()&&Mt(ct)&&Wr(import("./guildActivity-cEPNZcZM.js"))},async function(){if(fs()&&f.enableSeTracker){(await import("./trackerPrefStore-BN4ahbaL.js").then((function(e){return e.a}))).default.set(f.enableSeTracker)}}]
...
e&&sc(e)}function uc(){fs()&&n("worldPage")&&window.GameData&&Wr(import("./newMap-JdR9p19e.js"))}function lc(e){$(e).qtip("hide")}function fc(e){$a("needToPray",e),$a("lastTempleCheck",(new Date).setUTCHours(23,59,59,999)+1)}let dc=0
...
n&&mc(),fc(n)}function bc(){Wr(import("./bioWidgets-esgSKRJc.js"))}function vc(){Wr(import("./injectGuild-bnAoEAG4.js"))}const wc=()=>{Wr(import("./guildAdvisor-YR4KJ_tW.js"))}
const _c=()=>{Wr(import("./groups-jBffA_Tk.js"))}
const kc=()=>{Wr(import("./addRemoveTags-VyOfPwpX.js"))}
const jc=()=>{Wr(import("./guildChat-l4pdVxtt.js"))}
function xc(){Wr(import("./viewRecipe-M5IaLv3f.js"))}function Sc(){Wr(import("./ufsgAllowBack-AFG8mbOC.js"))}function $c(){Wr(import("./profile-jI3i8MQO.js").then((function(e){return e.p})))}function Lc(){Wr(import("./news-LGPd21bv.js"))}function Ec(){Wr(import("./viewArchive-qREAK-2x.js"))}const Oc=()=>{Wr(import("./inventory-yyJf07df.js"))},Pc=()=>{Wr(import("./bazaar-d9q5Bbut.js"))}
function Cc(){Wr(import("./injectQuestBookFull-dDJPoat8.js"))}const Tc=()=>{Wr(import("./scavenging-AcKNroCi.js"))}
const Nc=()=>{Wr(import("./toprated-bprKRkUy.js"))}
const Ac=()=>{Wr(import("./trade-50876_Mu.js"))}
var Mc={creatures:{"-":{"-":Sc}},items:{"-":{"-":Sc},view:{"-":()=>{Wr(import("./itemsView-24KOlDuy.js"))}}},masterrealms:{"-":{"-":Sc}},quests:{"-":{"-":Sc},view:{"-":()=>{Wr(import("./showAllQuestSteps-kheXoVEY.js"))}}},realms:{"-":{"-":Sc}},relics:{"-":{"-":Sc}},shops:{"-":{"-":Sc}},"-":{news:{"-":Lc},viewupdatearchive:{"-":Ec},viewarchive:{"-":Ec},"-":{"-":()=>{Wr(import("./unknownPage-2ouFGPck.js"))}}},arena:{"-":{"-":()=>{Wr(import("./arena-2oFrV8-S.js").then((function(e){return e.c})))}},dojoin:{"-":()=>{Wr(import("./arenaDoJoin-jKWGs-w8.js"))}},join:{"-":()=>{Wr(import("./arenaJoin-ITrzEpEZ.js"))}},completed:{"-":()=>{Wr(import("./completedArenas-hHsiHkso.js"))}},pickmove:{"-":()=>{Wr(import("./storeMoves-OGF4yRyO.js"))}},setup:{"-":()=>{Wr(import("./setupMoves-X9Bx4tLe.js"))}}},auctionhouse:{"-":{"-":()=>{Wr(import("./injectAuctionHouse-Jz47Pn72.js"))}},quickcreate:{"-":()=>{Wr(import("./quickCreate-G8buwGqR.js"))}}},bank:{"-":{"-":()=>{Wr(import("./injectBank-rYxNbPOA.js"))}}},blacksmith:{repairall:{"-":function(){Yt("fromworld")&&uc()}}},buffmarket:{"-":{"-":()=>{Wr(import("./injectBuffmarket-7b63hPul.js"))}}},combat:{attackplayer:{"-":$c}},composing:{"-":{"-":()=>{Wr(import("./composing-1NGQ6mIF.js"))}},breakdown:{"-":()=>{Wr(import("./breakdown-KGCm4ipX.js"))}},create:{"-":()=>{Wr(import("./composingCreate-4o8oX7My.js"))}}},findplayer:{"-":{"-":()=>{Wr(import("./findplayer-i0vnupmQ.js"))}}},guild:{inventory:{report:()=>{Wr(import("./guildReport-_IegV6NY.js"))},addtags:kc,removetags:kc,storeitems:()=>{Wr(import("./storeitems-XhkvGRI6.js"))}},chat:{"-":jc},dochat:{"-":jc},log:{"-":()=>{Wr(import("./guildLog-l02pSiQA.js"))}},groups:{viewstats:()=>{Wr(import("./injectGroupStats-O_-IKe0s.js"))},joinallgroupsundersize:_c,joinall:_c,"-":_c},manage:{"-":vc},advisor:{"-":wc,weekly:wc},history:{"-":bc},view:{"-":vc},scouttower:{"-":()=>{Wr(import("./injectScouttower-KJRcuuHV.js"))}},mailbox:{"-":()=>{Wr(import("./guildMailbox-gCv_WL45.js"))}},ranks:{"-":()=>{Wr(import("./rank-PBz5vtL2.js"))}},conflicts:{rpupgrades:()=>{Wr(import("./injectRPUpgrades-L_GIzW5B.js"))}},bank:{"-":()=>{Wr(import("./injectGuildBank--3wUP_dQ.js"))}},hall:{"-":()=>{Wr(import("./hall-hOogXhPn.js"))},post:bc},"-":{"-":vc}},hellforge:{"-":{"-":()=>{Wr(import("./hellforge--ZXAvaNI.js"))}}},inventing:{"-":{"-":function(){Wr(import("./inventing-yCY64PT9.js"))}},doinvent:{"-":xc},viewrecipe:{"-":xc}},log:{"-":{"-":()=>{Wr(import("./playerLog-MYuWTiAS.js"))}}},marketplace:{createreq:{"-":()=>{Wr(import("./marketplace-_UzTmDno.js"))}}},news:{fsbox:{"-":()=>{Wr(import("./newsFsbox-XFuyuSj-.js"))}},"-":{"-":Lc},shoutbox:{"-":()=>{Wr(import("./newsShoutbox-cNK6gwqx.js"))}},viewupdatearchive:{"-":Ec},viewarchive:{"-":Ec}},notepad:{showlogs:{"-":Jr},invmanagernew:{"-":Oc},guildinvmgr:{"-":Oc},recipemanager:{"-":ii},auctionsearch:{"-":Vr},onlineplayers:{"-":ei},quicklinkmanager:{"-":oi},monsterlog:{"-":zr},quickextract:{"-":ni},quickwear:{"-":ri},fsboxcontent:{"-":Kr},bufflogcontent:{"-":Qr},newguildlog:{"-":()=>{Wr(import("./newGuildLog-pmyMRvO5.js"))}},findbuffs:{"-":Yr},findother:{"-":Zr},savesettings:{"-":()=>{Wr(import("./load-d5Wb4zRn.js"))}},reliclist:{"-":ai},whosgotwhat:{"-":()=>{}}},points:{"-":{"-":()=>{Wr(import("./points-sPzmBVXH.js"))}}},potionbazaar:{"-":{"-":Pc},buyitem:{"-":Pc}},privatemessage:{"-":{"-":()=>{Wr(import("./privateMsg-YxUelM11.js"))}}},profile:{"-":{"-":$c},managecombatset:{"-":$c},report:{"-":$c},equipitem:{"-":$c},useitem:{"-":$c},changebio:{"-":bc},dropitems:{"-":function(){Wr(import("./injectProfileDropItems-wxT07c60.js"))}}},pvpladder:{"-":{"-":()=>{Wr(import("./ladder-R4uLaGMZ.js"))}}},questbook:{"-":{"-":Cc},atoz:{"-":Cc},viewquest:{"-":()=>{Wr(import("./injectQuestTracker-7-r0j3d3.js"))}}},quickbuff:{"-":{"-":()=>{Wr(import("./quickBuff-LtoxJEeu.js"))}}},scavenging:{"-":{"-":Tc},process:{"-":Tc}},settings:{"-":{"-":()=>{Wr(import("./injectSettings-Zfm02r5t.js"))}}},skills:{"-":{"-":()=>{}}},superelite:{"-":{"-":()=>{Wr(import("./superelite-wYieuKqL.js"))}}},tempinv:{"-":{"-":()=>{Wr(import("./mailbox-D6Qh7nH5.js"))}}},temple:{"-":{"-":yc}},titan:{"-":{"-":()=>{Wr(import("./injectTitan-Y1cksIHI.js"))}}},toprated:{xp:{"-":Nc},monthlyxp:{"-":Nc},gold:{"-":Nc},killstreak:{"-":Nc},bounties:{"-":Nc},risingstars:{"-":Nc},arena:{"-":Nc},superelites:{"-":Nc},smasher:{"-":Nc},globalquest:{"-":()=>{Wr(import("./globalQuest-roDVLETX.js"))}}},trade:{"-":{"-":Ac},sendgold:{"-":Ac},createsecure:{"-":Ac},docreatesecure:{"-":Ac}},world:{"-":{"-":uc}}}
...
t.classList.toggle("fshFixed",Mt("keepHelperMenuOnScreen")),Mt("draggableQuickLinks")&&(t.classList.add("fshMove"),Ar(t)),Gc(e,t),Ur(document.body,t)}(e)}let Uc=0,Fc=0,qc=0,Wc="",Qc=0,Jc=0
function zc(e){return Yt(e)||"-"}function Kc(e){const t=S(e)
return t?.value||"-"}function Xc(){if(j(Mc[Uc])&&j(Mc[Uc][Fc])&&k(Mc[Uc][Fc][qc]))return Mc[Uc][Fc][qc]}function Vc(){""!==document.location.search?(Uc=zc("cmd"),Fc=zc("subcmd"),qc=zc("subcmd2"),["points","privatemessage"].includes(Uc)&&(Wc=`/${zc("type")}`)):(Uc=Kc('input[name="cmd"]'),Fc=Kc('input[name="subcmd"]'),qc=Kc('input[name="subcmd2"]')),f.cmd=Uc,f.subcmd=Fc,f.subcmd2=qc,Jc=`${Uc}/${Fc}/${qc}${Wc}`,Qc=Xc()}function Yc(){k(Qc)&&(b(Jc),w("JS Perf",Jc),Qc(),_("JS Perf",Jc))}async function Zc(e){w("JS Perf","FSH.runCore"),Vc(),await e,cc(),Xt(3,Yc),Mt("playNewMessageSound")&&Xt(3,xr),f.huntingMode||Xt(3,Dc),_("JS Perf","FSH.runCore")}const eu=[()=>!("containerName"in CSSContainerRule.prototype),()=>!("toSpliced"in Array.prototype),()=>!navigator.cookieEnabled,()=>window!==window.parent,h]
...
M(),function(e,t){f.gmInfo=x(decodeURIComponent(t)),f.gmInfo?f.fshVer=e:f.fshVer=`${e}_native`,f.calfVer="117"}(e,t),m(),Zc(n),_("JS Perf","FSH.dispatch")}export{Ia as $,W as A,Hc as B,Mr as C,_s as D,Ci as E,Pi as F,_a as G,wa as H,Pt as I,Ct as J,es as K,Fo as L,sn as M,Mo as N,An as O,Bn as P,Dn as Q,vo as R,qo as S,Cn as T,En as U,Jn as V,Wn as W,Rn as X,Gn as Y,Ro as Z,Zt as _,Ba as a,ur as a$,Tn as a0,rn as a1,Ds as a2,Mn as a3,qn as a4,Bo as a5,zn as a6,Fs as a7,o as a8,ks as a9,Li as aA,si as aB,l as aC,nt as aD,Ge as aE,De as aF,Qe as aG,Ue as aH,lc as aI,s as aJ,Le as aK,ne as aL,Re as aM,G as aN,Mi as aO,Xe as aP,Bi as aQ,yi as aR,x as aS,Xt as aT,Gr as aU,bt as aV,yt as aW,wt as aX,vt as aY,_t as aZ,ir as a_,Yt as aa,rr as ab,Jr as ac,zr as ad,$a as ae,ms as af,f as ag,Us as ah,Mt as ai,Dr as aj,_e as ak,$r as al,Hn as am,ut as an,I as ao,te as ap,lr as aq,Aa as ar,Ms as as,pe as at,ge as au,Vt as av,Ne as aw,ue as ax,Lt as ay,ar as az,H as b,at as b$,e as b0,k as b1,Ie as b2,Qn as b3,Nn as b4,Oe as b5,un as b6,xe as b7,bo as b8,F as b9,Oa as bA,Ea as bB,Pa as bC,Fe as bD,qe as bE,Ze as bF,Ke as bG,ja as bH,Ha as bI,wn as bJ,St as bK,Ga as bL,j as bM,Tt as bN,ft as bO,Si as bP,w as bQ,_ as bR,Ca as bS,he as bT,$t as bU,nc as bV,Bt as bW,Te as bX,bi as bY,it as bZ,Ya as b_,ze as ba,Ye as bb,Co as bc,Oo as bd,Po as be,To as bf,co as bg,Go as bh,Do as bi,Uo as bj,U as bk,Ce as bl,Jo as bm,Qo as bn,V as bo,Ht as bp,Ot as bq,fe as br,Ma as bs,dn as bt,so as bu,Ve as bv,We as bw,tt as bx,ot as by,rt as bz,dr as c,je as c$,q as c0,fs as c1,Rr as c2,ve as c3,st as c4,mt as c5,Z as c6,r as c7,pt as c8,Bs as c9,J as cA,gt as cB,b as cC,Lc as cD,Cc as cE,xc as cF,B as cG,_i as cH,D as cI,na as cJ,Qi as cK,zi as cL,Ki as cM,Ji as cN,Zi as cO,xt as cP,we as cQ,cr as cR,jt as cS,Fn as cT,an as cU,ee as cV,Q as cW,K as cX,X as cY,ct as cZ,Xr as c_,pn as ca,Kn as cb,mn as cc,yn as cd,hn as ce,uo as cf,fo as cg,Io as ch,wo as ci,tn as cj,ro as ck,oo as cl,xo as cm,Rs as cn,wi as co,be as cp,Bc as cq,t as cr,L as cs,dt as ct,Wr as cu,_n as cv,Va as cw,se as cx,R as cy,kt as cz,Fr as d,Y as d0,Hs as d1,z as d2,ti as d3,vc as d4,In as d5,Ao as d6,Yo as d7,Ae as d8,Me as d9,Ei as dA,Se as dB,$e as dC,ht as dD,ci as dE,Pe as dF,de as dG,Un as dH,qa as dI,ae as dJ,vn as dK,ni as dL,fn as dM,ri as dN,tu as dO,io as da,Ar as db,le as dc,Vn as dd,ao as de,Ho as df,bn as dg,ye as dh,He as di,us as dj,qr as dk,ii as dl,me as dm,Qr as dn,oi as dp,Vr as dq,ei as dr,Zr as ds,Yr as dt,ie as du,kr as dv,Be as dw,yc as dx,mc as dy,Kr as dz,ka as e,ls as f,n as g,is as h,Ur as i,lt as j,ts as k,Et as l,Ir as m,$i as n,Za as o,jr as p,S as q,i as r,Sr as s,Ee as t,vi as u,Is as v,ds as w,sr as x,tc as y,Lr as z}
//# sourceMappingURL=calfSystem-G1dN925O.js.map
