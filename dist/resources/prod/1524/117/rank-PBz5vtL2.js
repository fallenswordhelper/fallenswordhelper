import{g as n}from"./guild-a4pzzzAR.js"
import{$ as t,G as s,aC as a,ai as r,o as e,p as o,s as i,r as c,ar as u,y as m,q as f,z as d,c as l,i as p,v as g,a8 as h,w as b,a_ as w}from"./calfSystem-G1dN925O.js"
import{b as k}from"./batch-0zyYgCi-.js"
import{b as j}from"./bitwiseAnd-b_h0Z7XX.js"
import{c as N}from"./createButton-LCF-b91n.js"
import{c as v}from"./createSpan-E64hPGZD.js"
import{i as x}from"./insertHtmlAfterBegin-lQu1LWMD.js"
import{a as C}from"./roundToString-8wwt6Rp-.js"
import{s as y}from"./sum-7xqj01JI.js"
import"./numberIsNaN--k2kVli9.js"
function B(t){return n({subcmd:"ranks",...t})}function I(n,t){return B({subcmd2:n,rank_id:t})}async function S(n,t){return await s({cmd:"guild",subcmd:"ranks",subcmd2:n,rank_id:t}),{s:!0}}let E=0
...
!function(n,t){t.includes(a())&&(E=n.rowIndex)}(t,n),g(s,` <span class="fshBlue">- ${n.join(", ")}</span>`)}}function L(n){const t=function(){const n=o().lastElementChild.previousElementSibling.rows?.[7]?.children[0]?.children[0]?.rows
if(n)return w(n)}()
t&&(k([3,t,1,l(z,n)]),q(t,n),E&&r("ajaxifyRankControls")&&e(o(),D,!0))}async function P(){if(b())return
const n=await t(B)
n?.s&&L(n.r)}export{P as default}
//# sourceMappingURL=rank-PBz5vtL2.js.map
