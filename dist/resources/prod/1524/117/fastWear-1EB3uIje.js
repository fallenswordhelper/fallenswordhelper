import{D as a,s as t,a9 as n,d as s,k as e,c,m as o,i,b1 as r,g as f,af as p,a8 as l,aT as u,o as b}from"./calfSystem-G1dN925O.js"
import{e as k,u as m}from"./useItem-iOIoCAnH.js"
...
a.className="fshBackpack",a.removeAttribute("style")}(),function(a,t){S.includes(t)||(U||j(a),r(t)&&S.push(t))}(a,x),0!==l(f("backpack_current")).length&&u(3,x,[a]),b(f("backpackContainer"),c(g,a))}async function y(){const a=await p(f("backpackContainer"),"Backpack","hcs")
a&&v(a)}export{y as default}
//# sourceMappingURL=fastWear-1EB3uIje.js.map
