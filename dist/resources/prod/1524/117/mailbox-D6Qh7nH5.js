import{a as t,u as n,$ as e,v as s,w as i,p as a,x as r,y as c,z as o,c as u,s as m,A as f,i as l,m as d,B as p,o as k,C as h,D as g,d as b,E as v,g as T}from"./calfSystem-G1dN925O.js"
import{a as x}from"./all-TTLWag-d.js"
import{c as y}from"./createInput-3jwazPKd.js"
import{c as j}from"./createLabel-LvV0YfxP.js"
import{i as I}from"./isArray-bNviZzJA.js"
import{r as C}from"./regExpGroups-4702yhMp.js"
...
H(t,await(s=n,e(E,M,s)))}function F(t,n,e){g("fshBls",e.target)&&function(t,n,e){m("mailbox","takeSimilar")
const s=e.dataset.id,{invIds:i}=t[s]
b(`taking all ${i.length} items`,e.parentNode),v(40,i).forEach(u(z,n))}(t,n,e.target)}function G(t,n,e){const s=d({className:"fshTakeGrid"})
!function(t,n){h(n).forEach(u(S,t))}(s,t),l(n,s),k(s,u(F,t,e))}function O(t){const n=d({id:"quickTake",innerHTML:'<div class="fshCenter"><br><font size="3"><b>Quick Take</b></font><br><br>Select which item to take all similar items from your Mailbox.</div><div></div>'}),{takeContainer:e,takeResult:s}=function(){const t=d(),n=p()
return l(t,n),{takeContainer:t,takeResult:n}}()
G(t,n,s),l(n,d()),l(n,e),l(a(),n)}function R(t,n){m("mailbox","toggleQuickTake"),B("qtOn","Mailbox",n)
...
//# sourceMappingURL=mailbox-D6Qh7nH5.js.map
