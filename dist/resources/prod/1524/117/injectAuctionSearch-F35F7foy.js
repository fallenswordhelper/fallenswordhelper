import{cx as t,a2 as e,p as s,d as a,ah as n,g as i,a7 as r,o as c,s as d,aS as l,bN as o}from"./calfSystem-G1dN925O.js"
import{e as u,s as h}from"./selfIdIs-htpkhmDE.js"
...
return e}(e),n+=`<td><span class="HelperTextLink" data-itemId="${s}" id="fshDel${s}">[Del]</span></td></tr>`,t+n}function $(){let t='<table cellspacing="2" cellpadding="2" class="fshLists" width="100%"><tr class="fshOr">'
...
i(p.id)&&(a(t,i(p.id)),r(p.gmname,p.currentItems))}function k(t){d("injectAuctionSearch","deleteQuickItem")
const e=t.getAttribute("data-itemId")
p.currentItems.splice(e,1),$()}const A=t=>i(`fshIn${p.fields[t]}`)
