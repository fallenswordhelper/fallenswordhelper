import{g as t}from"./guildManage-rZ5WMs6q.js"
import{o as e}from"./onlinePlayersPage-pX_nm_su.js"
import{b0 as n,bp as s,bM as a,ag as r,bs as o,ai as i,g as c,d as l,H as f,a8 as u,x as d,b_ as p,r as b,c as h,az as m,c7 as g,q as y,cz as v,p as x,o as w,s as k,a$ as L,ae as C,a_ as P,w as B,k as S,cY as j,dc as E,aC as T,b5 as I,aR as A}from"./calfSystem-G1dN925O.js"
import{c as N}from"./csvSplit-SWeoixMs.js"
import{l as R}from"./lastActivity-AD7TXVQF.js"
import{b as F}from"./buffObj-QxLUrgH2.js"
import{h as M}from"./simpleCheckbox-8V_A9jhn.js"
import{o as D}from"./onlineDot-BePpx2CP.js"
import{i as q}from"./intValue-JHhLnq8V.js"
...
function ut(t,e){l(t,c(e))}async function dt(t){!function(t,e){st(e,{href:t,findBuffNicks:at})}(t,await A(t))}function pt(){ut(ot.length,"potentialBuffers"),ot.length<=0?U("Done.","blue"):(U("Parsing player data ...","green"),ot.forEach(dt))}function bt(t,e){T()!==L(e)&&ot.push(t)}function ht(t,e){if(n=function(t){return parseInt($(t).find("td:eq(2)").text().replace(/,/g,""),10)}(e),n>=rt&&n>=W()){bt($(e).find("td:eq(1) a").attr("href"),$(e).find("td:eq(1) a").text())}var n}async function mt(t,n,s){const a=function(t,e){return 1===t?Math.round(it*e/50):t+1}(t,n)
...
n<s?mt(n,s,gt):pt()}async function yt(){if(it=parseInt(c("onlinePlayers").value,10),0!==it){gt(await e(1))}else pt()}function $t(t){const{tipped:e}=t.dataset,{mins:n}=R(e);(function(t,e,n){return t<5&&e>=rt&&e>=n})(n,Number(b(j,e)),W())&&bt(t.href,u(t))}function vt(t){lt.push(I+t)}async function xt(t){!function(t){const e=f(t)
S('#profileLeftColumn a[data-tipped*="Last Activity"]',e).forEach($t),ft+=1,ft===lt.length&&yt()}(await A(t))}function wt(t){const e=f(t)
c("guildMembers").checked&&S('#pCC a[data-tipped*="<td>VL:</td>"]',e).forEach($t),lt=[],lt.push(E),N(ct).forEach(vt),ft=0,c("alliesEnemies").checked?lt.forEach(xt):yt()}function kt(t,e){return 0!==e}function Lt(t){t.deleteRow(-1)}function Ct(){k("find buffs","clear results"),function(){const t=c("buffTable")
P(t.rows).filter(kt).forEach(h(Lt,t))}(),ut("","buffNicks"),U("Idle.","black"),ut("","potentialBuffers"),ut("0","buffersProcessed")}function Pt(e){B()||(ut(at,"buffNicks"),U(`Gathering list of ${e} ...`,"green"),z=c("level175").checked,ut("0","buffersProcessed"),ot=[],ct=c("extraProfile").value,C("extraProfile",ct),async function(){wt(await t())}())}function Bt(t,e){return t===e.id}function St(){k("find buffs","findBuffsStart")
const t=parseInt($("#selectedBuff").val(),10),e=F.find(h(Bt,t))
at=e.nicks,rt=e.lvl,Pt("potential buffers")}function jt(){k("find buffs","findOtherStart")
const t=$("#textToSearchFor").val().split(",").map(L).join(",")
C("textToSearchFor",t),at=t,rt=1,Pt("profiles to search")}function Et(){ct=i("extraProfile")}function Tt(t){w(c("findbuffsbutton"),t,!0)}function It(){w(c("clearresultsbutton"),Ct,!0)}function At(t){const e=t||x()
r.sortBy="name",r.sortAsc=!0,F.sort(H),Et(),l(K(_,ct),e),Q(),Tt(St),It()}function Nt(t){const e=t||x()
Et(),l(K(V,ct),e),Q(),Tt(jt),It()}export{At as injectFindBuffs,Nt as injectFindOther}
//# sourceMappingURL=findBuffs-K0yGHSFA.js.map
