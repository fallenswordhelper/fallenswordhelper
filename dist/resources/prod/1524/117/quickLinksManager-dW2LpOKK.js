...
import{S as t,L as s,M as n,N as i,O as l,P as a,a3 as c,Q as o,cb as v,T as u,U as d,X as r,_ as p,a0 as f,b4 as b,a1 as x,a2 as m,a4 as h,s as k,cg as g,a7 as w,W as L,ai as y,aS as j,ae as M,bh as q,bi as $,bc as Q,bf as R,bj as S}from"./calfSystem-G1dN925O.js"
import{M as C}from"./ModalTabbed-XQpfr7Fj.js"
...
return[n,i,a,function(){k("Quick Links Raw Editor","Save"),l()?c():s(1,i=1)},function(){k("Quick Links Raw Editor","Reset"),s(0,n="[]"),s(1,i=0),c()},function(){n=this.value,s(0,n)},()=>{s(1,i=a())},()=>{s(1,i=0)}]}class U extends t{constructor(e){super(),s(this,e,O,I,n,{})}}function F(e){let t,s
...
return e.$$set=e=>{"visible"in e&&s(0,n=e.visible)},[n,function(){k("Quick Links Manager","close"),s(0,n=!1)},i]}var P=class extends t{constructor(e){super(),s(this,e,H,F,n,{visible:0})}}
const X={visible:!0}
let _=0
function z(){_=e(X,_,P)}export{z as default}
//# sourceMappingURL=quickLinksManager-dW2LpOKK.js.map
