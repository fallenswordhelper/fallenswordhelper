import{az as t,s as n,c as s,bu as e,aB as f,b3 as o,p as u,n as a,b5 as c,dK as r,d1 as i,aT as l,ac as b,e as p,g as d,ab as g}from"./calfSystem-BlPuMQGT.js"
import{a as m}from"./roundToString-BBUMTgNH.js"
...
const n=function(){let t=o("h1",u())
return t=0!==t.length?a(t[0]):c(),t}()
...
let s="unknown",e="1"
n&&(s=function(t){return t[0].includes("k")?"k":t[0].includes("f")?"fsp":"stam"}(n),[e]=i(/[+-]?[.\d]+/,n[0])),L.buffs[a(t)]=[parseFloat(e),s],L.count+=1}(t):(L.count-=1,delete L.buffs[s]),L.count>0?F():(p("&nbsp;",d("buffCost")),L.buffCostTotalText="")}function R(t){return t.tagName&&"SPAN"!==t.tagName?R(t.parentNode):t}function z(t){if("fshSendBuffMsg"===t.target.id)return void function(t){t.count>0&&T(t)}(L)
const n=R(t.target);(function(t){return t.classList&&b("buffLink",t)})(n)&&M(n)}function E(t,n,s){return t.replace(n,`<span id="fshBuff${s}" class="buffLink fshBlue">${n.replace(/(`~)|(~`)|(\{b\})|(\{\/b\})/g,"")}</span>`)}function O(t){let n=t.replace(/\{b\}/g,"`~").replace(/\{\/b\}/g,"~`")
const s=n.match(/`~([^~]|~(?!`))*~`/g)
...
//# sourceMappingURL=render-BuVJcsH2.js.map
