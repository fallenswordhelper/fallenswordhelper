import{an as t,dh as e,p as s,e as a,aA as n,g as c,ap as i,o as r,s as d,bk as l,cs as o,ae as u}from"./calfSystem-BlPuMQGT.js"
import{e as h,s as f}from"./selfIdIs-CQSn4sGu.js"
...
c(p.id)&&(a(t,c(p.id)),i(p.gmname,p.currentItems))}function w(t){d("injectAuctionSearch","deleteQuickItem")
const e=t.getAttribute("data-itemId")
p.currentItems.splice(e,1),I()}const v=t=>c(`fshIn${p.fields[t]}`)
...
u(t)&&(p.currentItems=t,I())}function H(){d("injectAuctionSearch","resetRawEditor"),"fshAso"===p.id?p.currentItems=l(o.quickSearchList):p.currentItems=[],I()}function j(t){r(t,h([[f("fshReset"),H],[f("fshSave"),S],[f("fshAdd"),x],[t=>t.id.startsWith("fshDel"),w]]))}function T(n){const c=n||s()
...
//# sourceMappingURL=injectAuctionSearch-Io0loPRR.js.map
