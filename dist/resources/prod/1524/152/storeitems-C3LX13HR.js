import{z as t,C as e,E as o,N as s,O as r,s as a,aq as n,A as i,F as c,u as l,c as d,l as m,ab as f,k as u,ad as p,a4 as h,aB as b,bt as g}from"./calfSystem-BlPuMQGT.js"
import{b as j}from"./batch-g9WD9nW_.js"
import{t as F}from"./toggleForce-br4z9gGd.js"
import{F as v}from"./FolderButtons-DaPrgdYz.js"
import{g as k,M as N,d as I,i as x,a as y,b as C}from"./injectStoreItems-CNQAexwS.js"
...
var n=M(),l=c(n),d=c(l)
v(d,{get doFilter(){return o.doFilter},get folders(){return a().folders}}),s(e,n),r()}function B(t,e,o){o.checked=!1
const s=m(o),r=t.items[o.value]?.folder_id,a=-2!==e&&e!==r
F(s,a),F(s.nextElementSibling,a)}function w(t,e){a("storeitems","Filter Folder"),j([3,k(),0,d(B,t,Number(e))])}function L(t,e,o){o.checked=!1,function(t,e,o){t.items[o].folder_id=Number(e)}(t,e,o.value)
const s=m(o)
...
const e=await y()
e?.folders&&(function(t,e){l(_,{anchor:e,props:{doFilter:d(w,t),inv:t},target:e.parentNode})}(e,t),function(t,e){const o=[{id:"-1",name:"Main"},...f(t.folders).map((([t,e])=>({id:t,name:e})))]
...
//# sourceMappingURL=storeitems-C3LX13HR.js.map
