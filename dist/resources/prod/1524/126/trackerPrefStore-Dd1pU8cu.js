import{a,$ as s,C as t,f as e,bn as r,c as n,aO as o,dF as m,aQ as c}from"./calfSystem-DG-hTKTe.js"
import{r as i}from"./now-Cx4PsKjI.js"
import{u as p}from"./uniq-2BNwty6I.js"
...
return{lastUpdate:t,...y(n)}}(N,a),c("fsh_seLog",N),h.set(N))}function M(a,s){x=s,a(x),x&&!A&&async function(){for(A=!0,N=await o("fsh_seLog"),h.set(N);x;)A=!0,await m(1e3*C(N)),x&&await L(),A=!1}()}const O=function(){const{subscribe:a,set:s}=r(0)
return{subscribe:a,set:n(M,s)}}()
var S=Object.freeze({__proto__:null,default:O})
export{S as a,f as p,h as s,O as t}
//# sourceMappingURL=trackerPrefStore-Dd1pU8cu.js.map
