...
import{ag as t,m as n,g as a,a9 as r,i as o,c as s,v as i,o as l,s as c,aC as u,aE as f,aF as d,aG as m,aH as p,aI as h,y as g,b as v,ai as b,aJ as k,aK as y,aL as w,aM as C,aN as L,ae as V,k as D,aO as M,q as x,aP as A,aQ as S,aR as N,aS as H,D as B,aT as T,aU as E,aV as G,aW as P,aX as j,aY as F,aZ as _,a_ as R,a$ as O,b0 as I,b1 as W,aj as q,a8 as K,b2 as Y,b3 as U,b4 as z,a as Q,$ as J,S as X,L as Z,M as ee,am as te,T as ne,_ as ae,a0 as re,O as oe,a3 as se,b5 as ie,U as le,a4 as ce,N as ue,P as fe,Q as de,b6 as me,b7 as pe,b8 as he,b9 as ge,Z as ve,X as be,a5 as ke,ba as ye,d as we,ap as Ce,bb as $e,bc as Le,bd as Ve,E as De,be as Me,bf as xe,bg as Ae,bh as Se,bi as Ne,bj as He,bk as Be,bl as Te,bm as Ee,bn as Ge,bo as Pe,bp as je,bq as Fe,br as _e,bs as Re,bt as Oe,bu as Ie,bv as We,bw as qe,bx as Ke,by as Ye,bz as Ue,bA as ze,bB as Qe,bC as Je,bD as Xe,bE as Ze,bF as et,bG as tt,bH as nt,bI as at,bJ as rt,bK as ot,bL as st,bM as it,ah as lt}from"./calfSystem-CUgWHLtG.js"
import{i as ct}from"./insertElementAfter-CZh9nC1V.js"
import{t as ut}from"./toggleForce-br4z9gGd.js"
import{c as ft}from"./createSpan-C6zT5DkE.js"
import{i as dt}from"./insertTextBeforeEnd-CMWMTqlb.js"
import{r as mt,a as pt}from"./roundToString-Hif1MLyB.js"
import{a as ht}from"./addCommas-C_h2HN8s.js"
import{d as gt,q as vt}from"./quickbuffSuccess-CHxpkxA_.js"
import{c as bt}from"./createButton-CMC5towu.js"
import{i as kt}from"./isArray-eVldfhw1.js"
import{o as yt}from"./openQuickBuffById-6cMf-Stu.js"
import{c as wt}from"./createInput-DZ-lTyHM.js"
import{c as Ct}from"./createLabel-gOPWvr0E.js"
import{r as $t}from"./rnd-D_QmA-Fa.js"
import{v as Lt}from"./valueText-CpX32YUk.js"
import{c as Vt}from"./createStyle-DCnW_5bV.js"
import{h as Dt,u as Mt}from"./await_block-DpKGh93y.js"
import{u as xt}from"./uniq-Dzsj1uso.js"
import{g as At}from"./guild-CuLUwg__.js"
import{c as St}from"./createTable-DNrsnCmN.js"
...
import{L as Gt}from"./LinkButton-C46P8xIn.js"
import{r as Pt}from"./reduceBuffArray-Diy1E3zc.js"
import{p as jt}from"./profile-16lC7c6q.js"
import{a as Ft}from"./all-YfMtr2SN.js"
import{n as _t}from"./numberIsNaN-CGkd1jiA.js"
import{r as Rt}from"./reliclist-CKLWtaMp.js"
import{d as Ot}from"./daGroupStats-Bioe5_jt.js"
import{d as It,m as Wt}from"./mercEffect-B9PsSime.js"
import{d as qt}from"./daViewGroups-0nlukBpY.js"
import{a as Kt}from"./attribsToArray-B2FHTGml.js"
import{g as Yt}from"./guildMembers-xW-R9y84.js"
import{r as Ut}from"./remainingPages-BzskAxSU.js"
import{t as zt}from"./testQuant-CUL735o8.js"
import{m as Qt}from"./myStats-BIVJE5Bb.js"
import{s as Jt}from"./shouldBeArray-dArQIyo9.js"
import{s as Xt,j as Zt}from"./simpleCheckbox-BsLxfTBb.js"
...
import"./guildGroups-EsvEM3ex.js"
import"./view-iHslysy_.js"
...
function Sn(e,t){Dn?ut(Dn,!1):function(e){[Dn]=e.children,r("Shield Imps Remaining: ",Dn),Mn=ft(),o(Dn,Mn),i(Dn,"&nbsp;")
const t=bt({className:"xSmallLink",textContent:"Recast"})
o(Dn,t),l(t,xn)}(e)
const n=function(e){return e?Number(e.stack):0}(t)
Dn.className=function(e){return An[e]??"fshGreen"}(n),r(n,Mn)}function Nn(e,t,n){t||n?Sn(e,t):Dn&&ut(Dn,!0)}function Hn(e){return 0===e.type}let Bn=0,Tn=0,En=0,Gn=0,Pn=0,jn=0
function Fn(){Bn=Ln("Death Dealer"),Tn=Ln("Doubler"),En=Ln("Counter Attack"),Gn=Ln("Summon Shield Imp"),Pn=function(){const{dynamic:e}=GameData.realm()
return kt(e)&&e.some(Hn)}(),jn=GameData.player().killStreak}function _n(){!function(){const e=$("#actionlist-shield-imp")
1===e.length&&e.css("background-color",Vn[e.text()]||"#ad8043")}(),Fn()
const e=rn([Bn,Tn,En,Gn,Pn])
e&&(Nn(e,Gn,Bn),Cn(e,Bn,Pn,jn),bn(e,Bn,jn),un(e,En),pn(e,Tn))}function Rn(e){return ft({textContent:e})}function On(){window.GameController&&GameController.Realm&&!GameController.Realm.footprintTileList&&(GameController.Realm.footprintTileList=[])}function In(e,t,n){return Ct({className:`fshCurveEle fshCurveLbl fshPoint tip-static ${e}`,dataset:{tipped:t},htmlFor:n})}function Wn(e){const t=n({className:"fshToggle"}),a=wt({checked:e.prefVal,id:e.checkId,type:"checkbox"})
o(t,a)
const r=In(e.onClass,e.onTip,e.checkId)
o(t,r)
const s=In(e.offClass,e.offTip,e.checkId)
return o(t,s),o(e.worldName,t),a}let qn=0,Kn=0,Yn=0,Un=0,zn=0,Qn=0,Jn=0,Xn=0,Zn=0
...
Kn=ea(GameData.realm().minlevel),ta(t,"Min",Kn),Yn=ea(GameData.player().level),ta(t,"Your",Yn),o(e,t)}(e),Un=na("fshFormGroup","Quick Create Attack Group",e),zn=na("fshQuickBuff","Open Quick Buff Popup",e),Qn=na("fshRealmMap","Open Realm Map",e),Jn=na("fshTempleOne","Search map in Ultimate FSG",e)}function ra(){aa(qn),function(e){if(b("showSpeakerOnWorld")){const t=b("playNewMessageSound")
...
Zn=Wn({prefVal:n,checkId:"fshHuntCheck",onClass:"huntOn",onTip:"Hunting mode is ON",offClass:"huntOff",offTip:"Hunting mode is OFF",worldName:e})}(qn)}const oa=[[()=>Xn,function(){c("NewMap","toggleSound"),V("playNewMessageSound",!b("playNewMessageSound"))}],[()=>Zn,function(){c("NewMap","toggleHuntMode"),t.huntingMode=!t.huntingMode,V("huntingMode",t.huntingMode)}]],sa=[[()=>Un,function(e){c("NewMap","doFormGroup"),k(e),GameData.doAction(12,401,{},0)}],[()=>zn,function(){c("NewMap","openQuickBuff"),yt(y())}],[()=>Qn,function(){c("NewMap","openRealmMap"),window.open(`${w+C}map`,"fsMap")}],[()=>Jn,function(){c("NewMap","openUfsgMap")
const e=GameData.realm()
window.open(`${L}realms${C}view&realm_id=${e.id}`,"mapUfsg")}]]
function ia(e,t){const{target:n}=t,[,a]=e.find((([e])=>e()===n))??[]
a&&(n.blur(),a(n))}function la(e){return s(ia,e)}function ca(){qn||(qn=n({className:"fshCurveContainer",id:"fshWorldButtonContainer"}),ra(),l(qn,la(sa)),v(qn,"change",la(oa)),g(qn,a("worldCoord")))}function ua(e,t){Kn&&t.b.minlevel&&(On(),r(t.b.minlevel,Kn))}function fa(e,t){Yn&&r(t.b,Yn)}const da=["NORMAL","CHAMPION","ELITE","SUPER ELITE","TITAN","LEGENDARY"],ma=`url("${A}ui/world/icon_action_attack_`
let pa=!1
...
return function(e){Aa(e)||Na.push(e)}(a),a}let Ea=0,Ga=0,Pa=0,ja=0,Fa=0,_a=0
const Ra=()=>Ea,Oa=()=>Ga,Ia=()=>Pa,Wa=()=>ja,qa=()=>Fa,Ka=()=>_a
function Ya(e,t){return Lt(P(t,e))}function Ua(){var e
Ea=GameData.player().level,e=a("statbar-character-tooltip-stats"),Pa=Ya(e,j),Ga=Ya(e,F),Fa=Ya(e,_),ja=Ya(e,R),_a=Ya(e,O)}const za=e=>`<td>${e}:&nbsp;</td>`,Qa=e=>`<td width="40%">${e}</td>`
function Ja([e,t,n,a,r]){return[za(e),Qa(`${t} (your ${n}:<span class="${a}">${r()}</span>)`)]}function Xa(e){return["<tr>",...e,"</tr>"].join("")}function Za(e,t){return Xa([...Ja(e),...Ja(t)])}const er='<tr><td colspan="4" height="5"></td></tr><tr><td class="header" colspan="4" class="fshCenter">Enhancements</td></tr>'
function tr(e){return`<tr><td colspan="2">${e.name}:</td><td colspan="2">${e.value}</td></tr>`}function nr(e,t,n){return function(e){return`<table><tr><td><img src="${A}creatures/${e.image_id}.png" height="200" width="200"></td><td rowspan="2"><table width="400"><tr><td class="header" colspan="4" class="fshCenter">Statistics</td></tr>`}(e)+function(e,t){return Xa([za("Class"),Qa(e.creature_class),...Ja(["Level",e.level,"level",t,Ra])])}(e,n)+function(e){return Za(["Attack",e.attack,"defense","fshYellow",Oa],["Defense",e.defense,"attack","fshYellow",Ia])}(e)+function(e){return Za(["Armor",e.armor,"damage","fshYellow",Wa],["Damage",e.damage,"armor","fshYellow",qa])}(e)+function(e,t){return Xa([za("HP"),Qa(`${e.hp} (your HP:<span class="fshYellow">${Ka()}</span>)(1H: <span class="fshRed">${t}</span>)`),za("Gold"),Qa(e.gold)])}(e,t)+er+function(e){return 0===e.enhancements.length?'<tr><td colspan="4">[no enhancements]</td></tr>':e.enhancements.map(tr).join("")}(e)+function(e){return`<tr><td colspan="4" height="5"></td></tr><tr><td class="header" colspan="4" class="fshCenter">Description</td></tr><tr><td colspan="4">${e.description}</td></tr><tr><td colspan="4" height="5"></td></tr></table></td></tr><tr><td class="fshCenter"><b>${e.name}</b></td></tr></table>`}(e)}function ar(e){if(!Aa(e))return function(e){const n=Math.ceil(e.hp*t.hpVariable+e.armor*t.generalVariable)
let a="fshYellow"
return Ua(),Ra()>e.level&&(a="fshRed"),nr(e,n,a)}(e.response.data)}const rr=["verb","view","tip-static"]
async function or(e,t){const n=function(e){return I(e.parentNode.children).indexOf(e)}(e),a=await Ta(GameData.actions()[n].data.id,n)
...
function pr(e){return function(t,n,a,r){const o=mr[t];(function(e){return e&&U(e)})(o)&&function(e){return Y(e)||0===e}(r)?o(e)(t,n,a,r):e(t,n,a,r)}}function hr(){return e={subcmd:"contrib"},Q({cmd:"globalquests",...e})
...
return{c(){t=se("Server Error")},m(e,n){ne(e,t,n)},p:ae,d(e){e&&re(t)}}}function wr(e){let t,n,a,r=ue(e[1]),o=[]
for(let t=0;t<r.length;t+=1)o[t]=$r(vr(e,r,t))
return{c(){t=oe("table"),n=oe("tr"),n.innerHTML='<td class="header"></td> <td class="header"></td> <td class="header">Username</td> <td class="header">Kills</td>',a=fe()
for(let e=0;e<o.length;e+=1)o[e].c()
de(n,"class","svelte-2qtc6g"),de(t,"id","world-event-contrib-table"),de(t,"class","svelte-2qtc6g")},m(e,r){ne(e,t,r),le(t,n),le(t,a)
for(let e=0;e<o.length;e+=1)o[e]&&o[e].m(t,null)},p(e,n){if(1&n){let a
for(r=ue(e[1]),a=0;a<r.length;a+=1){const s=vr(e,r,a)
o[a]?o[a].p(s,n):(o[a]=$r(s),o[a].c(),o[a].m(t,null))}for(;a<o.length;a+=1)o[a].d(1)
o.length=r.length}},d(e){e&&re(t),me(o,e)}}}function Cr(e){let t,n,a,r
...
return{c(){t=se("Loading...")},m(e,n){ne(e,t,n)},p:ae,d(e){e&&re(t)}}}function Vr(e){let t,n,a={ctx:e,current:null,token:null,hasCatch:!0,pending:Lr,then:kr,catch:br,value:2,error:7}
return Dt(n=e[0],a),{c(){t=te(),a.block.c()},m(e,n){ne(e,t,n),a.block.m(e,a.anchor=n),a.mount=()=>t.parentNode,a.anchor=t},p(t,[r]){e=t,a.ctx=e,1&r&&n!==(n=e[0])&&Dt(n,a)||Mt(a,e,r)},i:ae,o:ae,d(e){e&&re(t),a.block.d(e),a.token=null,a=null}}}function Dr(e,t,n){let{promise:a}=t
return e.$$set=e=>{"promise"in e&&n(0,a=e.promise)},[a]}class Mr extends X{constructor(e){super(),Z(this,e,Dr,Vr,ee,{promise:0})}}let xr=0
...
b(e)&&(n=t+1,$.subscribe(z,s(Nr,n)),Nr(t+1))}function Tr(e,t,n){const a=e.slice()
...
function f(){return t[3](t[9])}return{key:e,first:null,c(){n=oe("div"),a=se(c),r=fe(),u&&u.c(),o=fe(),de(n,"class",s="fsh-message "+t[10]+" svelte-1t9oc1"),this.first=n},m(e,t){ne(e,n,t),le(n,a),le(n,r),u&&u.m(n,null),le(n,o),i||(l=be(n,"click",f),i=!0)},p(e,r){t=e,1&r&&c!==(c=t[9]+"")&&ce(a,c),t[11]>1?u?u.p(t,r):(u=Er(t),u.c(),u.m(n,o)):u&&(u.d(1),u=null),1&r&&s!==(s="fsh-message "+t[10]+" svelte-1t9oc1")&&de(n,"class",s)},d(e){e&&re(n),u&&u.d(),i=!1,l()}}}function Pr(e){let t,n=[],a=new Map,r=ue(e[1](e[0]))
const o=e=>e[9]
...
ne(e,t,a)},p(e,[s]){7&s&&(r=ue(e[1](e[0])),n=ve(n,s,o,1,e,r,a,t.parentNode,ke,Gr,t,Tr))},i:ae,o:ae,d(e){e&&re(t)
...
return[a,e=>xt(e,"msg").map((({msg:t,type:n})=>({msg:t,type:n,count:e.filter((({msg:e})=>e===t)).length}))),i,e=>i(e)]}class Fr extends X{constructor(e){super(),Z(this,e,jr,Pr,ee,{})}}let _r=0
function Rr(e){_r[e.name]?_r[e.name].seen&&(_r[e.name].seen+=1):(_r[e.name]={seen:1},function(e,t){t.creature_class=e.creature_class,t.image_id=e.image_id,t.level=Number(e.level),t.type=e.type}(e,_r[e.name]))}function Or(e,t,n){return t?e(t,n):n}function Ir(e,t){const n=e||{}
return n.min=Or(Math.min,n.min,t),n.max=Or(Math.max,n.max,t),n}const Wr=["attack","armor","damage","defense","hp"]
function qr(e,t,n){const a=Ir(t[n],Number(e[n]));(function(e,t){return!e||e.min!==t.min||e.max!==t.max})(t[n],a)&&(t[n]=a)}function Kr(e,t){e[t.name]=Ir(e[t.name],Number(t.value))}function Yr(e){_r||(_r={}),Rr(e),function(e,t){Wr.forEach(s(qr,e,t))}(e,_r[e.name]),function(e,t){(function(e){return e.enhancements&&e.enhancements.length>0})(e)&&(t.enhancements=t.enhancements||{},e.enhancements.forEach(s(Kr,t.enhancements)))}(e,_r[e.name]),H("fsh_monsterLog",_r)}async function Ur(){!function(e){_r=e||{}}(await S("fsh_monsterLog"))}const zr=[]
function Qr(e){var n
Aa(e)||(n=e.response.data,t.showMonsterLog&&Yr(n))}function Jr(e,t){return e.id===t.id}async function Xr(e,t){if(6!==e.type||function(e){if(zr.find(s(Jr,e.data)))return!0
...
const go=()=>io,vo=()=>po
function bo(){io=Rn("Current"),lo=Rn("Kills"),co=Rn("Member"),uo=Rn("% of Total"),fo=Rn("Status"),mo=Rn("Titan HP"),po=Rn("Total"),ho=Rn("Your Guild")}let ko=0,yo=0,wo=0,Co=0,$o=0,Lo=0,Vo=0,Do=0,Mo=0
const xo=()=>ko,Ao=()=>yo,So=()=>wo,No=()=>Co,Ho=()=>$o,Bo=()=>Lo,To=()=>Vo,Eo=()=>Do,Go=()=>Mo
function Po(){ko=ft({innerHTML:"&nbsp;"}),yo=ft({innerHTML:"&nbsp;"}),wo=ft(),Co=ft(),$o=ft(),Lo=ft(),Vo=ft(),Do=ft(),Mo=ft()}let jo=0
const Fo=()=>jo
function _o(){for(;jo.rows.length>8;)jo.deleteRow(8)}function Ro(e){const t=ft()
return o(t,e),dt(t,"%"),t}const Oo=[[[5,xo,!0],[1,Ao,!0]]],Io=[[[2,()=>mo,!0],[4,()=>ho,!0]]],Wo=[[[2,function(){const e=ft()
return o(e,So()),dt(e,"/"),o(e,No()),e}],[4,Ho]]],qo=()=>[[[2,go,!0],[4,s(Ro,Bo())]],!0],Ko=()=>[[[2,vo,!0],[4,s(Ro,To())]],!0],Yo=[[[2,()=>fo,!0],[4,Eo]],!0],Uo=[[[2,()=>co,!0],[2,()=>lo,!0],[2,()=>uo,!0]]]
let zo=0,Qo=0,Jo=""
const Xo=()=>Qo,Zo=()=>Jo
function es(){Qo=null,zo&&!B("fshHide",zo)&&(ut(zo,!0),we("&nbsp;",ko),we("&nbsp;",yo),r("",wo),r("",Co),r("",$o),r("",Lo),r("",Vo),we("",Do),we("",Mo),_o())}function ts(e){return 0===e.type&&(Qo=e.base_creature_id,Jo=`(${e.x},${e.y})`,!0)}function ns(){if(zo)ut(zo,!1)
else{const e=a("actionContainer")
zo=n({className:"fshActionBox titanInfo"}),Po(),jo=St({className:"fshCenter"}),bo(),so(jo,[Oo,Io,Wo,qo(),Ko(),Yo,[[[6,Go]]],Uo]),o(zo,Fo()),o(e,zo)}}function as(e){return e<=0?'<span class="fshGreen cooldown">No active cooldown</span>':`<span class="fshMaroon cooldown">Cooldown until: ${function(e){const t=new Date(Ce()+1e3*e)
return`${Tt(t.getHours())}:${Tt(t.getMinutes())} ${Tt(t.getDate())}/${$e[t.getMonth()]}/${t.getFullYear()}`}(e)}</span>`}function rs(e){return pt(Bt(e.max_hp-e.current_hp,e.kills),2)}function os(e){return pt(100*e.kills/e.max_hp,2)}function ss(e){!function(e){[[Ht(e.creature.name),xo],[Zo(),Ao],[e.current_hp,So],[e.max_hp,No],[e.kills,Ho],[rs(e),Bo],[os(e),To]].forEach((([e,t])=>r(e,t())))}(e),we(function(e){return Nt(e.kills,e.max_hp,e.current_hp)}(e),Eo()),we(as(e.cooldown),Go())}function is(e,t){return[[[2,()=>Rn(t.player.name)],[2,()=>Rn(t.kills.toString())],[2,()=>Rn(`${pt(100*t.kills/e.kills,2)}%`)]]]}function ls(e){return e.realm&&e.creature.base_id===Xo()&&e.realm===to()}function cs(e){const t=e.find(ls)
t&&(ss(t),function(e){if(_o(),!e.contributors)return
const t=e.contributors.map(s(is,e))
so(Fo(),t)}(t))}let us=null
...
const r={}
256&a&&(r.$$scope={dirty:a,ctx:e}),n.$set(r)},i(e){r||(Me(n.$$.fragment,e),r=!0)},o(e){Se(n.$$.fragment,e),r=!1},d(e){e&&re(t),Te(n)}}}function ys(e){let t,n,a=ue(De(16,e[0])),r=[]
...
for(a=ue(De(16,e[0])),s=0;s<a.length;s+=1){const o=vs(e,a,s)
...
return e?.r?.find(Rs)?.id}(),a=n&&await async function(e){const t=await Ot(e)
return Kt(t?.r?.attributes)}(n),r=a&&await async function(e){const t=await It(),n=Wt(t)
return e?.map(((e,t)=>e-n[t]))}(a)
r&&t({attack:r[0],defense:r[1],armor:r[2],hp:r[3],damage:r[4]}),As.set(["groupStore","Done."])}const Is=Pe(_s,((e,t)=>{Os(e,t)})),Ws=(e,t,n)=>Math.ceil(e*_e(t,0)*n),qs=(e,t)=>Ws(e,t,.0025),Ks=(e,t)=>Ws(e,t,.001),Ys=Ks,Us=Ks,zs=Ks,Qs=Ks,Js=Ks,Xs=(e,t)=>Math.ceil(e*(1+.001*_e(t,0))),Zs=(e,t)=>Math.ceil(e*(1-t*Re)),ei=je([]),ti=Pe(ei,((e,t)=>{e&&t(Pt(e))})),ni=Pe([ti,Is],(([e,t],n)=>{if(!e||!t)return
const a=Xs(t.defense,e.Constitution),r=t.hp+Ys(a,e.Fortitude)
n({dmgWithChiStrike:t.damage+Us(r,e["Chi Strike"]),defWithConst:a,hpWithFortitude:r,nmv:qs(t.attack,e["Nightmare Visage"]),sanctuary:zs(t.armor,e.Sanctuary)})}))
const ai=Pe([ni,Gs,Is],(function([e,t,n],a){if(!e||!t||!n)return
...
const ri=Pe([Gs,Fs],(([e,t],n)=>{if(!e||!t)return
const a=qs(t.attackValue,e.nightmareVisageLevel),r=Xs(t.defenseValue,e.constitutionLevel)
!function([e,t,n,a,r,o]){n({attackWithNmv:t.attackValue-a,chiStrike:e.chiStrikeLevel,cloak:e.cloakLevel?"Yes":"No",dmgWithChiStrike:t.damageValue+Us(o,e.chiStrikeLevel),defWithConst:r,hpWithFortitude:o,nmv:a,sanctuary:zs(t.armorValue,e.sanctuaryLevel)})}([e,t,n,a,r,t.hpValue+Ys(r,e.fortitudeLevel)])}))
const oi=Pe([ti,ri,Fs],(function([e,t,n],a){if(!e||!t||!n)return
...
e.cloakLevel?t("Yes"):t("No")})),li=Pe(Fs,((e,t)=>{t({armorValue:e?.armorValue??"",attackValue:e?.attackValue??"",damageValue:e?.damageValue??"",cloaked:e?.cloaked??"",defenseValue:e?.defenseValue??"",hpValue:e?.hpValue??""})})),ci=Pe(Es,((e,t)=>{t(e?.length??"")})),ui=Pe(oi,((e,t)=>{t({attack:e?.attack??"",dc225:e?.dc225??"",dc175:e?.dc175??"",defense:e?.defense??"",armor:e?.armor??"",hp:e?.hp??"",damage:e?.damage??""})})),fi=e=>({attack:e?.attack??"",defense:e?.defense??"",armor:e?.armor??"",hp:e?.hp??"",damage:e?.damage??""}),di=Pe(Is,((e,t)=>{t(fi(e))})),mi=Pe(ai,((e,t)=>{t(fi(e))}))
function pi(e,t,n){const a=e.slice()
return a[6]=t[n].id,a[7]=t[n].username,a}function hi(e){let t,n,a,r,o=e[7]+""
return{c(){t=oe("a"),n=se(o),r=se(" "),de(t,"href",a=""+(Oe+e[6])),de(t,"class","svelte-3priew")},m(e,a){ne(e,t,a),le(t,n),ne(e,r,a)},p(e,r){1&r&&o!==(o=e[7]+"")&&ce(n,o),1&r&&a!==(a=""+(Oe+e[6]))&&de(t,"href",a)},d(e){e&&(re(t),re(r))}}}function gi(e){let t,n,a,r=(e[0].length||"")+"",o=ue(e[0]),s=[]
...
const o=[({username:e})=>!a.includes(e),({last_login:e})=>e,({last_login:e})=>e<We(),({last_login:e})=>e>qe(),({level:e})=>e<400||e>421,({level:e})=>e<441||e>450],s=e=>o.every((t=>t(e))),i=({username:e},{username:t})=>Ie(e,t)
...
return{c(){t=oe("button"),t.textContent="Fetch Stats",de(t,"class","custombutton"),de(t,"type","button")},m(r,o){ne(r,t,o),n||(a=be(t,"click",e[12]),n=!0)},p:ae,d(e){e&&re(t),n=!1,a()}}}function Ci(e){let t,n,a,r,o,s,i,l,c,u,f,d,m,p,h,g,v,b,k,y,w,C,$,L,V,D,M,x,A,S,N,H,B,T,E,G,P,j,F,_,R,O,I,W,q,K,Y,U,z,Q,J,X,Z,ee,te,ae,ie,ue,me,pe,he,ge,ve,be,ke,ye,we,Ce,$e,Le,Ve,De,xe,Ae,Ne,Ee,Ge,Pe,je,Fe,_e,Re,Oe,Ie,We,qe,Ke,Ye,Ue,ze,Qe,Je,Xe,Ze,et,tt,nt,at,rt,ot,st,it,lt,ct,ut,ft,dt,mt,pt,ht,gt,vt,bt,kt,yt,wt,Ct,$t,Lt,Vt,Dt,Mt,xt,At,St,Nt,Ht,Bt,Tt,Et,Gt,Pt,jt,Ft,_t,Rt,Ot,It,Wt,qt,Kt,Yt,Ut,zt,Qt,Jt,Xt,Zt,en,tn,nn,an,rn,on,sn=e[3].noOfRelics+"",ln=e[3].leadDefenderBonus+"",cn=e[5].attackValue+"",un=e[6].attack+"",fn=e[5].defenseValue+"",dn=e[6].defense+"",mn=e[5].armorValue+"",pn=e[6].armor+"",hn=e[5].damageValue+"",gn=e[6].damage+"",vn=e[5].hpValue+"",bn=e[6].hp+"",kn=e[5].cloaked+"",yn=e[6].dc225+"",wn=e[6].dc175+"",Cn=e[8].attack+"",$n=e[9].attack+"",Ln=e[8].defense+"",Vn=e[9].defense+"",Dn=e[8].armor+"",Mn=e[9].armor+"",xn=e[8].damage+"",An=e[9].damage+"",Sn=e[8].hp+"",Nn=e[9].hp+""
return rn=new bi({props:{members:e[10]}}),{c(){t=oe("div"),n=oe("div"),n.textContent="Defending Guild Stats",a=fe(),r=oe("div"),o=oe("div"),o.textContent="Relic Count:",s=fe(),i=oe("div"),l=se(sn),c=fe(),u=oe("div"),u.textContent="Lead Defender Bonus:",f=fe(),d=oe("div"),m=se(ln),p=fe(),h=oe("div"),h.textContent="Lead Defender Cloaked:",g=fe(),v=oe("div"),b=se(e[4]),k=fe(),y=oe("div"),y.textContent="Other Defender Stats",w=fe(),C=oe("div"),$=oe("div"),$.textContent="Raw Attack:",L=fe(),V=oe("div"),D=se(cn),M=fe(),x=oe("div"),x.textContent="Attack w/ buffs:",A=fe(),S=oe("div"),N=se(un),H=fe(),B=oe("div"),B.textContent="Raw Defense:",T=fe(),E=oe("div"),G=se(fn),P=fe(),j=oe("div"),j.textContent="Defense w/buffs:",F=fe(),_=oe("div"),R=se(dn),O=fe(),I=oe("div"),I.textContent="Raw Armor:",W=fe(),q=oe("div"),K=se(mn),Y=fe(),U=oe("div"),U.textContent="Armor w/ buffs:",z=fe(),Q=oe("div"),J=se(pn),X=fe(),Z=oe("div"),Z.textContent="Raw Damage:",ee=fe(),te=oe("div"),ae=se(hn),ie=fe(),ue=oe("div"),ue.textContent="Damage w/ buffs:",me=fe(),pe=oe("div"),he=se(gn),ge=fe(),ve=oe("div"),ve.textContent="Raw HP:",be=fe(),ke=oe("div"),ye=se(vn),we=fe(),Ce=oe("div"),Ce.textContent="HP w/ buffs:",$e=fe(),Le=oe("div"),Ve=se(bn),De=fe(),xe=oe("div"),xe.textContent="Cloaked:",Ae=fe(),Ne=oe("div"),Ee=se(kn),Ge=fe(),Pe=oe("div"),Pe.textContent="Processed:",je=fe(),Fe=oe("div"),_e=se(e[7]),Re=fe(),Oe=oe("div"),Ie=oe("div"),Ie.textContent="Adjusted Defense Values",We=fe(),qe=oe("div"),Ke=oe("div"),Ke.textContent="DC225:",Ye=fe(),Ue=oe("div"),ze=se(yn),Qe=fe(),Je=oe("div"),Je.textContent="DC175:",Xe=fe(),Ze=oe("div"),et=se(wn),tt=fe(),nt=oe("div"),nt.textContent=" ",at=fe(),rt=oe("div"),rt.textContent="Attacking Group Stats",ot=fe(),st=oe("div"),it=oe("div"),it.textContent="Raw Group Attack:",lt=fe(),ct=oe("div"),ut=se(Cn),ft=fe(),dt=oe("div"),dt.textContent="Group Attack w/ buffs:",mt=fe(),pt=oe("div"),ht=se($n),gt=fe(),vt=oe("div"),vt.textContent="Raw Group Defense:",bt=fe(),kt=oe("div"),yt=se(Ln),wt=fe(),Ct=oe("div"),Ct.textContent="Group Defense w/ buffs:",$t=fe(),Lt=oe("div"),Vt=se(Vn),Dt=fe(),Mt=oe("div"),Mt.textContent="Raw Group Armor:",xt=fe(),At=oe("div"),St=se(Dn),Nt=fe(),Ht=oe("div"),Ht.textContent="Group Armor w/ buffs:",Bt=fe(),Tt=oe("div"),Et=se(Mn),Gt=fe(),Pt=oe("div"),Pt.textContent="Raw Group Damage:",jt=fe(),Ft=oe("div"),_t=se(xn),Rt=fe(),Ot=oe("div"),Ot.textContent="Group Damage w/ buffs:",It=fe(),Wt=oe("div"),qt=se(An),Kt=fe(),Yt=oe("div"),Yt.textContent="Raw Group HP:",Ut=fe(),zt=oe("div"),Qt=se(Sn),Jt=fe(),Xt=oe("div"),Xt.textContent="Group HP w/ buffs:",Zt=fe(),en=oe("div"),tn=se(Nn),nn=fe(),an=oe("div"),He(rn.$$.fragment),de(n,"class","b-top svelte-2rn368"),de(o,"class","svelte-2rn368"),de(i,"class","svelte-2rn368"),de(u,"class","svelte-2rn368"),de(d,"class","svelte-2rn368"),de(h,"class","svelte-2rn368"),de(v,"class","svelte-2rn368"),de(r,"class","stat-grid svelte-2rn368"),de(y,"class","b-top svelte-2rn368"),de($,"class","svelte-2rn368"),de(V,"class","svelte-2rn368"),de(x,"class","svelte-2rn368"),de(S,"class","svelte-2rn368"),de(B,"class","svelte-2rn368"),de(E,"class","svelte-2rn368"),de(j,"class","svelte-2rn368"),de(_,"class","svelte-2rn368"),de(I,"class","svelte-2rn368"),de(q,"class","svelte-2rn368"),de(U,"class","svelte-2rn368"),de(Q,"class","svelte-2rn368"),de(Z,"class","svelte-2rn368"),de(te,"class","svelte-2rn368"),de(ue,"class","svelte-2rn368"),de(pe,"class","svelte-2rn368"),de(ve,"class","svelte-2rn368"),de(ke,"class","svelte-2rn368"),de(Ce,"class","svelte-2rn368"),de(Le,"class","svelte-2rn368"),de(xe,"class","svelte-2rn368"),de(Ne,"class","svelte-2rn368"),de(Pe,"class","svelte-2rn368"),de(Fe,"class","svelte-2rn368"),de(C,"class","stat-grid svelte-2rn368"),de(t,"class","middle svelte-2rn368"),de(Ie,"class","b-top svelte-2rn368"),de(Ke,"class","svelte-2rn368"),de(Ue,"class","svelte-2rn368"),de(Je,"class","svelte-2rn368"),de(Ze,"class","svelte-2rn368"),de(nt,"class","svelte-2rn368"),de(qe,"class","stat-grid svelte-2rn368"),de(rt,"class","b-top svelte-2rn368"),de(it,"class","svelte-2rn368"),de(ct,"class","svelte-2rn368"),de(dt,"class","svelte-2rn368"),de(pt,"class","svelte-2rn368"),de(vt,"class","svelte-2rn368"),de(kt,"class","svelte-2rn368"),de(Ct,"class","svelte-2rn368"),de(Lt,"class","svelte-2rn368"),de(Mt,"class","svelte-2rn368"),de(At,"class","svelte-2rn368"),de(Ht,"class","svelte-2rn368"),de(Tt,"class","svelte-2rn368"),de(Pt,"class","svelte-2rn368"),de(Ft,"class","svelte-2rn368"),de(Ot,"class","svelte-2rn368"),de(Wt,"class","svelte-2rn368"),de(Yt,"class","svelte-2rn368"),de(zt,"class","svelte-2rn368"),de(Xt,"class","svelte-2rn368"),de(en,"class","svelte-2rn368"),de(st,"class","stat-grid svelte-2rn368"),de(Oe,"class","right svelte-2rn368"),de(an,"class","bottom b-top svelte-2rn368")},m(e,re){ne(e,t,re),le(t,n),le(t,a),le(t,r),le(r,o),le(r,s),le(r,i),le(i,l),le(r,c),le(r,u),le(r,f),le(r,d),le(d,m),le(r,p),le(r,h),le(r,g),le(r,v),le(v,b),le(t,k),le(t,y),le(t,w),le(t,C),le(C,$),le(C,L),le(C,V),le(V,D),le(C,M),le(C,x),le(C,A),le(C,S),le(S,N),le(C,H),le(C,B),le(C,T),le(C,E),le(E,G),le(C,P),le(C,j),le(C,F),le(C,_),le(_,R),le(C,O),le(C,I),le(C,W),le(C,q),le(q,K),le(C,Y),le(C,U),le(C,z),le(C,Q),le(Q,J),le(C,X),le(C,Z),le(C,ee),le(C,te),le(te,ae),le(C,ie),le(C,ue),le(C,me),le(C,pe),le(pe,he),le(C,ge),le(C,ve),le(C,be),le(C,ke),le(ke,ye),le(C,we),le(C,Ce),le(C,$e),le(C,Le),le(Le,Ve),le(C,De),le(C,xe),le(C,Ae),le(C,Ne),le(Ne,Ee),le(C,Ge),le(C,Pe),le(C,je),le(C,Fe),le(Fe,_e),ne(e,Re,re),ne(e,Oe,re),le(Oe,Ie),le(Oe,We),le(Oe,qe),le(qe,Ke),le(qe,Ye),le(qe,Ue),le(Ue,ze),le(qe,Qe),le(qe,Je),le(qe,Xe),le(qe,Ze),le(Ze,et),le(qe,tt),le(qe,nt),le(Oe,at),le(Oe,rt),le(Oe,ot),le(Oe,st),le(st,it),le(st,lt),le(st,ct),le(ct,ut),le(st,ft),le(st,dt),le(st,mt),le(st,pt),le(pt,ht),le(st,gt),le(st,vt),le(st,bt),le(st,kt),le(kt,yt),le(st,wt),le(st,Ct),le(st,$t),le(st,Lt),le(Lt,Vt),le(st,Dt),le(st,Mt),le(st,xt),le(st,At),le(At,St),le(st,Nt),le(st,Ht),le(st,Bt),le(st,Tt),le(Tt,Et),le(st,Gt),le(st,Pt),le(st,jt),le(st,Ft),le(Ft,_t),le(st,Rt),le(st,Ot),le(st,It),le(st,Wt),le(Wt,qt),le(st,Kt),le(st,Yt),le(st,Ut),le(st,zt),le(zt,Qt),le(st,Jt),le(st,Xt),le(st,Zt),le(st,en),le(en,tn),ne(e,nn,re),ne(e,an,re),Be(rn,an,null),on=!0},p(e,t){(!on||8&t)&&sn!==(sn=e[3].noOfRelics+"")&&ce(l,sn),(!on||8&t)&&ln!==(ln=e[3].leadDefenderBonus+"")&&ce(m,ln),(!on||16&t)&&ce(b,e[4]),(!on||32&t)&&cn!==(cn=e[5].attackValue+"")&&ce(D,cn),(!on||64&t)&&un!==(un=e[6].attack+"")&&ce(N,un),(!on||32&t)&&fn!==(fn=e[5].defenseValue+"")&&ce(G,fn),(!on||64&t)&&dn!==(dn=e[6].defense+"")&&ce(R,dn),(!on||32&t)&&mn!==(mn=e[5].armorValue+"")&&ce(K,mn),(!on||64&t)&&pn!==(pn=e[6].armor+"")&&ce(J,pn),(!on||32&t)&&hn!==(hn=e[5].damageValue+"")&&ce(ae,hn),(!on||64&t)&&gn!==(gn=e[6].damage+"")&&ce(he,gn),(!on||32&t)&&vn!==(vn=e[5].hpValue+"")&&ce(ye,vn),(!on||64&t)&&bn!==(bn=e[6].hp+"")&&ce(Ve,bn),(!on||32&t)&&kn!==(kn=e[5].cloaked+"")&&ce(Ee,kn),(!on||128&t)&&ce(_e,e[7]),(!on||64&t)&&yn!==(yn=e[6].dc225+"")&&ce(ze,yn),(!on||64&t)&&wn!==(wn=e[6].dc175+"")&&ce(et,wn),(!on||256&t)&&Cn!==(Cn=e[8].attack+"")&&ce(ut,Cn),(!on||512&t)&&$n!==($n=e[9].attack+"")&&ce(ht,$n),(!on||256&t)&&Ln!==(Ln=e[8].defense+"")&&ce(yt,Ln),(!on||512&t)&&Vn!==(Vn=e[9].defense+"")&&ce(Vt,Vn),(!on||256&t)&&Dn!==(Dn=e[8].armor+"")&&ce(St,Dn),(!on||512&t)&&Mn!==(Mn=e[9].armor+"")&&ce(Et,Mn),(!on||256&t)&&xn!==(xn=e[8].damage+"")&&ce(_t,xn),(!on||512&t)&&An!==(An=e[9].damage+"")&&ce(qt,An),(!on||256&t)&&Sn!==(Sn=e[8].hp+"")&&ce(Qt,Sn),(!on||512&t)&&Nn!==(Nn=e[9].hp+"")&&ce(tn,Nn)},i(e){on||(Me(rn.$$.fragment,e),on=!0)},o(e){Se(rn.$$.fragment,e),on=!1},d(e){e&&(re(t),re(Re),re(Oe),re(nn),re(an)),Te(rn)}}}function $i(e){let t,n,a,r,o,s=e[0].is_owner&&ki(e)
...
let p=!1
return Ye((()=>{n(1,p=!1),Hs.set(0),Ts.set([]),_s.set(0),ei.set([])})),e.$$set=e=>{"relicData"in e&&n(0,d=e.relicData)},[d,p,a,r,o,s,i,l,u,f,m,function(e){c("relic",e.detail)},function(){c("relic","fetchStats"),n(1,p=!0),Hs.set(d.controlled_by.guild_id),Ts.set(m),_s.set(GameData.player().hasGroup),ei.set(GameData.player().buffs)}]}class Vi extends X{constructor(e){super(),Z(this,e,Li,$i,ee,{relicData:0})}}let Di=0
function Mi(e,t){var n,r
t?.response?.data?.defenders?.length>0&&(n=a("dialog-relic"),r=t.response.data,Di&&Di.$destroy(),Di=new Vi({props:{relicData:r},target:n}))}function xi(e,t){"ACT_REPAIR"===t&&GameData.fetch(Qe+f+Je+Xe)}let Ai=!1
...
i(Oi,`${a}<br>`)}async function Wi(){const e=zt(Ri.value)
e&&(c("NewMap","quickBuy"),await Ft(Ut(e,Ii)),GameData.doAction(14,3,{id:Pi.id,item_id:Pi.itemId},0),Fi.close())}function qi(){_i?r("",Oi):function(){_i=n({className:"fshClear",textContent:"Select how many to quick-buy:"}),Ri=wt({id:"buyAmount",className:"fshNumberInput",min:1,max:99,value:1,type:"number"}),o(_i,Ri)
const e=bt({textContent:"Quick-buy"})
l(e,Wi),o(_i,e),Oi=n(),o(_i,Oi),o(ji,_i)}()}function Ki(e,t){Pi=t,ji=ji||a("shopDialogConfirm"),ji&&(Fi=Fi||$(ji).data("hcsWorldDialogShopConfirm"),Fi&&qi())}function Yi(e){let t,n
return{c(){t=oe("div"),n=se(e[0]),de(t,"id","tp-overlay"),de(t,"class","svelte-1lrosbw")},m(e,a){ne(e,t,a),le(t,n)},p(e,t){1&t&&ce(n,e[0])},d(e){e&&re(t)}}}function Ui(e){let t,n=e[1]&&Yi(e)
return{c(){n&&n.c(),t=te()},m(e,a){n&&n.m(e,a),ne(e,t,a)},p(e,[a]){e[1]?n?n.p(e,a):(n=Yi(e),n.c(),n.m(t.parentNode,t)):n&&(n.d(1),n=null)},i:ae,o:ae,d(e){e&&re(t),n&&n.d(e)}}}function zi(e,t,n){let{tpButton:a}=t,r=0,o=0,s=!1
function i(){const e=GameData.player().teleportCooldown
n(0,r=e-ot()+o),r>0||(clearInterval(s),n(1,s=!1),a.classList.remove("cooldown"))}return window.$.subscribe("stats.player",i),window.$.subscribe(rt,(function(e,t){o=ot(),i(),s||0!==t.response.response||n(1,s=setInterval((()=>{i()}),1e3))})),e.$$set=e=>{"tpButton"in e&&n(2,a=e.tpButton)},[r,s,a]}class Qi extends X{constructor(e){super(),Z(this,e,zi,Ui,ee,{tpButton:2})}}function Ji(e){return e.numberOfCreatureHitsTillDead-e.numberOfHitsRequired<=1?", dies on miss":", survives a miss"}function Xi(e,t){return"-"===t?e:"-"===e||e>t?"-":e}const Zi=[[e=>"-"===e.playerHits&&"-"===e.creatureHits,()=>"Unresolved"],[e=>"-"===e.playerHits,()=>"Player dies"],[e=>1===e.playerHits,e=>`Player 1 hits${Ji(e)}`],[e=>e.playerHits>1,e=>`Player > 1 hits${Ji(e)}`]]
...
function ll(e){return Math.floor(e.creature.defense*e.player.darkCurseLevel*Re)}function cl(e){const t=il(e)
...
ec(e,t,{groupExists:!0,groupAttackValue:a[0].value,groupDefenseValue:a[1].value,groupArmorValue:a[2].value,groupDamageValue:a[3].value,groupHPValue:a[4].value})}(e,t,await Ot(n))}}async function ac(e,t){const n=function(e){if(kt(e.r))return e.r.find(tc)?.id}(await qt())
nc(e,t,n)}async function rc(e,t){if(Kl||(Kl=a("dialog-viewcreature")),Kl&&(Jl(""),Xl(""),t?.response?.data)){ql(t.response.data.name,Kl)
const e=await Qt(!0)
e&&function(e,t){e.player.hasGroup&&ac(e,t),ec(e,t,{groupExists:!1})}(t,e)}}let oc=0
...
U(t)&&(e.target.blur(),t(e))}function kc(){const e=a("worldPage")
if(!e)return
...
a.length>0?function(e,t){we(`You are missing some ${mc()} hunting buffs<br>(${t.join(", ")})`,e)}(e,a):Lc(e)}function Dc(e,n,a){dc()&&function(e,n){t.showHuntingBuffs?Vc(e,n):Lc(e)}(e,a)}function Mc(e,t){return 6!==t.type||(0!==t.data.creature_type||t.data.level>=e)}function xc(e){const t=E(e)
...
const n=s(Dc,e)
$.subscribe(d,n),t.showHuntingBuffs&&window.initialGameData&&n(null,{b:window.initialGameData.player.buffs})}(e),oc=b("hidePlayerActions"),$.subscribe(z,ic),ic()},function(){Ze(),et()&&Gi()},function(){$.subscribe(st,rc)},function(){Hr.forEach(Br)},function(){b("enableCreatureColoring")&&o(document.body,Vt("#actionList .creature-1 {color: green;}\n#actionList .creature-2 {color: yellow;}\n#actionList .creature-3 {color: red;}"))},function(){$.subscribe(z,fr),fr(),function(){const e=GameData.doAction
GameData.doAction=pr(e)}()},function(){Ur(),$.subscribe("-1-success.action-response 4-success.action-response 5-success.action-response 25-success.action-response",Zr),Zr()},function(){$.subscribe(ze,xi)},async function(){if(b("keepLogs")){!function(e){e&&($a=e),$.subscribe(N,xa)}(await S("fsh_combatLog"))}},function(){window.initialGameData&&gs(0,window.initialGameData),$.subscribe(`${Le} ${Ve}`,gs)},function(){$.subscribe(at,Ki)},function(){$.subscribe(Ue,Mi)},function(){$("#messageCenter").worldMessageCenter({offset:"0 60"})},function(){k("#mapTooltip")},function(){ca(),$.subscribe(p,ua),$.subscribe(h,fa)},function(){_n(),$.subscribe(`${d} ${m}`,_n)},function(){v(a("actionList"),"mouseover",lr)},function(){const{body:e}=document
...
b("messageStack")&&(e=a("messageCenter"),new Fr({target:e}))},function(){GameController?.Realm?.footprintTexture?Ni():$.subscribe("fixed.realm",Hi)}]
function Pc(){e(Gc)}export{Pc as default}
//# sourceMappingURL=newMap-BgZ227Z5.js.map
