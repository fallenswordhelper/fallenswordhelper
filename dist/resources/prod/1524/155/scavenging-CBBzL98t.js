import{g as n,c as t,b as s,aP as e,i as o,s as a,d as c,av as i,aM as r,l as u,au as f,dJ as l,bw as g,u as d,p as m,a9 as p,b_ as b}from"./calfSystem-UyQ_FKFu.js"
import{c as v}from"./closestTable-DwwUFwTi.js"
...
return t?x(t):""}(n)}return t}function T(n){return function(t,s,e){n(t,s,e),f("lastScavPage",`${l}scavenging&cave_id=${e}&gold=${s}`),c(R(),(S||(S=d(),o(m(),S)),c("",S),S))}}function y(){!function(){if(!sendRequest)return
const n=sendRequest
g(n)&&(sendRequest=T(n))}(),function(){const t=n("multiplier_count")
t&&M(t)}()}export{y as default}
//# sourceMappingURL=scavenging-CBBzL98t.js.map
