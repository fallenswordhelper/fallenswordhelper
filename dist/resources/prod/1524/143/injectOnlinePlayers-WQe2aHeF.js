import{o as n}from"./onlinePlayersPage-myolUmd5.js"
import{cH as e,dn as t,c as a,ao as s,o as l,g as i,s as r,cm as o,aA as c,r as f,ds as u,ay as h,bQ as p,ak as d,aj as v,ck as m,x as g,b6 as y,b as L,K as M,b8 as P,u as b,B as x}from"./calfSystem-ChzN4Q-P.js"
import{l as I}from"./loadDataTables-DAgfHQpB.js"
import{r as k}from"./remainingPages-BzskAxSU.js"
import{a as C,g as O}from"./levelHighlight-DCaL97MF.js"
import{f as w}from"./formatLocalDateTime-S3uf4uPd.js"
import{l as _,p as R}from"./lvlTests-Be0w6ckd.js"
const j=(n,[e])=>n.id===e
...
const e=n(1)
v("lastOnlineCheck",h()),nn("Parsing online players..."),en(await e)}],["fshReset",()=>function(n){r("OnlinePlayers","resetEvt"),v("onlinePlayerMinLvl",m.onlinePlayerMinLvl),v("onlinePlayerMaxLvl",m.onlinePlayerMaxLvl),$("#fshMinLvl",n).val(m.onlinePlayerMinLvl),$("#fshMaxLvl",n).val(m.onlinePlayerMaxLvl),S()}(F)]]
...
var n
X(await y("fsh_onlinePlayers")),l(F[0],(n=tn,t=>e(j,n,t))),L(F[0],"keyup",B)}async function sn(n){g()||(F=n?$(n):$("#pCC"),await I(),an())}export{sn as default}
//# sourceMappingURL=injectOnlinePlayers-WQe2aHeF.js.map
