import{k as t,p as n,cu as e,b as s,q as o,ad as a,w as i,ct as c,ba as r,d as l,N as u,aj as m,cv as p,b5 as d,m as f,aT as g,A as h,c as b,s as v,ap as C,cw as S,i as N,o as k,am as E,cx as x,B as y,ac as $,cy as j,ay as A,cz as w,e as L,cd as q,$ as B,cA as T,ao as I,g as F,bd as P,z as Q}from"./calfSystem-ChzN4Q-P.js"
import{s as _}from"./sum-DdZz7_s4.js"
import{a as z}from"./addCommas-C_h2HN8s.js"
import{c as G}from"./createInput-DC6X1nzh.js"
import{c as H}from"./createTable-Ci23qAYY.js"
import{p as M,s as R}from"./pubsub-BMEeRQG0.js"
import{r as K,g as O}from"./rnd-D_QmA-Fa.js"
import{i as U}from"./insertHtmlAfterBegin-eEM8BtQM.js"
import{i as V}from"./insertHtmlAfterEnd-DEdxHibR.js"
let W=[]
const D=t=>t.map((({buffs:t,duration:n,id:e})=>({cost:Math.max(t.map((({level:t})=>t)).reduce(_,0)*n,5e3),id:e}))),J=[[(t,n)=>!t&&!n,()=>0],[(t,n)=>!t&&n,(t,n,e)=>e.remove()],[(t,n)=>t&&n,(t,n,e)=>a(`Cost: ${z(n)}`,e)],[(t,n)=>t&&!n,(t,n)=>i(t.parentNode,`<div class="fshBlue template-cost">Cost: ${z(n)}</div>`)]]
function X(t){const n=W.find((({id:n})=>n===Number(t.value)))?.cost,e=o(".template-cost",t.parentNode),s=J.find((([t])=>t(n,e)))
...
o?.s&&(W=D(o.r.templates),t.forEach(X),s(n(),"change",Y))}(o)}function tt(t,n){l("",t.children[0]),t.children[0].classList.add("fshPot"),t.children[0].style.backgroundImage=`url(${d}composing/${O(1,11)}_${O(1,51)}.png)`,l(`Creating '<span class="fshBold">${n}</span>' Potion`,t.children[2]),l("",t.children[3])}function nt(t){const n=t.parentNode
...
e&&n&&(n.error?l(`<div class="fshScs">${n.error}</div>`,e):nt(t))}(t,await async function(t){const n=await c({cache:!1,dataType:"text",data:{cmd:"composing",subcmd:"createajax",template_id:t,fshrnd:K()}})
...
return 0===s&&a(t[1],n.insertCell(-1)),N(n.insertCell(-1),(o=(s+1).toString(),i=t[0],G({className:"awesome orange",dataset:{templateId:i},type:"button",value:o}))),n}function rt(t,n,e){return t.forEach(b(ct,e,n.insertRow(-1))),n}function lt(t){return[t.value,t.text]}function ut(e,s,o){const a=function(t,n,e){const s=H({id:"fshFastCompose"})
return ot(s,e),t.reduce(b(rt,n),s)}(t("#composing-template-multi option").map(lt),s,o)
N(e,a),k(n(),it),R("quickcreate",b(at,a))}function mt(t){v("composing","FastCompose"),i(t,"<br>")
...
return n&&e&&s?1e3*(3600*n+60*e+Number(s))+A():0}function dt(t){m(p,t)}function ft(t){return w({subcmd:"collect",potion_id:t})}async function gt(t){const n=await L({cmd:"composing",subcmd:"collect",potion_id:t})
if(!n)return{s:!1}
const e=q(n)
return e.includes("collected")?{s:!0}:{s:!1,e:{message:e}}}function ht(t){const n=t.getAttribute("onclick").split("&")[2].split("=")[1]
U(t.parentNode,`[ <span class="fsh-quick-collect"><button class="fshBl fsh-bli" type="button" value="${n}">Quick Collect</button></span> ]&nbsp;`)}const bt=t=>"BUTTON"===t.tagName&&"Quick Collect"===$(t)
...
const o=await function(t){return B(ft,gt,t)}(e)
!function(t,n){t.classList.remove("fshSpinner"),n.s?vt(t,"fshGreen","Collected"):vt(t,"fshRed","Error")}(n,o)}function St(t){bt(t.target)&&Ct(t.target)}function Nt(t){V(t,'<span class="quickCreate">[<span class="sendLink">Quick Create</span>]</span>')}const kt=t=>"SPAN"===t.tagName&&"quickCreate"===t.className
...
//# sourceMappingURL=composing-Cml4Yp89.js.map
