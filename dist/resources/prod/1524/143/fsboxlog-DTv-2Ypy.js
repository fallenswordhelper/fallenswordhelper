...
import{S as s,O as n,P as e,bF as a,bG as o,bA as l,bD as c,bH as r,as as i,R as u,T as f,U as m,W as b,X as p,_ as d,at as h,a4 as $,a7 as g,s as v,b6 as x,b8 as k,m as y,q as S,aN as F,ac as M,aF as z,dM as C,a3 as L,Q as _,av as j,bp as q,bS as B,a8 as N}from"./calfSystem-ChzN4Q-P.js"
import{M as T}from"./ModalTitled-C-7Cgn78.js"
function w(t,s,n){const e=t.slice()
return e[7]=s[n][0],e[8]=s[n][1],e[9]=s[n][2],e}function H(t){return{c:L,m:L,p:L,d:L}}function A(t){let s,n=_(t[1]),e=[]
for(let s=0;s<n.length;s+=1)e[s]=D(w(t,n,s))
return{c(){for(let t=0;t<e.length;t+=1)e[t].c()
s=j()},m(t,n){for(let s=0;s<e.length;s+=1)e[s]&&e[s].m(t,n)
b(t,s,n)},p(t,a){if(2&a){let o
for(n=_(t[1]),o=0;o<n.length;o+=1){const l=w(t,n,o)
e[o]?e[o].p(l,a):(e[o]=D(l),e[o].c(),e[o].m(s.parentNode,s))}for(;o<e.length;o+=1)e[o].d(1)
e.length=n.length}},d(t){t&&$(s),q(e,t)}}}function D(t){let s,n,e,a,o,l,c,r,i,d,h,v=t[8]+"",x=t[9]+""
return{c(){s=u("br"),n=f(),e=u("span"),a=u("a"),o=g(v),c=g("\n          says:"),r=f(),i=u("q"),d=g(x),h=f(),m(a,"href",l=""+(B+t[7])),m(a,"class","svelte-14ozmrh")},m(t,l){b(t,s,l),b(t,n,l),b(t,e,l),p(e,a),p(a,o),p(e,c),b(t,r,l),b(t,i,l),p(i,d),p(i,h)},p(t,s){2&s&&v!==(v=t[8]+"")&&N(o,v),2&s&&l!==(l=""+(B+t[7]))&&m(a,"href",l),2&s&&x!==(x=t[9]+"")&&N(d,x)},d(t){t&&($(s),$(n),$(e),$(r),$(i))}}}function G(t){return{c:L,m:L,p:L,d:L}}function O(t){let s,n,e,a,o,l,c={ctx:t,current:null,token:null,hasCatch:!1,pending:G,then:A,catch:H}
...
return[Number(F(n?.href,"player_id")),M(n),z(S("q",s))]}const l=([t,s,n])=>t&&C(s)&&C(n)
...
//# sourceMappingURL=fsboxlog-DTv-2Ypy.js.map
