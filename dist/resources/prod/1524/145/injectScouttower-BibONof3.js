import{bj as t,o as e,F as n,w as s,c$ as a,s as c,aG as l,aH as o,ac as i,S as r,O as u,P as f,Q as h,R as d,T as m,U as p,W as g,X as b,a3 as $,a4 as T,bp as v,E as w,ay as k,as as y,a7 as x,_ as N,at as R,bA as S,bD as j,a5 as F,bF as H,bG as C,bH as E,a8 as L,b6 as _,f as B,bU as A,b8 as M,bu as U,x as G,aS as I,p as X,cl as D,d as K,b3 as V,n as q,i as O,q as P}from"./calfSystem-CvwhhJv4.js"
import{d as Q}from"./dataRows-DV8H12Ga.js"
import{g as W}from"./getTitle-C1xil_UC.js"
import{a as Y,g as Z,t as z}from"./getTitanString-DvEb_zLX.js"
import{a as J}from"./roundToString-_HLuWg7Z.js"
import{p as tt}from"./parseDateAsTimestamp-BbFrd8v4.js"
import{c as et}from"./closestTable-DA5PEIxg.js"
import{L as nt}from"./LinkButtonBracketed-CA2auUeo.js"
...
a("[b]",e)&&function(t){t.previousElementSibling&&(c("scout tower","buffIndividual"),l(o(t.previousElementSibling.href)))}(e),a("all",e)&&function(t){const e=t.parentNode.parentNode.parentNode.parentNode,n=Q(e,3,0).map(at).join()
c("scout tower","buffAll"),l(n)}(e)}function lt(t){n("fshBl",t.target)&&ct(t)}function ot(t){s(t.cells[0],' <button class="fshBl fshXSmall">[b]</button>')}function it(t){Q(t,3,0).forEach(ot),s(t.rows[0].cells[0],' <button class="fshBl fshXSmall">all</button>')}function rt(t,e){return t.rows.length>1&&e>1}function ut(n){n.length>2&&function(n){t(n).filter(rt).forEach(it),e(n[1],lt)}(n)}function ft(t){const e=t.hp.split("/")
var n,a,c
s(t.tr.cells[3],(n=Number(i(t.tr.cells[3])),a=Number(e[0]),c=Number(e[1]),`<br><span class="fshBlue"> (${J(Y(c-a,n),2)}% Current <br>${J(100*n/c,2)}% Total<br>${Z(n,c,a)})`))}function ht(t,e,n){const s=t.slice()
...
return{c(){e=x("Select None")},m(t,n){g(t,e,n)},d(t){t&&T(e)}}}function yt(t){return{c:$,m:$,p:$,i:$,o:$,d:$}}function xt(t){let e,n,s,a,c,l,o,i,r,u,f,h,$,v,w,k,H,C,E,L,_,B,A,M,U,G,I,X={ctx:t,current:null,token:null,hasCatch:!1,pending:yt,then:Tt,catch:$t,blocks:[,,,]}
return y(t[4](),X),{c(){e=d("table"),n=d("tbody"),s=d("tr"),s.innerHTML='<td class="header svelte-1s0h251" colspan="3"></td>',a=m(),c=d("tr"),l=d("td"),o=d("label"),i=d("input"),r=x("\n          Current"),u=m(),f=d("label"),h=d("input"),$=x("\n          History"),v=m(),w=d("label"),k=d("input"),H=x("\n          Securable"),C=m(),E=d("tr"),E.innerHTML='<td class="header svelte-1s0h251" colspan="3"></td>',L=m(),_=d("tr"),B=d("td"),X.block.c(),A=m(),M=d("tr"),M.innerHTML='<td class="header svelte-1s0h251" colspan="3"></td>',p(i,"type","checkbox"),p(o,"class","svelte-1s0h251"),p(h,"type","checkbox"),p(f,"class","svelte-1s0h251"),p(k,"type","checkbox"),p(w,"class","svelte-1s0h251"),p(l,"colspan","3"),p(l,"class","svelte-1s0h251"),p(B,"colspan","3"),p(B,"class","svelte-1s0h251"),p(e,"class","svelte-1s0h251")},m(d,m){g(d,e,m),b(e,n),b(n,s),b(n,a),b(n,c),b(c,l),b(l,o),b(o,i),i.checked=t[0],b(o,r),b(l,u),b(l,f),b(f,h),h.checked=t[1],b(f,$),b(l,v),b(l,w),b(w,k),k.checked=t[2],b(w,H),b(n,C),b(n,E),b(n,L),b(n,_),b(_,B),X.block.m(B,X.anchor=null),X.mount=()=>B,X.anchor=null,b(n,A),b(n,M),U=!0,G||(I=[N(i,"change",t[13]),N(i,"change",t[5]),N(h,"change",t[14]),N(h,"change",t[6]),N(k,"change",t[15]),N(k,"change",t[7])],G=!0)},p(e,n){t=e,1&n[0]&&(i.checked=t[0]),2&n[0]&&(h.checked=t[1]),4&n[0]&&(k.checked=t[2]),R(X,t,n)},i(t){U||(S(X.block),U=!0)},o(t){for(let t=0;t<3;t+=1){const e=X.blocks[t]
j(e)}U=!1},d(t){t&&T(e),X.block.d(),X.token=null,X=null,G=!1,F(I)}}}const Nt="fsh_titanFilter"
...
function Lt(t,e){return B(w(t).map((([t,e])=>[z(t),e])).filter((([t])=>!e[t])).filter((([,t])=>t.coolTime>k())).map((([t,e])=>[t,{...e,seen:"no"}])))}async function _t(t,e){const n=function(t,e){const n=B(U(e,"titanName").map(Et))
return{...n,...t&&Lt(t,n)}}(await _("fsh_titans"),e)
t[0].rows.length>5&&function(t,e,n){new Ht({anchor:t.rows[5],props:{theTitans:e,titanRows:n},target:t.children[0]})}(t[0],n,e),M("fsh_titans",n)}function Bt(t){"A"===t.target.tagName&&c("scoutTower","realmLink")}function At(t){!function(t){const n=encodeURIComponent(t.titanName),[s]=t.tr.cells[0].children,a=q({href:`${V}creatures&search_name=${n}`,target:"_blank"})
e(a,(()=>{c("scoutTower","guideLink")})),O(a,s),O(t.tr.cells[0],a)}(t),function(t){s(t.tr.cells[0],t.titanName)}(t)}function Mt(t){!function(t){t.active&&ft(t)}(t),At(t),function(t){const[,n]=t.tr.cells,s=i(n)
K(`<a href="${V}realms&search_name=${s}" target="_blank">${s}</a>`,n),e(n,Bt)}(t)}const Ut=t=>{return{guildKills:Number(i(t.cells[3])),hp:i(t.cells[2]),titanName:z((e=t,W(P("img",e)))),tr:t,visible:!0}
var e},Gt=t=>({...t,active:!t.hp.includes("-"),titanHp:t.hp.split("/").map(Number)}),It=t=>({...t,securable:t.active&&Math.ceil(t.titanHp[1]/2+1)-t.guildKills<=t.titanHp[0]})
function Xt(){if(G())return
const t=I(D,X())
if(!t?.length)return
ut(t)
const e=(t=>Q(t[1],4,0)?.map(Ut).map(Gt).map(It))(t)
e&&(e.forEach(Mt),_t(t,e))}export{Xt as default}
//# sourceMappingURL=injectScouttower-BibONof3.js.map
