import{am as t,s as n,c as s,bk as e,ao as o,aS as f,p as a,ac as u,aU as c,dn as r,cU as i,aJ as l,F as p,d,g as b,E as g}from"./calfSystem-CvwhhJv4.js"
import{a as m}from"./roundToString-_HLuWg7Z.js"
...
const n=M(t.target);(function(t){return t.classList&&p("buffLink",t)})(n)&&E(n)}function P(t,n,s){return t.replace(n,`<span id="fshBuff${s}" class="buffLink fshBlue">${n.replace(/(`~)|(~`)|(\{b\})|(\{\/b\})/g,"")}</span>`)}function U(t){let n=t.replace(/\{b\}/g,"`~").replace(/\{\/b\}/g,"~`")
const s=n.match(/`~([^~]|~(?!`))*~`/g)
if(s)return n=s.reduce(P,n),n.indexOf("[cmd]")<0&&(n+="[cmd]"),n=n.replace("[cmd]",'<br><input id="fshSendBuffMsg" class="custombutton" type="button" value="Ask For Buffs"><br><span id="buffCost" class="fshRed">&nbsp;</span>'),n}export{R as b,U as r}
//# sourceMappingURL=render-y6jMJLyP.js.map
