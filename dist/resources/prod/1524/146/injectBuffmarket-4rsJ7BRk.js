import{a,b as s,$ as t,q as e,o as n,p as f,c,d as u,s as i,e as r,f as o,h as d,r as p}from"./calfSystem-DiXGAkgN.js"
function l(s){return t={subcmd:"buy",id:s},a({cmd:"buffmarket",...t})
var t}function m(a){return s({cmd:"buffmarket",subcmd:"buy",id:a},"Request accepted - buffs have automatically been cast.")}async function b(a,s){i("buffmarket","search"),s.preventDefault(),r('<div class="fshWaiting">Loading...</div>',a)
const t=o(new FormData(s.target)),n=await d(t)
if(!n)return
const f=e("#buff-results",n)
if(!f)return
const c=f.parentElement.innerHTML
r(c,a)}async function g(a,s){const e=a.target.parentNode
e.className="fshActionRow",r('<div class="fshSpin"><span class="fshSpinner"></span></div>',e)
const n=await function(a){return t(l,m,a)}(s)
...
//# sourceMappingURL=injectBuffmarket-4rsJ7BRk.js.map
