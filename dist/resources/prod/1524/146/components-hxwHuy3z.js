import{F as t,bP as n,bO as e,S as c,P as o,Q as s,U as r,bD as l,bE as a,bF as i,bG as u,_ as p,ax as m,b_ as d,bH as f,b3 as $,b8 as g,bs as h,a5 as b,a8 as k,a0 as y,a3 as v,a4 as x,a9 as w,T as C,s as S,ew as T,bJ as D,bK as E,bL as L,au as I,av as M,bp as Q,R as H,bq as N,cX as j,bu as _,ex as P,ci as q,v as A,h as B,cg as V,$ as U,d as W,H as F,aj as G,n as R,C as J,D as K,l as O,ey as X,q as z,o as Y,b2 as Z,g as tt,be as nt}from"./calfSystem-DiXGAkgN.js"
import{L as et}from"./LinkButtonBracketed-BJfzmIPV.js"
import{d as ct}from"./daComponents-BUF4_KxM.js"
import{c as ot}from"./closestTd-BfCcJtlN.js"
...
const s=f()
return[c,o,function(){S("components","enableQuickDel"),e(0,c=!0),s("enableQuickDel")},function(){S("components","countComponents"),e(1,o=!0)},function(){S("components","insertQuickExtract"),P()},function(){S("components","deleteAllVisible"),s("deleteAllVisible")},function(n){j.call(this,t,n)}]}class Nt extends c{constructor(t){super(),o(this,t,Ht,Qt,s,{})}}function jt(t){return q({subcmd:"destroycomponent",removeIndex:t})}async function _t(t){const n=await B({cmd:"profile",subcmd:"destroycomponent",component_id:t})
return n?function(t,n){const e=V(n)
...
return n.length>0?{r:n.map((t=>t.c)),s:!0}:e.length>0?{e:{message:e[0].m},s:!1}:{e:{message:t[0].m},s:!1}}(await A(t.map(_t)))}function qt(t){if(!t)return
...
async function Jt(t){const n=Vt(t),e=await(c=t.map(Ft),U(jt,Pt,c))
var c
...
n.forEach(W(At,!0)),await A(F(30,t).map(Jt)),n.forEach(W(At,!1))}function Ot(t){const{itemId:n,invId:e}=J(K,t.dataset.tipped)
...
//# sourceMappingURL=components-hxwHuy3z.js.map
