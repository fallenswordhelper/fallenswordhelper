import{g as s}from"./getMembrList-C3ieFZkr.js"
import{cE as t,n as a,i as e,bc as n,d as r,bl as i,s as c,by as l,h as o,q as d,bk as u,aH as f,aC as m,$ as p,e as v,v as h,I as b,x as y,y as C,aV as g,p as w,ao as B,be as j,t as k,aE as S,o as T,ad as L}from"./calfSystem-DiXGAkgN.js"
import{i as R}from"./interceptSubmit-CMErm11z.js"
import{l as D}from"./loadDataTables-B_SweZpV.js"
import{p as F}from"./playerLinkFromMembrList-BS_035Wg.js"
import{c as M}from"./createTable-DIZxuZkj.js"
import{c as N}from"./chromeHandlers-BqvWiX7D.js"
...
return e(c,l),e(l,t),n(3,H,[l,i,r(I,s,c,l)]),c}function O(s){return l({subcmd:"advisor",subcmd2:"view",period:s})}const V=s=>m(f(s))
function W(s){return{player:{level:0,name:f(s.cells[0])},stats:[3,4,5,6,7,9,1,2,8].map((t=>V(s.cells[t])))}}async function _(s){return function(s){if(!s)return{s:!1}
const t=d("#pCC table table",s)
return{r:u(t.rows).slice(1,-1).map(W),s:!0}}(await o({cmd:"guild",subcmd:"advisor",subcmd2:"view",period:s}))}async function z(s,t){var a
return function(s,t,a){return y(s.lastElementChild.lastElementChild,` day ${t},`),a.r}(s,t,await(a=t,p(O,_,a)))}function K(s,t,a){return t+s[a]}function Q(s,t,a){return{...t,stats:t.stats.map(r(K,s[a].stats))}}function Y(s,t){return s.map(r(Q,t))}function Z(s){return{player:s.player,stats:[s.stats[6],s.stats[7],s.stats[6]+s.stats[7],s.stats[1],s.stats[2],s.stats[3],s.stats[4],s.stats[8],s.stats[5]]}}function ss(s,t){return t.stats.map(r(K,s))}function ts(s,t){return`${s}<td><u>${t}</u></td>`}function as(s,t){const a=t.stats.map(x)
...
es(t,await h(a))}(t)}function rs(s,t){return 0===t?f(s):L(s)}function is(s,t){const a=u(t.cells,rs)
return a.splice(0,1,F(s,a[0]),q(a[0],s),A(a[0],s)),a}function cs(s,t){const a=function(s,t){return u(s.rows).slice(1,-1).map(r(is,t))}(s,t),n=function(s){const t=s.rows[s.rows.length-1].cloneNode(!0),a=E()
e(a,t)
const n=t.cells[0]
...
//# sourceMappingURL=guildAdvisor-CIhddX52.js.map
