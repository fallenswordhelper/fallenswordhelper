import{m as t,a as e,d as s}from"./dropItem-CsZlrJDb.js"
import{ay as n,cq as a,$ as o,y as i,C as r,G as c,D as u,an as l,K as d,ak as m,N as f,O as p,F as h,J as k,ap as b,Q as v,R as g,ac as w,k as L,cu as S,f as _,s as y,m as $,h as D,z as E,E as N,d7 as x,db as C,H as Q,av as T,bQ as A,ab as H,aT as I,br as O,c as R,dr as F,dd as M,bb as U,bc as j,t as B,a4 as G,aA as J,o as P,p as q}from"./calfSystem-Cs6CSxoU.js"
import{d as z}from"./doStatTotal-CYFlRYmG.js"
import{e as K}from"./errorDialog-B4_TjdGG.js"
import{a as V}from"./arrayFromRadioNodeList-B2UaM4Hg.js"
import{b as W}from"./batch-BtMyX_wP.js"
let Y=0,X=0
...
v(()=>{g(n,d(e).name),a!==(a=d(e).id)&&(s.value=(s.__value=d(e).id)??"")}),f(t,s)}),u(o,4).__click=function(){e.moveItemsToFolder(d(s))},l(o,()=>d(s),t=>k(s,t)),f(t,n),p()}function rt(){return tt().filter(t=>!w("fshHide",L(t)))}b(["click"])
let ct=null
...
var vt=r('<svelte-css-wrapper style="display: contents"><!></svelte-css-wrapper>',1),gt=r('<svelte-css-wrapper style="display: contents"><!></svelte-css-wrapper>&nbsp; <svelte-css-wrapper style="display: contents"><!></svelte-css-wrapper>&nbsp; <!>',1)
...
x(l,()=>({"--button-width":"11.8em"})),C(l.lastChild,{onclick:function(){y("storeitems","toggleShowExtraLinks"),a(!a()),T("showExtraLinks",a()),e.doExtraLinks(a())},children:(t,e)=>{var n=A()
...
var m=u(d,2),h=t=>{var e=vt(),s=N(e)
x(s,()=>({"--button-width":"10.8em"})),C(s.lastChild,{onclick:r,children:(t,e)=>{var s=A("Select All Guild Locked")
f(t,s)}}),f(t,e)}
Q(m,t=>{"storeitems"===n.subcmd2&&t(h)}),f(t,c),p()}let Lt=null
function St(t,e){if(13699!==e.item_id)return e.item_name
const s=t.find(t=>t.value===String(e.inv_id))
return s?I(s.parentNode.parentNode.children[2]):e.item_name}function _t(t){return Lt||(Lt=async function(t){const e=await ut()
return e?.items?_(H(e.items).map(([e,s])=>[e,{...s,item_name:St(t,s)}])):{}}(t)),Lt}function yt(t,e){return t[e]=(t[e]||0)+1,t}const $t=(t,e,s)=>` [<button class="fshStoreItemsButton ${t}"${e}>${s}</button>]`,Dt=(t,e,s)=>$t(`${t} actionButton tooltip-multiline fshNoWrap`,(t=>` data-tooltip="INSTANTLY ${t} THE ITEM. NO REFUNDS OR DO-OVERS! Use at own risk."`)(e),`Quick ${s}`),Et=(t,e,s)=>`[<a href="${t}"${e}>${s}</a>]`
function Nt(t,e){return e[0]()?t+e[1]():t}function xt(t,e,s){return[[()=>t[0],()=>`${function(t){return t.bound?'<span class="aHSpacer"></span>':Et(`${M}${encodeURIComponent(t.item_name)}`,"","AH")}(s)} ${(t=>Et(`${U}items${j}view&item_id=${t.item_id}`,' target="_blank"',"UFSG"))(s)}`],[()=>!0,()=>`&nbsp;${s.item_name}`],[()=>((t,e,s)=>t[2]&&e[s.item_id]>1)(t,e,s),()=>$t("fshBlack","","Check All")],[()=>((t,e)=>t[3]&&(!e.bound||-1!==e.guild_tag))(t,s),()=>Dt("fshBlue","SENDS","Send")],[()=>((t,e)=>t[4]&&-1===e.guild_tag)(t,s),()=>Dt("fshRed","DROP","Drop")]]}function Ct(t,e,[s,n]){const a=s
...
O(3,W,[[3,e,0,R(Ct,t,s)]])}async function Tt(){const t=rt()
if(!t.length)return
const e=await ut()
e.items&&t.map(t=>[t,e.items[t.value]]).filter(([,t])=>t).forEach(([t,e])=>{t.checked=!t.disabled&&-1!==e.guild_tag})}function At(t){return function(e){t[0]=e,Qt(t)}}function Ht(t){return function(e){t[4]=e,Qt(t)}}function It(){if(G())return
if(!Z())return
const t=bt.map(t=>J(t))
z(),function(t){const[e]=document.forms
B(wt,{props:{doDropLinks:Ht(t),doExtraLinks:At(t),doSelectLocked:Tt,showExtraLinks:t[0],showQuickDropLinks:t[4]},target:e.parentNode.children[5].children[0]})}(t),t.some(t=>t)&&Qt(t),P(q(),kt)}export{it as M,ut as a,rt as b,mt as c,nt as d,Z as e,tt as g,It as i}
//# sourceMappingURL=injectStoreItems-zTGuyh4P.js.map
