import{aS as t,o as e,D as n,v as s,cq as a,s as o,a3 as l,S as c,J as r,K as i,L as u,M as f,N as h,P as m,Q as d,W as p,X as g,aY as b,C as $,_ as T,U as k,b4 as v,b7 as w,Y as y,b9 as N,ba as j,bb as x,a0 as S,f as R,bk as C,w as L,au as H,p as B,bG as E,d as F,aG as _,n as M,i as I,q as A}from"./calfSystem-rn9Rc_nF.js"
import{d as q}from"./dataRows-whWgu9nK.js"
import{g as G}from"./getTitle-KOgbTbIb.js"
import{a as K,g as U,t as X}from"./getTitanString-Fx1fxwUU.js"
import{g as Y}from"./getPlayerId-kFPa1sEG.js"
import{o as D}from"./openQuickBuffById-shBuZQr_.js"
import{a as O}from"./roundToString-8wwt6Rp-.js"
import{u as P}from"./uniq-rEURYuE3.js"
import{n as Q}from"./now-pQzGw6vd.js"
import{g as J,s as V}from"./idb-1b6_RJN1.js"
import{p as W}from"./parseDateAsTimestamp-MCADjuC9.js"
import{e as z}from"./each-FVHw1i8T.js"
import{h as Z,u as tt}from"./await_block-WHQS3VDb.js"
import{c as et}from"./closestTable-CpAyN3ci.js"
import{L as nt}from"./LinkButtonBracketed-vDzVLYI2.js"
...
const at=t=>Y(t.cells[0].children[0].href)
function ot(t){const{target:e}=t
a("[b]",e)&&function(t){t.previousElementSibling&&(o("scout tower","buffIndividual"),D(Y(t.previousElementSibling.href)))}(e),a("all",e)&&function(t){const e=t.parentNode.parentNode.parentNode.parentNode,n=q(e,3,0).map(at).join()
o("scout tower","buffAll"),D(n)}(e)}function lt(t){n("fshBl",t.target)&&ot(t)}function ct(t){s(t.cells[0],' <button class="fshBl fshXSmall">[b]</button>')}function rt(t){q(t,3,0).forEach(ct),s(t.rows[0].cells[0],' <button class="fshBl fshXSmall">all</button>')}function it(t,e){return t.rows.length>1&&e>1}function ut(n){n.length>2&&function(n){t(n).filter(it).forEach(rt),e(n[1],lt)}(n)}function ft(t){const e=t.hp.split("/")
var n,a,o
s(t.tr.cells[3],(n=Number(l(t.tr.cells[3])),a=Number(e[0]),o=Number(e[1]),`<br><span class="fshBlue"> (${O(K(o-a,n),2)}% Current <br>${O(100*n/o,2)}% Total<br>${U(n,o,a)})`))}function ht(t,e,n){const s=t.slice()
...
return{c(){e=T("Select None")},m(t,n){m(t,e,n)},d(t){t&&g(e)}}}function yt(t){return{c:p,m:p,p:p,i:p,o:p,d:p}}function Nt(t){let e,n,s,a,o,l,c,r,i,p,b,$,N,j,x,S,R,C,L,H,B,E,F,_,M,I,A,q={ctx:t,current:null,token:null,hasCatch:!1,pending:yt,then:Tt,catch:$t,blocks:[,,,]}
return Z(t[4](),q),{c(){e=u("table"),n=u("tbody"),s=u("tr"),s.innerHTML='<td class="header svelte-1s0h251" colspan="3"></td>',a=f(),o=u("tr"),l=u("td"),c=u("label"),r=u("input"),i=T("\n          Current"),p=f(),b=u("label"),$=u("input"),N=T("\n          History"),j=f(),x=u("label"),S=u("input"),R=T("\n          Securable"),C=f(),L=u("tr"),L.innerHTML='<td class="header svelte-1s0h251" colspan="3"></td>',H=f(),B=u("tr"),E=u("td"),q.block.c(),F=f(),_=u("tr"),_.innerHTML='<td class="header svelte-1s0h251" colspan="3"></td>',h(r,"type","checkbox"),h(c,"class","svelte-1s0h251"),h($,"type","checkbox"),h(b,"class","svelte-1s0h251"),h(S,"type","checkbox"),h(x,"class","svelte-1s0h251"),h(l,"colspan","3"),h(l,"class","svelte-1s0h251"),h(E,"colspan","3"),h(E,"class","svelte-1s0h251"),h(e,"class","svelte-1s0h251")},m(u,f){m(u,e,f),d(e,n),d(n,s),d(n,a),d(n,o),d(o,l),d(l,c),d(c,r),r.checked=t[0],d(c,i),d(l,p),d(l,b),d(b,$),$.checked=t[1],d(b,N),d(l,j),d(l,x),d(x,S),S.checked=t[2],d(x,R),d(n,C),d(n,L),d(n,H),d(n,B),d(B,E),q.block.m(E,q.anchor=null),q.mount=()=>E,q.anchor=null,d(n,F),d(n,_),M=!0,I||(A=[k(r,"change",t[13]),k(r,"change",t[5]),k($,"change",t[14]),k($,"change",t[6]),k(S,"change",t[15]),k(S,"change",t[7])],I=!0)},p(e,n){t=e,1&n[0]&&(r.checked=t[0]),2&n[0]&&($.checked=t[1]),4&n[0]&&(S.checked=t[2]),tt(q,t,n)},i(t){M||(v(q.block),M=!0)},o(t){for(let t=0;t<3;t+=1){const e=q.blocks[t]
w(e)}M=!1},d(t){t&&g(e),q.block.d(),q.token=null,q=null,I=!1,y(A)}}}const jt="fsh_titanFilter"
...
function Et(t,e){return R($(t).map((([t,e])=>[X(t),e])).filter((([t])=>!e[t])).filter((([,t])=>t.coolTime>Q())).map((([t,e])=>[t,{...e,seen:"no"}])))}async function Ft(t,e){const n=function(t,e){const n=R(P(e,"titanName").map(Bt))
...
F(`<a href="${_}realms&search_name=${s}" target="_blank">${s}</a>`,n),e(n,_t)}(t)}const At=t=>{return{guildKills:Number(l(t.cells[3])),hp:l(t.cells[2]),titanName:X((e=t,G(A("img",e)))),tr:t,visible:!0}
var e},qt=t=>({...t,active:!t.hp.includes("-"),titanHp:t.hp.split("/").map(Number)}),Gt=t=>({...t,securable:t.active&&Math.ceil(t.titanHp[1]/2+1)-t.guildKills<=t.titanHp[0]})
function Kt(){if(L())return
const t=H(E,B())
if(!t?.length)return
ut(t)
const e=(t=>q(t[1],4,0)?.map(At).map(qt).map(Gt))(t)
e&&(e.forEach(It),Ft(t,e))}export{Kt as default}
//# sourceMappingURL=injectScouttower-f0z2CeiY.js.map
