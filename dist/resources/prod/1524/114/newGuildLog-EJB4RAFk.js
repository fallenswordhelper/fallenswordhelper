import{cE as t,E as e,g as s,c as i,cF as n,w as o,d as a,p as d,o as c,x as r,ad as l,s as h,a4 as f,F as u,q as p,aM as m,v as g,b$ as b,a3 as y,al as k}from"./calfSystem-rn9Rc_nF.js"
import{a as w}from"./all-TTLWag-d.js"
import{c as j}from"./createTable-y_VvNoOw.js"
import{e as L,s as R}from"./selfIdIs-UTusKVQ8.js"
import{f as N}from"./functionPasses-EKTPXVtw.js"
import{h as v}from"./hideElement-RABq1RME.js"
import{r as G}from"./remainingPages-B8w0PByy.js"
import{t as T}from"./toggleForce-4Mg38a6N.js"
import{a as x,g as I}from"./guildGroupCombat-PALZIBZU.js"
import{a as H}from"./addLogColoring-NIPJx-0B.js"
import{g as P,s as E}from"./idb-1b6_RJN1.js"
import{p as S}from"./parseDateAsTimestamp-MCADjuC9.js"
...
V=Number(e),1===Q&&(J=Math.min(V,z)),f(`Loading ${Q} of ${J}...`,X)}(e)}function et(t,e){return[()=>1===Q,()=>t===_?.log?.[0]?.[0],()=>e===_?.log?.[0]?.[2]].every(N)}function st(){const t=m("width_full",K)
1===t.length&&function(t){const e=t[0],s=e.rows.length-1
for(let t=1;t<s;t+=2){const s=e.rows[t],i=k(s.cells[1]),n=S(i),o=s.cells[2].innerHTML
if(et(n,o)){W=!1
break}Y.push([100*Q+t,n,i,o,U(o)])}}(t)}function it(t){tt(t),st()}function nt(t){Y.push([0].concat(t))}function ot(){E("fsh_guildLog",_)}const at=(t,e)=>e[1]!==t,dt=t=>t.slice(1,5)
...
function ut(){W&&Y.sort(ft),f("Loading complete.",X),_.log=Y.filter(i(at,(new Date).setSeconds(0,0))).map(dt),ot(),d()&&function(){Z=j({id:"fshInjectHere",className:"width_full"}),g(Z,C),Y.forEach(rt)
const t=s("fshInjectHere")
d().replaceChild(Z,t),H("myGuildLog",1,3),x(),I()}()}async function pt(t){it(t),await function(){let t=[]
return W?t=G(J,O).map((async t=>it(await t))):_.log.forEach(nt),w(t)}(),ut()}function mt(t,e,s){s[4]===t&&(T(s[5],e),T(s[6],e))}function gt(t){h("newGuildLog","toggleItem")
const e=Number(t.getAttribute("item"))
_.checks[e]=!_.checks[e],ot(),Y.forEach(i(mt,e,!_.checks[e]))}function bt(t){t?.classList?.remove("fshHide")}function yt(t){bt(t[5]),bt(t[6])}function kt(t,e,s){h("newGuildLog",t),_.checks=e.slice(0),ht(),Y.forEach(s)}function wt(){kt("selectAll",F,yt)}function jt(t){v(t[5]),v(t[6])}function Lt(){kt("selectNone",M,jt)}async function Rt(){h("newGuildLog","refresh"),_.log=!1,ot(),f("Loading Page 1 ...",X),Y=[],W=!0,a("",s("fshInjectHere"))
pt(await O(1))}function Nt(t){!function(t){_=t||_,_.checks=_.checks||F.slice(0)}(t),a(A,d()),q=s("fshNewGuildLog"),X=s("fshOutput"),c(q,L([[t=>"INPUT"===t.tagName,gt],[R("fshAll"),wt],[R("fshNone"),Lt],[R("rfsh"),Rt]])),ht(),z=Number(l("newGuildLogHistoryPages")),J=z,async function(){pt(await O(1))}()}async function vt(){if(o())return
const t=P("fsh_guildLog")
!function(){const t=s("notification-guild-log")
v(t)}(),Nt(await t)}export{vt as default}
//# sourceMappingURL=newGuildLog-EJB4RAFk.js.map
