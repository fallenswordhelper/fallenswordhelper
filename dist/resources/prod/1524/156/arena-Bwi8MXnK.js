import{cr as n,h as t,aa as a,c as e,bI as s,j as r,s as o,cs as i,aN as c,r as l,ct as f,cu as u,ad as d,a3 as p,a0 as m,bH as h}from"./calfSystem-79LsojAC.js"
import{a as v}from"./arena-CNwpmiE0.js"
import{i as b}from"./interceptSubmit-c1dihHnz.js"
import{l as g}from"./loadDataTables-VTwwaj33.js"
import{f as y,a as x,m as L,t as M}from"./assets-DPlwo2nm.js"
import{l as T,p as _}from"./lvlTests-CmrBffHL.js"
import{c as j}from"./changeMinMax-BVdV3Et0.js"
...
const N=()=>q
function C(){s(y,q)}function D(n,t){q=q||{},q.minLvl=n,q.maxLvl=t,C()}function S(){$('#arenaTypeTabs table[width="635"]').DataTable().draw()}function H(){o("arena","changeLvls"),j(D,S)}function I(){o("arena","resetLvls"),D(i.arenaMinLvl,i.arenaMaxLvl),$("#fshMinLvl").val(q.minLvl),$("#fshMaxLvl").val(q.maxLvl),S()}function J(n){o("arena","hideMoves"),q=q||{},q.hideMoves=n.target.checked,C(),$(".moveMax").toggle(!n.target.checked)}function R(n,t){return!N()||function(n){const t=N().minLvl,a=N().maxLvl,e=c(n[7])
return T(_,e,t,a)}(t)}function z(n,t,a,e){return!0}function A(n,t,a,e){$(`#${n}`,t).val(N()?.[a]??i[e])}function B(){const n=function(){const n=$("#pCC > table > tbody > tr:nth-child(4)")
return n.clone().insertBefore(n).find("td").attr("height","2"),n.clone().insertAfter(n).find("td").attr("height","1"),n}(),t=$(x)
!function(n){const t=$("#fshHideMoves",n)
null!=N()?.hideMoves&&(t.prop("checked",N().hideMoves),$(".moveMax").toggle(!N().hideMoves)),t.on("click",J)}(t),function(n){A("fshMinLvl",n,"minLvl","arenaMinLvl")}(t),function(n){A("fshMaxLvl",n,"maxLvl","arenaMaxLvl")}(t),function(n){$("#fshMinLvl, #fshMaxLvl",n).on("keyup",H),$("#fshReset",n).on("click",I)}(t),$("td",n).append(t)}function G(n,t){E?.[t]||(n.css("background-color","#F5F298"),n.find("tr").css("background-color","#F5F298"))}function O(n,t){const a=l(/(?<move>\d)\.png/,$("img",t).attr("src"))
...
e&&n(N()?.id)&&(N().id[e]=e,G(t,e))}(e,s),function(n){const t=n.eq(1),a=t.text().split(/\s\/\s/)
...
$("a",a).contents().unwrap(),$(t).prepend($("<thead/>").append(a))}function rn(){B(),C(),$.fn.dataTable.ext.search.push(R),$.fn.dataTable.ext.search.push(z)}function on(r,[o,i,c]){const l=$('table[width="635"]',r)
...
//# sourceMappingURL=arena-Bwi8MXnK.js.map
