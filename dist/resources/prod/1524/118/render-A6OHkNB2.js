import{ag as t,s as n,c as s,a$ as e,ai as o,az as f,p as a,a8 as u,aC as c,c7 as r,ar as i,D as l,d as p,g as d,C as b}from"./calfSystem-hszmVKJw.js"
...
r=r.replace(/{playername}/g,n),r=function(t,n){return w.find(s(B,t))[1](t,m(n.buffs).join(", "),n)}(r,t),window.openQuickMsgDialog(n,r,"")}const C=/[^a-zA-Z0-9.,+\- ]/g
let S=0
const j=["(?<k>[+-]?[.\\d]{1,10} {0,10}k)","(?<fsp>[+-]?[.\\d]{1,10} {0,10}fsp)","(?<stam>[+-]?[.\\d]{1,10} {0,10}stam)"]
function x(t){return t&&"BR"!==t.nodeName}function y(t){return r((S||(S=new RegExp(j.join("|"))),S),i(t.replace(C,"")))}function v(t){let n=function(t){let n="",s=t
for(;x(s);){const t=u(s)
...
function N(t){return`<tr><td>${t[0]}</td><td>: ${t[1][0]}${t[1][1]}</td></tr>`}function A(t,n){return t[n[1][1]]+=n[1][0],t}function D(){const t=b(L.buffs),n=(e=t.reduce(A,{k:0,fsp:0,stam:0,unknown:0}),h.map(s($,e)).join(""))
var e
...
let s="unknown",e="1"
n&&(s=function(t){return t[0].includes("k")?"k":t[0].includes("f")?"fsp":"stam"}(n),[e]=r(/[+-]?[.\d]+/,n[0])),L.buffs[u(t)]=[parseFloat(e),s],L.count+=1}(t):(L.count-=1,delete L.buffs[s]),L.count>0?D():(p("&nbsp;",d("buffCost")),L.buffCostTotalText="")}function M(t){return t.tagName&&"SPAN"!==t.tagName?M(t.parentNode):t}function R(t){if("fshSendBuffMsg"===t.target.id)return void function(t){t.count>0&&T(t)}(L)
const n=M(t.target);(function(t){return t.classList&&l("buffLink",t)})(n)&&F(n)}function z(t,n,s){return t.replace(n,`<span id="fshBuff${s}" class="buffLink fshBlue">${n.replace(/(`~)|(~`)|(\{b\})|(\{\/b\})/g,"")}</span>`)}function E(t){let n=t.replace(/\{b\}/g,"`~").replace(/\{\/b\}/g,"~`")
const s=n.match(/`~([^~]|~(?!`))*~`/g)
if(s)return n=s.reduce(z,n),n.indexOf("[cmd]")<0&&(n+="[cmd]"),n=n.replace("[cmd]",'<br><input id="fshSendBuffMsg" class="custombutton" type="button" value="Ask For Buffs"><br><span id="buffCost" class="fshRed">&nbsp;</span>'),n}export{R as b,E as r}
//# sourceMappingURL=render-A6OHkNB2.js.map
