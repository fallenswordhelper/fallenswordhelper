import{k as n,a8 as t,g as e,d as a,ao as s,ap as i,r as o,ae as r,c as l,b as c,s as m,i as u,a9 as f,aa as p}from"./calfSystem-hszmVKJw.js"
import{c as d}from"./createSpan-CnsAZiOU.js"
import{i as b}from"./insertTextBeforeEnd-DcqXfvBD.js"
import{n as x}from"./numberIsNaN-CGkd1jiA.js"
import{i as g}from"./intValue-C7nTQec1.js"
import{p as S}from"./parseGoldUpgrades-kAE-9IOc.js"
import"./genericNotification-C6YkjcJY.js"
let E=0,h=0
const N={}
...
c(t.nextElementSibling.nextElementSibling.nextElementSibling.children[0].rows[0].cells[0].children[0],"keyup",l(C,n,t))}function v(){h=g(t(e("statbar-fsp"))),$("Current"),$("Maximum"),a(`<a href="${s}${i}marketplace">Sell at Marketplace</a>`,M("Gold").nextElementSibling.nextElementSibling.nextElementSibling)}function T(n,t){const e=M(n).nextElementSibling.nextElementSibling
if(e){const n=Number(o(/(?<value>\d{1,3}) \/ 115/,e.innerHTML))
r(t,n+5)}}function w(){"1"===p("type")?S():(E=n("#pCC > table:last-of-type > tbody > tr:nth-child(even) > td:first-child"),T("+1 Max Allies","alliestotal"),T("+1 Max Enemies","enemiestotal"),v())}export{w as default}
//# sourceMappingURL=points-l5NB6ozb.js.map
