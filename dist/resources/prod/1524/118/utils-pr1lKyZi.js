import{g as a}from"./guildMembers-lKyL-vXF.js"
import{a as t}from"./all-YfMtr2SN.js"
import{aO as s,dA as e,f as r,C as m,aQ as n,bP as o,bs as i}from"./calfSystem-hszmVKJw.js"
...
n($,s)}async function A(a){const t=await j(),s={lastUpdate:t.lastUpdate,members:r(m(t.members).map((([t,s])=>[t,s.filter((t=>t[4]>a))])))}
n($,s)}async function x(){const[s,e]=await t([j(),a(o())]),r=e.map((({username:a})=>a))
return p(s.members).filter((a=>t=>!a.find((a=>a===t)))(r)).sort(i)}export{U as a,l as b,u as c,L as d,h as e,$ as f,j as g,v as h,d as l,b as m,A as p,x as r,g as u,y as v}
//# sourceMappingURL=utils-pr1lKyZi.js.map
