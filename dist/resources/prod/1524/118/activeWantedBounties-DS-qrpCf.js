import{G as e,ag as n,i as t,dv as s,m as r,a7 as i,d as a,dw as o,v as c,a8 as u,q as l,a2 as f,ai as d,ae as b,g as p,aq as h,H as m,r as L,w as g,o as w,s as y}from"./calfSystem-hszmVKJw.js"
import{f as v}from"./functionPasses-BXOT6NCP.js"
import{c as $}from"./createSpan-CnsAZiOU.js"
import{b as N}from"./now-Cx4PsKjI.js"
import{s as R}from"./shouldBeArray-CXmpMNUb.js"
...
var t
return{target:u(n),link:n.href,lvl:u(n.nextSibling).replace(/[[|\]]/g,""),reward:u(e[2]),rewardType:H(e),xpLoss:u(e[3]),posted:u(e[4])}}let C=0,M={},U={},q=!1,G=!1,E=[]
const O=()=>M,X=()=>U,K=()=>q,z=()=>E
...
if(e=n.enableActiveBountyList,t=n.enableWantedList,M=f("bountyList"),U=f("wantedList"),C=d("bountyListRefreshTime"),G=d("bwNeedsRefresh"),G||I(e,t)&&(G=!0),be.some(v)){U={},U.bounty=[],U.isRefreshed=!0,U.lastUpdate=N(),q=!1,E=R("wantedNames"),b("bwNeedsRefresh",!1)
...
//# sourceMappingURL=activeWantedBounties-DS-qrpCf.js.map
