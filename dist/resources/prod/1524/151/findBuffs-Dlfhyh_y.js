import{bz as t,bZ as e,cu as n,az as s,c0 as a,aB as r,g as o,e as i,ah as c,n as l,b6 as f,d3 as u,q as d,a5 as p,cH as b,r as h,c as m,aO as y,dl as g,p as v,o as x,s as w,bw as k,bx as L,aw as C,a4 as P,e8 as B,k as S,dm as I,dS as T,e9 as E,aW as A,b8 as N,bD as j,bm as D}from"./calfSystem-C1X5YxJZ.js"
import{o as R}from"./onlinePlayersPage-D-D9Z4A-.js"
import{b as F}from"./buffObj-BIwiFUIW.js"
import{h as M}from"./simpleCheckbox-nwywzlgZ.js"
import{o as H}from"./onlineDot-D8QnVOid.js"
...
let z=null
function W(){z=o("bufferProgress")}function Q(t,e){i(t,z),e&&(z.style.color=e)}let U=0
...
function ut(t,e){i(t,o(e))}async function dt(t){!function(t,e){st(e,{href:t,findBuffNicks:at})}(t,await D(t))}function pt(){ut(ot.length,"potentialBuffers"),ot.length<=0?Q("Done.","blue"):(Q("Parsing player data ...","green"),ot.forEach(dt))}function bt(t,e){N()!==L(e)&&ot.push(t)}function ht(t,e){if(n=function(t){return parseInt($(t).find("td:eq(2)").text().replace(/,/g,""),10)}(e),n>=rt&&n>=Y()){bt($(e).find("td:eq(1) a").attr("href"),$(e).find("td:eq(1) a").text())}var n}async function mt(t,e,n){const s=function(t,e){return 1===t?Math.round(it*e/50):t+1}(t,e)
...
n<s?mt(n,s,yt):pt()}async function gt(){if(it=parseInt(o("onlinePlayers").value,10),0!==it){yt(await R(1))}else pt()}function $t(t){const{tipped:e}=t.dataset,{mins:n}=I(e);(function(t,e,n){return t<5&&e>=rt&&e>=n})(n,Number(h(T,e)),Y())&&bt(t.href,l(t))}function vt(t){lt.push(j+t)}async function xt(t){!function(t){const e=c(t)
S('#profileLeftColumn a[data-tipped*="Last Activity"]',e).forEach($t),ft+=1,ft===lt.length&&gt()}(await D(t))}function wt(t){const e=c(t)
...
s.sortBy="name",s.sortAsc=!0,F.sort(q),Tt(),i(J(_,ct),e),W(),Et(St),At()}function jt(t){const e=t||v()
Tt(),i(J(V,ct),e),W(),Et(It),At()}export{Nt as injectFindBuffs,jt as injectFindOther}
//# sourceMappingURL=findBuffs-Dlfhyh_y.js.map
