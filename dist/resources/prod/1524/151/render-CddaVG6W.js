import{az as t,s as n,c as s,bx as e,aB as f,b6 as o,p as a,n as u,b8 as c,dM as r,d3 as i,aX as l,ac as b,e as p,g as d,ab as g}from"./calfSystem-C1X5YxJZ.js"
import{a as m}from"./roundToString-BGDlzdGc.js"
...
function N(t){return`<tr><td>${t[0]}</td><td>: ${t[1][0]}${t[1][1]}</td></tr>`}function M(t,n){return t[n[1][1]]+=n[1][0],t}function A(){const t=g(L.buffs),n=(e=t.reduce(M,{k:0,fsp:0,stam:0,unknown:0}),k.map(s($,e)).join(""))
var e
...
let s="unknown",e="1"
n&&(s=function(t){return t[0].includes("k")?"k":t[0].includes("f")?"fsp":"stam"}(n),[e]=i(/[+-]?[.\d]+/,n[0])),L.buffs[u(t)]=[parseFloat(e),s],L.count+=1}(t):(L.count-=1,delete L.buffs[s]),L.count>0?A():(p("&nbsp;",d("buffCost")),L.buffCostTotalText="")}function R(t){return t.tagName&&"SPAN"!==t.tagName?R(t.parentNode):t}function z(t){if("fshSendBuffMsg"===t.target.id)return void function(t){t.count>0&&T(t)}(L)
const n=R(t.target);(function(t){return t.classList&&b("buffLink",t)})(n)&&F(n)}function E(t,n,s){return t.replace(n,`<span id="fshBuff${s}" class="buffLink fshBlue">${n.replace(/(`~)|(~`)|(\{b\})|(\{\/b\})/g,"")}</span>`)}function O(t){let n=t.replace(/\{b\}/g,"`~").replace(/\{\/b\}/g,"~`")
const s=n.match(/`~([^~]|~(?!`))*~`/g)
if(s)return n=s.reduce(E,n),n.indexOf("[cmd]")<0&&(n+="[cmd]"),n=n.replace("[cmd]",'<br><input id="fshSendBuffMsg" class="custombutton" type="button" value="Ask For Buffs"><br><span id="buffCost" class="fshRed">&nbsp;</span>'),n}export{z as b,O as r}
//# sourceMappingURL=render-CddaVG6W.js.map
