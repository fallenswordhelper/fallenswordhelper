import{g as t}from"./getProfile-KZlYslNT.js"
import{e as n}from"./executeAll-DIAWIge1.js"
import{q as s,e,b5 as a,aR as c,b6 as f,b7 as i,n as u,s as r,k as o,c as l,aW as b,g as d,aL as h,as as p,b8 as m,aB as k,b as q,ak as S,aw as y,a4 as $,o as g}from"./calfSystem-C1X5YxJZ.js"
import{i as T}from"./insertHtmlAfterEnd-Dw44WurJ.js"
import{s as v}from"./setTipped-_gKWzwad.js"
import{d as x,q as B}from"./quickbuffSuccess-B3rgWfF-.js"
...
return n?`<span class="quickbuffActivate" data-buffid="${n.value}">Activate</span>`:'<span class="fshRed;">Off</span>'}(n)}function J(t,n,s){e(Q(t,n),s)}function K(t,n){return t[n.name]=n.duration,t}const W=t=>n=>n.name===t
function z(t,n,s){const a=function(t,n){const s=t.find(W(n))
return s?.value??0}(t,n)
let c="fshLime"
a<100&&(c="fshRed"),e(`<span class="${c}">${a}%</span>`,s)}function U(t){!function(t){if(!t?._enhancements)return
...
J(n,"Guild Buffer",d("fshGB")),J(n,"Buff Master",d("fshBM")),J(n,"Extend",d("fshExt")),J(n,"Reinforce",d("fshRI"))}(t)}function V(t){const n=d(`skill-${t}`)
n&&(n.checked=!0)}function X(){const t=p("blist")
t&&function(t){t.split(";").forEach(V)}(t)}let Y=0
...
if(!s)return
const e=t(m())
T(s.children[0],'<div id="helperQBheader"><table class="quickbuffTable"><thead><tr><th class="quickbuffTableHeader">Sustain</th><th class="quickbuffTableHeader">Fury Caster</th><th class="quickbuffTableHeader">Guild Buffer</th><th class="quickbuffTableHeader">Buff Master</th><th class="quickbuffTableHeader">Extend</th><th class="quickbuffTableHeader">Reinforce</th></tr></thead><tbody><tr><td id="fshSus" class="quickbuffTableDetail">&nbsp;</td><td id="fshFur" class="quickbuffTableDetail">&nbsp;</td><td id="fshGB"  class="quickbuffTableDetail">&nbsp;</td><td id="fshBM"  class="quickbuffTableDetail">&nbsp;</td><td id="fshExt" class="quickbuffTableDetail">&nbsp;</td><td id="fshRI"  class="quickbuffTableDetail">&nbsp;</td></tr></tbody></table></div>'),n([G,X,tt,ut,P,it,rt]),U(await e)}export{ot as default}
//# sourceMappingURL=quickBuff-TLDwdVeZ.js.map
