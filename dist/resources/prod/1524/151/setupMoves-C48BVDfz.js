import{$ as t,ag as n,a4 as o,s as e,cw as a,c as i,r as p,a1 as s,a5 as c,cy as u,S as r,cz as l}from"./calfSystem-C1X5YxJZ.js"
import{a as d}from"./arena-CgHFL0T_.js"
...
let k=0,x=0
function b(n,o){return function(n,o){return t(m,v,n,o)}("x"===n?0:Number(n)+1,o)}function C(t){return t.value}function _(t,n){if(t!==h[n])return k.eq(n).attr({src:u,width:"25",height:"25"}),b("x",n)}function y(t,n){if("x"!==t&&t!==h[n])return b(t,n)}async function w(t){const n=t.map(y)
...
h.push(e)
const a=$(g)
$(`option[value=${e}]`,a).prop("selected",!0),t.append(a)}function B(t){e("arena__setup","setupMoves"),$(t.target).off(),k=$('#pCC a[href*="=pickmove&"] img')
...
//# sourceMappingURL=setupMoves-C48BVDfz.js.map
