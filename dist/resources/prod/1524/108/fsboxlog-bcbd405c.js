...
import{S as s,L as n,M as e,bf as o,bg as a,ba as r,bd as l,bh as c,N as i,O as f,P as u,R as m,T as p,W as b,Z as h,a1 as d,n as g,l as $,q as v,as as x,a5 as j,an as k,cH as y,Y as L,aj as M,b0 as S,bp as C,a2 as _}from"./calfSystem-34913441.js"
import{h as q,u as w}from"./await_block-d58cecee.js"
import{e as z}from"./each-6f7f5a14.js"
import{M as B}from"./ModalTitled-945b0136.js"
import{g as F,s as N}from"./idb-ec5d6344.js"
import"./Modal-108b3dd4.js"
function T(t,s,n){const e=t.slice()
return e[7]=s[n][0],e[8]=s[n][1],e[9]=s[n][2],e}function H(t){return{c:L,m:L,p:L,d:L}}function Y(t){let s,n=z(t[1]),e=[]
...
return{c(){s=i("br"),n=f(),e=i("span"),o=i("a"),a=d(v),l=d("\n          says:"),c=f(),b=i("q"),g=d(x),$=f(),u(o,"href",r=""+(C+t[7])),u(o,"class","svelte-14ozmrh")},m(t,r){m(t,s,r),m(t,n,r),m(t,e,r),p(e,o),p(o,a),p(e,l),m(t,c,r),m(t,b,r),p(b,g),p(b,$)},p(t,s){2&s&&v!==(v=t[8]+"")&&_(a,v),2&s&&r!==(r=""+(C+t[7]))&&u(o,"href",r),2&s&&x!==(x=t[9]+"")&&_(g,x)},d(t){t&&(h(s),h(n),h(e),h(c),h(b))}}}function P(t){return{c:L,m:L,p:L,d:L}}function R(t){let s,n,e,o,a,r,l={ctx:t,current:null,token:null,hasCatch:!1,pending:P,then:Y,catch:H}
...
return{c(){s=d("FS Box Log")},m(t,n){m(t,s,n)},d(t){t&&h(s)}}}function Z(t){let s,n
...
n(1,o=t.split("<br>").map(a).filter(r))},function(){N("fsh_fsboxcontent",""),g("FS Box Log","clear storage"),n(1,o=[])}]}var D=class extends s{constructor(t){super(),n(this,t,A,Z,e,{visible:0})}}
const E={visible:!0}
let G=0
function I(){G=t(E,G,D)}export{I as default}
//# sourceMappingURL=fsboxlog-bcbd405c.js.map
