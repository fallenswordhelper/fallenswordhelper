...
import{ad as t,l as n,g as a,a6 as r,i as o,c as s,v as l,o as i,aA as c,aB as u,E as f,aC as d,aD as m,aE as p,aF as h,y as g,b as v,af as b,aG as w,aH as k,aI as y,aJ as C,aK as L,ab as D,j as V,n as x,ax as A,q as S,aL as M,aM as N,D as H,aN as B,aO as q,aP as T,aQ as E,aR as G,aS as j,aT as P,aU as F,aV as R,aW as _,aX as I,ag as O,a5 as W,aY as Y,aZ as K,a_ as z,a as U,$ as Q,S as J,L as X,M as Z,aj as ee,R as te,Y as ne,Z as ae,N as re,a1 as oe,a$ as se,T as le,a2 as ie,O as ce,P as ue,b0 as fe,b1 as de,b2 as me,b3 as pe,b4 as he,b5 as ge,W as ve,b6 as be,s as we,b7 as ke,b8 as ye,b9 as Ce,ba as $e,bb as Le,bc as De,bd as Ve,be as xe,bf as Ae,bg as Se,bh as Me,bi as Ne,bj as He,bk as Be,bl as qe,bm as Te,bn as Ee,bo as Ge,bp as je,bq as Pe,br as Fe,bs as Re,bt as _e,bu as Ie,bv as Oe,bw as We,bx as Ye,by as Ke,bz as ze,bA as Ue,bB as Qe,bC as Je,ae as Xe}from"./calfSystem-34913441.js"
import{i as Ze}from"./insertElementAfter-639f3edf.js"
import{t as et}from"./toggleForce-6124e333.js"
import{c as tt}from"./createSpan-d7c936c3.js"
import{i as nt}from"./insertTextBeforeEnd-90772609.js"
import{r as at,a as rt}from"./roundToString-b56b87fd.js"
import{a as ot}from"./addCommas-47d6aaa1.js"
import{d as st,q as lt}from"./quickbuffSuccess-68b38bf5.js"
import{c as it}from"./createButton-ae13c659.js"
import{o as ct}from"./openQuickBuffById-3914df94.js"
import{c as ut}from"./createInput-4ae8777b.js"
import{c as ft}from"./createLabel-91e7de95.js"
import{g as dt,s as mt}from"./idb-ec5d6344.js"
import{r as pt}from"./rnd-6f762303.js"
import{v as ht}from"./valueText-238d2284.js"
import{c as gt}from"./createStyle-e8b661d2.js"
import{h as vt,u as bt}from"./await_block-d58cecee.js"
import{e as wt,u as kt,d as yt}from"./each-6f7f5a14.js"
import{u as Ct}from"./uniq-a7375dfa.js"
import{g as $t}from"./guild-014ef050.js"
import{c as Lt}from"./createTable-407ce13c.js"
...
import{L as Tt}from"./LinkButton-aabd28ac.js"
import{r as Et}from"./reduceBuffArray-e31428bc.js"
import{p as Gt}from"./profile-3aa5b35b.js"
import{a as jt}from"./all-414e0607.js"
import{n as Pt}from"./numberIsNaN-a40c3bbb.js"
import{r as Ft}from"./reliclist-7d77b4f3.js"
import{d as Rt}from"./daGroupStats-41e6b27e.js"
import{d as _t,m as It}from"./mercEffect-072ff624.js"
import{d as Ot}from"./daViewGroups-277b3166.js"
import{a as Wt}from"./attribsToArray-e520f204.js"
import{g as Yt}from"./guildMembers-3d3812de.js"
import{r as Kt}from"./remainingPages-9b4c19bf.js"
import{t as zt}from"./testQuant-69a26f83.js"
import{m as Ut}from"./myStats-1ab0fda3.js"
import{s as Qt}from"./shouldBeArray-4329f859.js"
import{h as Jt}from"./hideElement-baffa60f.js"
import{s as Xt,j as Zt}from"./simpleCheckbox-7fbdc790.js"
...
import"./buffReportParser-111ca0f4.js"
...
Vn.className=function(e){return Sn[e]||"fshGreen"}(n),r(n,xn)}function Nn(e,t,n){t||n?Mn(e,t):Vn&&et(Vn,!0)}function Hn(e){return 0===e.type}let Bn=0,qn=0,Tn=0,En=0,Gn=0,jn=0
...
Zn=On({prefVal:n,checkId:"fshHuntCheck",onClass:"huntOn",onTip:"Hunting mode is ON",offClass:"huntOff",offTip:"Hunting mode is OFF",worldName:e})}(Wn)}const oa=[[()=>Xn,function(){D("playNewMessageSound",!b("playNewMessageSound"))}],[()=>Zn,function(){t.huntingMode=!t.huntingMode,D("huntingMode",t.huntingMode)}]],sa=[[()=>zn,function(e){w(e),GameData.doAction(12,401,{},0)}],[()=>Un,function(){ct(k())}],[()=>Qn,function(){window.open(`${y+C}map`,"fsMap")}],[()=>Jn,function(){const e=GameData.realm()
...
return q(t)??{response:{msg:"Server Error",response:1}}}const Na=[]
...
a&&or(t,a)}function lr(e,t){return n=e,rr.every((e=>H(e,n)))&&!H("fshTip",e)&&H("creature",t)
...
return e.$$set=e=>{"promise"in e&&n(0,a=e.promise)},[a]}class xr extends J{constructor(e){super(),X(this,e,Vr,Dr,Z,{promise:0})}}let Ar=0
...
b(e)&&(n=t+1,$.subscribe(z,s(Nr,n)),Nr(t+1))}function qr(e){e.remove()}function Tr(e,t){!function(e){(function(e){return e.response&&e.response.msg&&e.response.msg.startsWith("Creature did not exist at that location")})(e)&&GameData.fetch(he+ge)}(t),V(".creature-4 > .quickCombat > .verbs").forEach(qr)}function Er(e,t,n){const a=e.slice()
...
return[r,e=>Ct(e,"msg").map((({msg:t,type:n})=>({msg:t,type:n,count:e.filter((({msg:e})=>e===t)).length}))),i,e=>i(e)]}class Rr extends J{constructor(e){super(),X(this,e,Fr,Pr,Z,{})}}let _r=0
...
function Vo(){co=Rn("Current"),uo=Rn("Kills"),fo=Rn("Member"),mo=Rn("% of Total"),po=Rn("Status"),ho=Rn("Titan HP"),go=Rn("Total"),vo=Rn("Your Guild")}let xo=0,Ao=0,So=0,Mo=0,No=0,Ho=0,Bo=0,qo=0,To=0
const Eo=()=>xo,Go=()=>Ao,jo=()=>So,Po=()=>Mo,Fo=()=>No,Ro=()=>Ho,_o=()=>Bo,Io=()=>qo,Oo=()=>To
function Wo(){xo=tt({innerHTML:"&nbsp;"}),Ao=tt({innerHTML:"&nbsp;"}),So=tt(),Mo=tt(),No=tt(),Ho=tt(),Bo=tt(),qo=tt(),To=tt()}let Yo=0
const Ko=()=>Yo
...
return o(t,e),nt(t,"%"),t}let Jo=0,Xo=0,Zo=""
const es=()=>Xo,ts=()=>Zo
function ns(){Xo=null,Jo&&!H("fshHide",Jo)&&(et(Jo,!0),we("&nbsp;",xo),we("&nbsp;",Ao),r("",So),r("",Mo),r("",No),r("",Ho),r("",Bo),we("",qo),we("",To),zo())}function as(e){return 0===e.type&&(Xo=e.base_creature_id,Zo=`(${e.x},${e.y})`,!0)}function rs(){if(Jo)et(Jo,!1)
else{const e=a("actionContainer")
Jo=n({className:"fshActionBox titanInfo"}),Wo(),Yo=Lt({className:"fshCenter"}),Vo(),io(Yo,[[[[5,Eo,!0],[1,Go,!0]]],[[[2,$o,!0],[4,Do,!0]]],[[[2,Uo],[4,Fo]]],[[[2,bo,!0],[4,s(Qo,Ro())]],!0],[[[2,Lo,!0],[4,s(Qo,_o())]],!0],[[[2,Co,!0],[4,Io]],!0],[[[6,Oo]]],[[[2,ko,!0],[2,wo,!0],[2,yo,!0]]]]),o(Jo,Ko()),o(e,Jo)}}function os(e){return e<=0?'<span class="fshGreen cooldown">No active cooldown</span>':`<span class="fshMaroon cooldown">Cooldown until: ${function(e){const t=new Date(At()+1e3*e)
return`${Ht(t.getHours())}:${Ht(t.getMinutes())} ${Ht(t.getDate())}/${ke[t.getMonth()]}/${t.getFullYear()}`}(e)}</span>`}function ss(e){return rt(xt(e.max_hp-e.current_hp,e.kills),2)}function ls(e){return rt(100*e.kills/e.max_hp,2)}function is(e){!function(e){[[Vt(e.creature.name),Eo],[ts(),Go],[e.current_hp,jo],[e.max_hp,Po],[e.kills,Fo],[ss(e),Ro],[ls(e),_o]].forEach((([e,t])=>r(e,t())))}(e),we(function(e){return Dt(e.kills,e.max_hp,e.current_hp)}(e),Io()),we(os(e.cooldown),Oo())}function cs(e,t){return[[[2,()=>Rn(t.player.name)],[2,()=>Rn(t.kills.toString())],[2,()=>Rn(`${rt(100*t.kills/e.kills,2)}%`)]]]}function us(e){return e.realm&&e.creature.base_id===es()&&e.realm===ao()}function fs(e){const t=e.find(us)
...
let{members:r=[]}=t
const o=e=>`Buff ${Ne[e]} 16`
function s(e,t,n){n.target.blur(),Bt(`${He}&players=${e.join(",")}`,"fsQuickBuff",618,1e3,",scrollbars"),a("buffBatch",o(t))}return e.$$set=e=>{"members"in e&&n(0,r=e.members)},[r,o,s,(e,t,n)=>s(e,t,n)]}class Ls extends J{constructor(e){super(),X(this,e,$s,Cs,Z,{members:0})}}function Ds(e,t){return e>10*t||e<t?e:10*t}const Vs=[["levelValue","level"],["attackValue","attack"],["attackBonus","bonus_attack"],["defenseValue","defense"],["defenseBonus","bonus_defense"],["armorValue","armor"],["armorBonus","bonus_armor"],["damageValue","damage"],["damageBonus","bonus_damage"],["hpValue","hp"],["hpBonus","bonus_hp"],["killStreakValue","killstreak"]]
...
n.push([a,Ms(r)]),t(n)}))),Ns.set(["defendersStore","Done."])}(e,t)})),js=Be(Gs,((e,t)=>{const n=e?.find((([e])=>0===e))
...
n({attackWithNmv:t.attackValue-a,chiStrike:e.chiStrikeLevel,cloak:e.cloakLevel?"Yes":"No",dmgWithChiStrike:i,defWithConst:r,hpWithFortitude:s,nmv:a,sanctuary:Js(t.armorValue,e.sanctuaryLevel)})}))
...
f(t)&&n(0,r=t.filter(s).sort(l))}(e)})),e.$$set=e=>{"members"in e&&n(1,a=e.members)},[r,a]}class kl extends J{constructor(e){super(),X(this,e,wl,bl,Z,{members:1})}}function yl(e){let t,n,a
...
return{c(){t=re("button"),t.textContent="Fetch Stats",ue(t,"class","custombutton"),ue(t,"type","button")},m(r,o){te(r,t,o),n||(a=ve(t,"click",e[12]),n=!0)},p:ne,d(e){e&&ae(t),n=!1,a()}}}function Ll(e){let t,n,a,r,o,s,l,i,c,u,f,d,m,p,h,g,v,b,w,k,y,C,$,L,D,V,x,A,S,M,N,H,B,q,T,E,G,j,P,F,R,_,I,O,W,Y,K,z,U,Q,J,X,Z,ee,ne,se,fe,de,me,pe,he,ge,ve,be,we,ke,ye,Ce,Le,De,xe,Ne,He,Be,qe,Te,Ee,Ge,je,Pe,Fe,Re,_e,Ie,Oe,We,Ye,Ke,ze,Ue,Qe,Je,Xe,Ze,et,tt,nt,at,rt,ot,st,lt,it,ct,ut,ft,dt,mt,pt,ht,gt,vt,bt,wt,kt,yt,Ct,$t,Lt,Dt,Vt,xt,At,St,Mt,Nt,Ht,Bt=e[3].noOfRelics+"",qt=e[3].leadDefenderBonus+"",Tt=e[5].attackValue+"",Et=e[6].attack+"",Gt=e[5].defenseValue+"",jt=e[6].defense+"",Pt=e[5].armorValue+"",Ft=e[6].armor+"",Rt=e[5].damageValue+"",_t=e[6].damage+"",It=e[5].hpValue+"",Ot=e[6].hp+"",Wt=e[5].cloaked+"",Yt=e[6].dc225+"",Kt=e[6].dc175+"",zt=e[8].attack+"",Ut=e[9].attack+"",Qt=e[8].defense+"",Jt=e[9].defense+"",Xt=e[8].armor+"",Zt=e[9].armor+"",en=e[8].damage+"",tn=e[9].damage+"",nn=e[8].hp+"",an=e[9].hp+""
return Nt=new kl({props:{members:e[10]}}),{c(){t=re("div"),n=re("div"),n.textContent="Defending Guild Stats",a=ce(),r=re("div"),o=re("div"),o.textContent="Relic Count:",s=re("div"),l=oe(Bt),i=ce(),c=re("div"),c.textContent="Lead Defender Bonus:",u=re("div"),f=oe(qt),d=ce(),m=re("div"),m.textContent="Lead Defender Cloaked:",p=re("div"),h=oe(e[4]),g=ce(),v=re("div"),v.textContent="Other Defender Stats",b=ce(),w=re("div"),k=re("div"),k.textContent="Raw Attack:",y=re("div"),C=oe(Tt),$=ce(),L=re("div"),L.textContent="Attack w/ buffs:",D=re("div"),V=oe(Et),x=ce(),A=re("div"),A.textContent="Raw Defense:",S=re("div"),M=oe(Gt),N=ce(),H=re("div"),H.textContent="Defense w/buffs:",B=re("div"),q=oe(jt),T=ce(),E=re("div"),E.textContent="Raw Armor:",G=re("div"),j=oe(Pt),P=ce(),F=re("div"),F.textContent="Armor w/ buffs:",R=re("div"),_=oe(Ft),I=ce(),O=re("div"),O.textContent="Raw Damage:",W=re("div"),Y=oe(Rt),K=ce(),z=re("div"),z.textContent="Damage w/ buffs:",U=re("div"),Q=oe(_t),J=ce(),X=re("div"),X.textContent="Raw HP:",Z=re("div"),ee=oe(It),ne=ce(),se=re("div"),se.textContent="HP w/ buffs:",fe=re("div"),de=oe(Ot),me=ce(),pe=re("div"),pe.textContent="Cloaked:",he=re("div"),ge=oe(Wt),ve=ce(),be=re("div"),be.textContent="Processed:",we=re("div"),ke=oe(e[7]),ye=ce(),Ce=re("div"),Le=re("div"),Le.textContent="Adjusted Defense Values",De=ce(),xe=re("div"),Ne=re("div"),Ne.textContent="DC225:",He=re("div"),Be=oe(Yt),qe=ce(),Te=re("div"),Te.textContent="DC175:",Ee=re("div"),Ge=oe(Kt),je=ce(),Pe=re("div"),Pe.textContent=" ",Fe=ce(),Re=re("div"),Re.textContent="Attacking Group Stats",_e=ce(),Ie=re("div"),Oe=re("div"),Oe.textContent="Raw Group Attack:",We=re("div"),Ye=oe(zt),Ke=ce(),ze=re("div"),ze.textContent="Group Attack w/ buffs:",Ue=re("div"),Qe=oe(Ut),Je=ce(),Xe=re("div"),Xe.textContent="Raw Group Defense:",Ze=re("div"),et=oe(Qt),tt=ce(),nt=re("div"),nt.textContent="Group Defense w/ buffs:",at=re("div"),rt=oe(Jt),ot=ce(),st=re("div"),st.textContent="Raw Group Armor:",lt=re("div"),it=oe(Xt),ct=ce(),ut=re("div"),ut.textContent="Group Armor w/ buffs:",ft=re("div"),dt=oe(Zt),mt=ce(),pt=re("div"),pt.textContent="Raw Group Damage:",ht=re("div"),gt=oe(en),vt=ce(),bt=re("div"),bt.textContent="Group Damage w/ buffs:",wt=re("div"),kt=oe(tn),yt=ce(),Ct=re("div"),Ct.textContent="Raw Group HP:",$t=re("div"),Lt=oe(nn),Dt=ce(),Vt=re("div"),Vt.textContent="Group HP w/ buffs:",xt=re("div"),At=oe(an),St=ce(),Mt=re("div"),Ae(Nt.$$.fragment),ue(n,"class","b-top svelte-1qul0wc"),ue(o,"class","svelte-1qul0wc"),ue(s,"class","svelte-1qul0wc"),ue(c,"class","svelte-1qul0wc"),ue(u,"class","svelte-1qul0wc"),ue(m,"class","svelte-1qul0wc"),ue(p,"class","svelte-1qul0wc"),ue(r,"class","stat-grid svelte-1qul0wc"),ue(v,"class","b-top svelte-1qul0wc"),ue(k,"class","svelte-1qul0wc"),ue(y,"class","svelte-1qul0wc"),ue(L,"class","svelte-1qul0wc"),ue(D,"class","svelte-1qul0wc"),ue(A,"class","svelte-1qul0wc"),ue(S,"class","svelte-1qul0wc"),ue(H,"class","svelte-1qul0wc"),ue(B,"class","svelte-1qul0wc"),ue(E,"class","svelte-1qul0wc"),ue(G,"class","svelte-1qul0wc"),ue(F,"class","svelte-1qul0wc"),ue(R,"class","svelte-1qul0wc"),ue(O,"class","svelte-1qul0wc"),ue(W,"class","svelte-1qul0wc"),ue(z,"class","svelte-1qul0wc"),ue(U,"class","svelte-1qul0wc"),ue(X,"class","svelte-1qul0wc"),ue(Z,"class","svelte-1qul0wc"),ue(se,"class","svelte-1qul0wc"),ue(fe,"class","svelte-1qul0wc"),ue(pe,"class","svelte-1qul0wc"),ue(he,"class","svelte-1qul0wc"),ue(be,"class","svelte-1qul0wc"),ue(we,"class","svelte-1qul0wc"),ue(w,"class","stat-grid svelte-1qul0wc"),ue(t,"class","middle svelte-1qul0wc"),ue(Le,"class","b-top svelte-1qul0wc"),ue(Ne,"class","svelte-1qul0wc"),ue(He,"class","svelte-1qul0wc"),ue(Te,"class","svelte-1qul0wc"),ue(Ee,"class","svelte-1qul0wc"),ue(Pe,"class","svelte-1qul0wc"),ue(xe,"class","stat-grid svelte-1qul0wc"),ue(Re,"class","b-top svelte-1qul0wc"),ue(Oe,"class","svelte-1qul0wc"),ue(We,"class","svelte-1qul0wc"),ue(ze,"class","svelte-1qul0wc"),ue(Ue,"class","svelte-1qul0wc"),ue(Xe,"class","svelte-1qul0wc"),ue(Ze,"class","svelte-1qul0wc"),ue(nt,"class","svelte-1qul0wc"),ue(at,"class","svelte-1qul0wc"),ue(st,"class","svelte-1qul0wc"),ue(lt,"class","svelte-1qul0wc"),ue(ut,"class","svelte-1qul0wc"),ue(ft,"class","svelte-1qul0wc"),ue(pt,"class","svelte-1qul0wc"),ue(ht,"class","svelte-1qul0wc"),ue(bt,"class","svelte-1qul0wc"),ue(wt,"class","svelte-1qul0wc"),ue(Ct,"class","svelte-1qul0wc"),ue($t,"class","svelte-1qul0wc"),ue(Vt,"class","svelte-1qul0wc"),ue(xt,"class","svelte-1qul0wc"),ue(Ie,"class","stat-grid svelte-1qul0wc"),ue(Ce,"class","right svelte-1qul0wc"),ue(Mt,"class","bottom b-top svelte-1qul0wc")},m(e,ae){te(e,t,ae),le(t,n),le(t,a),le(t,r),le(r,o),le(r,s),le(s,l),le(r,i),le(r,c),le(r,u),le(u,f),le(r,d),le(r,m),le(r,p),le(p,h),le(t,g),le(t,v),le(t,b),le(t,w),le(w,k),le(w,y),le(y,C),le(w,$),le(w,L),le(w,D),le(D,V),le(w,x),le(w,A),le(w,S),le(S,M),le(w,N),le(w,H),le(w,B),le(B,q),le(w,T),le(w,E),le(w,G),le(G,j),le(w,P),le(w,F),le(w,R),le(R,_),le(w,I),le(w,O),le(w,W),le(W,Y),le(w,K),le(w,z),le(w,U),le(U,Q),le(w,J),le(w,X),le(w,Z),le(Z,ee),le(w,ne),le(w,se),le(w,fe),le(fe,de),le(w,me),le(w,pe),le(w,he),le(he,ge),le(w,ve),le(w,be),le(w,we),le(we,ke),te(e,ye,ae),te(e,Ce,ae),le(Ce,Le),le(Ce,De),le(Ce,xe),le(xe,Ne),le(xe,He),le(He,Be),le(xe,qe),le(xe,Te),le(xe,Ee),le(Ee,Ge),le(xe,je),le(xe,Pe),le(Ce,Fe),le(Ce,Re),le(Ce,_e),le(Ce,Ie),le(Ie,Oe),le(Ie,We),le(We,Ye),le(Ie,Ke),le(Ie,ze),le(Ie,Ue),le(Ue,Qe),le(Ie,Je),le(Ie,Xe),le(Ie,Ze),le(Ze,et),le(Ie,tt),le(Ie,nt),le(Ie,at),le(at,rt),le(Ie,ot),le(Ie,st),le(Ie,lt),le(lt,it),le(Ie,ct),le(Ie,ut),le(Ie,ft),le(ft,dt),le(Ie,mt),le(Ie,pt),le(Ie,ht),le(ht,gt),le(Ie,vt),le(Ie,bt),le(Ie,wt),le(wt,kt),le(Ie,yt),le(Ie,Ct),le(Ie,$t),le($t,Lt),le(Ie,Dt),le(Ie,Vt),le(Ie,xt),le(xt,At),te(e,St,ae),te(e,Mt,ae),Se(Nt,Mt,null),Ht=!0},p(e,t){(!Ht||8&t)&&Bt!==(Bt=e[3].noOfRelics+"")&&ie(l,Bt),(!Ht||8&t)&&qt!==(qt=e[3].leadDefenderBonus+"")&&ie(f,qt),(!Ht||16&t)&&ie(h,e[4]),(!Ht||32&t)&&Tt!==(Tt=e[5].attackValue+"")&&ie(C,Tt),(!Ht||64&t)&&Et!==(Et=e[6].attack+"")&&ie(V,Et),(!Ht||32&t)&&Gt!==(Gt=e[5].defenseValue+"")&&ie(M,Gt),(!Ht||64&t)&&jt!==(jt=e[6].defense+"")&&ie(q,jt),(!Ht||32&t)&&Pt!==(Pt=e[5].armorValue+"")&&ie(j,Pt),(!Ht||64&t)&&Ft!==(Ft=e[6].armor+"")&&ie(_,Ft),(!Ht||32&t)&&Rt!==(Rt=e[5].damageValue+"")&&ie(Y,Rt),(!Ht||64&t)&&_t!==(_t=e[6].damage+"")&&ie(Q,_t),(!Ht||32&t)&&It!==(It=e[5].hpValue+"")&&ie(ee,It),(!Ht||64&t)&&Ot!==(Ot=e[6].hp+"")&&ie(de,Ot),(!Ht||32&t)&&Wt!==(Wt=e[5].cloaked+"")&&ie(ge,Wt),(!Ht||128&t)&&ie(ke,e[7]),(!Ht||64&t)&&Yt!==(Yt=e[6].dc225+"")&&ie(Be,Yt),(!Ht||64&t)&&Kt!==(Kt=e[6].dc175+"")&&ie(Ge,Kt),(!Ht||256&t)&&zt!==(zt=e[8].attack+"")&&ie(Ye,zt),(!Ht||512&t)&&Ut!==(Ut=e[9].attack+"")&&ie(Qe,Ut),(!Ht||256&t)&&Qt!==(Qt=e[8].defense+"")&&ie(et,Qt),(!Ht||512&t)&&Jt!==(Jt=e[9].defense+"")&&ie(rt,Jt),(!Ht||256&t)&&Xt!==(Xt=e[8].armor+"")&&ie(it,Xt),(!Ht||512&t)&&Zt!==(Zt=e[9].armor+"")&&ie(dt,Zt),(!Ht||256&t)&&en!==(en=e[8].damage+"")&&ie(gt,en),(!Ht||512&t)&&tn!==(tn=e[9].damage+"")&&ie(kt,tn),(!Ht||256&t)&&nn!==(nn=e[8].hp+"")&&ie(Lt,nn),(!Ht||512&t)&&an!==(an=e[9].hp+"")&&ie(At,an)},i(e){Ht||($e(Nt.$$.fragment,e),Ht=!0)},o(e){Ve(Nt.$$.fragment,e),Ht=!1},d(e){e&&(ae(t),ae(ye),ae(Ce),ae(St),ae(Mt)),Me(Nt)}}}function Dl(e){let t,n,a,r,o,s=e[0].is_owner&&yl(e)
...
let m=!1
return Re((()=>{n(1,m=!1),qs.set(0),Es.set([]),_s.set(0),nl.set([])})),e.$$set=e=>{"relicData"in e&&n(0,f=e.relicData)},[f,m,a,r,o,s,l,i,c,u,d,function(e){x("relic",e.detail)},function(){x("relic","fetchStats"),n(1,m=!0),qs.set(f.controlled_by.guild_id),Es.set(d),_s.set(GameData.player().hasGroup),nl.set(GameData.player().buffs)}]}class xl extends J{constructor(e){super(),X(this,e,Vl,Dl,Z,{relicData:0})}}let Al=0
function Sl(e,t){var n,r
t?.response?.data?.defenders?.length>0&&(n=a("dialog-relic"),r=t.response.data,Al&&Al.$destroy(),Al=new xl({props:{relicData:r},target:n}))}function Ml(e,t){"ACT_REPAIR"===t&&GameData.fetch(Oe+u+he+ge)}let Nl=!1
function Hl(e,t,n,a,r,o,s,l,i){return e.beginPath(),e.arc(o+l/2,s+i/2,l/6,0,2*Math.PI,!1),e.fillStyle=this.color,e.fill(),e.lineWidth=1,e.strokeStyle="black",e.stroke(),!0}function Bl(){if(!Nl){const e=GameController.Realm.footprintTexture
e.color=b("footprintColor"),e.Draw=Hl,Nl=!0}}function ql(){GameController?.Realm?.footprintTexture&&(Bl(),$.unsubscribe("fixed.realm",ql))}let Tl=0
...
return{c(){n&&n.c(),t=ee()},m(e,a){n&&n.m(e,a),te(e,t,a)},p(e,[a]){e[1]?n?n.p(e,a):(n=Ul(e),n.c(),n.m(t.parentNode,t)):n&&(n.d(1),n=null)},i:ne,o:ne,d(e){e&&ae(t),n&&n.d(e)}}}function Jl(e,t,n){let{tpButton:a}=t,r=0,o=0,s=!1
function l(){const e=GameData.player().teleportCooldown
n(0,r=e-Nt()+o),r>0||(clearInterval(s),n(1,s=!1),a.classList.remove("cooldown"))}return window.$.subscribe("stats.player",l),window.$.subscribe(Qe,(function(e,t){o=Nt(),l(),s||0!==t.response.response||n(1,s=setInterval((()=>{l()}),1e3))})),e.$$set=e=>{"tpButton"in e&&n(2,a=e.tpButton)},[r,s,a]}class Xl extends J{constructor(e){super(),X(this,e,Jl,Ql,Z,{tpButton:2})}}function Zl(e){return e.numberOfCreatureHitsTillDead-e.numberOfHitsRequired<=1?", dies on miss":", survives a miss"}function ei(e,t){return"-"===t?e:"-"===e||e>t?"-":e}const ti=[[e=>"-"===e.playerHits&&"-"===e.creatureHits,()=>"Unresolved"],[e=>"-"===e.playerHits,()=>"Player dies"],[e=>1===e.playerHits,e=>`Player 1 hits${Zl(e)}`],[e=>e.playerHits>1,e=>`Player > 1 hits${Zl(e)}`]]
...
ac(e,t,n)}async function oc(e,t){if(Ki||(Ki=a("dialog-viewcreature")),Ki&&(Xi(""),Zi(""),t?.response?.data)){Yi(t.response.data.name,Ki)
const e=await Ut(!0)
e&&function(e,t){e.player.hasGroup&&rc(e,t),tc(e,t,{groupExists:!1})}(t,e)}}let sc=0
function lc(e){const t=E("verbs",e)
1===t.length&&Jt(t[0])}function ic(){if(!sc)return
const e=a("actionList")
O("player",e).forEach(lc)}const cc="showHuntingBuffs"
function uc(){return`${Xt(cc)} ${Zt("enabledHuntingMode")}<select name="enabledHuntingMode"><option value="1"${en(t.enabledHuntingMode,"1")}>${t.buffsName}</option><option value="2"${en(t.enabledHuntingMode,"2")}>${t.buffs2Name}</option><option value="3"${en(t.enabledHuntingMode,"3")}>${t.buffs3Name}</option></select>`}let fc=0,dc=""
const mc=()=>fc,pc=()=>dc
...
if(!e)return
const t=n({className:"fshCenter fshFten"}),r=n({id:"fshWorldPrefs",innerHTML:`${Xt("showCreatureInfo")}&nbsp;&nbsp;${Xt("showMonsterLog")}&nbsp;&nbsp;${Xt("showTitanInfo")}&nbsp;&nbsp;${Xt("showBuffInfo")}<br>${Xt("hideSubLvlCreature")}&nbsp;&nbsp;${Xt("hidePlayerActions")}&nbsp;&nbsp;${uc()}`})
...
return function(e){return!e||!e.actions||0===e.actions.length}(t)?e:(t.actions=t.actions.filter(s(Ac,function(e){return e.realm&&e.realm.minlevel||GameData.realm().minlevel}(t))),Xe(t))}function Mc(e,n){t.hideSubLvlCreature&&function(e){return e.data&&e.data.d&&tn(e.data.d,ge)}(n)&&(e.dataFilter=Sc)}function Nc(e){t[e[0]]=Qt(e[1])}function Hc(e){t[e]=Qt(e)}function Bc(){[["buffs","huntingBuffs"],["buffs2","huntingBuffs2"],["buffs3","huntingBuffs3"]].forEach(Nc),["doNotKillList"].forEach(Hc)}function qc(e){t[e[0]]=b(e[1])}function Tc(e){t[e]=b(e)}function Ec(){[["buffsName","huntingBuffsName"],["buffs2Name","huntingBuffs2Name"],["buffs3Name","huntingBuffs3Name"],["showHuntingBuffs","showHuntingBuffs"]].forEach(qc),["enabledHuntingMode","hideSubLvlCreature","showTitanInfo","showBuffInfo","showMonsterLog","showCreatureInfo"].forEach(Tc)}const Gc=[function(){Cc(),Bc(),Ec()
const e=kc()
$.ajaxPrefilter("JSON",Mc),t.hideSubLvlCreature&&GameData.fetch(ge),function(e){hc()
const n=s(xc,e)
$.subscribe(d,n),t.showHuntingBuffs&&window.initialGameData&&n(null,{b:window.initialGameData.player.buffs})}(e),sc=b("hidePlayerActions"),$.subscribe(z,ic),ic()},function(){We(),Ye()&&jl()},function(){$.subscribe(Je,oc)},function(){Hr.forEach(Br)},function(){b("enableCreatureColoring")&&o(document.body,gt("#actionList .creature-1 {color: green;}\n#actionList .creature-2 {color: yellow;}\n#actionList .creature-3 {color: red;}"))},function(){$.subscribe(z,fr),fr(),function(){const e=GameData.doAction
GameData.doAction=pr(e)}()},function(){Qr(),$.subscribe("-1-success.action-response 4-success.action-response 5-success.action-response 25-success.action-response",to),to()},function(){$.subscribe(Ie,Ml)},async function(){if(b("keepLogs")){!function(e){e&&($a=e),$.subscribe(N,Aa)}(await dt("fsh_combatLog"))}},function(){window.initialGameData&&bs(0,window.initialGameData),$.subscribe(`${ye} ${Ce}`,bs)},function(){$.subscribe(Ue,zl)},function(){$.subscribe(_e,Sl)},function(){$("#messageCenter").worldMessageCenter({offset:"0 60"})},function(){w("#mapTooltip")},function(){ca(),$.subscribe(p,ua),$.subscribe(h,fa)},function(){Fn(),$.subscribe(`${d} ${m}`,Fn)},function(){v(a("actionList"),"mouseover",ir)},function(){const{body:e}=document
...
function jc(){e(Gc),t.userIsDev&&$.subscribe(N,Tr)}export{jc as default}
//# sourceMappingURL=newMap-7ae0c2cc.js.map
