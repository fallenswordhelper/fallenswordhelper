import{ag as t,s as n,c as s,b1 as e,ai as o,aB as f,p as a,a8 as u,aC as c,cc as r,at as i,D as l,d as p,g as b,C as d}from"./calfSystem-KuDT30_2.js"
...
let s="unknown",e="1"
n&&(s=function(t){return t[0].includes("k")?"k":t[0].includes("f")?"fsp":"stam"}(n),[e]=r(/[+-]?[.\d]+/,n[0])),L.buffs[u(t)]=[parseFloat(e),s],L.count+=1}(t):(L.count-=1,delete L.buffs[s]),L.count>0?R():(p("&nbsp;",b("buffCost")),L.buffCostTotalText="")}function M(t){return t.tagName&&"SPAN"!==t.tagName?M(t.parentNode):t}function D(t){if("fshSendBuffMsg"===t.target.id)return void function(t){t.count>0&&T(t)}(L)
...
//# sourceMappingURL=render-CV-yQi-J.js.map
