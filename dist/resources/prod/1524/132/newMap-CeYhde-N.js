...
import{L as Et}from"./LinkButton-Ln28W4pK.js"
import{r as Gt}from"./reduceBuffArray-Diy1E3zc.js"
import{p as Pt}from"./profile-pmmP_ThH.js"
import{a as jt}from"./all-YfMtr2SN.js"
import{n as Ft}from"./numberIsNaN-CGkd1jiA.js"
import{r as _t}from"./reliclist-BkTBwYeg.js"
import{d as Rt}from"./daGroupStats-HuJ_kjK7.js"
import{d as Ot,m as It}from"./mercEffect-vHsfgg8L.js"
import{d as Wt}from"./daViewGroups-BJ-84KRZ.js"
import{a as Kt}from"./attribsToArray-CLGkQpQo.js"
import{g as Yt}from"./guildMembers-CJo5h_tc.js"
import{r as Ut}from"./remainingPages-BzskAxSU.js"
import{t as zt}from"./testQuant-CUL735o8.js"
import{m as Qt}from"./myStats-CvMZnTQn.js"
import{s as Jt}from"./shouldBeArray-B8PKPURg.js"
import{s as Xt,j as Zt}from"./simpleCheckbox-qN1iLL05.js"
...
Qr(await Tn(e.data.id,t))}let Zr=!1
function eo(){t.showMonsterLog&&(GameData.actions().forEach(Xr),Zr||(c("NewMap","MonsterLog"),Zr=!0))}let to=""
const ao=()=>to
function no(){return At({subcmd:"scouttower"})}function ro(e,[t,a,n]){const r=e.insertCell(-1)
return r.colSpan=t,n&&(r.className="header"),o(r,a()),r}function oo(e,t,a){const n=e.insertRow(-1)
return a&&(n.className="fshBlue"),function(e,t){t.forEach(s(ro,e))}(n,t),n}function so(e,t){oo(e,t[0],t[1])}function lo(e,t){t.forEach(s(so,e))}let io=0,co=0,uo=0,fo=0,mo=0,po=0,ho=0,go=0
const vo=()=>io,bo=()=>co,wo=()=>uo,ko=()=>fo,yo=()=>mo,Co=()=>po,$o=()=>ho,Lo=()=>go
function Vo(){io=Fa("Current"),co=Fa("Kills"),uo=Fa("Member"),fo=Fa("% of Total"),mo=Fa("Status"),po=Fa("Titan HP"),ho=Fa("Total"),go=Fa("Your Guild")}let Do=0,Mo=0,xo=0,Ao=0,So=0,No=0,Ho=0,Bo=0,To=0
const qo=()=>Do,Eo=()=>Mo,Go=()=>xo,Po=()=>Ao,jo=()=>So,Fo=()=>No,_o=()=>Ho,Ro=()=>Bo,Oo=()=>To
function Io(){Do=ft({innerHTML:"&nbsp;"}),Mo=ft({innerHTML:"&nbsp;"}),xo=ft(),Ao=ft(),So=ft(),No=ft(),Ho=ft(),Bo=ft(),To=ft()}let Wo=0
const Ko=()=>Wo
function Yo(){for(;Wo.rows.length>8;)Wo.deleteRow(8)}function Uo(){const e=ft()
return o(e,Go()),dt(e,"/"),o(e,Po()),e}function zo(e){const t=ft()
return o(t,e),dt(t,"%"),t}let Qo=0,Jo=0,Xo=""
const Zo=()=>Jo,es=()=>Xo
function ts(){Jo=null,Qo&&!B("fshHide",Qo)&&(ut(Qo,!0),ye("&nbsp;",Do),ye("&nbsp;",Mo),r("",xo),r("",Ao),r("",So),r("",No),r("",Ho),ye("",Bo),ye("",To),Yo())}function as(e){return 0===e.type&&(Jo=e.base_creature_id,Xo=`(${e.x},${e.y})`,!0)}function ns(){if(Qo)ut(Qo,!1)
else{const e=n("actionContainer")
Qo=a({className:"fshActionBox titanInfo"}),Io(),Wo=St({className:"fshCenter"}),Vo(),lo(Wo,[[[[5,qo,!0],[1,Eo,!0]]],[[[2,Co,!0],[4,Lo,!0]]],[[[2,Uo],[4,jo]]],[[[2,vo,!0],[4,s(zo,Fo())]],!0],[[[2,$o,!0],[4,s(zo,_o())]],!0],[[[2,yo,!0],[4,Ro]],!0],[[[6,Oo]]],[[[2,wo,!0],[2,bo,!0],[2,ko,!0]]]]),o(Qo,Ko()),o(e,Qo)}}function rs(e){return e<=0?'<span class="fshGreen cooldown">No active cooldown</span>':`<span class="fshMaroon cooldown">Cooldown until: ${function(e){const t=new Date(Ce()+1e3*e)
return`${Tt(t.getHours())}:${Tt(t.getMinutes())} ${Tt(t.getDate())}/${$e[t.getMonth()]}/${t.getFullYear()}`}(e)}</span>`}function os(e){return pt(Bt(e.max_hp-e.current_hp,e.kills),2)}function ss(e){return pt(100*e.kills/e.max_hp,2)}function ls(e){!function(e){[[Ht(e.creature.name),qo],[es(),Eo],[e.current_hp,Go],[e.max_hp,Po],[e.kills,jo],[os(e),Fo],[ss(e),_o]].forEach((([e,t])=>r(e,t())))}(e),ye(function(e){return Nt(e.kills,e.max_hp,e.current_hp)}(e),Ro()),ye(rs(e.cooldown),Oo())}function is(e,t){return[[[2,()=>Fa(t.player.name)],[2,()=>Fa(t.kills.toString())],[2,()=>Fa(`${pt(100*t.kills/e.kills,2)}%`)]]]}function cs(e){return e.realm&&e.creature.base_id===Zo()&&e.realm===ao()}function us(e){const t=e.find(cs)
t&&(ls(t),function(e){if(Yo(),!e.contributors)return
const t=e.contributors.map(s(is,e))
lo(Ko(),t)}(t))}let fs=null
const ds=e=>e?.s&&wt(e.r),ms=e=>t.showTitanInfo&&wt(e)&&e.some(as)
async function ps(){!function(e,t){ds(t)&&(us(t.r),ms(GameData.realm().dynamic)?fs=window.setTimeout(e,3e4):ts())}(ps,await J(no))}function hs(e){fs&&(window.clearTimeout(fs),fs=null),ms(e)?(ns(),ps()):ts()}function gs(e){var t
e.dynamic&&(t=e.name,to=t,hs(e.dynamic))}function vs(e,t){t.realm?.name&&gs(t.realm)}function bs(e,t,a){const n=e.slice()
return n[5]=t[a],n[7]=a,n}function ws(e){let t,a=e[1](e[7])+""
return{c(){t=se(a)},m(e,a){ae(e,t,a)},p:ne,d(e){e&&re(t)}}}function ks(e){let t,a,n,r
return a=new Et({props:{$$slots:{default:[ws]},$$scope:{ctx:e}}}),a.$on("click",(function(...t){return e[3](e[5],e[7],...t)})),{c(){t=oe("li"),He(a.$$.fragment),n=fe()},m(e,o){ae(e,t,o),Be(a,t,null),ie(t,n),r=!0},p(t,n){e=t
const r={}
256&n&&(r.$$scope={dirty:n,ctx:e}),a.$set(r)},i(e){r||(Me(a.$$.fragment,e),r=!0)},o(e){Se(a.$$.fragment,e),r=!1},d(e){e&&re(t),Te(a)}}}function ys(e){let t,a,n=ue(De(16,e[0])),r=[]
for(let t=0;t<n.length;t+=1)r[t]=ks(bs(e,n,t))
...
for(n=ue(De(16,e[0])),s=0;s<n.length;s+=1){const o=bs(e,n,s)
r[s]?(r[s].p(o,a),Me(r[s],1)):(r[s]=ks(o),r[s].c(),Me(r[s],1),r[s].m(t,null))}for(xe(),s=n.length;s<r.length;s+=1)o(s)
Ae()}},i(e){if(!a){for(let e=0;e<n.length;e+=1)Me(r[e])
a=!0}},o(e){r=r.filter(Boolean)
for(let e=0;e<r.length;e+=1)Se(r[e])
a=!1},d(e){e&&re(t),me(r,e)}}}function Cs(e,t,a){const n=Ne()
let{members:r=[]}=t
const o=e=>`Buff ${qe[e]} 16`
function s(e,t,a){a.target.blur(),qt(`${Ee}&players=${e.join(",")}`,"fsQuickBuff",618,1e3,",scrollbars"),n("buffBatch",o(t))}return e.$$set=e=>{"members"in e&&a(0,r=e.members)},[r,o,s,(e,t,a)=>s(e,t,a)]}class $s extends X{constructor(e){super(),Z(this,e,Cs,ys,ee,{members:0})}}function Ls(e,t){return e>10*t||e<t?e:10*t}const Vs=[["levelValue","level"],["attackValue","attack"],["attackBonus","bonus_attack"],["defenseValue","defense"],["defenseBonus","bonus_defense"],["armorValue","armor"],["armorBonus","bonus_armor"],["damageValue","damage"],["damageBonus","bonus_damage"],["hpValue","hp"],["hpBonus","bonus_hp"],["killStreakValue","killstreak"]]
function Ds(e,t,a){e[a[0]]=Number(t[a[1]])}const Ms=[["counterAttackLevel","Counter Attack"],["doublerLevel","Doubler"],["deathDealerLevel","Death Dealer"],["darkCurseLevel","Dark Curse"],["holyFlameLevel","Holy Flame"],["constitutionLevel","Constitution"],["sanctuaryLevel","Sanctuary"],["flinchLevel","Flinch"],["nightmareVisageLevel","Nightmare Visage"],["superEliteSlayerLevel","Super Elite Slayer"],["fortitudeLevel","Fortitude"],["chiStrikeLevel","Chi Strike"],["terrorizeLevel","Terrorize"],["barricadeLevel","Barricade"],["reignOfTerrorLevel","Reign Of Terror"],["anchoredLevel","Anchored"],["severeConditionLevel","Severe Condition"],["entrenchLevel","Entrench"],["cloakLevel","Cloak"]]
function xs(e,t,a){e[a[0]]=t[a[1]]||0}function As(e){if(!e._skills)return
const t=Gt(e._skills),a={}
return function(e,t){Vs.forEach(s(Ds,e,t))}(a,e),function(e,t){Ms.forEach(s(xs,e,t))}(a,t),a.superEliteSlayerMultiplier=mt(.002*a.superEliteSlayerLevel,2),Ft(a.armorValue)&&function(e){e.attackValue=Ls(e.attackBonus,e.levelValue),e.defenseValue=Ls(e.defenseBonus,e.levelValue),e.armorValue=Ls(e.armorBonus,e.levelValue),e.damageValue=Ls(e.damageBonus,e.levelValue),e.hpValue=e.hpBonus}(a),a}const Ss=Pe(["statusStore","Done."])
let Ns=[]
const Hs=Ge(Ss,((e,t)=>{const a=Ns.find((([t])=>t===e[0]))
a?[,a[1]]=e:Ns=[...Ns,e]
const n=Ns.find((([,e])=>"Done."!==e))
t(n?.[1]??"Done.")})),Bs=Pe(0)
const Ts=Ge(Bs,((e,t)=>{!async function(e,t){if(!e)return
Ss.set(["relicStore","Processing defending guild relics ... "])
const a=await _t(e)
if(!a?.r?.relics)return void Ss.set(["relicStore","AJAX Error"])
const n=a.r.relics.length,r=1===n?1.5:mt(1-n/10,2)
t({noOfRelics:n,relicMultiplier:r,leadDefenderBonus:`${String(100*r)}%`}),Ss.set(["relicStore","Done."])}(e,t)})),qs=Pe([])
const Es=Ge(qs,((e,t)=>{!async function(e,t){if(!e.length)return
Ss.set(["defendersStore","Processing defending group stats ... "])
const a=[]
await jt(e.map((async(e,n)=>{const r=await Pt(e)
a.push([n,As(r)]),t(a)}))),Ss.set(["defendersStore","Done."])}(e,t)})),Gs=Ge(Es,((e,t)=>{const a=e?.find((([e])=>0===e))
a&&t(a[1])})),Ps=(e,t,a)=>Math.ceil(a*(0===t?e:je))
function js(e,t,[a,n]){return{armorValue:t.armorValue+Ps(e,a,n.armorValue),attackValue:t.attackValue+Ps(e,a,n.attackValue),damageValue:t.damageValue+Ps(e,a,n.damageValue),cloaked:t.cloaked+(n.cloakLevel?1:0),defenseValue:t.defenseValue+Ps(e,a,n.defenseValue),hpValue:t.hpValue+Ps(e,a,n.hpValue)}}const Fs=Ge([Ts,Es],(([e,t],a)=>{if(!e?.relicMultiplier||!t?.length)return
const n=t?.reduce(s(js,e.relicMultiplier),{armorValue:0,attackValue:0,damageValue:0,cloaked:0,defenseValue:0,hpValue:0})
a(n)})),_s=Pe(0),Rs=e=>e.members[0].name===GameData.player().username
...
r&&t({attack:r[0],defense:r[1],armor:r[2],hp:r[3],damage:r[4]}),Ss.set(["groupStore","Done."])}const Is=Ge(_s,((e,t)=>{Os(e,t)})),Ws=(e,t,a)=>Math.ceil(e*Fe(t,0)*a),Ks=(e,t)=>Ws(e,t,.0025),Ys=(e,t)=>Ws(e,t,.001),Us=Ys,zs=Ys,Qs=Ys,Js=Ys,Xs=Ys,Zs=(e,t)=>Math.ceil(e*(1+.001*Fe(t,0))),el=(e,t)=>Math.ceil(e*(1-t*_e)),tl=Pe([]),al=Ge(tl,((e,t)=>{e&&t(Gt(e))})),nl=Ge([al,Is],(([e,t],a)=>{if(!e||!t)return
const n=Zs(t.defense,e.Constitution),r=Us(n,e.Fortitude),o=t.hp+r,s=zs(o,e["Chi Strike"])
a({dmgWithChiStrike:t.damage+s,defWithConst:n,hpWithFortitude:o,nmv:Ks(t.attack,e["Nightmare Visage"]),sanctuary:Qs(t.armor,e.Sanctuary)})}))
const rl=Ge([nl,Gs,Is],(function([e,t,a],n){if(!e||!t||!a)return
const r=a.attack-e.nmv,o=Js(r,t.flinchLevel),s=Xs(e.dmgWithChiStrike,t.terrorizeLevel)
n({attack:r-o,defense:e.defWithConst+e.nmv,armor:a.armor+e.sanctuary,hp:e.hpWithFortitude,damage:e.dmgWithChiStrike-s})})),ol=Ge([Gs,Fs],(([e,t],a)=>{if(!e||!t)return
const n=Ks(t.attackValue,e.nightmareVisageLevel),r=Zs(t.defenseValue,e.constitutionLevel),o=Us(r,e.fortitudeLevel),s=t.hpValue+o,l=zs(s,e.chiStrikeLevel),i=t.damageValue+l
a({attackWithNmv:t.attackValue-n,chiStrike:e.chiStrikeLevel,cloak:e.cloakLevel?"Yes":"No",dmgWithChiStrike:i,defWithConst:r,hpWithFortitude:s,nmv:n,sanctuary:Qs(t.armorValue,e.sanctuaryLevel)})}))
const sl=Ge([al,ol,Fs],(function([e,t,a],n){if(!e||!t||!a)return
const r=Js(t.attackWithNmv,e.Flinch),o=t.defWithConst+t.nmv,s=Xs(t.dmgWithChiStrike,e.Terrorize)
n({attack:t.attackWithNmv-r,dc225:el(o,225),dc175:el(o,175),defense:o,armor:a.armorValue+t.sanctuary,hp:t.hpWithFortitude,damage:t.dmgWithChiStrike-s})})),ll=Ge(Ts,((e,t)=>{t({noOfRelics:e?.noOfRelics??"",leadDefenderBonus:e?.leadDefenderBonus??""})})),il=Ge(Gs,((e,t)=>{if(!e)return t("")
e.cloakLevel?t("Yes"):t("No")})),cl=Ge(Fs,((e,t)=>{t({armorValue:e?.armorValue??"",attackValue:e?.attackValue??"",damageValue:e?.damageValue??"",cloaked:e?.cloaked??"",defenseValue:e?.defenseValue??"",hpValue:e?.hpValue??""})})),ul=Ge(Es,((e,t)=>{t(e?.length??"")})),fl=Ge(sl,((e,t)=>{t({attack:e?.attack??"",dc225:e?.dc225??"",dc175:e?.dc175??"",defense:e?.defense??"",armor:e?.armor??"",hp:e?.hp??"",damage:e?.damage??""})})),dl=e=>({attack:e?.attack??"",defense:e?.defense??"",armor:e?.armor??"",hp:e?.hp??"",damage:e?.damage??""}),ml=Ge(Is,((e,t)=>{t(dl(e))})),pl=Ge(rl,((e,t)=>{t(dl(e))}))
function hl(e,t,a){const n=e.slice()
return n[6]=t[a].id,n[7]=t[a].username,n}function gl(e){let t,a,n,r,o=e[7]+""
return{c(){t=oe("a"),a=se(o),r=se(" "),de(t,"href",n=""+(Re+e[6])),de(t,"class","svelte-3priew")},m(e,n){ae(e,t,n),ie(t,a),ae(e,r,n)},p(e,r){1&r&&o!==(o=e[7]+"")&&ce(a,o),1&r&&n!==(n=""+(Re+e[6]))&&de(t,"href",n)},d(e){e&&(re(t),re(r))}}}function vl(e){let t,a,n,r=(e[0].length||"")+"",o=ue(e[0]),s=[]
for(let t=0;t<o.length;t+=1)s[t]=gl(hl(e,o,t))
...
for(o=ue(e[0]),t=0;t<o.length;t+=1){const r=hl(e,o,t)
s[t]?s[t].p(r,a):(s[t]=gl(r),s[t].c(),s[t].m(n,null))}for(;t<s.length;t+=1)s[t].d(1)
s.length=o.length}},i:ne,o:ne,d(e){e&&(re(t),re(a),re(n)),me(s,e)}}}function bl(e,t,a){let{members:n=[]}=t,r=[]
...
l(Ol,`${n}<br>`)}async function Wl(){const e=zt(Rl.value)
e&&(c("NewMap","quickBuy"),await jt(Ut(e,Il)),GameData.doAction(14,3,{id:Pl.id,item_id:Pl.itemId},0),Fl.close())}function Kl(){_l?r("",Ol):function(){_l=a({className:"fshClear",textContent:"Select how many to quick-buy:"}),Rl=yt({id:"buyAmount",className:"fshNumberInput",min:1,max:99,value:1,type:"number"}),o(_l,Rl)
const e=bt({textContent:"Quick-buy"})
i(e,Wl),o(_l,e),Ol=a(),o(_l,Ol),o(jl,_l)}()}function Yl(e,t){Pl=t,jl=jl||n("shopDialogConfirm"),jl&&(Fl=Fl||$(jl).data("hcsWorldDialogShopConfirm"),Fl&&Kl())}function Ul(e){let t,a
return{c(){t=oe("div"),a=se(e[0]),de(t,"id","tp-overlay"),de(t,"class","svelte-dcwx64")},m(e,n){ae(e,t,n),ie(t,a)},p(e,t){1&t&&ce(a,e[0])},d(e){e&&re(t)}}}function zl(e){let t,a=e[1]&&Ul(e)
return{c(){a&&a.c(),t=te()},m(e,n){a&&a.m(e,n),ae(e,t,n)},p(e,[n]){e[1]?a?a.p(e,n):(a=Ul(e),a.c(),a.m(t.parentNode,t)):a&&(a.d(1),a=null)},i:ne,o:ne,d(e){e&&re(t),a&&a.d(e)}}}function Ql(e,t,a){let{tpButton:n}=t,r=0,o=0,s=!1
function l(){const e=GameData.player().teleportCooldown
a(0,r=e-ot()+o),r>0||(clearInterval(s),a(1,s=!1),n.classList.remove("cooldown"))}return window.$.subscribe("stats.player",l),window.$.subscribe(rt,(function(e,t){o=ot(),l(),s||0!==t.response.response||a(1,s=setInterval((()=>{l()}),1e3))})),e.$$set=e=>{"tpButton"in e&&a(2,n=e.tpButton)},[r,s,n]}class Jl extends X{constructor(e){super(),Z(this,e,Ql,zl,ee,{tpButton:2})}}function Xl(e){return e.numberOfCreatureHitsTillDead-e.numberOfHitsRequired<=1?", dies on miss":", survives a miss"}function Zl(e,t){return"-"===t?e:"-"===e||e>t?"-":e}const ei=[[e=>"-"===e.playerHits&&"-"===e.creatureHits,()=>"Unresolved"],[e=>"-"===e.playerHits,()=>"Player dies"],[e=>1===e.playerHits,e=>`Player 1 hits${Xl(e)}`],[e=>e.playerHits>1,e=>`Player > 1 hits${Xl(e)}`]]
function ti(e,t){return t[0](e)}function ai(e){e.playerHits=Zl(e.numberOfHitsRequired,e.numberOfCreatureHitsTillDead),e.creatureHits=Zl(e.numberOfCreatureHitsTillDead,e.numberOfHitsRequired),e.fightStatus=function(e){const t=ei.find(s(ti,e))
return t?t[1](e):"Unknown"}(e)}function ni(e,t,a){return e.callback.groupExists?t:a}function ri(e,t,a,n){t>0&&(e.extraNotes+=`${a} = ${Math.floor(n*t*.001)}<br>`)}const oi=e=>ni(e,e.callback.groupArmorValue,e.player.armorValue)
function si(e){e.creatureHitByHowMuch>=0?function(e){const t=e.generalVariable*e.creature.damage
t<e.overallArmorValue?e.numberOfCreatureHitsTillDead=e.overallHPValue:e.numberOfCreatureHitsTillDead=Math.ceil(e.overallHPValue/(t-e.overallArmorValue))}(e):e.numberOfCreatureHitsTillDead="-"}function li(e){!function(e){const t=oi(e)
e.overallArmorValue=t+Math.floor(e.player.armorValue*e.player.sanctuaryLevel*.001)}(e),function(e){ri(e,e.player.sanctuaryLevel,"Sanc Bonus Armor",e.player.armorValue)}(e),function(e){e.terrorizeEffect=Math.floor(e.creature.damage*e.player.terrorizeLevel*.001)}(e),function(e){e.player.terrorizeLevel>0&&(e.extraNotes+=`Terrorize Creature Damage Effect = ${-1*e.terrorizeEffect}<br>`)}(e),e.creature.damage-=e.terrorizeEffect,function(e){e.creatureDamageDone=Math.ceil(e.generalVariable*e.creature.damage-e.overallArmorValue+e.overallHPValue)}(e),si(e)}const ii=e=>ni(e,e.callback.groupAttackValue,e.player.attackValue)
function ci(e){return Math.floor(e.creature.defense*e.player.darkCurseLevel*_e)}function ui(e){const t=ii(e)
e.player.darkCurseLevel>0&&(e.extraNotes+=`DC Bonus Attack = ${ci(e)}<br>`),e.nightmareVisageAttackMovedToDefense=Math.floor((t+e.counterAttackBonusAttack)*e.player.nightmareVisageLevel*.0025),e.player.nightmareVisageLevel>0&&(e.extraNotes+=`NMV Attack moved to Defense = ${e.nightmareVisageAttackMovedToDefense}<br>`),e.overallAttackValue=t+e.counterAttackBonusAttack-e.nightmareVisageAttackMovedToDefense,e.hitByHowMuch=function(e){const t=e.creature.defense-ci(e)
return 3===e.combatEvaluatorBias?e.overallAttackValue-Math.ceil(t)-50:e.overallAttackValue-Math.ceil(e.attackVariable*t)}(e)}const fi=(e,t,a)=>Math.max(Math.ceil((e-t+1)/a/.0025),0)
function di(e){e.lowestCALevelToStillHit=fi(e.counterAttackBonusAttack,e.hitByHowMuch,e.player.attackValue),e.lowestCALevelToStillKill=fi(e.counterAttackBonusDamage,e.damageDone,e.player.damageValue)}function mi(e){di(e),e.lowestFeasibleCALevel=Math.max(e.lowestCALevelToStillHit,e.lowestCALevelToStillKill),e.extraNotes+=`Lowest CA to still 1-hit this creature = ${e.lowestFeasibleCALevel}<br>`,0!==e.lowestFeasibleCALevel&&function(e){e.extraAttackAtLowestFeasibleCALevel=Math.floor(.0025*e.player.attackValue*e.lowestFeasibleCALevel),e.extraDamageAtLowestFeasibleCALevel=Math.floor(.0025*e.player.damageValue*e.lowestFeasibleCALevel),e.extraNotes+=`Extra CA Att/Dam at this lowered CA level = ${e.extraAttackAtLowestFeasibleCALevel} / ${e.extraDamageAtLowestFeasibleCALevel}<br>`}(e),e.extraStaminaPerHitAtLowestFeasibleCALevel=function(e){return e.player.counterAttackLevel>0?Math.ceil(.0025*(1+e.player.doublerLevel/50)*e.lowestFeasibleCALevel):0}(e),e.extraStaminaPerHitAtLowestFeasibleCALevel<e.extraStaminaPerHit?e.extraNotes+=`Extra Stam Used at this lowered CA level = ${e.extraStaminaPerHitAtLowestFeasibleCALevel}<br>`:e.extraNotes+="No reduction of stam used at the lower CA level<br>"}function pi(e,t,a){e[t]>203?e.extraNotes+=`Even with CA203 you cannot ${a} this creature<br>`:0!==e[t]&&(e.extraNotes+=`You need a minimum of CA${e[t]} to ${a} this creature<br>`)}function hi(e){(function(e){return e.player.counterAttackLevel>0&&1===e.numberOfHitsRequired})(e)&&mi(e),function(e){return"-"===e.numberOfHitsRequired||1!==e.numberOfHitsRequired}(e)&&function(e){di(e),pi(e,"lowestCALevelToStillHit","hit"),pi(e,"lowestCALevelToStillKill","1-hit kill")}(e)}const gi=e=>ni(e,e.callback.groupHPValue,e.player.hpValue),vi=e=>ni(e,e.callback.groupDamageValue,e.player.damageValue)
function bi(e){if(function(e){const t=gi(e),{fortitudeLevel:a}=e.player
...
e.chiStrikeExtraDamage=Math.floor(e.overallHPValue*t*.001),t>0&&(e.extraNotes+=`Chi Strike Bonus Damage = ${e.chiStrikeExtraDamage}<br>`)}(e),e.overallDamageValue=vi(e)+e.deathDealerBonusDamage+e.counterAttackBonusDamage+e.holyFlameBonusDamage+e.chiStrikeExtraDamage,e.damageDone=Math.floor(e.overallDamageValue-(e.generalVariable*e.creature.armor+e.hpVariable*e.creature.hp)),e.hitByHowMuch>0){let t=1
e.overallDamageValue>=e.generalVariable*e.creature.armor&&(t=e.overallDamageValue-e.generalVariable*e.creature.armor),e.numberOfHitsRequired=Math.ceil(e.hpVariable*e.creature.hp/t)}else e.numberOfHitsRequired="-"}const wi=e=>ni(e,e.callback.groupDefenseValue,e.player.defenseValue),ki=e=>Math.floor(wi(e)*e.player.constitutionLevel*.001)
const yi=e=>e.creature.attack-e.creature.attack*e.player.flinchLevel*.001-e.overallDefenseValue
function Ci(e){e.overallDefenseValue=wi(e)+ki(e)+e.nightmareVisageAttackMovedToDefense,function(e){e.player.constitutionLevel>0&&(e.extraNotes+=`Constitution Bonus Defense = ${ki(e)}<br>`)}(e),function(e){ri(e,e.player.flinchLevel,"Flinch Bonus Attack Reduction",e.creature.attack)}(e),e.creatureHitByHowMuch=Math.floor(e.attackVariable*yi(e)),3===e.combatEvaluatorBias&&(e.creatureHitByHowMuch=Math.floor(yi(e)-50))}function $i(e){e.extraNotes="",function(e){e.player.superEliteSlayerLevel>0&&(e.extraNotes+=`SES Stat Reduction Multiplier = ${e.player.superEliteSlayerMultiplier}<br>`)}(e),function(e){e.holyFlameBonusDamage=0,"Undead"===e.creature.class&&(e.holyFlameBonusDamage=Math.max(Math.floor((e.player.damageValue-e.creature.armor)*e.player.holyFlameLevel*.002),0),e.player.holyFlameLevel>0&&(e.extraNotes+=`HF Bonus Damage = ${e.holyFlameBonusDamage}<br>`))}(e),function(e){e.deathDealerBonusDamage=Math.floor(e.player.damageValue*(Math.min(.01*Math.floor(e.player.killStreakValue/5)*e.player.deathDealerLevel,20)/100))}(e),function(e){e.counterAttackBonusAttack=Math.floor(.0025*e.player.attackValue*e.player.counterAttackLevel),e.counterAttackBonusDamage=Math.floor(.0025*e.player.damageValue*e.player.counterAttackLevel)}(e),function(e){e.extraStaminaPerHit=0,e.player.counterAttackLevel>0&&(e.extraStaminaPerHit=Math.ceil(.0025*(1+e.player.doublerLevel/50)*e.player.counterAttackLevel))}(e),function(e){e.player.deathDealerLevel>0&&(e.extraNotes+=`DD Bonus Damage = ${e.deathDealerBonusDamage}<br>`)}(e),function(e){e.player.counterAttackLevel>0&&(e.extraNotes+=`CA Bonus Attack/Damage = ${e.counterAttackBonusAttack} / ${e.counterAttackBonusDamage}<br>CA Extra Stam Used = ${e.extraStaminaPerHit}<br>`)}(e)}const Li=e=>e.creatureHitByHowMuch>=0?"Yes":"No",Vi=e=>e.hitByHowMuch>0?"Yes":"No",Di=e=>`<span style="color:#333333">${e}</span>`,Mi=e=>`<tr>${e}</tr>`,xi=(e,t)=>`<td${t%2?"":' class="fshRight"'}>${e}</td>`,Ai=e=>Mi(e.map(xi).join("")),Si=e=>Mi(`<td bgcolor="#CD9E4B" colspan="4" align="center">${(e=>e.callback.groupExists?"Group ":"")(e)}Combat Evaluation</td>`),Ni=e=>Ai([Di("Will I hit it?"),Vi(e),Di("Extra Attack:"),`( ${e.hitByHowMuch} )`]),Hi=e=>Ai([Di("# Hits to kill it?"),e.numberOfHitsRequired,Di("Extra Damage:"),`( ${e.damageDone} )`]),Bi=e=>Ai([Di("Will I be hit?"),Li(e),Di("Extra Defense:"),`( ${-1*e.creatureHitByHowMuch} )`]),Ti=e=>Ai([Di("# Hits to kill me?"),e.numberOfCreatureHitsTillDead,Di("Extra Armor + HP:"),`( ${-1*e.creatureDamageDone} )`]),qi=e=>Ai([Di("# Player Hits?"),e.playerHits,Di("# Creature Hits?"),e.creatureHits]),Ei=e=>Mi(`${xi(Di("Fight Status:"),0)}<td colspan="3"><span>${e.fightStatus}</span></td>`),Gi=e=>Mi(`${xi(Di("Notes:"),0)}<td colspan="3"><span style="font-size:x-small;">${e.extraNotes}</span></td>`)
let Pi=0,ji=0,Fi=0
function _i(){return cr(ji)?"Remove from do not kill list":"Add to the do not kill list"}function Ri(){r(_i(),Fi)}function Oi(){c("NewMap","doNotKillLink")
const e=t.doNotKillList.indexOf(ji);-1===e?t.doNotKillList.push(ji):t.doNotKillList.splice(e,1),Ri(),V("doNotKillList",t.doNotKillList.join()),fr()}function Ii(){Fi?Ri():function(){Fi=bt({className:"fshBl",textContent:_i()})
const e=a({className:"description",innerHTML:'<span class="ui-helper-hidden-accessible"><input type="text"></span>'})
o(e,Fi),o(Pi,e),i(Fi,Oi)}()}function Wi(e,t){!function(e){if(!Pi){const t=G("body",e)
1===t.length&&([Pi]=t)}}(t),Pi&&(ji=I(e),Ii())}let Ki=0,Yi=0,Ui=0,zi=0
function Qi(){Ui||(Yi||(Yi=a(),o(Ki,Yi),o(Ki,a({innerHTML:'<span class="fshFooter">*Does include CA, DD, HF, DC, Flinch, Super Elite Slayer, NMV, Sanctuary, Constitution, Fortitude, Chi Strike and Terrorize (if active) and allow for randomness (1.1053). Constitution, NMV, Fortitude and Chi Strike apply to group stats.</span>'}))),Ui=a(),o(Yi,Ui))}function Ji(e){Qi(),ye(e,Ui)}function Xi(e){zi||(Qi(),zi=a(),o(Yi,zi)),ye(e,zi)}function Zi(e,t){const a={name:e.name,class:e.creature_class,attack:Number(e.attack),defense:Number(e.defense),armor:Number(e.armor),damage:Number(e.damage),hp:Number(e.hp)}
return function(e,t,a){3===a&&(t.attack-=Math.ceil(t.attack*e),t.defense-=Math.ceil(t.defense*e),t.armor-=Math.ceil(t.armor*e),t.damage-=Math.ceil(t.damage*e),t.hp-=Math.ceil(t.hp*e))}(t,a,e.type),a}function ec(e,a,n){const r={}
r.callback=n,r.player=As(a),function(e){e.combatEvaluatorBias=t.combatEvaluatorBias,e.attackVariable=1.1053,e.generalVariable=t.generalVariable,e.hpVariable=t.hpVariable}(r),r.creature=Zi(e.response.data,r.player.superEliteSlayerMultiplier),function(e){var t
t=e,[$i,ui,bi,Ci,li,ai,hi].forEach((e=>e(t)))}(r),r.evaluatorHTML=function(e){return`<table width="100%"><tbody>${Si(e)}${Ni(e)}${Hi(e)}${Bi(e)}${Ti(e)}${qi(e)}${Ei(e)}${Gi(e)}</tbody></table>`}(r),n.groupExists?Xi(r.evaluatorHTML):Ji(r.evaluatorHTML)}function tc(e){return e.members[0].name===u()}async function ac(e,t,a){if(a){!function(e,t,a){if(!a.r?.attributes)return
const n=a.r.attributes
ec(e,t,{groupExists:!0,groupAttackValue:n[0].value,groupDefenseValue:n[1].value,groupArmorValue:n[2].value,groupDamageValue:n[3].value,groupHPValue:n[4].value})}(e,t,await Rt(a))}}async function nc(e,t){const a=function(e){if(wt(e.r))return e.r.find(tc)?.id}(await Wt())
ac(e,t,a)}async function rc(e,t){if(Ki||(Ki=n("dialog-viewcreature")),Ki&&(Ji(""),Xi(""),t?.response?.data)){Wi(t.response.data.name,Ki)
const e=await Qt(!0)
e&&function(e,t){e.player.hasGroup&&nc(e,t),ec(e,t,{groupExists:!1})}(t,e)}}let oc=0
function sc(e){const t=G("verbs",e)
1===t.length&&lt(t[0])}function lc(){if(!oc)return
const e=n("actionList")
W("player",e).forEach(sc)}const ic="showHuntingBuffs"
function cc(){return`${Xt(ic)} ${Zt("enabledHuntingMode")}<select name="enabledHuntingMode"><option value="1"${ea(t.enabledHuntingMode,"1")}>${t.buffsName}</option><option value="2"${ea(t.enabledHuntingMode,"2")}>${t.buffs2Name}</option><option value="3"${ea(t.enabledHuntingMode,"3")}>${t.buffs3Name}</option></select>`}let uc=0,fc=""
const dc=()=>uc,mc=()=>fc
function pc(){const e=[null,[t.buffs,t.buffsName],[t.buffs2,t.buffs2Name],[t.buffs3,t.buffs3Name]][t.enabledHuntingMode]
wt(e)&&([uc,fc]=e)}function hc(e){"enabledHuntingMode"===e.target.name&&(c("NewMap","toggleEnabledHuntingMode"),t.enabledHuntingMode=e.target.value,V("enabledHuntingMode",t.enabledHuntingMode),pc(),GameData.fetch(f))}function gc(e){c("NewMap","togglePref"),t[e]=!t[e],V(e,t[e])}const vc={hideSubLvlCreature:function(){gc("hideSubLvlCreature"),GameData.fetch(Xe)},hidePlayerActions:function(){c("NewMap","toggleHidePlayerActions"),oc=!oc,V("hidePlayerActions",oc),GameData.fetch(Xe)},showCreatureInfo:()=>gc("showCreatureInfo"),showHuntingBuffs:function(){gc("showHuntingBuffs"),GameData.fetch(f)},showMonsterLog:()=>gc("showMonsterLog"),showTitanInfo:function(){gc("showTitanInfo"),hs(GameData.realm().dynamic)},showBuffInfo:function(){gc("showBuffInfo"),ja()}}
function bc(e){const t=vc[e.target.name]
U(t)&&(e.target.blur(),t(e))}function wc(){const e=n("worldPage")
if(!e)return
const t=a({className:"fshCenter fshFten"}),r=a({id:"fshWorldPrefs",innerHTML:`${Xt("showCreatureInfo")}&nbsp;&nbsp;${Xt("showMonsterLog")}&nbsp;&nbsp;${Xt("showTitanInfo")}&nbsp;&nbsp;${Xt("showBuffInfo")}<br>${Xt("hideSubLvlCreature")}&nbsp;&nbsp;${Xt("hidePlayerActions")}&nbsp;&nbsp;${cc()}`})
i(r,bc),v(r,"change",hc),o(t,r)
const s=a()
return o(t,s),o(e,t),s}const kc=[{generalVariable:1.1053,hpVariable:1.1},{generalVariable:1.1,hpVariable:1.053},{generalVariable:1.053,hpVariable:1},{generalVariable:1.1053,hpVariable:1}]
function yc(){var e
t.combatEvaluatorBias=b("combatEvaluatorBias"),t.generalVariable=(e=t.combatEvaluatorBias,kc[e]?kc[e].generalVariable:1.1053),t.hpVariable=function(e){return kc[e]?kc[e].hpVariable:1.1}(t.combatEvaluatorBias)}function Cc(e,t){return e[t.name]=!0,e}function $c(e,t,a){return e[I(a)]||t.push(a),t}function Lc(e){ye("",e)}function Vc(e,t){const a=t.b.reduce(Cc,{}),n=dc().reduce(s($c,a),[])
n.length>0?function(e,t){ye(`You are missing some ${mc()} hunting buffs<br>(${t.join(", ")})`,e)}(e,n):Lc(e)}function Dc(e,a,n){dc()&&function(e,a){t.showHuntingBuffs?Vc(e,a):Lc(e)}(e,n)}function Mc(e,t){return 6!==t.type||(0!==t.data.creature_type||t.data.level>=e)}function xc(e){const t=q(e)
return t?.actions?.length?(t.actions=t.actions.filter(s(Mc,function(e){return e.realm?.minlevel||GameData.realm().minlevel}(t))),it(t)):e}function Ac(e,a){t.hideSubLvlCreature&&function(e){return e.data?.d&&ta(e.data.d,Xe)}(a)&&(e.dataFilter=xc)}function Sc(e){t[e[0]]=Jt(e[1])}function Nc(e){t[e]=Jt(e)}function Hc(){[["buffs","huntingBuffs"],["buffs2","huntingBuffs2"],["buffs3","huntingBuffs3"]].forEach(Sc),["doNotKillList"].forEach(Nc)}function Bc(e){t[e[0]]=b(e[1])}function Tc(e){t[e]=b(e)}function qc(){[["buffsName","huntingBuffsName"],["buffs2Name","huntingBuffs2Name"],["buffs3Name","huntingBuffs3Name"],["showHuntingBuffs","showHuntingBuffs"]].forEach(Bc),["enabledHuntingMode","hideSubLvlCreature","showTitanInfo","showBuffInfo","showMonsterLog","showCreatureInfo"].forEach(Tc)}const Ec=[function(){let e=0
window.requestAnimationFrame=t=>{const a=window.performance.now(),n=Math.max(e+16,a)
return e=n,setTimeout((()=>{t(e)}),n-a)},window.cancelAnimationFrame=clearTimeout},function(){yc(),Hc(),qc()
const e=wc()
$.ajaxPrefilter("JSON",Ac),t.hideSubLvlCreature&&GameData.fetch(Xe),function(e){pc()
const a=s(Dc,e)
$.subscribe(d,a),t.showHuntingBuffs&&window.initialGameData&&a(null,{b:window.initialGameData.player.buffs})}(e),oc=b("hidePlayerActions"),$.subscribe(z,lc),lc()},function(){Ze(),et()&&Gl()},function(){$.subscribe(st,rc)},function(){Hr.forEach(Br)},function(){b("enableCreatureColoring")&&o(document.body,Vt("#actionList .creature-1 {color: green;}\n#actionList .creature-2 {color: yellow;}\n#actionList .creature-3 {color: red;}"))},function(){$.subscribe(z,fr),fr(),function(){const e=GameData.doAction
GameData.doAction=pr(e)}()},function(){Ur(),$.subscribe("-1-success.action-response 4-success.action-response 5-success.action-response 25-success.action-response",eo),eo()},function(){$.subscribe(ze,Al)},async function(){if(b("keepLogs")){!function(e){e&&($n=e),$.subscribe(N,xn)}(await S("fsh_combatLog"))}},function(){window.initialGameData&&vs(0,window.initialGameData),$.subscribe(`${Le} ${Ve}`,vs)},function(){$.subscribe(nt,Yl)},function(){$.subscribe(Ue,xl)},function(){$("#messageCenter").worldMessageCenter({offset:"0 60"})},function(){w("#mapTooltip")},function(){cn(),$.subscribe(p,un),$.subscribe(h,fn)},function(){ja(),$.subscribe(`${d} ${m}`,ja)},function(){v(n("actionList"),"mouseover",ir)},function(){const{body:e}=document
...
!function(e,t){new Jl({target:e,props:t})}(e,{tpButton:e})},function(){var e
b("messageStack")&&(e=n("messageCenter"),new jr({target:e}))},function(){GameController?.Realm?.footprintTexture?Hl():$.subscribe("fixed.realm",Bl)}]
function Gc(){e(Ec)}export{Gc as default}
//# sourceMappingURL=newMap-CeYhde-N.js.map
