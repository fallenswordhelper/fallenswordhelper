import{a,$ as s,C as t,f as e,bp as r,b as n,aQ as o,dO as c,bJ as m,aS as i}from"./calfSystem-Blt4DbaE.js"
import{u as p}from"./uniq-D422dDMJ.js"
...
return{lastUpdate:t,...w(n)}}(N,a),i("fsh_seLog",N),h.set(N))}function L(a,s){g=s,a(g),g&&!A&&async function(){for(A=!0,N=await o("fsh_seLog"),h.set(N);g;)A=!0,await c(1e3*x(N)),g&&await E(),A=!1}()}const M=function(){const{subscribe:a,set:s}=r(0)
return{subscribe:a,set:n(L,s)}}()
var O=Object.freeze({__proto__:null,default:M})
export{O as a,f as p,h as s,M as t}
//# sourceMappingURL=trackerPrefStore-Da3PKx5-.js.map
