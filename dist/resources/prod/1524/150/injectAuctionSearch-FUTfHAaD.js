import{U as t,db as e,p as s,h as a,an as n,g as c,a5 as i,o as r,s as d,bb as l,cl as o,K as u}from"./calfSystem-BGOTz8de.js"
import{e as h,s as f}from"./selfIdIs-7BV1yzfH.js"
import{i as m}from"./isChecked-D_0do7nT.js"
let p=0
function b(t,e){return"checkbox"===p.tags[t]?`<input type="checkbox"${m(e)} disabled>`:function(t){return p.url&&""!==p.url[t]}(t)?`<a href="${p.url[t].replace("@replaceme@",e)}">${e}</a>`:e}function g(t,e){return`${t}<th>${e}</th>`}function y(t,e,s,a){let n="<tr>"
...
function A(){const t=`${$}${p.headers.reduce(g,"")}<th>Action</th></tr>${p.currentItems.reduce(y,"")}${function(){let t="<tr>"
...
p.currentItems.splice(e,1),A()}const w=t=>c(`fshIn${p.fields[t]}`)
...
u(t)&&(p.currentItems=t,A())}function H(){d("injectAuctionSearch","resetRawEditor"),"fshAso"===p.id?p.currentItems=l(o.quickSearchList):p.currentItems=[],A()}function j(t){r(t,h([[f("fshReset"),H],[f("fshSave"),S],[f("fshAdd"),x],[t=>t.id.startsWith("fshDel"),v]]))}function T(n){const c=n||s()
...
//# sourceMappingURL=injectAuctionSearch-FUTfHAaD.js.map
