import{$ as e,a as t,h as a,o as r,j as n,k as s,l as u,m as c,n as o,p as f,M as i,t as d,u as g}from"./calfSystem-KFszEm2S.js"
import{b as m}from"./buffmarket-yCcQ7hT7.js"
import{c as l}from"./closestTd-B3n7Fm_s.js"
function p(e){return m({subcmd:"toggle",id:e})}function b(e){return t({cmd:"buffmarket",subcmd:"toggle",id:e},"Buff Package toggled!")}function k(t){return e(p,b,t)}function h(e){return m({subcmd:"feature",id:e})}function v(e){return t({cmd:"buffmarket",subcmd:"feature",id:e},"Buff Package featured for 24 hours!")}function y(t){return e(h,v,t)}function B(e){return m({subcmd:"delete",id:e})}function E(e){return t({cmd:"buffmarket",subcmd:"delete",id:e},"Buff Package deleted!")}function C(t){return e(B,E,t)}function P(e,t){const a=e.getAttribute("onclick").match(/id=(\d+)/)[1]
...
return e.append(t),e}(),n=l(e.target)
n.replaceWith(r)
const s=await t(a)
...
//# sourceMappingURL=injectManage-Dw-Idnjt.js.map
