import{q as t,l as n,p as a,u as o,cK as s,o as e,c as i,h as c,s as u,e as p,g as d,k as r}from"./calfSystem-KFszEm2S.js"
import{c as f}from"./closestTable-D_vJ9Njb.js"
...
c(t).forEach((t,a)=>{r(n(o[a]),t)})}("#statbar-gold, #statbar-gold-tooltip dd, #pCC b",s),h(o.depoPos)}function v(t,n,a){a.preventDefault(),u("bank",n),async function(t,n,a){const o=await p({...t.data,mode:n,amount:a})
if(!o)return
...
u&&c&&function(t,n,a){h(t.depoPos),e(n,i(v,t,"deposit")),e(a,i(v,t,"withdraw"))}(n,c,u)}function k(a){const o=t(a.headSelector)
o&&n(o)===a.headText&&g(a)}export{k as a}
//# sourceMappingURL=ajaxifyBank-CaEms2rC.js.map
