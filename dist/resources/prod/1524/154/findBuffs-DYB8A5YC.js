import{bx as t,bX as e,cq as n,ax as s,b_ as a,az as r,g as o,d as i,af as c,l,b4 as f,c$ as u,q as d,a3 as p,cD as b,r as h,c as m,aM as y,dh as g,p as v,o as x,s as k,bu as w,bv as L,au as P,a2 as C,e3 as B,h as I,di as S,dN as T,e4 as E,aU as N,b6 as A,bB as j,bk as D}from"./calfSystem-KFszEm2S.js"
import{o as R}from"./onlinePlayersPage-Ckw7Ipi3.js"
import{b as F}from"./buffObj-BIwiFUIW.js"
import{h as M}from"./simpleCheckbox-C7oDqkXH.js"
import{o as q}from"./onlineDot-hLWANonx.js"
...
function ut(t,e){i(t,o(e))}async function dt(t){!function(t,e){st(e,{href:t,findBuffNicks:at})}(t,await D(t))}function pt(){ut(ot.length,"potentialBuffers"),ot.length<=0?z("Done.","blue"):(z("Parsing player data ...","green"),ot.forEach(dt))}function bt(t,e){A()!==L(e)&&ot.push(t)}function ht(t,e){if(n=function(t){return parseInt($(t).find("td:eq(2)").text().replace(/,/g,""),10)}(e),n>=rt&&n>=Q()){bt($(e).find("td:eq(1) a").attr("href"),$(e).find("td:eq(1) a").text())}var n}async function mt(t,e,n){const s=function(t,e){return 1===t?Math.round(it*e/50):t+1}(t,e)
...
n<s?mt(n,s,yt):pt()}async function gt(){if(it=parseInt(o("onlinePlayers").value,10),0!==it){yt(await R(1))}else pt()}function $t(t){const{tipped:e}=t.dataset,{mins:n}=S(e);(function(t,e,n){return t<5&&e>=rt&&e>=n})(n,Number(h(T,e)),Q())&&bt(t.href,l(t))}function vt(t){lt.push(j+t)}async function xt(t){!function(t){const e=c(t)
I('#profileLeftColumn a[data-tipped*="Last Activity"]',e).forEach($t),ft+=1,ft===lt.length&&gt()}(await D(t))}function kt(t){const e=c(t)
o("guildMembers").checked&&I('#pCC a[data-tipped*="<td>VL:</td>"]',e).forEach($t),lt=[],lt.push(E),N(ct).forEach(vt),ft=0,o("alliesEnemies").checked?lt.forEach(xt):gt()}function wt(t,e){return 0!==e}function Lt(t){t.deleteRow(-1)}function Pt(){k("find buffs","clear results"),function(){const t=o("buffTable")
w(t.rows).filter(wt).forEach(m(Lt,t))}(),ut("","buffNicks"),z("Idle.","black"),ut("","potentialBuffers"),ut("0","buffersProcessed")}function Ct(t){C()||(ut(at,"buffNicks"),z(`Gathering list of ${t} ...`,"green"),J=o("level175").checked,ut("0","buffersProcessed"),ot=[],ct=o("extraProfile").value,P("extraProfile",ct),async function(){kt(await B())}())}function Bt(t,e){return t===e.id}function It(){k("find buffs","findBuffsStart")
const t=parseInt($("#selectedBuff").val(),10),e=F.find(m(Bt,t))
at=e.nicks,rt=e.lvl,Ct("potential buffers")}function St(){k("find buffs","findOtherStart")
const t=$("#textToSearchFor").val().split(",").map(L).join(",")
P("textToSearchFor",t),at=t,rt=1,Ct("profiles to search")}function Tt(){ct=r("extraProfile")}function Et(t){x(o("findbuffsbutton"),t,!0)}function Nt(){x(o("clearresultsbutton"),Pt,!0)}function At(t){const e=t||v()
s.sortBy="name",s.sortAsc=!0,F.sort(G),Tt(),i(K(_,ct),e),X(),Et(It),Nt()}function jt(t){const e=t||v()
Tt(),i(K(V,ct),e),X(),Et(St),Nt()}export{At as injectFindBuffs,jt as injectFindOther}
//# sourceMappingURL=findBuffs-DYB8A5YC.js.map
