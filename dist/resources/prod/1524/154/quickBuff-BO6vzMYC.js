import{g as t}from"./getProfile-BnPxlZjo.js"
import{e as n}from"./executeAll-DIAWIge1.js"
import{q as s,d as e,b3 as a,aP as c,b4 as f,b5 as i,l as u,s as r,h as o,c as l,aU as b,g as d,aJ as h,aq as p,b6 as m,az as k,b as q,ai as S,au as y,a2 as $,o as g}from"./calfSystem-KFszEm2S.js"
import{i as T}from"./insertHtmlAfterEnd-F9ihJfxX.js"
import{s as v}from"./setTipped-_gKWzwad.js"
import{d as x,q as B}from"./quickbuffSuccess-DqzKikHx.js"
...
v(s.replace("</center>",`<br>Stamina Cost: ${e}$&`),n)}(t,n),_(t,n)}function P(){o('#buff-outer label[for^="skill-"]').forEach(O)}function w(t){const n=f("h1",d("players"))[0]
!function(t,n){return!t&&n}(n,t)?n&&D(n):setTimeout(w,100,t-1)}function F(){d("targetPlayers").value&&w(9)}function G(t){const n=function(t){const n=Math.floor(t/60),s=t%60
let e=h(n,"m")
return n>0&&s>0&&(e+=" "),e+=h(s,"s"),e}(t)
return`<span class="fshLime">On</span>&nbsp;<span class="fshBuffOn">(${n})</span>`}function I(t,n){const e=t[n]??0
return e?G(e):function(t){const n=s(`#buff-outer input[data-name="${t}"]`)
return n?`<span class="quickbuffActivate" data-buffid="${n.value}">Activate</span>`:'<span class="fshRed;">Off</span>'}(n)}function J(t,n,s){e(I(t,n),s)}function Q(t,n){return t[n.name]=n.duration,t}function z(t,n,s){const a=function(t,n){const s=t.find((t=>n=>n.name===t)(n))
...
J(n,"Guild Buffer",d("fshGB")),J(n,"Buff Master",d("fshBM")),J(n,"Extend",d("fshExt")),J(n,"Reinforce",d("fshRI"))}(t)}function U(t){const n=d(`skill-${t}`)
n&&(n.checked=!0)}function V(){const t=p("blist")
t&&function(t){t.split(";").forEach(U)}(t)}let W=0
function X(){W.length?(window.addPlayers([W.shift()]),setTimeout(X,200)):setTimeout(F,200)}function Y(){const t=p("players")
...
if(!s)return
const e=t(m())
T(s.children[0],'<div id="helperQBheader"><table class="quickbuffTable"><thead><tr><th class="quickbuffTableHeader">Sustain</th><th class="quickbuffTableHeader">Fury Caster</th><th class="quickbuffTableHeader">Guild Buffer</th><th class="quickbuffTableHeader">Buff Master</th><th class="quickbuffTableHeader">Extend</th><th class="quickbuffTableHeader">Reinforce</th></tr></thead><tbody><tr><td id="fshSus" class="quickbuffTableDetail">&nbsp;</td><td id="fshFur" class="quickbuffTableDetail">&nbsp;</td><td id="fshGB"  class="quickbuffTableDetail">&nbsp;</td><td id="fshBM"  class="quickbuffTableDetail">&nbsp;</td><td id="fshExt" class="quickbuffTableDetail">&nbsp;</td><td id="fshRI"  class="quickbuffTableDetail">&nbsp;</td></tr></tbody></table></div>'),n([P,V,Y,ft,F,ct,it]),K(await e)}export{ut as default}
//# sourceMappingURL=quickBuff-BO6vzMYC.js.map
