...
function header(o) {
  return `<tr><td rowspan="2" colspan="2" class="headCell"><h1>Find ${
    o.header
  }</h1></td><td class="findLabel">Select ${
    o.what
...
function outputTable(o) {
  return (
    `<br><h1>Potential ${o.processed}ers and Bio Info</h1><br>` +
...
export default function pageLayout(o, extraProfile) {
  // Legacy
  return `<table class="fshFind"><tbody>${header(o)}${cutoff(o)}${searchGuildMembers(
    o,
  )}${searchAlly(o, extraProfile)}${onlineList(o)}${progress(
    o,
  )}</tbody></table>${outputTable(o)}${disclaimer()}`;
}
