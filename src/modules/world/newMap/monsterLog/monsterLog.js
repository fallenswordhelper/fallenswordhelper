...
import { getMonsterPrefs, processMonsterLog } from './processMonsterLog';
...
function thisMob(e, el) {
  return e.id === el.id;
}

function seenBefore(e) {
  if (processedMonsters.find(partial(thisMob, e.data))) {
    return true;
  }
